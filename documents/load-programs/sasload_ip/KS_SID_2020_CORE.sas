...
*  Data Step                  *;                                                
*******************************;                                                
DATA KS_SIDC_2020_CORE;                                                         
INFILE 'KS_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 936;                           
...
INPUT                                                                           
      ...
      @84     HISPANIC                      N2PF.                               
      @86     HISPANIC_X                    $CHAR1.                             
      @87     HospitalUnit                  N2PF.                               
      @89     HOSPST                        $CHAR2.                             
      @91     I10_BIRTH                     N3PF.                               
      @94     I10_DELIVERY                  N3PF.                               
      @97     I10_DX1                       $CHAR7.                             
      @104    I10_DX2                       $CHAR7.                             
      @111    I10_DX3                       $CHAR7.                             
      @118    I10_DX4                       $CHAR7.                             
      ...
      @474    I10_PR24                      $CHAR7.                             
      @481    I10_PR25                      $CHAR7.                             
      @488    I10_PROCTYPE                  N3PF.                               
      @491    I10_SERVICELINE               N2PF.                               
      @493    KEY                           15.                                 
      @508    LOS                           N5PF.                               
      @513    LOS_X                         N6PF.                               
      @519    MDC                           N2PF.                               
      ...
      @546    PAY3                          N2PF.                               
      @548    PAY3_X                        $CHAR3.                             
      @551    PCLASS_ORPROC                 N2PF.                               
      @553    PL_CBSA                       N3PF.                               
      @556    PL_NCHS                       N2PF.                               
      @558    PL_RUCC                       N2PF.                               
      @560    PL_UIC                        N2PF.                               
      @562    PL_UR_CAT4                    N2PF.                               
      @564    POA_Disch_Edit1               N2PF.                               
      @566    POA_Disch_Edit2               N2PF.                               
      @568    POA_Hosp_Edit1                N2PF.                               
      @570    POA_Hosp_Edit2                N2PF.                               
      @572    POA_Hosp_Edit3                N2PF.                               
      @574    POA_Hosp_Edit3_Value          N8P2F.                              
      ...
      @704    PRDAY25                       N5PF.                               
      @709    PSTATE                        $CHAR2.                             
      @711    PSTATE_GEO                    $CHAR2.                             
      @713    PSTCO                         N5PF.                               
      @718    PSTCO_GEO                     N5PF.                               
      @723    RACE                          N2PF.                               
      @725    RACE_PCT_MISS_HOSP            N7P2F.                              
      @732    RACE_X                        $CHAR1.                             
      @733    TOTCHG                        N10PF.                              
      @743    TOTCHG_X                      N15P2F.                             
      @758    TRAN_IN                       N2PF.                               
