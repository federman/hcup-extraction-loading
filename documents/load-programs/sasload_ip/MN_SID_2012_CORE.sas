...
*  Data Step                  *;                                                
*******************************;                                                
DATA MN_SIDC_2012_CORE;                                                         
INFILE 'MN_SID_2012_CORE.ASC' FIRSTOBS=3 LRECL = 2005;                          
...
INPUT                                                                           
      ...
      @783    LOS                           N5PF.                               
      @788    LOS_X                         N6PF.                               
      @794    MARITALSTATUSUB04             $CHAR1.                             
      @795    MARITALSTATUS_X               $CHAR1.                             
      @796    MDC                           N2PF.                               
      @798    MDC24                         N2PF.                               
      @800    MDC_NoPOA                     N2PF.                               
      @802    MEDINCSTQ                     N2PF.                               
      ...
      @1641   PSTATE                        $CHAR2.                             
      @1643   PSTCO2                        N5PF.                               
      @1648   PointOfOriginUB04             $CHAR1.                             
      @1649   PointOfOrigin_X               $CHAR1.                             
      @1650   TOTCHG                        N10PF.                              
