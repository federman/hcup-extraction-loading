...
INFILE 'AR_SID_2009_CORE.ASC' LRECL = 698;                                      
...
INPUT                                                                           
      ...
      @456    PL_CBSA                  N3PF.                                    
      @459    PL_MSA1993               N3PF.                                    
      @462    PL_NCHS2006              N2PF.                                    
      @464    PL_RUCA10_2005           N2PF.                                    
      @466    PL_RUCA2005              N4P1F.                                   
      @470    PL_RUCA4_2005            N2PF.                                    
      @472    PL_RUCC2003              N2PF.                                    
      @474    PL_UIC2003               N2PF.                                    
      @476    PL_UR_CAT4               N2PF.                                    
      @478    PNUM_R                   N9PF.                                    
      @487    PR1                      $CHAR4.                                  
      ...
      @586    PSTATE                   $CHAR2.                                  
      @588    PSTCO2                   N5PF.                                    
      @593    PointOfOriginUB04        $CHAR1.                                  
      @594    PointOfOrigin_X          $CHAR1.                                  
      @595    RACE                     N2PF.                                    
      @597    RACE_X                   $CHAR1.                                  
      @598    TOTCHG                   N10PF.                                   
      @608    TOTCHG_X                 N15P2F.                                  
