...
*  Data Step                  *;                                                
*******************************;                                                
DATA SD_SIDC_2017_CORE;                                                         
INFILE 'SD_SID_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1016;                          
...
INPUT                                                                           
      ...
      @91     HISPANIC                      N2PF.                               
      @93     HISPANIC_X                    $CHAR1.                             
      @94     HospitalUnit                  N2PF.                               
      @96     HOSPST                        $CHAR2.                             
      @98     I10_DX_Admitting              $CHAR7.                             
      @105    I10_DX1                       $CHAR7.                             
      @112    I10_DX2                       $CHAR7.                             
      @119    I10_DX3                       $CHAR7.                             
      @126    I10_DX4                       $CHAR7.                             
      ...
      @639    PL_UIC                        N2PF.                               
      @641    PL_UR_CAT4                    N2PF.                               
      @643    POA_Disch_Edit1               N2PF.                               
      @645    POA_Disch_Edit2               N2PF.                               
      @647    POA_Hosp_Edit1                N2PF.                               
      @649    POA_Hosp_Edit2                N2PF.                               
      @651    POA_Hosp_Edit3                N2PF.                               
      @653    POA_Hosp_Edit3_Value          N8P2F.                              
