...
*  Data Step                  *;                                                
*******************************;                                                
DATA CA_SIDC_2019_CORE;                                                         
INFILE 'CA_SID_2019_CORE.ASC' FIRSTOBS=3 LRECL = 991;                           
...
INPUT                                                                           
      ...
      @548    I10_PR24                      $CHAR7.                             
      @555    I10_PR25                      $CHAR7.                             
      @562    I10_PROCTYPE                  N3PF.                               
      @565    I10_SERVICELINE               N2PF.                               
      @567    KEY                           15.                                 
      @582    LOS                           N5PF.                               
      @587    LOS_X                         N6PF.                               
      @593    MDC                           N2PF.                               
