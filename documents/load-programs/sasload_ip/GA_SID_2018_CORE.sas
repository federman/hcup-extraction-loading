...
*  Data Step                  *;                                                
*******************************;                                                
DATA GA_SIDC_2018_CORE;                                                         
INFILE 'GA_SID_2018_CORE.ASC' FIRSTOBS=3 LRECL = 3725;                          
...
INPUT                                                                           
      ...
      @1646   I10_DX98                      $CHAR7.                             
      @1653   I10_DX99                      $CHAR7.                             
      @1660   I10_DX100                     $CHAR7.                             
      @1667   I10_DX101                     $CHAR7.                             
      @1674   I10_DX102                     $CHAR7.                             
      @1681   I10_DX103                     $CHAR7.                             
      @1688   I10_DX104                     $CHAR7.                             
      @1695   I10_NDX                       N3PF.                               
      @1698   I10_NPR                       N3PF.                               
      @1701   I10_PR1                       $CHAR7.                             
      @1708   I10_PR2                       $CHAR7.                             
      ...
      @2380   I10_PR98                      $CHAR7.                             
      @2387   I10_PR99                      $CHAR7.                             
      @2394   I10_PR100                     $CHAR7.                             
      @2401   I10_PROCTYPE                  N3PF.                               
      @2404   KEY                           15.                                 
      @2419   LOS                           N5PF.                               
      @2424   LOS_X                         N6PF.                               
      @2430   MARITALSTATUS_X               $CHAR1.                             
      @2431   MARITALSTATUSUB04             $CHAR1.                             
      @2432   MDC                           N2PF.                               
      @2434   MDC_NoPOA                     N2PF.                               
      @2436   MDNUM1_R                      N9PF.                               
      @2445   MDNUM2_R                      N9PF.                               
      ...
      @2512   PL_RUCC                       N2PF.                               
      @2514   PL_UIC                        N2PF.                               
      @2516   PL_UR_CAT4                    N2PF.                               
      @2518   POA_Disch_Edit1               N2PF.                               
      @2520   POA_Disch_Edit2               N2PF.                               
      @2522   POA_Hosp_Edit1                N2PF.                               
      @2524   POA_Hosp_Edit2                N2PF.                               
      @2526   POA_Hosp_Edit3                N2PF.                               
      @2528   POA_Hosp_Edit3_Value          N8P2F.                              
      @2536   PointOfOrigin_X               $CHAR1.                             
      @2537   PointOfOriginUB04             $CHAR1.                             
      @2538   PRDAY1                        N5PF.                               
      @2543   PRDAY2                        N5PF.                               
      @2548   PRDAY3                        N5PF.                               
      @2553   PRDAY4                        N5PF.                               
