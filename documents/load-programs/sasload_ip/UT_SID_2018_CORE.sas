...
*  Data Step                  *;                                                
*******************************;                                                
DATA UT_SIDC_2018_CORE;                                                         
INFILE 'UT_SID_2018_CORE.ASC' FIRSTOBS=3 LRECL = 1733;                          
...
INPUT                                                                           
      ...
      @1224   DaysToEvent                   N6PF.                               
      @1230   DHOUR                         N4PF.                               
      @1234   DIED                          N2PF.                               
      @1236   DISP_X                        $CHAR2.                             
      @1238   DISPUB04                      N2PF.                               
      @1240   DISPUNIFORM                   N2PF.                               
      @1242   DMONTH                        N2PF.                               
      @1244   DQTR                          N2PF.                               
      @1246   DRG                           N3PF.                               
      @1249   DRG_NoPOA                     N3PF.                               
      ...
      @1468   I10_PR5                       $CHAR7.                             
      @1475   I10_PR6                       $CHAR7.                             
      @1482   I10_PROCTYPE                  N3PF.                               
      @1485   KEY                           15.                                 
      @1500   LOS                           N5PF.                               
      @1505   LOS_X                         N6PF.                               
      @1511   MARITALSTATUS_X               $CHAR1.                             
      @1512   MARITALSTATUSUB04             $CHAR1.                             
      @1513   MDC                           N2PF.                               
      @1515   MDC_NoPOA                     N2PF.                               
      @1517   MDNUM1_R                      N9PF.                               
      @1526   MEDINCSTQ                     N2PF.                               
      ...
      @1580   PL_RUCC                       N2PF.                               
      @1582   PL_UIC                        N2PF.                               
      @1584   PL_UR_CAT4                    N2PF.                               
      @1586   PointOfOrigin_X               $CHAR1.                             
      @1587   PointOfOriginUB04             $CHAR1.                             
      @1588   PRDAY1                        N5PF.                               
      @1593   PRDAY2                        N5PF.                               
      @1598   PRDAY3                        N5PF.                               
      @1603   PRDAY4                        N5PF.                               
