...
*  Data Step                  *;                                                
*******************************;                                                
DATA CA_SIDC_2020_CORE;                                                         
INFILE 'CA_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 996;                           
...
INPUT                                                                           
      ...
      @599    PAY1_X                        $CHAR3.                             
      @602    PAYER1_X                      $CHAR4.                             
      @606    PCLASS_ORPROC                 N2PF.                               
      @608    PL_CBSA                       N3PF.                               
      @611    PL_NCHS                       N2PF.                               
      @613    PL_RUCC                       N2PF.                               
      @615    PL_UIC                        N2PF.                               
      @617    PL_UR_CAT4                    N2PF.                               
      @619    POA_Disch_Edit1               N2PF.                               
      @621    POA_Disch_Edit2               N2PF.                               
      @623    POA_Hosp_Edit1                N2PF.                               
      @625    POA_Hosp_Edit2                N2PF.                               
      @627    POA_Hosp_Edit3                N2PF.                               
      @629    POA_Hosp_Edit3_Value          N8P2F.                              
      @637    PointOfOrigin_X               $CHAR1.                             
      ...
      @759    PRDAY25                       N5PF.                               
      @764    PSTATE                        $CHAR2.                             
      @766    PSTATE_GEO                    $CHAR2.                             
      @768    RACE                          N2PF.                               
      @770    RACE_PCT_MISS_HOSP            N7P2F.                              
      @777    RACE_X                        $CHAR10.                            
      @787    TOTCHG                        N10PF.                              
      @797    TOTCHG_X                      N15P2F.                             
      @812    TRAN_IN                       N2PF.                               
