...
*  Data Step                  *;                                                
*******************************;                                                
DATA MI_SIDC_2020_CORE;                                                         
INFILE 'MI_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 1006;                          
...
INPUT                                                                           
      ...
      @502    I10_PR29                      $CHAR7.                             
      @509    I10_PR30                      $CHAR7.                             
      @516    I10_PROCTYPE                  N3PF.                               
      @519    I10_SERVICELINE               N2PF.                               
      @521    KEY                           15.                                 
      @536    LOS                           N5PF.                               
      @541    LOS_X                         N6PF.                               
      @547    MDC                           N2PF.                               
      ...
      @771    PrimLang                      $CHAR3.                             
      @774    PSTATE                        $CHAR2.                             
      @776    PSTATE_GEO                    $CHAR2.                             
      @778    PSTCO_GEO                     N5PF.                               
      @783    RACE                          N2PF.                               
      @785    RACE_PCT_MISS_HOSP            N7P2F.                              
      @792    RACE_X                        $CHAR1.                             
      @793    TRAN_IN                       N2PF.                               
      @795    TRAN_OUT                      N2PF.                               
      @797    YEAR                          N4PF.                               
