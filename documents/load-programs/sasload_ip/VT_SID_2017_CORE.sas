...
*  Data Step                  *;                                                
*******************************;                                                
DATA VT_SIDC_2017_CORE;                                                         
INFILE 'VT_SID_2017_CORE.ASC' FIRSTOBS=3 LRECL = 2348;                          
...
INPUT                                                                           
      ...
      @1605   HCUP_OS                       N2PF.                               
      @1607   HISPANIC                      N2PF.                               
      @1609   HISPANIC_X                    $CHAR1.                             
      @1610   HOSP_NPI                      $CHAR10.                            
      @1620   HOSPST                        $CHAR2.                             
      @1622   I10_DX_Admitting              $CHAR7.                             
      @1629   I10_DX1                       $CHAR7.                             
      @1636   I10_DX2                       $CHAR7.                             
      @1643   I10_DX3                       $CHAR7.                             
      @1650   I10_DX4                       $CHAR7.                             
      ...
      @2014   PL_RUCC                       N2PF.                               
      @2016   PL_UIC                        N2PF.                               
      @2018   PL_UR_CAT4                    N2PF.                               
      @2020   POA_Disch_Edit1               N2PF.                               
      @2022   POA_Disch_Edit2               N2PF.                               
      @2024   POA_Hosp_Edit1                N2PF.                               
      @2026   POA_Hosp_Edit2                N2PF.                               
      @2028   POA_Hosp_Edit3                N2PF.                               
      @2030   POA_Hosp_Edit3_Value          N8P2F.                              
      @2038   PointOfOrigin_X               $CHAR1.                             
      @2039   PointOfOriginUB04             $CHAR1.                             
      @2040   PRDAY1                        N5PF.                               
      @2045   PRDAY2                        N5PF.                               
      @2050   PRDAY3                        N5PF.                               
      @2055   PRDAY4                        N5PF.                               
