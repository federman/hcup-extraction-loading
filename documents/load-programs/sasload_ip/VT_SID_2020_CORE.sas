...
*  Data Step                  *;                                                
*******************************;                                                
DATA VT_SIDC_2020_CORE;                                                         
INFILE 'VT_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 855;                           
...
INPUT                                                                           
      ...
      @425    I10_PR19                      $CHAR7.                             
      @432    I10_PR20                      $CHAR7.                             
      @439    I10_PROCTYPE                  N3PF.                               
      @442    I10_SERVICELINE               N2PF.                               
      @444    KEY                           15.                                 
      @459    LOS                           N5PF.                               
      @464    LOS_X                         N6PF.                               
      @470    MDC                           N2PF.                               
      ...
      @498    PAYER2_X                      $CHAR6.                             
      @504    PAYER3_X                      $CHAR6.                             
      @510    PCLASS_ORPROC                 N2PF.                               
      @512    PL_CBSA                       N3PF.                               
      @515    PL_NCHS                       N2PF.                               
      @517    PL_RUCC                       N2PF.                               
      @519    PL_UIC                        N2PF.                               
      @521    PL_UR_CAT4                    N2PF.                               
      @523    POA_Disch_Edit1               N2PF.                               
      @525    POA_Disch_Edit2               N2PF.                               
      @527    POA_Hosp_Edit1                N2PF.                               
      @529    POA_Hosp_Edit2                N2PF.                               
      @531    POA_Hosp_Edit3                N2PF.                               
      @533    POA_Hosp_Edit3_Value          N8P2F.                              
      @541    PointOfOrigin_X               $CHAR1.                             
      @542    PointOfOriginUB04             $CHAR1.                             
      @543    PRDAY1                        N5PF.                               
      @548    PRDAY2                        N5PF.                               
      @553    PRDAY3                        N5PF.                               
      @558    PRDAY4                        N5PF.                               
      ...
      @638    PRDAY20                       N5PF.                               
      @643    PSTATE                        $CHAR2.                             
      @645    PSTATE_GEO                    $CHAR2.                             
      @647    PSTCO                         N5PF.                               
      @652    PSTCO_GEO                     N5PF.                               
      @657    RACE                          N2PF.                               
      @659    RACE_PCT_MISS_HOSP            N7P2F.                              
      @666    RACE_X                        $CHAR1.                             
      @667    READMIT                       N2PF.                               
      @669    TOTCHG                        N10PF.                              
      @679    TOTCHG_X                      N15P2F.                             
