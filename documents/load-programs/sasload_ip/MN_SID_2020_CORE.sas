...
*  Data Step                  *;                                                
*******************************;                                                
DATA MN_SIDC_2020_CORE;                                                         
INFILE 'MN_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 1287;                          
...
INPUT                                                                           
      ...
      @123    HOSPST                        $CHAR2.                             
      @125    I10_BIRTH                     N3PF.                               
      @128    I10_DELIVERY                  N3PF.                               
      @131    I10_DX_Admitting              $CHAR7.                             
      @138    I10_DX1                       $CHAR7.                             
      @145    I10_DX2                       $CHAR7.                             
      @152    I10_DX3                       $CHAR7.                             
      @159    I10_DX4                       $CHAR7.                             
      ...
      @821    PAY3                          N2PF.                               
      @823    PAY3_X                        $CHAR7.                             
      @830    PCLASS_ORPROC                 N2PF.                               
      @832    PL_CBSA                       N3PF.                               
      @835    PL_NCHS                       N2PF.                               
      @837    PL_RUCC                       N2PF.                               
      @839    PL_UIC                        N2PF.                               
      @841    PL_UR_CAT4                    N2PF.                               
      @843    POA_Disch_Edit1               N2PF.                               
      @845    POA_Disch_Edit2               N2PF.                               
      @847    POA_Hosp_Edit1                N2PF.                               
      @849    POA_Hosp_Edit2                N2PF.                               
      @851    POA_Hosp_Edit3                N2PF.                               
      @853    POA_Hosp_Edit3_Value          N8P2F.                              
      @861    PointOfOrigin_X               $CHAR1.                             
      @862    PointOfOriginUB04             $CHAR1.                             
      @863    PRDAY1                        N5PF.                               
      @868    PRDAY2                        N5PF.                               
      @873    PRDAY3                        N5PF.                               
      @878    PRDAY4                        N5PF.                               
      ...
      @1013   PrimLang                      $CHAR3.                             
      @1016   PSTATE                        $CHAR2.                             
      @1018   PSTATE_GEO                    $CHAR2.                             
      @1020   PSTCO_GEO                     N5PF.                               
      @1025   RACE                          N2PF.                               
      @1027   RACE_PCT_MISS_HOSP            N7P2F.                              
      @1034   RACE_X                        $CHAR20.                            
      @1054   TOTCHG                        N10PF.                              
      @1064   TOTCHG_X                      N15P2F.                             
      @1079   TRAN_IN                       N2PF.                               
      @1081   TRAN_OUT                      N2PF.                               
      @1083   YEAR                          N4PF.                               
      @1087   ZIP                           $CHAR5.                             
      @1092   ZIP3                          $CHAR3.                             
      @1095   ZIPINC_QRTL                   N3PF.                               
      @1098   AYEAR                         N4PF.                               
      @1102   BMONTH                        N2PF.                               
      @1104   BYEAR                         N4PF.                               
      @1108   PRMONTH1                      N2PF.                               
