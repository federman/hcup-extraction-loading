...
*  Data Step                  *;                                                
*******************************;                                                
DATA KY_SIDC_2019_CORE;                                                         
INFILE 'KY_SID_2019_CORE.ASC' FIRSTOBS=3 LRECL = 967;                           
...
INPUT                                                                           
      ...
      @97     HCUP_OS                       N2PF.                               
      @99     HISPANIC                      N2PF.                               
      @101    HISPANIC_X                    $CHAR2.                             
      @103    HOSPST                        $CHAR2.                             
      @105    HOSP_NPI                      $CHAR10.                            
      @115    I10_BIRTH                     N2PF.                               
      @117    I10_DELIVERY                  N2PF.                               
      @119    I10_DX1                       $CHAR7.                             
      @126    I10_DX2                       $CHAR7.                             
      @133    I10_DX3                       $CHAR7.                             
      @140    I10_DX4                       $CHAR7.                             
      ...
      @505    I10_PR24                      $CHAR7.                             
      @512    I10_PR25                      $CHAR7.                             
      @519    I10_PROCTYPE                  N3PF.                               
      @522    I10_SERVICELINE               N2PF.                               
      @524    KEY                           15.                                 
      @539    LOS                           N5PF.                               
      @544    LOS_X                         N6PF.                               
      @550    MDC                           N2PF.                               
      ...
      @595    PL_UIC                        N2PF.                               
      @597    PL_UR_CAT4                    N2PF.                               
      @599    POA_Disch_Edit1               N2PF.                               
      @601    POA_Disch_Edit2               N2PF.                               
      @603    POA_Hosp_Edit1                N2PF.                               
      @605    POA_Hosp_Edit2                N2PF.                               
      @607    POA_Hosp_Edit3                N2PF.                               
      @609    POA_Hosp_Edit3_Value          N8P2F.                              
      @617    PRDAY1                        N5PF.                               
      @622    PRDAY2                        N5PF.                               
      @627    PRDAY3                        N5PF.                               
      @632    PRDAY4                        N5PF.                               
      ...
      @737    PRDAY25                       N5PF.                               
      @742    PSTATE                        $CHAR2.                             
      @744    PSTATE_GEO                    $CHAR2.                             
      @746    PSTCO                         N5PF.                               
      @751    PSTCO_GEO                     N5PF.                               
      @756    PointOfOriginUB04             $CHAR1.                             
      @757    PointOfOrigin_X               $CHAR1.                             
      @758    RACE                          N2PF.                               
      @760    RACE_EDIT                     N2PF.                               
      @762    RACE_X                        $CHAR2.                             
      @764    TOTCHG                        N10PF.                              
