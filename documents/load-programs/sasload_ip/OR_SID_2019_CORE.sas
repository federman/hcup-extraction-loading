...
*  Data Step                  *;                                                
*******************************;                                                
DATA OR_SIDC_2019_CORE;                                                         
INFILE 'OR_SID_2019_CORE.ASC' FIRSTOBS=3 LRECL = 996;                           
...
INPUT                                                                           
      ...
      @485    I10_PR24                      $CHAR7.                             
      @492    I10_PR25                      $CHAR7.                             
      @499    I10_PROCTYPE                  N3PF.                               
      @502    I10_SERVICELINE               N2PF.                               
      @504    KEY                           15.                                 
      @519    LOS                           N5PF.                               
      @524    LOS_X                         N6PF.                               
      @530    MDC                           N2PF.                               
      ...
      @774    PSTCO                         N5PF.                               
      @779    PSTCO_GEO                     N5PF.                               
      @784    PointOfOriginUB04             $CHAR1.                             
      @785    PointOfOrigin_X               $CHAR2.                             
      @787    RACE                          N2PF.                               
      @789    RACE_EDIT                     N2PF.                               
      @791    RACE_X                        $CHAR2.                             
      @793    TOTCHG                        N10PF.                              
