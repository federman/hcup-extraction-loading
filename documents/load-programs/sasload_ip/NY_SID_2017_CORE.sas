...
*  Data Step                  *;                                                
*******************************;                                                
DATA NY_SIDC_2017_CORE;                                                         
INFILE 'NY_SID_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1143;                          
...
INPUT                                                                           
      ...
      @121    HCUP_OS                       N2PF.                               
      @123    HISPANIC                      N2PF.                               
      @125    HISPANIC_X                    $CHAR39.                            
      @164    Homeless                      N2PF.                               
      @166    HOSP_NPI                      $CHAR10.                            
      @176    HOSPST                        $CHAR2.                             
      @178    I10_DX_Admitting              $CHAR7.                             
      @185    I10_DX1                       $CHAR7.                             
      @192    I10_DX2                       $CHAR7.                             
      @199    I10_DX3                       $CHAR7.                             
      @206    I10_DX4                       $CHAR7.                             
