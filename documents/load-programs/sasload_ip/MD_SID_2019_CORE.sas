...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SIDC_2019_CORE;                                                         
INFILE 'MD_SID_2019_CORE.ASC' FIRSTOBS=3 LRECL = 1705;                          
...
INPUT                                                                           
      ...
      @129    DXPOA77                       $CHAR1.                             
      @130    DXPOA78                       $CHAR1.                             
      @131    DaysBurnUnit                  N3PF.                               
      @134    DaysCCU                       N3PF.                               
      @137    DaysICU                       N3PF.                               
      @140    DaysNICU                      N3PF.                               
      @143    DaysPICU                      N3PF.                               
      @146    DaysShockUnit                 N3PF.                               
      @149    DaysToEvent                   N6PF.                               
      @155    FEMALE                        N2PF.                               
      @157    HCUP_ED                       N2PF.                               
      @159    HCUP_OS                       N2PF.                               
      @161    HISPANIC                      N2PF.                               
      ...
      @164    HOSPST                        $CHAR2.                             
      @166    Homeless                      N2PF.                               
      @168    HospitalUnit                  N2PF.                               
      @170    I10_BIRTH                     N2PF.                               
      @172    I10_DELIVERY                  N2PF.                               
      @174    I10_DX1                       $CHAR7.                             
      @181    I10_DX2                       $CHAR7.                             
      @188    I10_DX3                       $CHAR7.                             
      @195    I10_DX4                       $CHAR7.                             
      ...
      @1162   I10_PR63                      $CHAR7.                             
      @1169   I10_PR64                      $CHAR7.                             
      @1176   I10_PROCTYPE                  N3PF.                               
      @1179   I10_SERVICELINE               N2PF.                               
      @1181   KEY                           15.                                 
      @1196   LOS                           N5PF.                               
      @1201   LOS_X                         N6PF.                               
      @1207   MARITALSTATUSUB04             $CHAR1.                             
      @1208   MARITALSTATUS_X               $CHAR1.                             
      @1209   MDC                           N2PF.                               
      @1211   MDC_NoPOA                     N2PF.                               
      @1213   MDNUM1_R                      N9PF.                               
      @1222   MDNUM2_R                      N9PF.                               
      ...
      @1278   PL_RUCC                       N2PF.                               
      @1280   PL_UIC                        N2PF.                               
      @1282   PL_UR_CAT4                    N2PF.                               
      @1284   POA_Disch_Edit1               N2PF.                               
      @1286   POA_Disch_Edit2               N2PF.                               
      @1288   POA_Hosp_Edit1                N2PF.                               
      @1290   POA_Hosp_Edit2                N2PF.                               
      @1292   POA_Hosp_Edit3                N2PF.                               
      @1294   POA_Hosp_Edit3_Value          N8P2F.                              
      @1302   PRDAY1                        N5PF.                               
      @1307   PRDAY2                        N5PF.                               
      @1312   PRDAY3                        N5PF.                               
      @1317   PRDAY4                        N5PF.                               
      ...
      @1617   PRDAY64                       N5PF.                               
      @1622   PSTATE                        $CHAR2.                             
      @1624   PSTATE_GEO                    $CHAR2.                             
      @1626   PSTCO                         N5PF.                               
      @1631   PSTCO_GEO                     N5PF.                               
      @1636   PointOfOriginUB04             $CHAR1.                             
      @1637   PointOfOrigin_X               $CHAR2.                             
      @1639   PrimLang                      $CHAR3.                             
      @1642   RACE                          N2PF.                               
      @1644   RACE_EDIT                     N2PF.                               
      @1646   RACE_X                        $CHAR1.                             
