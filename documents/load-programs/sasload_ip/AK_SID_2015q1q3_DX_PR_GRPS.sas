...
*   AK_SID_2015q1q3_DX_PR_GRPS.SAS:                                             
...
*  Data Step                  *;                                                
*******************************;                                                
DATA AK_SIDC_2015q1q3_DX_PR_GRPS;                                               
INFILE 'AK_SID_2015q1q3_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 873;                 
...
INPUT                                                                           
      ...
      @517    INJURY                        N2PF.                               
      @519    INJURY_CUT                    N2PF.                               
      @521    INJURY_DROWN                  N2PF.                               
      @523    INJURY_FALL                   N2PF.                               
      @525    INJURY_FIRE                   N2PF.                               
      @527    INJURY_FIREARM                N2PF.                               
      @529    INJURY_MACHINERY              N2PF.                               
      @531    INJURY_MVT                    N2PF.                               
      @533    INJURY_NATURE                 N2PF.                               
      @535    INJURY_POISON                 N2PF.                               
      @537    INJURY_STRUCK                 N2PF.                               
      @539    INJURY_SUFFOCATION            N2PF.                               
      @541    INTENT_ASSAULT                N2PF.                               
      @543    INTENT_SELF_HARM              N2PF.                               
      @545    INTENT_UNINTENTIONAL          N2PF.                               
      @547    KEY                           15.                                 
      @562    MULTINJURY                    N2PF.                               
      @564    PCLASS1                       N2PF.                               
      @566    PCLASS2                       N2PF.                               
      ...
      @848    U_NEWBN4L                     N2PF.                               
      @850    U_NUCMED                      N2PF.                               
      @852    U_OBSERVATION                 N2PF.                               
      @854    U_OCCTHERAPY                  N2PF.                               
      @856    U_ORGANACQ                    N2PF.                               
      @858    U_OTHIMPLANTS                 N2PF.                               
      @860    U_PACEMAKER                   N2PF.                               
      @862    U_PHYTHERAPY                  N2PF.                               
      @864    U_RADTHERAPY                  N2PF.                               
      @866    U_RESPTHERAPY                 N2PF.                               
      @868    U_SPEECHTHERAPY               N2PF.                               
      @870    U_STRESS                      N2PF.                               
      @872    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
