...
*  Data Step                  *;                                                
*******************************;                                                
DATA CO_SIDC_2020_CORE;                                                         
INFILE 'CO_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 1047;                          
...
INPUT                                                                           
      ...
      @48     HOSPST                        $CHAR2.                             
      @50     I10_BIRTH                     N3PF.                               
      @53     I10_DELIVERY                  N3PF.                               
      @56     I10_DX_Admitting              $CHAR7.                             
      @63     I10_DX1                       $CHAR7.                             
      @70     I10_DX2                       $CHAR7.                             
      @77     I10_DX3                       $CHAR7.                             
      @84     I10_DX4                       $CHAR7.                             
      ...
      @754    PRDAY30                       N5PF.                               
      @759    PSTATE                        $CHAR2.                             
      @761    PSTATE_GEO                    $CHAR2.                             
      @763    PSTCO                         N5PF.                               
      @768    PSTCO_GEO                     N5PF.                               
      @773    RACE                          N2PF.                               
      @775    RACE_PCT_MISS_HOSP            N7P2F.                              
      @782    RACE_X                        $CHAR15.                            
      @797    SUBSTATE_REGION_X             $CHAR3.                             
      @800    TOTCHG                        N10PF.                              
      @810    TOTCHG_X                      N15P2F.                             
      @825    TRAN_IN                       N2PF.                               
      @827    TRAN_OUT                      N2PF.                               
