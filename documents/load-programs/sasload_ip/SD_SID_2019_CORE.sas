...
*  Data Step                  *;                                                
*******************************;                                                
DATA SD_SIDC_2019_CORE;                                                         
INFILE 'SD_SID_2019_CORE.ASC' FIRSTOBS=3 LRECL = 1060;                          
...
INPUT                                                                           
      ...
      @95     HISPANIC_X                    $CHAR1.                             
      @96     HOSPST                        $CHAR2.                             
      @98     HospitalUnit                  N2PF.                               
      @100    I10_BIRTH                     N2PF.                               
      @102    I10_DELIVERY                  N2PF.                               
      @104    I10_DX1                       $CHAR7.                             
      @111    I10_DX2                       $CHAR7.                             
      @118    I10_DX3                       $CHAR7.                             
      @125    I10_DX4                       $CHAR7.                             
      ...
      @595    I10_PR24                      $CHAR7.                             
      @602    I10_PR25                      $CHAR7.                             
      @609    I10_PROCTYPE                  N3PF.                               
      @612    I10_SERVICELINE               N2PF.                               
      @614    KEY                           15.                                 
      @629    LOS                           N5PF.                               
      @634    LOS_X                         N6PF.                               
      @640    MDC                           N2PF.                               
      ...
      @684    PL_UIC                        N2PF.                               
      @686    PL_UR_CAT4                    N2PF.                               
      @688    POA_Disch_Edit1               N2PF.                               
      @690    POA_Disch_Edit2               N2PF.                               
      @692    POA_Hosp_Edit1                N2PF.                               
      @694    POA_Hosp_Edit2                N2PF.                               
      @696    POA_Hosp_Edit3                N2PF.                               
      @698    POA_Hosp_Edit3_Value          N8P2F.                              
      @706    PRDAY1                        N5PF.                               
      @711    PRDAY2                        N5PF.                               
      @716    PRDAY3                        N5PF.                               
      @721    PRDAY4                        N5PF.                               
      ...
      @826    PRDAY25                       N5PF.                               
      @831    PSTATE                        $CHAR2.                             
      @833    PSTATE_GEO                    $CHAR2.                             
      @835    PSTCO                         N5PF.                               
      @840    PSTCO_GEO                     N5PF.                               
      @845    PointOfOriginUB04             $CHAR1.                             
      @846    PointOfOrigin_X               $CHAR1.                             
      @847    RACE                          N2PF.                               
      @849    RACE_EDIT                     N2PF.                               
      @851    RACE_X                        $CHAR1.                             
      @852    TOTCHG                        N10PF.                              
