...
*  Data Step                  *;                                                
*******************************;                                                
DATA AZ_SIDC_2021_CORE;                                                         
INFILE 'AZ_SID_2021_CORE.ASC' FIRSTOBS=3 LRECL = 758;                           
...
INPUT                                                                           
      ...
      @427    I10_PR11                      $CHAR7.                             
      @434    I10_PR12                      $CHAR7.                             
      @441    I10_PROCTYPE                  N3PF.                               
      @444    I10_SERVICELINE               N2PF.                               
      @446    KEY                           15.                                 
      @461    LOS                           N5PF.                               
      @466    LOS_X                         N6PF.                               
      @472    MARITALSTATUSUB04             $CHAR1.                             
      @473    MDBOARD1                      $CHAR1.                             
      @474    MDBOARD2                      $CHAR1.                             
      @475    MDC                           N2PF.                               
      @477    MDC_NoPOA                     N2PF.                               
      ...
      @519    PAY1                          N2PF.                               
      @521    PAY1_X                        $CHAR2.                             
      @523    PCLASS_ORPROC                 N2PF.                               
      @525    PL_CBSA                       N3PF.                               
      @528    PL_NCHS                       N2PF.                               
      @530    PL_RUCC                       N2PF.                               
      @532    PL_UIC                        N2PF.                               
      @534    PL_UR_CAT4                    N2PF.                               
      @536    POA_Disch_Edit1               N2PF.                               
      @538    POA_Disch_Edit2               N2PF.                               
      @540    POA_Hosp_Edit1                N2PF.                               
      @542    POA_Hosp_Edit2                N2PF.                               
      @544    POA_Hosp_Edit3                N2PF.                               
      @546    POA_Hosp_Edit3_Value          N8P2F.                              
      @554    PointOfOrigin_X               $CHAR1.                             
      ...
      @611    PRDAY12                       N5PF.                               
      @616    PSTATE                        $CHAR2.                             
      @618    PSTATE_GEO                    $CHAR2.                             
      @620    PSTCO_GEO                     N5PF.                               
      @625    RACE                          N2PF.                               
      @627    RACE_PCT_MISS_HOSP            N7P2F.                              
      @634    RACE_X                        $CHAR3.                             
      @637    SPLIT_IPED                    N2PF.                               
      @639    TOTCHG                        N10PF.                              
      @649    TOTCHG_X                      N15P2F.                             
