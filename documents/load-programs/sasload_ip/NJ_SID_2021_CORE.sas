...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SIDC_2021_CORE;                                                         
INFILE 'NJ_SID_2021_CORE.ASC' FIRSTOBS=3 LRECL = 3504;                          
...
INPUT                                                                           
      ...
      @2512   HCUP_OS                       N2PF.                               
      @2514   HISPANIC                      N2PF.                               
      @2516   HISPANIC_X                    $CHAR5.                             
      @2521   Homeless                      N2PF.                               
      @2523   HOSPST                        $CHAR2.                             
      @2525   I10_BIRTH                     N3PF.                               
      @2528   I10_DELIVERY                  N3PF.                               
      @2531   I10_DX_Admitting              $CHAR7.                             
      @2538   I10_DX1                       $CHAR7.                             
      @2545   I10_DX2                       $CHAR7.                             
      @2552   I10_DX3                       $CHAR7.                             
      @2559   I10_DX4                       $CHAR7.                             
      ...
      @2964   I10_PR24                      $CHAR7.                             
      @2971   I10_PR25                      $CHAR7.                             
      @2978   I10_PROCTYPE                  N3PF.                               
      @2981   I10_SERVICELINE               N2PF.                               
      @2983   KEY                           15.                                 
      @2998   LOS                           N5PF.                               
      @3003   LOS_X                         N6PF.                               
      @3009   MARITALSTATUS_X               $CHAR1.                             
      @3010   MARITALSTATUSUB04             $CHAR1.                             
      @3011   MDC                           N2PF.                               
      @3013   MDC_NoPOA                     N2PF.                               
      @3015   MDNUM1_R                      N9PF.                               
      @3024   MDNUM2_R                      N9PF.                               
      ...
      @3094   PAY3                          N2PF.                               
      @3096   PAY3_X                        $CHAR10.                            
      @3106   PCLASS_ORPROC                 N2PF.                               
      @3108   PL_CBSA                       N3PF.                               
      @3111   PL_NCHS                       N2PF.                               
      @3113   PL_RUCC                       N2PF.                               
      @3115   PL_UIC                        N2PF.                               
      @3117   PL_UR_CAT4                    N2PF.                               
      @3119   POA_Disch_Edit1               N2PF.                               
      @3121   POA_Disch_Edit2               N2PF.                               
      @3123   POA_Hosp_Edit1                N2PF.                               
      @3125   POA_Hosp_Edit2                N2PF.                               
      @3127   POA_Hosp_Edit3                N2PF.                               
      @3129   POA_Hosp_Edit3_Value          N8P2F.                              
      @3137   PointOfOrigin_X               $CHAR1.                             
      @3138   PointOfOriginUB04             $CHAR1.                             
      @3139   PRDAY1                        N5PF.                               
      @3144   PRDAY2                        N5PF.                               
      @3149   PRDAY3                        N5PF.                               
      @3154   PRDAY4                        N5PF.                               
      ...
      @3264   PrimLang                      $CHAR3.                             
      @3267   PSTATE                        $CHAR2.                             
      @3269   PSTATE_GEO                    $CHAR2.                             
      @3271   PSTCO                         N5PF.                               
      @3276   PSTCO_GEO                     N5PF.                               
      @3281   RACE                          N2PF.                               
      @3283   RACE_PCT_MISS_HOSP            N7P2F.                              
      @3290   RACE_X                        $CHAR5.                             
      @3295   READMIT                       N2PF.                               
      @3297   TOTCHG                        N10PF.                              
      @3307   TOTCHG_X                      N15P2F.                             
      @3322   TRAN_IN                       N2PF.                               
      @3324   TRAN_OUT                      N2PF.                               
      @3326   YEAR                          N4PF.                               
      @3330   ZIP                           $CHAR5.                             
      @3335   ZIP3                          $CHAR3.                             
      @3338   ZIPINC_QRTL                   N3PF.                               
      @3341   TOWN                          $CHAR4.                             
      @3345   AYEAR                         N4PF.                               
      @3349   BMONTH                        N2PF.                               
      @3351   BYEAR                         N4PF.                               
