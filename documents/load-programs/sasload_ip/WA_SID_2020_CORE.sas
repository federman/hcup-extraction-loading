...
*  Data Step                  *;                                                
*******************************;                                                
DATA WA_SIDC_2020_CORE;                                                         
INFILE 'WA_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 885;                           
...
INPUT                                                                           
      ...
      @637    PAY3                          N2PF.                               
      @639    PAY3_X                        $CHAR3.                             
      @642    PCLASS_ORPROC                 N2PF.                               
      @644    PL_CBSA                       N3PF.                               
      @647    PL_NCHS                       N2PF.                               
      @649    PL_RUCC                       N2PF.                               
      @651    PL_UIC                        N2PF.                               
      @653    PL_UR_CAT4                    N2PF.                               
      @655    POA_Disch_Edit1               N2PF.                               
      @657    POA_Disch_Edit2               N2PF.                               
      @659    POA_Hosp_Edit1                N2PF.                               
      @661    POA_Hosp_Edit2                N2PF.                               
      @663    POA_Hosp_Edit3                N2PF.                               
      @665    POA_Hosp_Edit3_Value          N8P2F.                              
      ...
      @795    PRDAY25                       N5PF.                               
      @800    PSTATE                        $CHAR2.                             
      @802    PSTATE_GEO                    $CHAR2.                             
      @804    PSTCO                         N5PF.                               
      @809    PSTCO_GEO                     N5PF.                               
      @814    RACE                          N2PF.                               
      @816    RACE_PCT_MISS_HOSP            N7P2F.                              
      @823    RACE_X                        $CHAR6.                             
      @829    TOTCHG                        N10PF.                              
      @839    TOTCHG_X                      N15P2F.                             
      @854    TRAN_IN                       N2PF.                               
