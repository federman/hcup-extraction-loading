...
*  Data Step                  *;                                                
*******************************;                                                
DATA NM_SIDC_2020_CORE;                                                         
INFILE 'NM_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 561;                           
...
INPUT                                                                           
      ...
      @281    I10_PR5                       $CHAR7.                             
      @288    I10_PR6                       $CHAR7.                             
      @295    I10_PROCTYPE                  N3PF.                               
      @298    I10_SERVICELINE               N2PF.                               
      @300    KEY                           15.                                 
      @315    LOS                           N5PF.                               
      @320    LOS_X                         N6PF.                               
      @326    MDC                           N2PF.                               
      ...
      @371    PAY3                          N2PF.                               
      @373    PAY3_X                        $CHAR2.                             
      @375    PCLASS_ORPROC                 N2PF.                               
      @377    PL_CBSA                       N3PF.                               
      @380    PL_NCHS                       N2PF.                               
      @382    PL_RUCC                       N2PF.                               
      @384    PL_UIC                        N2PF.                               
      @386    PL_UR_CAT4                    N2PF.                               
      @388    POA_Disch_Edit1               N2PF.                               
      @390    POA_Disch_Edit2               N2PF.                               
      @392    POA_Hosp_Edit1                N2PF.                               
      @394    POA_Hosp_Edit2                N2PF.                               
      @396    POA_Hosp_Edit3                N2PF.                               
      @398    POA_Hosp_Edit3_Value          N8P2F.                              
      ...
      @433    PRDAY6                        N5PF.                               
      @438    PSTATE                        $CHAR2.                             
      @440    PSTATE_GEO                    $CHAR2.                             
      @442    PSTCO                         N5PF.                               
      @447    PSTCO_GEO                     N5PF.                               
      @452    RACE                          N2PF.                               
      @454    RACE_PCT_MISS_HOSP            N7P2F.                              
      @461    RACE_X                        $CHAR2.                             
      @463    TOTCHG                        N10PF.                              
      @473    TOTCHG_X                      N15P2F.                             
      @488    TRAN_IN                       N2PF.                               
