...
*  Data Step                  *;                                                
*******************************;                                                
DATA MN_SIDC_2019_CORE;                                                         
INFILE 'MN_SID_2019_CORE.ASC' FIRSTOBS=3 LRECL = 2420;                          
...
INPUT                                                                           
      ...
      @147    HCUP_OS                       N2PF.                               
      @149    HISPANIC                      N2PF.                               
      @151    HISPANIC_X                    $CHAR2.                             
      @153    HOSPST                        $CHAR2.                             
      @155    I10_BIRTH                     N2PF.                               
      @157    I10_DELIVERY                  N2PF.                               
      @159    I10_DX1                       $CHAR7.                             
      @166    I10_DX2                       $CHAR7.                             
      @173    I10_DX3                       $CHAR7.                             
      @180    I10_DX4                       $CHAR7.                             
      ...
      @1322   I10_PR79                      $CHAR7.                             
      @1329   I10_PR80                      $CHAR7.                             
      @1336   I10_PROCTYPE                  N3PF.                               
      @1339   I10_SERVICELINE               N2PF.                               
      @1341   KEY                           15.                                 
      @1356   LOS                           N5PF.                               
      @1361   LOS_X                         N6PF.                               
      @1367   MDC                           N2PF.                               
      ...
      @1867   RACE_X                        $CHAR20.                            
      @1887   TOTCHG                        N10PF.                              
      @1897   TOTCHG_X                      N15P2F.                             
      @1912   TRAN_IN                       N2PF.                               
      @1914   TRAN_OUT                      N2PF.                               
      @1916   YEAR                          N4PF.                               
      @1920   ZIP                           $CHAR5.                             
      @1925   ZIP3                          $CHAR3.                             
      @1928   ZIPINC_QRTL                   N3PF.                               
      @1931   AYEAR                         N4PF.                               
      @1935   BMONTH                        N2PF.                               
      @1937   BYEAR                         N4PF.                               
      @1941   PRMONTH1                      N2PF.                               
