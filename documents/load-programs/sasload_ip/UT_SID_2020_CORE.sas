...
*  Data Step                  *;                                                
*******************************;                                                
DATA UT_SIDC_2020_CORE;                                                         
INFILE 'UT_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 2950;                          
...
INPUT                                                                           
      ...
      @2475   HCUP_OS                       N2PF.                               
      @2477   HISPANIC                      N2PF.                               
      @2479   HISPANIC_X                    $CHAR6.                             
      @2485   HOSPST                        $CHAR2.                             
      @2487   I10_BIRTH                     N3PF.                               
      @2490   I10_DELIVERY                  N3PF.                               
      @2493   I10_DX_Admitting              $CHAR7.                             
      @2500   I10_DX1                       $CHAR7.                             
      @2507   I10_DX2                       $CHAR7.                             
      @2514   I10_DX3                       $CHAR7.                             
      @2521   I10_DX4                       $CHAR7.                             
      ...
      @2674   I10_PR5                       $CHAR7.                             
      @2681   I10_PR6                       $CHAR7.                             
      @2688   I10_PROCTYPE                  N3PF.                               
      @2691   I10_SERVICELINE               N2PF.                               
      @2693   KEY                           15.                                 
      @2708   LOS                           N5PF.                               
      @2713   LOS_X                         N6PF.                               
      @2719   MARITALSTATUS_X               $CHAR1.                             
      @2720   MARITALSTATUSUB04             $CHAR1.                             
      @2721   MDC                           N2PF.                               
      @2723   MDC_NoPOA                     N2PF.                               
      @2725   MDNUM1_R                      N9PF.                               
      @2734   MEDINCSTQ                     N2PF.                               
      ...
      @2751   PAY1                          N2PF.                               
      @2753   PAY1_X                        $CHAR30.                            
      @2783   PCLASS_ORPROC                 N2PF.                               
      @2785   PL_CBSA                       N3PF.                               
      @2788   PL_NCHS                       N2PF.                               
      @2790   PL_RUCC                       N2PF.                               
      @2792   PL_UIC                        N2PF.                               
      @2794   PL_UR_CAT4                    N2PF.                               
      @2796   PointOfOrigin_X               $CHAR1.                             
      @2797   PointOfOriginUB04             $CHAR1.                             
      @2798   PRDAY1                        N5PF.                               
      @2803   PRDAY2                        N5PF.                               
      @2808   PRDAY3                        N5PF.                               
      @2813   PRDAY4                        N5PF.                               
      ...
      @2823   PRDAY6                        N5PF.                               
      @2828   PSTATE                        $CHAR2.                             
      @2830   PSTATE_GEO                    $CHAR2.                             
      @2832   PSTCO_GEO                     N5PF.                               
      @2837   RACE                          N2PF.                               
      @2839   RACE_PCT_MISS_HOSP            N7P2F.                              
      @2846   RACE_X                        $CHAR6.                             
      @2852   TOTCHG                        N10PF.                              
      @2862   TOTCHG_X                      N15P2F.                             
      @2877   TRAN_IN                       N2PF.                               
      @2879   TRAN_OUT                      N2PF.                               
      @2881   VisitLink                     N9PF.                               
      @2890   YEAR                          N4PF.                               
