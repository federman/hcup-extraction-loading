...
*  Data Step                  *;                                                
*******************************;                                                
DATA OR_SIDC_2021_CORE;                                                         
INFILE 'OR_SID_2021_CORE.ASC' FIRSTOBS=3 LRECL = 1005;                          
...
INPUT                                                                           
      ...
      @487    I10_PR24                      $CHAR7.                             
      @494    I10_PR25                      $CHAR7.                             
      @501    I10_PROCTYPE                  N3PF.                               
      @504    I10_SERVICELINE               N2PF.                               
      @506    KEY                           15.                                 
      @521    LOS                           N5PF.                               
      @526    LOS_X                         N6PF.                               
      @532    MDC                           N2PF.                               
      ...
      @607    PAY3                          N2PF.                               
      @609    PAY3_X                        $CHAR9.                             
      @618    PCLASS_ORPROC                 N2PF.                               
      @620    PL_CBSA                       N3PF.                               
      @623    PL_NCHS                       N2PF.                               
      @625    PL_RUCC                       N2PF.                               
      @627    PL_UIC                        N2PF.                               
      @629    PL_UR_CAT4                    N2PF.                               
      @631    POA_Disch_Edit1               N2PF.                               
      @633    POA_Disch_Edit2               N2PF.                               
      @635    POA_Hosp_Edit1                N2PF.                               
      @637    POA_Hosp_Edit2                N2PF.                               
      @639    POA_Hosp_Edit3                N2PF.                               
      @641    POA_Hosp_Edit3_Value          N8P2F.                              
      @649    PointOfOrigin_X               $CHAR2.                             
      ...
      @772    PRDAY25                       N5PF.                               
      @777    PSTATE                        $CHAR2.                             
      @779    PSTATE_GEO                    $CHAR2.                             
      @781    PSTCO                         N5PF.                               
      @786    PSTCO_GEO                     N5PF.                               
      @791    RACE                          N2PF.                               
      @793    RACE_PCT_MISS_HOSP            N7P2F.                              
      @800    RACE_X                        $CHAR2.                             
      @802    TOTCHG                        N10PF.                              
      @812    TOTCHG_X                      N15P2F.                             
      @827    TRAN_IN                       N2PF.                               
