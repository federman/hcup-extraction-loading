...
*  Data Step                  *;                                                
*******************************;                                                
DATA AK_SIDC_2017_CORE;                                                         
INFILE 'AK_SID_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1482;                          
...
INPUT                                                                           
      ...
      @638    HCUP_OS                       N2PF.                               
      @640    HISPANIC                      N2PF.                               
      @642    HISPANIC_X                    $CHAR1.                             
      @643    HospitalUnit                  N2PF.                               
      @645    HOSPST                        $CHAR2.                             
      @647    I10_DX_Admitting              $CHAR7.                             
      @654    I10_DX1                       $CHAR7.                             
      @661    I10_DX2                       $CHAR7.                             
      @668    I10_DX3                       $CHAR7.                             
      @675    I10_DX4                       $CHAR7.                             
      ...
      @1078   MEDINCSTQ                     N2PF.                               
      @1080   NCPT                          N4PF.                               
      @1084   OBSERVATION                   N4PF.                               
      @1088   OS_TIME                       N11P2F.                             
      @1099   P7EDSRC_X                     $CHAR2.                             
      @1101   PAY1                          N2PF.                               
      @1103   PAY1_X                        $CHAR2.                             
      @1105   PAY2                          N2PF.                               
      @1107   PAY2_X                        $CHAR2.                             
      ...
      @1113   PL_CBSA                       N3PF.                               
      @1116   PL_NCHS                       N2PF.                               
      @1118   POA_Disch_Edit1               N2PF.                               
      @1120   POA_Disch_Edit2               N2PF.                               
      @1122   POA_Hosp_Edit1                N2PF.                               
      @1124   POA_Hosp_Edit2                N2PF.                               
      @1126   POA_Hosp_Edit3                N2PF.                               
      @1128   POA_Hosp_Edit3_Value          N8P2F.                              
      @1136   PointOfOrigin_X               $CHAR1.                             
      @1137   PointOfOriginUB04             $CHAR1.                             
      @1138   PRDAY1                        N5PF.                               
      @1143   PRDAY2                        N5PF.                               
      @1148   PRDAY3                        N5PF.                               
      @1153   PRDAY4                        N5PF.                               
