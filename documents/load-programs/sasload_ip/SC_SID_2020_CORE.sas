...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SIDC_2020_CORE;                                                         
INFILE 'SC_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 488;                           
...
INPUT                                                                           
      ...
      @52     HOSPST                        $CHAR2.                             
      @54     I10_BIRTH                     N3PF.                               
      @57     I10_DELIVERY                  N3PF.                               
      @60     I10_DX_Admitting              $CHAR7.                             
      @67     I10_DX1                       $CHAR7.                             
      @74     I10_DX2                       $CHAR7.                             
      @81     I10_DX3                       $CHAR7.                             
      @88     I10_DX4                       $CHAR7.                             
      ...
      @269    I10_PR12                      $CHAR7.                             
      @276    I10_PR13                      $CHAR7.                             
      @283    I10_PROCTYPE                  N3PF.                               
      @286    I10_SERVICELINE               N2PF.                               
      @288    KEY                           15.                                 
      @303    LOS                           N5PF.                               
      @308    LOS_X                         N6PF.                               
      @314    MDC                           N2PF.                               
      ...
      @337    PAY1                          N2PF.                               
      @339    PAY1_X                        $CHAR2.                             
      @341    PCLASS_ORPROC                 N2PF.                               
      @343    PL_NCHS                       N2PF.                               
      @345    PL_UR_CAT4                    N2PF.                               
      @347    POA_Disch_Edit1               N2PF.                               
      @349    POA_Disch_Edit2               N2PF.                               
      @351    POA_Hosp_Edit1                N2PF.                               
      @353    POA_Hosp_Edit2                N2PF.                               
      @355    POA_Hosp_Edit3                N2PF.                               
      @357    POA_Hosp_Edit3_Value          N8P2F.                              
      @365    PointOfOrigin_X               $CHAR1.                             
      @366    PointOfOriginUB04             $CHAR1.                             
      @367    PRDAY1                        N5PF.                               
      @372    PRDAY2                        N5PF.                               
      @377    PRDAY3                        N5PF.                               
      @382    PRDAY4                        N5PF.                               
