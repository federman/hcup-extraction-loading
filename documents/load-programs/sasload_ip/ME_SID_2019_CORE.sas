...
*  Data Step                  *;                                                
*******************************;                                                
DATA ME_SIDC_2019_CORE;                                                         
INFILE 'ME_SID_2019_CORE.ASC' FIRSTOBS=3 LRECL = 880;                           
...
INPUT                                                                           
      ...
      @463    I10_PR24                      $CHAR7.                             
      @470    I10_PR25                      $CHAR7.                             
      @477    I10_PROCTYPE                  N3PF.                               
      @480    I10_SERVICELINE               N2PF.                               
      @482    KEY                           15.                                 
      @497    LOS                           N5PF.                               
      @502    MDC                           N2PF.                               
      @504    MDC_NoPOA                     N2PF.                               
      ...
      @543    PL_UIC                        N2PF.                               
      @545    PL_UR_CAT4                    N2PF.                               
      @547    POA_Disch_Edit1               N2PF.                               
      @549    POA_Disch_Edit2               N2PF.                               
      @551    POA_Hosp_Edit1                N2PF.                               
      @553    POA_Hosp_Edit2                N2PF.                               
      @555    POA_Hosp_Edit3                N2PF.                               
      @557    POA_Hosp_Edit3_Value          N8P2F.                              
      @565    PRDAY1                        N5PF.                               
      @570    PRDAY2                        N5PF.                               
      @575    PRDAY3                        N5PF.                               
      @580    PRDAY4                        N5PF.                               
