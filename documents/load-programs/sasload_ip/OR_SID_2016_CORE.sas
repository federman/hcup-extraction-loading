...
*  Data Step                  *;                                                
*******************************;                                                
DATA OR_SIDC_2016_CORE;                                                         
INFILE 'OR_SID_2016_CORE.ASC' FIRSTOBS=3 LRECL = 1256;                          
...
INPUT                                                                           
      ...
      @114    HospitalUnit                  N2PF.                               
      @116    HOSPST                        $CHAR2.                             
      @118    I10_DX_Admitting              $CHAR7.                             
      @125    I10_DX1                       $CHAR7.                             
      @132    I10_DX2                       $CHAR7.                             
      @139    I10_DX3                       $CHAR7.                             
      @146    I10_DX4                       $CHAR7.                             
      ...
      @307    I10_DX27                      $CHAR7.                             
      @314    I10_DX28                      $CHAR7.                             
      @321    I10_ECAUSE1                   $CHAR7.                             
      @328    I10_ECAUSE2                   $CHAR7.                             
      @335    I10_ECAUSE3                   $CHAR7.                             
      @342    I10_ECAUSE4                   $CHAR7.                             
      @349    I10_ECAUSE5                   $CHAR7.                             
      @356    I10_ECAUSE6                   $CHAR7.                             
      @363    I10_NDX                       N3PF.                               
      @366    I10_NECAUSE                   N2PF.                               
      @368    I10_NPR                       N3PF.                               
      @371    I10_PR1                       $CHAR7.                             
      @378    I10_PR2                       $CHAR7.                             
      @385    I10_PR3                       $CHAR7.                             
      ...
      @752    PL_UIC                        N2PF.                               
      @754    PL_UR_CAT4                    N2PF.                               
      @756    POA_Disch_Edit1               N2PF.                               
      @758    POA_Disch_Edit2               N2PF.                               
      @760    POA_Hosp_Edit1                N2PF.                               
      @762    POA_Hosp_Edit2                N2PF.                               
      @764    POA_Hosp_Edit3                N2PF.                               
      @766    POA_Hosp_Edit3_Value          N8P2F.                              
      @774    PointOfOrigin_X               $CHAR2.                             
      @776    PointOfOriginUB04             $CHAR1.                             
      @777    PRDAY1                        N5PF.                               
      @782    PRDAY2                        N5PF.                               
      @787    PRDAY3                        N5PF.                               
      @792    PRDAY4                        N5PF.                               
