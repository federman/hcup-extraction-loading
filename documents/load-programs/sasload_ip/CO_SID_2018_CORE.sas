...
*  Data Step                  *;                                                
*******************************;                                                
DATA CO_SIDC_2018_CORE;                                                         
INFILE 'CO_SID_2018_CORE.ASC' FIRSTOBS=3 LRECL = 1145;                          
...
INPUT                                                                           
      ...
      @714    PL_UIC                        N2PF.                               
      @716    PL_UR_CAT4                    N2PF.                               
      @718    PointOfOrigin_X               $CHAR4.                             
      @722    PointOfOriginUB04             $CHAR1.                             
      @723    PRDAY1                        N5PF.                               
      @728    PRDAY2                        N5PF.                               
      @733    PRDAY3                        N5PF.                               
      @738    PRDAY4                        N5PF.                               
