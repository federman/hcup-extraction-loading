...
*  Data Step                  *;                                                
*******************************;                                                
DATA KY_SIDC_2021_CORE;                                                         
INFILE 'KY_SID_2021_CORE.ASC' FIRSTOBS=3 LRECL = 998;                           
...
INPUT                                                                           
      ...
      @100    HCUP_OS                       N2PF.                               
      @102    HISPANIC                      N2PF.                               
      @104    HISPANIC_X                    $CHAR2.                             
      @106    HOSP_NPI                      $CHAR10.                            
      @116    HOSPST                        $CHAR2.                             
      @118    I10_BIRTH                     N3PF.                               
      @121    I10_DELIVERY                  N3PF.                               
      ...
      @529    I10_PR24                      $CHAR7.                             
      @536    I10_PR25                      $CHAR7.                             
      @543    I10_PROCTYPE                  N3PF.                               
      @546    I10_SERVICELINE               N2PF.                               
      @548    KEY                           15.                                 
      @563    LOS                           N5PF.                               
      @568    LOS_X                         N6PF.                               
      @574    MDC                           N2PF.                               
      ...
      @643    PointOfOrigin_X               $CHAR1.                             
      @644    PointOfOriginUB04             $CHAR1.                             
      @645    PRDAY1                        N5PF.                               
      @650    PRDAY2                        N5PF.                               
      @655    PRDAY3                        N5PF.                               
      @660    PRDAY4                        N5PF.                               
      ...
      @765    PRDAY25                       N5PF.                               
      @770    PSTATE                        $CHAR2.                             
      @772    PSTATE_GEO                    $CHAR2.                             
      @774    PSTCO                         N5PF.                               
      @779    PSTCO_GEO                     N5PF.                               
      @784    RACE                          N2PF.                               
      @786    RACE_PCT_MISS_HOSP            N7P2F.                              
      @793    RACE_X                        $CHAR2.                             
      @795    TOTCHG                        N10PF.                              
      @805    TOTCHG_X                      N15P2F.                             
      @820    TRAN_IN                       N2PF.                               
