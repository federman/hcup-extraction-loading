...
*  Data Step                  *;                                                
*******************************;                                                
DATA NE_SIDC_2019_CORE;                                                         
INFILE 'NE_SID_2019_CORE.ASC' FIRSTOBS=3 LRECL = 755;                           
...
INPUT                                                                           
      ...
      @379    I10_PR14                      $CHAR7.                             
      @386    I10_PR15                      $CHAR7.                             
      @393    I10_PROCTYPE                  N3PF.                               
      @396    I10_SERVICELINE               N2PF.                               
      @398    KEY                           15.                                 
      @413    LOS                           N5PF.                               
      @418    LOS_X                         N6PF.                               
      @424    MDC                           N2PF.                               
      ...
      @460    PL_UIC                        N2PF.                               
      @462    PL_UR_CAT4                    N2PF.                               
      @464    POA_Disch_Edit1               N2PF.                               
      @466    POA_Disch_Edit2               N2PF.                               
      @468    POA_Hosp_Edit1                N2PF.                               
      @470    POA_Hosp_Edit2                N2PF.                               
      @472    POA_Hosp_Edit3                N2PF.                               
      @474    POA_Hosp_Edit3_Value          N8P2F.                              
      @482    PRDAY1                        N5PF.                               
      @487    PRDAY2                        N5PF.                               
      @492    PRDAY3                        N5PF.                               
      @497    PRDAY4                        N5PF.                               
      ...
      @552    PRDAY15                       N5PF.                               
      @557    PSTATE                        $CHAR2.                             
      @559    PSTATE_GEO                    $CHAR2.                             
      @561    PSTCO                         N5PF.                               
      @566    PSTCO_GEO                     N5PF.                               
      @571    PointOfOriginUB04             $CHAR1.                             
      @572    PointOfOrigin_X               $CHAR1.                             
      @573    TOTCHG                        N10PF.                              
      @583    TOTCHG_X                      N15P2F.                             
      @598    TRAN_IN                       N2PF.                               
      @600    TRAN_OUT                      N2PF.                               
