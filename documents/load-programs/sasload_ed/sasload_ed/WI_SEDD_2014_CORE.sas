...
*  Data Step                  *;                                                
*******************************;                                                
DATA WI_SEDDC_2014_CORE;                                                        
INFILE 'WI_SEDD_2014_CORE.ASC' FIRSTOBS=3 LRECL = 2030;                         
...
INPUT                                                                           
      ...
      @1184   DXCCS49                       N4PF.                               
      @1188   DXVER                         N3PF.                               
      @1191   DX_Visit_Reason1              $CHAR7.                             
      @1198   DX_Visit_Reason2              $CHAR7.                             
      @1205   DX_Visit_Reason3              $CHAR7.                             
      @1212   DaysToEvent                   N6PF.                               
      @1218   ECODE1                        $CHAR7.                             
      @1225   ECODE2                        $CHAR7.                             
      @1232   ECODE3                        $CHAR7.                             
      @1239   ECODE4                        $CHAR7.                             
      ...
      @1319   HCUP_ED                       N2PF.                               
      @1321   HCUP_OS                       N2PF.                               
      @1323   HISPANIC_X                    $CHAR1.                             
      @1324   HOSPBRTH                      N3PF.                               
      @1327   HOSPST                        $CHAR2.                             
      @1329   HOSP_NPI                      $CHAR10.                            
      @1339   Homeless                      N2PF.                               
      @1341   KEY                           15.                                 
      @1356   LOS                           N5PF.                               
      @1361   LOS_X                         N6PF.                               
      ...
      @1947   PSTATE                        $CHAR2.                             
      @1949   PSTCO2                        N5PF.                               
      @1954   PointOfOriginUB04             $CHAR1.                             
      @1955   PointOfOrigin_X               $CHAR1.                             
      @1956   RACE                          N2PF.                               
      @1958   RACE_X                        $CHAR2.                             
      @1960   STATE_AS                      N2PF.                               
      @1962   STATE_ED                      N2PF.                               
      @1964   STATE_OS                      N2PF.                               
      @1966   TOTCHG                        N10PF.                              
      @1976   TOTCHG_X                      N15P2F.                             
      @1991   VisitLink                     N9PF.                               
      @2000   YEAR                          N4PF.                               
      @2004   ZIP                           $CHAR5.                             
      @2009   ZIP3                          $CHAR3.                             
      @2012   ZIPINC_QRTL                   N3PF.                               
      @2015   AYEAR                         N4PF.                               
      @2019   BMONTH                        N2PF.                               
      @2021   BYEAR                         N4PF.                               
      @2025   PRMONTH1                      N2PF.                               
