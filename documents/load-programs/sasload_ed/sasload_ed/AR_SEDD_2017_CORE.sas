...
*  Data Step                  *;                                                
*******************************;                                                
DATA AR_SEDDC_2017_CORE;                                                        
INFILE 'AR_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1232;                         
...
INPUT                                                                           
      ...
      @649    HOSPST                        $CHAR2.                             
      @651    I10_DX_Visit_Reason1          $CHAR7.                             
      @658    I10_DX1                       $CHAR7.                             
      @665    I10_DX2                       $CHAR7.                             
      @672    I10_DX3                       $CHAR7.                             
      @679    I10_DX4                       $CHAR7.                             
      ...
      @937    I10_PR7                       $CHAR7.                             
      @944    I10_PR8                       $CHAR7.                             
      @951    I10_PROCTYPE                  N3PF.                               
      @954    KEY                           15.                                 
      @969    LOS                           N5PF.                               
      @974    LOS_X                         N6PF.                               
      @980    MARITALSTATUS_X               $CHAR1.                             
      @981    MARITALSTATUSUB04             $CHAR1.                             
      @982    MDNUM1_R                      N9PF.                               
      @991    MDNUM2_R                      N9PF.                               
      @1000   MDNUM3_R                      N9PF.                               
      @1009   MDNUM4_R                      N9PF.                               
      @1018   MDNUMTYPE1                    $CHAR1.                             
      @1019   MEDINCSTQ                     N2PF.                               
      @1021   MRN_R                         N9PF.                               
      @1030   NCPT                          N4PF.                               
      @1034   OS_TIME                       N11P2F.                             
      ...
      @1129   STATE_OS                      N2PF.                               
      @1131   TOTCHG                        N10PF.                              
      @1141   TOTCHG_X                      N15P2F.                             
      @1156   VisitLink                     N9PF.                               
      @1165   YEAR                          N4PF.                               
      @1169   ZIP3                          $CHAR3.                             
      @1172   ZIPINC_QRTL                   N3PF.                               
      @1175   AYEAR                         N4PF.                               
      @1179   BMONTH                        N2PF.                               
      @1181   BYEAR                         N4PF.                               
      @1185   PRMONTH1                      N2PF.                               
