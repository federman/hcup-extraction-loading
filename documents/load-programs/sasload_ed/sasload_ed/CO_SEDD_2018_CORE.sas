...
*  Data Step                  *;                                                
*******************************;                                                
DATA CO_SEDDC_2018_CORE;                                                        
INFILE 'CO_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 1791;                         
...
INPUT                                                                           
      ...
      @1333   Homeless                      N2PF.                               
      @1335   HOSPST                        $CHAR2.                             
      @1337   I10_DX_Visit_Reason1          $CHAR7.                             
      @1344   I10_DX_Visit_Reason2          $CHAR7.                             
      @1351   I10_DX_Visit_Reason3          $CHAR7.                             
      @1358   I10_DX1                       $CHAR7.                             
      @1365   I10_DX2                       $CHAR7.                             
      @1372   I10_DX3                       $CHAR7.                             
      @1379   I10_DX4                       $CHAR7.                             
      ...
      @1688   PL_RUCC                       N2PF.                               
      @1690   PL_UIC                        N2PF.                               
      @1692   PL_UR_CAT4                    N2PF.                               
      @1694   PointOfOrigin_X               $CHAR4.                             
      @1698   PointOfOriginUB04             $CHAR1.                             
      @1699   PSTATE                        $CHAR2.                             
      @1701   PSTCO                         N5PF.                               
      @1706   PSTCO2                        N5PF.                               
      @1711   RACE                          N2PF.                               
      ...
      @1732   STATE_OS                      N2PF.                               
      @1734   TOTCHG                        N10PF.                              
      @1744   TOTCHG_X                      N15P2F.                             
      @1759   YEAR                          N4PF.                               
      @1763   ZIP                           $CHAR5.                             
      @1768   ZIP3                          $CHAR3.                             
      @1771   ZIPINC_QRTL                   N3PF.                               
      @1774   SUBSTATE_REGION_X             $CHAR3.                             
      @1777   HOSPID                        N5PF.                               
      @1782   AYEAR                         N4PF.                               
      @1786   BMONTH                        N2PF.                               
      @1788   BYEAR                         N4PF.                               
