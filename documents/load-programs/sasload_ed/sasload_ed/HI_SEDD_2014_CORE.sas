...
*  Data Step                  *;                                                
*******************************;                                                
DATA HI_SEDDC_2014_CORE;                                                        
INFILE 'HI_SEDD_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1818;                         
...
INPUT                                                                           
      ...
      @1015   CPTM1_98                      $CHAR2.                             
      @1017   CPTM1_99                      $CHAR2.                             
      @1019   CPTM1_100                     $CHAR2.                             
      @1021   CPTM1_101                     $CHAR2.                             
      @1023   CPTM2_1                       $CHAR2.                             
      @1025   CPTM2_2                       $CHAR2.                             
      @1027   CPTM2_3                       $CHAR2.                             
      @1029   CPTM2_4                       $CHAR2.                             
      ...
      @1217   CPTM2_98                      $CHAR2.                             
      @1219   CPTM2_99                      $CHAR2.                             
      @1221   CPTM2_100                     $CHAR2.                             
      @1223   CPTM2_101                     $CHAR2.                             
      @1225   DIED                          N2PF.                               
      @1227   DISPUB04                      N2PF.                               
      @1229   DISPUNIFORM                   N2PF.                               
      @1231   DISP_X                        $CHAR2.                             
      @1233   DMONTH                        N2PF.                               
      @1235   DQTR                          N2PF.                               
      @1237   DX1                           $CHAR7.                             
      ...
      @1704   STATE_OS                      N2PF.                               
      @1706   TOTCHG                        N10PF.                              
      @1716   TOTCHG_X                      N15P2F.                             
      @1731   YEAR                          N4PF.                               
      @1735   ZIP3                          $CHAR3.                             
      @1738   ZIPINC_QRTL                   N3PF.                               
      @1741   HOSPID                        N5PF.                               
      @1746   AGEGROUP                      N3PF.                               
      @1749   AYEAR                         N4PF.                               
      @1753   BMONTH                        N2PF.                               
