...
*  Data Step                  *;                                                
*******************************;                                                
DATA MA_SEDDC_2014_CORE;                                                        
INFILE 'MA_SEDD_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1696;                         
...
INPUT                                                                           
      ...
      @1147   DXPOA31                       $CHAR1.                             
      @1148   DXVER                         N3PF.                               
      @1151   DaysBetweenVisits             N4PF.                               
      @1155   DaysToEvent                   N6PF.                               
      @1161   ECODE1                        $CHAR7.                             
      @1168   ECODE2                        $CHAR7.                             
      @1175   ECODE3                        $CHAR7.                             
      @1182   ECODE4                        $CHAR7.                             
      ...
      @1363   POA_Disch_Edit1               N2PF.                               
      @1365   POA_Disch_Edit2               N2PF.                               
      @1367   POA_Hosp_Edit1                N2PF.                               
      @1369   POA_Hosp_Edit2                N2PF.                               
      @1371   POA_Hosp_Edit3                N2PF.                               
      @1373   POA_Hosp_Edit3_Value          N8P2F.                              
      @1381   PR1                           $CHAR7.                             
      @1388   PR2                           $CHAR7.                             
      @1395   PR3                           $CHAR7.                             
      @1402   PR4                           $CHAR7.                             
