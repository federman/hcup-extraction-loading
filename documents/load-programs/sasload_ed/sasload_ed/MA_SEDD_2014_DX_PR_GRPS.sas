...
*  Data Step                  *;                                                
*******************************;                                                
DATA MA_SEDDC_2014_DX_PR_GRPS;                                                  
INFILE 'MA_SEDD_2014_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 851;                    
...
INPUT                                                                           
      ...
      @565    INJURY                        N2PF.                               
      @567    INJURY_CUT                    N2PF.                               
      @569    INJURY_DROWN                  N2PF.                               
      @571    INJURY_FALL                   N2PF.                               
      @573    INJURY_FIRE                   N2PF.                               
      @575    INJURY_FIREARM                N2PF.                               
      @577    INJURY_MACHINERY              N2PF.                               
      @579    INJURY_MVT                    N2PF.                               
      @581    INJURY_NATURE                 N2PF.                               
      @583    INJURY_POISON                 N2PF.                               
      @585    INJURY_STRUCK                 N2PF.                               
      @587    INJURY_SUFFOCATION            N2PF.                               
      @589    INTENT_ASSAULT                N2PF.                               
      @591    INTENT_SELF_HARM              N2PF.                               
      @593    INTENT_UNINTENTIONAL          N2PF.                               
      @595    KEY                           15.                                 
      @610    MULTINJURY                    N2PF.                               
      @612    PCLASS1                       N2PF.                               
      @614    PCLASS2                       N2PF.                               
