...
*  Data Step                  *;                                                
*******************************;                                                
DATA IA_SEDDC_2014_DX_PR_GRPS;                                                  
INFILE 'IA_SEDD_2014_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 660;                    
...
INPUT                                                                           
      ...
      @554    INJURY                        N2PF.                               
      @556    INJURY_CUT                    N2PF.                               
      @558    INJURY_DROWN                  N2PF.                               
      @560    INJURY_FALL                   N2PF.                               
      @562    INJURY_FIRE                   N2PF.                               
      @564    INJURY_FIREARM                N2PF.                               
      @566    INJURY_MACHINERY              N2PF.                               
      @568    INJURY_MVT                    N2PF.                               
      @570    INJURY_NATURE                 N2PF.                               
      @572    INJURY_POISON                 N2PF.                               
      @574    INJURY_STRUCK                 N2PF.                               
      @576    INJURY_SUFFOCATION            N2PF.                               
      @578    INTENT_ASSAULT                N2PF.                               
      @580    INTENT_SELF_HARM              N2PF.                               
      @582    INTENT_UNINTENTIONAL          N2PF.                               
      @584    KEY                           15.                                 
      @599    MULTINJURY                    N2PF.                               
      @601    U_BLOOD                       N2PF.                               
      @603    U_CATH                        N2PF.                               
      @605    U_CCU                         N2PF.                               
      @607    U_CHESTXRAY                   N2PF.                               
      @609    U_CTSCAN                      N2PF.                               
      @611    U_DIALYSIS                    N2PF.                               
      @613    U_ECHO                        N2PF.                               
      @615    U_ED                          N2PF.                               
      ...
      @647    U_PACEMAKER                   N2PF.                               
      @649    U_PHYTHERAPY                  N2PF.                               
      @651    U_RADTHERAPY                  N2PF.                               
      @653    U_RESPTHERAPY                 N2PF.                               
      @655    U_SPEECHTHERAPY               N2PF.                               
      @657    U_STRESS                      N2PF.                               
      @659    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
