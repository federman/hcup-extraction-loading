...
*  Data Step                  *;                                                
*******************************;                                                
DATA FL_SEDDC_2020_CORE;                                                        
INFILE 'FL_SEDD_2020_CORE.ASC' FIRSTOBS=3 LRECL = 615;                          
...
INPUT                                                                           
      ...
      @335    HCUP_ED                       N2PF.                               
      @337    HCUP_OS                       N2PF.                               
      @339    HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @344    HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @349    HISPANIC                      N2PF.                               
      @351    HISPANIC_X                    $CHAR2.                             
      @353    Homeless                      N2PF.                               
      @355    HOSPST                        $CHAR2.                             
      @357    I10_DX_Visit_Reason1          $CHAR7.                             
      @364    I10_DX1                       $CHAR7.                             
      @371    I10_DX2                       $CHAR7.                             
      @378    I10_DX3                       $CHAR7.                             
      @385    I10_DX4                       $CHAR7.                             
      ...
      @533    PL_UIC                        N2PF.                               
      @535    PL_UR_CAT4                    N2PF.                               
      @537    PointOfOrigin_X               $CHAR2.                             
      @539    PointOfOriginUB04             $CHAR1.                             
      @540    PSTATE                        $CHAR2.                             
      @542    PSTATE_GEO                    $CHAR2.                             
      @544    PSTCO                         N5PF.                               
      @549    PSTCO_GEO                     N5PF.                               
      @554    RACE                          N2PF.                               
      @556    RACE_X                        $CHAR1.                             
