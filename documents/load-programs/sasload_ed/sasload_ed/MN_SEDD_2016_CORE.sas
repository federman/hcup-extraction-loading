...
*  Data Step                  *;                                                
*******************************;                                                
DATA MN_SEDDC_2016_CORE;                                                        
INFILE 'MN_SEDD_2016_CORE.ASC' FIRSTOBS=3 LRECL = 1705;                         
...
INPUT                                                                           
      ...
      @838    HCUP_OS                       N2PF.                               
      @840    HISPANIC                      N2PF.                               
      @842    HISPANIC_X                    $CHAR20.                            
      @862    HOSPST                        $CHAR2.                             
      @864    I10_DX_Visit_Reason1          $CHAR7.                             
      @871    I10_DX1                       $CHAR7.                             
      @878    I10_DX2                       $CHAR7.                             
      @885    I10_DX3                       $CHAR7.                             
      @892    I10_DX4                       $CHAR7.                             
      ...
      @1032   I10_DX24                      $CHAR7.                             
      @1039   I10_DX25                      $CHAR7.                             
      @1046   I10_ECAUSE1                   $CHAR7.                             
      @1053   I10_ECAUSE2                   $CHAR7.                             
      @1060   I10_ECAUSE3                   $CHAR7.                             
      @1067   I10_ECAUSE4                   $CHAR7.                             
      @1074   I10_ECAUSE5                   $CHAR7.                             
      @1081   I10_ECAUSE6                   $CHAR7.                             
      @1088   I10_ECAUSE7                   $CHAR7.                             
      @1095   I10_ECAUSE8                   $CHAR7.                             
      @1102   I10_ECAUSE9                   $CHAR7.                             
      @1109   I10_ECAUSE10                  $CHAR7.                             
      @1116   I10_NDX                       N3PF.                               
      @1119   I10_NECAUSE                   N2PF.                               
      @1121   I10_NPR                       N3PF.                               
      @1124   I10_PR1                       $CHAR7.                             
      @1131   I10_PR2                       $CHAR7.                             
      @1138   I10_PR3                       $CHAR7.                             
      ...
      @1358   PL_RUCC                       N2PF.                               
      @1360   PL_UIC                        N2PF.                               
      @1362   PL_UR_CAT4                    N2PF.                               
      @1364   POA_Disch_Edit1               N2PF.                               
      @1366   POA_Disch_Edit2               N2PF.                               
      @1368   POA_Hosp_Edit1                N2PF.                               
      @1370   POA_Hosp_Edit2                N2PF.                               
      @1372   POA_Hosp_Edit3                N2PF.                               
      @1374   POA_Hosp_Edit3_Value          N8P2F.                              
      @1382   PointOfOrigin_X               $CHAR1.                             
      @1383   PointOfOriginUB04             $CHAR1.                             
      @1384   PRDAY1                        N5PF.                               
      @1389   PRDAY2                        N5PF.                               
      @1394   PRDAY3                        N5PF.                               
      @1399   PRDAY4                        N5PF.                               
      ...
      @1528   STATE_OS                      N2PF.                               
      @1530   TOTCHG                        N10PF.                              
      @1540   TOTCHG_X                      N15P2F.                             
      @1555   YEAR                          N4PF.                               
      @1559   ZIP                           $CHAR5.                             
      @1564   ZIP3                          $CHAR3.                             
      @1567   ZIPINC_QRTL                   N3PF.                               
      @1570   AYEAR                         N4PF.                               
      @1574   BMONTH                        N2PF.                               
      @1576   BYEAR                         N4PF.                               
      @1580   PRMONTH1                      N2PF.                               
