...
*  Data Step                  *;                                                
*******************************;                                                
DATA IA_SEDDC_2014_CORE;                                                        
INFILE 'IA_SEDD_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1455;                         
...
INPUT                                                                           
      ...
      @1115   DXCCS31                       N4PF.                               
      @1119   DXVER                         N3PF.                               
      @1122   DX_Visit_Reason1              $CHAR7.                             
      @1129   DX_Visit_Reason2              $CHAR7.                             
      @1136   DX_Visit_Reason3              $CHAR7.                             
      ...
      @1362   PL_RUCC                       N2PF.                               
      @1364   PL_UIC                        N2PF.                               
      @1366   PL_UR_CAT4                    N2PF.                               
      @1368   PROCTYPE                      N3PF.                               
      @1371   PSTATE                        $CHAR2.                             
      @1373   PSTCO                         N5PF.                               
      @1378   PSTCO2                        N5PF.                               
      @1383   PointOfOriginUB04             $CHAR1.                             
      @1384   PointOfOrigin_X               $CHAR1.                             
      @1385   RACE                          N2PF.                               
      @1387   RACE_X                        $CHAR4.                             
      @1391   STATE_AS                      N2PF.                               
      @1393   STATE_ED                      N2PF.                               
      @1395   STATE_OS                      N2PF.                               
      @1397   TOTCHG                        N10PF.                              
      @1407   TOTCHG_X                      N15P2F.                             
      @1422   VisitLink                     N9PF.                               
      @1431   YEAR                          N4PF.                               
      @1435   ZIP                           $CHAR5.                             
      @1440   ZIP3                          $CHAR3.                             
      @1443   ZIPINC_QRTL                   N3PF.                               
      @1446   AYEAR                         N4PF.                               
      @1450   BMONTH                        N2PF.                               
      @1452   BYEAR                         N4PF.                               
      ;                                                                         
