...
*   RI_SEDD_2015q1q3_DX_PR_GRPS.SAS:                                            
...
*  Data Step                  *;                                                
*******************************;                                                
DATA RI_SEDDC_2015q1q3_DX_PR_GRPS;                                              
INFILE 'RI_SEDD_2015q1q3_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 322;                
...
INPUT                                                                           
      ...
      @276    INJURY                        N2PF.                               
      @278    INJURY_CUT                    N2PF.                               
      @280    INJURY_DROWN                  N2PF.                               
      @282    INJURY_FALL                   N2PF.                               
      @284    INJURY_FIRE                   N2PF.                               
      @286    INJURY_FIREARM                N2PF.                               
      @288    INJURY_MACHINERY              N2PF.                               
      @290    INJURY_MVT                    N2PF.                               
      @292    INJURY_NATURE                 N2PF.                               
      @294    INJURY_POISON                 N2PF.                               
      @296    INJURY_STRUCK                 N2PF.                               
      @298    INJURY_SUFFOCATION            N2PF.                               
      @300    INTENT_ASSAULT                N2PF.                               
      @302    INTENT_SELF_HARM              N2PF.                               
      @304    INTENT_UNINTENTIONAL          N2PF.                               
      @306    KEY                           15.                                 
      @321    MULTINJURY                    N2PF.                               
      ;                                                                         
