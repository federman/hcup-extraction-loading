...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SEDDC_2014_CORE;                                                        
INFILE 'NJ_SEDD_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1783;                         
...
INPUT                                                                           
      ...
      @950    DXPOA24                       $CHAR1.                             
      @951    DXVER                         N3PF.                               
      @954    DX_Visit_Reason1              $CHAR7.                             
      @961    DX_Visit_Reason2              $CHAR7.                             
      @968    DX_Visit_Reason3              $CHAR7.                             
      @975    ECODE1                        $CHAR7.                             
      @982    ECODE2                        $CHAR7.                             
      @989    ECODE3                        $CHAR7.                             
      @996    ECODE4                        $CHAR7.                             
      ...
      @1121   HCUP_ED                       N2PF.                               
      @1123   HCUP_OS                       N2PF.                               
      @1125   HISPANIC_X                    $CHAR5.                             
      @1130   HOSPBRTH                      N3PF.                               
      @1133   HOSPST                        $CHAR2.                             
      @1135   KEY                           15.                                 
      @1150   LOS                           N5PF.                               
      @1155   LOS_X                         N6PF.                               
      @1161   MARITALSTATUSUB04             $CHAR1.                             
      @1162   MDNUM1_R                      N9PF.                               
      @1171   MDNUM2_R                      N9PF.                               
      @1180   MEDINCSTQ                     N2PF.                               
      @1182   MOMNUM_R                      N9PF.                               
      ...
      @1248   PL_RUCC                       N2PF.                               
      @1250   PL_UIC                        N2PF.                               
      @1252   PL_UR_CAT4                    N2PF.                               
      @1254   POA_Disch_Edit1               N2PF.                               
      @1256   POA_Disch_Edit2               N2PF.                               
      @1258   POA_Hosp_Edit1                N2PF.                               
      @1260   POA_Hosp_Edit2                N2PF.                               
      @1262   POA_Hosp_Edit3                N2PF.                               
      @1264   POA_Hosp_Edit3_Value          N8P2F.                              
      @1272   PR1                           $CHAR7.                             
      @1279   PR2                           $CHAR7.                             
      @1286   PR3                           $CHAR7.                             
      @1293   PR4                           $CHAR7.                             
      ...
      @1580   PSTCO                         N5PF.                               
      @1585   PSTCO2                        N5PF.                               
      @1590   PointOfOriginUB04             $CHAR1.                             
      @1591   PointOfOrigin_X               $CHAR1.                             
      @1592   PrimLang                      $CHAR3.                             
      @1595   RACE                          N2PF.                               
      @1597   RACE_X                        $CHAR5.                             
      @1602   READMIT                       N2PF.                               
      ...
      @1608   STATE_OS                      N2PF.                               
      @1610   TOTCHG                        N10PF.                              
      @1620   TOTCHG_X                      N15P2F.                             
      @1635   YEAR                          N4PF.                               
      @1639   ZIP                           $CHAR5.                             
      @1644   ZIP3                          $CHAR3.                             
      @1647   ZIPINC_QRTL                   N3PF.                               
      @1650   TOWN                          $CHAR4.                             
      @1654   AYEAR                         N4PF.                               
      @1658   BMONTH                        N2PF.                               
      @1660   BYEAR                         N4PF.                               
