...
*   VT_SEDD_2015q1q3_DX_PR_GRPS.SAS:                                            
...
*  Data Step                  *;                                                
*******************************;                                                
DATA VT_SEDDC_2015q1q3_DX_PR_GRPS;                                              
INFILE 'VT_SEDD_2015q1q3_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 728;                
...
INPUT                                                                           
      ...
      @422    INJURY                        N2PF.                               
      @424    INJURY_CUT                    N2PF.                               
      @426    INJURY_DROWN                  N2PF.                               
      @428    INJURY_FALL                   N2PF.                               
      @430    INJURY_FIRE                   N2PF.                               
      @432    INJURY_FIREARM                N2PF.                               
      @434    INJURY_MACHINERY              N2PF.                               
      @436    INJURY_MVT                    N2PF.                               
      @438    INJURY_NATURE                 N2PF.                               
      @440    INJURY_POISON                 N2PF.                               
      @442    INJURY_STRUCK                 N2PF.                               
      @444    INJURY_SUFFOCATION            N2PF.                               
      @446    INTENT_ASSAULT                N2PF.                               
      @448    INTENT_SELF_HARM              N2PF.                               
      @450    INTENT_UNINTENTIONAL          N2PF.                               
      @452    KEY                           15.                                 
      @467    MULTINJURY                    N2PF.                               
      @469    PCLASS1                       N2PF.                               
      @471    PCLASS2                       N2PF.                               
      ...
      @703    U_NEWBN4L                     N2PF.                               
      @705    U_NUCMED                      N2PF.                               
      @707    U_OBSERVATION                 N2PF.                               
      @709    U_OCCTHERAPY                  N2PF.                               
      @711    U_ORGANACQ                    N2PF.                               
      @713    U_OTHIMPLANTS                 N2PF.                               
      @715    U_PACEMAKER                   N2PF.                               
      @717    U_PHYTHERAPY                  N2PF.                               
      @719    U_RADTHERAPY                  N2PF.                               
      @721    U_RESPTHERAPY                 N2PF.                               
      @723    U_SPEECHTHERAPY               N2PF.                               
      @725    U_STRESS                      N2PF.                               
      @727    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
