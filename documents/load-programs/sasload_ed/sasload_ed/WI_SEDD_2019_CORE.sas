...
*  Data Step                  *;                                                
*******************************;                                                
DATA WI_SEDDC_2019_CORE;                                                        
INFILE 'WI_SEDD_2019_CORE.ASC' FIRSTOBS=3 LRECL = 2267;                         
...
INPUT                                                                           
      ...
      @1512   CPTM1_98                      $CHAR2.                             
      @1514   CPTM1_99                      $CHAR2.                             
      @1516   CPTM1_100                     $CHAR2.                             
      @1518   CPTM1_101                     $CHAR2.                             
      @1520   CPTM1_102                     $CHAR2.                             
      @1522   CPTM1_103                     $CHAR2.                             
      @1524   CPTM1_104                     $CHAR2.                             
      @1526   CPTM1_105                     $CHAR2.                             
      @1528   CPTM1_106                     $CHAR2.                             
      @1530   CPTM1_107                     $CHAR2.                             
      @1532   CPTM1_108                     $CHAR2.                             
      @1534   CPTM1_109                     $CHAR2.                             
      @1536   CPTM1_110                     $CHAR2.                             
      @1538   CPTM1_111                     $CHAR2.                             
      @1540   CPTM1_112                     $CHAR2.                             
      @1542   CPTM1_113                     $CHAR2.                             
      @1544   CPTM1_114                     $CHAR2.                             
      @1546   CPTM1_115                     $CHAR2.                             
      @1548   CPTM1_116                     $CHAR2.                             
      @1550   CPTM1_117                     $CHAR2.                             
      @1552   CPTM1_118                     $CHAR2.                             
      @1554   CPTM2_1                       $CHAR2.                             
      @1556   CPTM2_2                       $CHAR2.                             
      @1558   CPTM2_3                       $CHAR2.                             
      @1560   CPTM2_4                       $CHAR2.                             
      ...
      @1748   CPTM2_98                      $CHAR2.                             
      @1750   CPTM2_99                      $CHAR2.                             
      @1752   CPTM2_100                     $CHAR2.                             
      @1754   CPTM2_101                     $CHAR2.                             
      @1756   CPTM2_102                     $CHAR2.                             
      @1758   CPTM2_103                     $CHAR2.                             
      @1760   CPTM2_104                     $CHAR2.                             
      @1762   CPTM2_105                     $CHAR2.                             
      @1764   CPTM2_106                     $CHAR2.                             
      @1766   CPTM2_107                     $CHAR2.                             
      @1768   CPTM2_108                     $CHAR2.                             
      @1770   CPTM2_109                     $CHAR2.                             
      @1772   CPTM2_110                     $CHAR2.                             
      @1774   CPTM2_111                     $CHAR2.                             
      @1776   CPTM2_112                     $CHAR2.                             
      @1778   CPTM2_113                     $CHAR2.                             
      @1780   CPTM2_114                     $CHAR2.                             
      @1782   CPTM2_115                     $CHAR2.                             
      @1784   CPTM2_116                     $CHAR2.                             
      @1786   CPTM2_117                     $CHAR2.                             
      @1788   CPTM2_118                     $CHAR2.                             
      @1790   DIED                          N2PF.                               
      @1792   DISPUB04                      N2PF.                               
      @1794   DISPUNIFORM                   N2PF.                               
      @1796   DISP_X                        $CHAR2.                             
      @1798   DMONTH                        N2PF.                               
      @1800   DQTR                          N2PF.                               
      @1802   DSHOSPID                      $CHAR17.                            
      @1819   DaysToEvent                   N6PF.                               
      @1825   FEMALE                        N2PF.                               
      @1827   HCUP_ED                       N2PF.                               
      @1829   HCUP_OS                       N2PF.                               
      @1831   HISPANIC                      N2PF.                               
      @1833   HISPANIC_X                    $CHAR1.                             
      @1834   HOSPST                        $CHAR2.                             
      @1836   HOSP_NPI                      $CHAR10.                            
      @1846   Homeless                      N2PF.                               
      @1848   I10_DX1                       $CHAR7.                             
      @1855   I10_DX2                       $CHAR7.                             
      @1862   I10_DX3                       $CHAR7.                             
      ...
      @2058   I10_DX31                      $CHAR7.                             
      @2065   I10_DX32                      $CHAR7.                             
      @2072   I10_DX_Visit_Reason1          $CHAR7.                             
      @2079   I10_DX_Visit_Reason2          $CHAR7.                             
      @2086   I10_DX_Visit_Reason3          $CHAR7.                             
      @2093   I10_NDX                       N3PF.                               
      @2096   I10_PROCTYPE                  N3PF.                               
      @2099   KEY                           15.                                 
      @2114   LOS                           N5PF.                               
      @2119   LOS_X                         N6PF.                               
      @2125   MDSPEC1                       $CHAR3.                             
      ...
      @2177   PL_RUCC                       N2PF.                               
      @2179   PL_UIC                        N2PF.                               
      @2181   PL_UR_CAT4                    N2PF.                               
      @2183   PSTATE                        $CHAR2.                             
      @2185   PSTATE_GEO                    $CHAR2.                             
      @2187   PSTCO                         N5PF.                               
      @2192   PSTCO_GEO                     N5PF.                               
      @2197   PointOfOriginUB04             $CHAR1.                             
      @2198   PointOfOrigin_X               $CHAR1.                             
      @2199   RACE                          N2PF.                               
      @2201   RACE_X                        $CHAR2.                             
      @2203   STATE_AS                      N2PF.                               
      @2205   STATE_ED                      N2PF.                               
      @2207   STATE_OS                      N2PF.                               
      @2209   TOTCHG                        N10PF.                              
      @2219   TOTCHG_X                      N15P2F.                             
      @2234   VisitLink                     N9PF.                               
      @2243   YEAR                          N4PF.                               
      @2247   ZIP                           $CHAR5.                             
      @2252   ZIP3                          $CHAR3.                             
      @2255   ZIPINC_QRTL                   N3PF.                               
      @2258   AYEAR                         N4PF.                               
      @2262   BMONTH                        N2PF.                               
      @2264   BYEAR                         N4PF.                               
      ;                                                                         
