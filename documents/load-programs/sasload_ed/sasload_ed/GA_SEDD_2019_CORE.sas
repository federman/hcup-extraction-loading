...
*  Data Step                  *;                                                
*******************************;                                                
DATA GA_SEDDC_2019_CORE;                                                        
INFILE 'GA_SEDD_2019_CORE.ASC' FIRSTOBS=3 LRECL = 2360;                         
...
INPUT                                                                           
      ...
      @1795   I10_PR29                      $CHAR7.                             
      @1802   I10_PR30                      $CHAR7.                             
      @1809   I10_PROCTYPE                  N3PF.                               
      @1812   KEY                           15.                                 
      @1827   LOS                           N5PF.                               
      @1832   LOS_X                         N6PF.                               
      @1838   MARITALSTATUSUB04             $CHAR1.                             
      @1839   MARITALSTATUS_X               $CHAR1.                             
      @1840   MDNUM1_R                      N9PF.                               
      @1849   MDNUM2_R                      N9PF.                               
      @1858   MDNUM3_R                      N9PF.                               
      @1867   MDNUM4_R                      N9PF.                               
      ...
      @1918   PL_RUCC                       N2PF.                               
      @1920   PL_UIC                        N2PF.                               
      @1922   PL_UR_CAT4                    N2PF.                               
      @1924   POA_Disch_Edit1               N2PF.                               
      @1926   POA_Disch_Edit2               N2PF.                               
      @1928   POA_Hosp_Edit1                N2PF.                               
      @1930   POA_Hosp_Edit2                N2PF.                               
      @1932   POA_Hosp_Edit3                N2PF.                               
      @1934   POA_Hosp_Edit3_Value          N8P2F.                              
      @1942   PRDAY1                        N5PF.                               
      @1947   PRDAY2                        N5PF.                               
      @1952   PRDAY3                        N5PF.                               
      @1957   PRDAY4                        N5PF.                               
      ...
      @2087   PRDAY30                       N5PF.                               
      @2092   PSTATE                        $CHAR2.                             
      @2094   PSTATE_GEO                    $CHAR2.                             
      @2096   PSTCO                         N5PF.                               
      @2101   PSTCO_GEO                     N5PF.                               
      @2106   PointOfOriginUB04             $CHAR1.                             
      @2107   PointOfOrigin_X               $CHAR1.                             
      @2108   RACE                          N2PF.                               
      @2110   RACE_X                        $CHAR1.                             
      @2111   STATE_AS                      N2PF.                               
      @2113   STATE_ED                      N2PF.                               
      @2115   STATE_OS                      N2PF.                               
      @2117   TOTCHG                        N10PF.                              
      @2127   TOTCHG_X                      N15P2F.                             
      @2142   VisitLink                     N9PF.                               
      @2151   YEAR                          N4PF.                               
      @2155   ZIP                           $CHAR5.                             
      @2160   ZIP3                          $CHAR3.                             
      @2163   ZIPINC_QRTL                   N3PF.                               
      @2166   HOSPID                        N5PF.                               
      @2171   AYEAR                         N4PF.                               
      @2175   BMONTH                        N2PF.                               
      @2177   BYEAR                         N4PF.                               
