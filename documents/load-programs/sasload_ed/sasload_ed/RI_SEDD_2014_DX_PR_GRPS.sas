...
*  Data Step                  *;                                                
*******************************;                                                
DATA RI_SEDDC_2014_DX_PR_GRPS;                                                  
INFILE 'RI_SEDD_2014_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 311;                    
...
INPUT                                                                           
      ...
      @265    INJURY                        N2PF.                               
      @267    INJURY_CUT                    N2PF.                               
      @269    INJURY_DROWN                  N2PF.                               
      @271    INJURY_FALL                   N2PF.                               
      @273    INJURY_FIRE                   N2PF.                               
      @275    INJURY_FIREARM                N2PF.                               
      @277    INJURY_MACHINERY              N2PF.                               
      @279    INJURY_MVT                    N2PF.                               
      @281    INJURY_NATURE                 N2PF.                               
      @283    INJURY_POISON                 N2PF.                               
      @285    INJURY_STRUCK                 N2PF.                               
      @287    INJURY_SUFFOCATION            N2PF.                               
      @289    INTENT_ASSAULT                N2PF.                               
      @291    INTENT_SELF_HARM              N2PF.                               
      @293    INTENT_UNINTENTIONAL          N2PF.                               
      @295    KEY                           15.                                 
      @310    MULTINJURY                    N2PF.                               
      ;                                                                         
