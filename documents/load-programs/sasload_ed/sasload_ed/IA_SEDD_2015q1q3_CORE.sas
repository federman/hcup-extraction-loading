...
*  Data Step                  *;                                                
*******************************;                                                
DATA IA_SEDDC_2015q1q3_CORE;                                                    
INFILE 'IA_SEDD_2015q1q3_CORE.ASC' FIRSTOBS=3 LRECL = 1450;                     
...
INPUT                                                                           
      ...
      @780    DMONTH                        N2PF.                               
      @782    DQTR                          N2PF.                               
      @784    DX_Visit_Reason1              $CHAR7.                             
      @791    DX_Visit_Reason2              $CHAR7.                             
      @798    DX_Visit_Reason3              $CHAR7.                             
      @805    DX1                           $CHAR7.                             
      @812    DX2                           $CHAR7.                             
      @819    DX3                           $CHAR7.                             
      @826    DX4                           $CHAR7.                             
      ...
      @1357   PL_RUCC                       N2PF.                               
      @1359   PL_UIC                        N2PF.                               
      @1361   PL_UR_CAT4                    N2PF.                               
      @1363   PointOfOrigin_X               $CHAR1.                             
      @1364   PointOfOriginUB04             $CHAR1.                             
      @1365   PROCTYPE                      N3PF.                               
      @1368   PSTATE                        $CHAR2.                             
      @1370   PSTCO                         N5PF.                               
      @1375   PSTCO2                        N5PF.                               
