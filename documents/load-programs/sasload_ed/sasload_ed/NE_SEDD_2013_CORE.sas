...
*  Data Step                  *;                                                
*******************************;                                                
DATA NE_SEDDC_2013_CORE;                                                        
INFILE 'NE_SEDD_2013_CORE.ASC' FIRSTOBS=3 LRECL = 996;                          
...
INPUT                                                                           
      ...
      @719    DXCCS8                   N4PF.                                    
      @723    DXCCS9                   N4PF.                                    
      @727    DX_Visit_Reason1         $CHAR5.                                  
      @732    DaysToEvent              N6PF.                                    
      @738    ECODE1                   $CHAR5.                                  
      @743    ECODE2                   $CHAR5.                                  
      @748    ECODE3                   $CHAR5.                                  
      @753    ECODE4                   $CHAR5.                                  
      ...
      @827    LOS                      N5PF.                                    
      @832    LOS_X                    N6PF.                                    
      @838    MARITALSTATUSUB04        $CHAR1.                                  
      @839    MARITALSTATUS_X          $CHAR1.                                  
      @840    MEDINCSTQ                N2PF.                                    
      @842    NCHRONIC                 N3PF.                                    
      @845    NCPT                     N3PF.                                    
      @848    NDX                      N2PF.                                    
      ...
      @874    PL_CBSA                  N3PF.                                    
      @877    PL_NCHS                  N2PF.                                    
      @879    PL_RUCA10_2005           N2PF.                                    
      @881    PL_RUCA2005              N4P1F.                                   
      @885    PL_RUCA4_2005            N2PF.                                    
      @887    PL_RUCC                  N2PF.                                    
      @889    PL_UIC                   N2PF.                                    
      @891    PL_UR_CAT4               N2PF.                                    
      @893    PROCTYPE                 N3PF.                                    
