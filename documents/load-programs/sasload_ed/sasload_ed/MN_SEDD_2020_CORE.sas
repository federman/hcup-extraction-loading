/*******************************************************************            
* Creation Date: 08/14/2021                                                     
*   MN_SEDD_2020_CORE.SAS:                                                      
...
*  Data Step                  *;                                                
*******************************;                                                
DATA MN_SEDDC_2020_CORE;                                                        
INFILE 'MN_SEDD_2020_CORE.ASC' FIRSTOBS=3 LRECL = 3729;                         
...
INPUT                                                                           
      ...
      @3083   HCUP_ED                       N2PF.                               
      @3085   HCUP_OS                       N2PF.                               
      @3087   HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @3092   HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @3097   HISPANIC                      N2PF.                               
      @3099   HISPANIC_X                    $CHAR2.                             
      @3101   HOSPST                        $CHAR2.                             
      @3103   I10_DX_Visit_Reason1          $CHAR7.                             
      @3110   I10_DX1                       $CHAR7.                             
      @3117   I10_DX2                       $CHAR7.                             
      @3124   I10_DX3                       $CHAR7.                             
      @3131   I10_DX4                       $CHAR7.                             
      ...
      @3515   PL_RUCC                       N2PF.                               
      @3517   PL_UIC                        N2PF.                               
      @3519   PL_UR_CAT4                    N2PF.                               
      @3521   POA_Disch_Edit1               N2PF.                               
      @3523   POA_Disch_Edit2               N2PF.                               
      @3525   POA_Hosp_Edit1                N2PF.                               
      @3527   POA_Hosp_Edit2                N2PF.                               
      @3529   POA_Hosp_Edit3                N2PF.                               
      @3531   POA_Hosp_Edit3_Value          N8P2F.                              
      @3539   PointOfOrigin_X               $CHAR1.                             
      @3540   PointOfOriginUB04             $CHAR1.                             
      @3541   PRDAY1                        N5PF.                               
      @3546   PRDAY2                        N5PF.                               
      @3551   PRDAY3                        N5PF.                               
      @3556   PRDAY4                        N5PF.                               
      ...
      @3624   STATE_OS                      N2PF.                               
      @3626   TOTCHG                        N10PF.                              
      @3636   TOTCHG_X                      N15P2F.                             
      @3651   YEAR                          N4PF.                               
      @3655   ZIP                           $CHAR5.                             
      @3660   ZIP3                          $CHAR3.                             
      @3663   ZIPINC_QRTL                   N3PF.                               
      @3666   AYEAR                         N4PF.                               
      @3670   BMONTH                        N2PF.                               
      @3672   BYEAR                         N4PF.                               
      @3676   PRMONTH1                      N2PF.                               
