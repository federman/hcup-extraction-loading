...
*  Data Step                  *;                                                
*******************************;                                                
DATA MO_SEDDC_2020_CORE;                                                        
INFILE 'MO_SEDD_2020_CORE.ASC' FIRSTOBS=3 LRECL = 3094;                         
...
INPUT                                                                           
      ...
      @2252   HCUP_ED                       N2PF.                               
      @2254   HCUP_OS                       N2PF.                               
      @2256   HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @2261   HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @2266   HISPANIC                      N2PF.                               
      @2268   HISPANIC_X                    $CHAR1.                             
      @2269   Homeless                      N2PF.                               
      @2271   HOSPST                        $CHAR2.                             
      @2273   I10_DX1                       $CHAR7.                             
      @2280   I10_DX2                       $CHAR7.                             
      ...
      @2711   MEDINCSTQ                     N2PF.                               
      @2713   NCPT                          N4PF.                               
      @2717   OBSERVATION                   N4PF.                               
      @2721   OPservice                     $CHAR1.                             
      @2722   OS_TIME                       N11P2F.                             
      @2733   PAY1                          N2PF.                               
      @2735   PAY1_X                        $CHAR2.                             
      @2737   PAY2                          N2PF.                               
      ...
      @2750   PL_RUCC                       N2PF.                               
      @2752   PL_UIC                        N2PF.                               
      @2754   PL_UR_CAT4                    N2PF.                               
      @2756   PointOfOrigin_X               $CHAR1.                             
      @2757   PointOfOriginUB04             $CHAR1.                             
      @2758   PRDAY1                        N5PF.                               
      @2763   PRDAY2                        N5PF.                               
      @2768   PRDAY3                        N5PF.                               
      @2773   PRDAY4                        N5PF.                               
