...
*  Data Step                  *;                                                
*******************************;                                                
DATA OR_SEDDC_2015q1q3_CORE;                                                    
INFILE 'OR_SEDD_2015q1q3_CORE.ASC' FIRSTOBS=3 LRECL = 2136;                     
...
INPUT                                                                           
      ...
      @1553   DURATION                      N6PF.                               
      @1559   DX_Visit_Reason1              $CHAR7.                             
      @1566   DX_Visit_Reason2              $CHAR7.                             
      @1573   DX_Visit_Reason3              $CHAR7.                             
      @1580   DX1                           $CHAR7.                             
      @1587   DX2                           $CHAR7.                             
      @1594   DX3                           $CHAR7.                             
      @1601   DX4                           $CHAR7.                             
      ...
      @2053   PL_RUCC                       N2PF.                               
      @2055   PL_UIC                        N2PF.                               
      @2057   PL_UR_CAT4                    N2PF.                               
      @2059   PointOfOrigin_X               $CHAR2.                             
      @2061   PointOfOriginUB04             $CHAR1.                             
      @2062   PROCTYPE                      N3PF.                               
      @2065   PSTATE                        $CHAR2.                             
      @2067   PSTCO                         N5PF.                               
      @2072   PSTCO2                        N5PF.                               
