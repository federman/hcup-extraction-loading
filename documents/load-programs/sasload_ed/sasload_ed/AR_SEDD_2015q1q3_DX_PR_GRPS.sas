...
*   AR_SEDD_2015q1q3_DX_PR_GRPS.SAS:                                            
...
*  Data Step                  *;                                                
*******************************;                                                
DATA AR_SEDDC_2015q1q3_DX_PR_GRPS;                                              
INFILE 'AR_SEDD_2015q1q3_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 702;                
...
INPUT                                                                           
      ...
      @516    INJURY                        N2PF.                               
      @518    INJURY_CUT                    N2PF.                               
      @520    INJURY_DROWN                  N2PF.                               
      @522    INJURY_FALL                   N2PF.                               
      @524    INJURY_FIRE                   N2PF.                               
      @526    INJURY_FIREARM                N2PF.                               
      @528    INJURY_MACHINERY              N2PF.                               
      @530    INJURY_MVT                    N2PF.                               
      @532    INJURY_NATURE                 N2PF.                               
      @534    INJURY_POISON                 N2PF.                               
      @536    INJURY_STRUCK                 N2PF.                               
      @538    INJURY_SUFFOCATION            N2PF.                               
      @540    INTENT_ASSAULT                N2PF.                               
      @542    INTENT_SELF_HARM              N2PF.                               
      @544    INTENT_UNINTENTIONAL          N2PF.                               
      @546    KEY                           15.                                 
      @561    MULTINJURY                    N2PF.                               
      @563    PCLASS1                       N2PF.                               
      @565    PCLASS2                       N2PF.                               
      ...
      @677    U_NEWBN4L                     N2PF.                               
      @679    U_NUCMED                      N2PF.                               
      @681    U_OBSERVATION                 N2PF.                               
      @683    U_OCCTHERAPY                  N2PF.                               
      @685    U_ORGANACQ                    N2PF.                               
      @687    U_OTHIMPLANTS                 N2PF.                               
      @689    U_PACEMAKER                   N2PF.                               
      @691    U_PHYTHERAPY                  N2PF.                               
      @693    U_RADTHERAPY                  N2PF.                               
      @695    U_RESPTHERAPY                 N2PF.                               
      @697    U_SPEECHTHERAPY               N2PF.                               
      @699    U_STRESS                      N2PF.                               
      @701    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
