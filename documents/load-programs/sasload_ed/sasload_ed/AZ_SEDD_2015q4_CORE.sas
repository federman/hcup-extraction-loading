...
*  Data Step                  *;                                                
*******************************;                                                
DATA AZ_SEDDC_2015q4_CORE;                                                      
INFILE 'AZ_SEDD_2015q4_CORE.ASC' FIRSTOBS=3 LRECL = 1009;                       
...
INPUT                                                                           
      ...
      @200    HCUP_OS                       N2PF.                               
      @202    HISPANIC                      N2PF.                               
      @204    HISPANIC_X                    $CHAR1.                             
      @205    Homeless                      N2PF.                               
      @207    HOSP_NPI                      $CHAR10.                            
      @217    HOSPST                        $CHAR2.                             
      @219    I10_DX_Visit_Reason1          $CHAR7.                             
      @226    I10_DX_Visit_Reason2          $CHAR7.                             
      @233    I10_DX_Visit_Reason3          $CHAR7.                             
      @240    I10_DX1                       $CHAR7.                             
      @247    I10_DX2                       $CHAR7.                             
      @254    I10_DX3                       $CHAR7.                             
      @261    I10_DX4                       $CHAR7.                             
      ...
      @443    I10_DXCCS8                    N4PF.                               
      @447    I10_DXCCS9                    N4PF.                               
      @451    I10_DXCCS10                   N4PF.                               
      @455    I10_DXCCS11                   N4PF.                               
      @459    I10_DXCCS12                   N4PF.                               
      @463    I10_DXCCS13                   N4PF.                               
      @467    I10_DXCCS14                   N4PF.                               
      @471    I10_DXCCS15                   N4PF.                               
      @475    I10_DXCCS16                   N4PF.                               
      @479    I10_DXCCS17                   N4PF.                               
      @483    I10_DXCCS18                   N4PF.                               
      @487    I10_DXCCS19                   N4PF.                               
      @491    I10_DXCCS20                   N4PF.                               
      @495    I10_DXCCS21                   N4PF.                               
      @499    I10_DXCCS22                   N4PF.                               
      @503    I10_DXCCS23                   N4PF.                               
      @507    I10_DXCCS24                   N4PF.                               
      @511    I10_DXCCS25                   N4PF.                               
      @515    I10_ECAUSE1                   $CHAR7.                             
      @522    I10_ECAUSE2                   $CHAR7.                             
      @529    I10_ECAUSE3                   $CHAR7.                             
      @536    I10_ECAUSE4                   $CHAR7.                             
      @543    I10_ECAUSE5                   $CHAR7.                             
      @550    I10_ECAUSE6                   $CHAR7.                             
      @557    I10_ECauseCCS1                N4PF.                               
      @561    I10_ECauseCCS2                N4PF.                               
      @565    I10_ECauseCCS3                N4PF.                               
      @569    I10_ECauseCCS4                N4PF.                               
      @573    I10_ECauseCCS5                N4PF.                               
      @577    I10_ECauseCCS6                N4PF.                               
      @581    I10_HOSPBRTH                  N3PF.                               
      @584    I10_NCHRONIC                  N3PF.                               
      @587    I10_NDX                       N3PF.                               
      @590    I10_NECAUSE                   N2PF.                               
      @592    I10_NEOMAT                    N2PF.                               
      @594    I10_NPR                       N3PF.                               
      @597    I10_ORPROC                    N2PF.                               
      @599    I10_PR1                       $CHAR7.                             
      ...
      @704    I10_PRCCS8                    N3PF.                               
      @707    I10_PRCCS9                    N3PF.                               
      @710    I10_PRCCS10                   N3PF.                               
      @713    I10_PRCCS11                   N3PF.                               
      @716    I10_PRCCS12                   N3PF.                               
      @719    I10_PROCTYPE                  N3PF.                               
      @722    KEY                           15.                                 
      @737    LOS                           N5PF.                               
      @742    LOS_X                         N6PF.                               
      @748    MARITALSTATUSUB04             $CHAR1.                             
      @749    MDBOARD1                      $CHAR1.                             
      @750    MDBOARD2                      $CHAR1.                             
      @751    MDNUM1_R                      N9PF.                               
      @760    MDNUM2_R                      N9PF.                               
      ...
      @805    PL_UIC                        N2PF.                               
      @807    PL_UR_CAT4                    N2PF.                               
      @809    PointOfOrigin_X               $CHAR1.                             
      @810    PointOfOriginUB04             $CHAR1.                             
      @811    PRDAY1                        N5PF.                               
      @816    PRDAY2                        N5PF.                               
      @821    PRDAY3                        N5PF.                               
      @826    PRDAY4                        N5PF.                               
