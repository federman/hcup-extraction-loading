...
*  Data Step                  *;                                                
*******************************;                                                
DATA CO_SEDDC_2020_CORE;                                                        
INFILE 'CO_SEDD_2020_CORE.ASC' FIRSTOBS=3 LRECL = 3510;                         
...
nition"                                                                         
  ...
  SUBSTATE_REGION_X          LENGTH=$3                                          
  LABEL="Region of the Hospital within a State (as received from source)"       
...
INPUT                                                                           
      ...
      @2404   CPTM1_98                      $CHAR2.                             
      @2406   CPTM1_99                      $CHAR2.                             
      @2408   CPTM1_100                     $CHAR2.                             
      @2410   CPTM1_101                     $CHAR2.                             
      @2412   CPTM1_102                     $CHAR2.                             
      @2414   CPTM1_103                     $CHAR2.                             
      @2416   CPTM1_104                     $CHAR2.                             
      @2418   CPTM1_105                     $CHAR2.                             
      @2420   CPTM1_106                     $CHAR2.                             
      @2422   CPTM1_107                     $CHAR2.                             
      @2424   CPTM1_108                     $CHAR2.                             
      @2426   CPTM1_109                     $CHAR2.                             
      @2428   CPTM1_110                     $CHAR2.                             
      @2430   CPTM1_111                     $CHAR2.                             
      @2432   CPTM1_112                     $CHAR2.                             
      @2434   CPTM1_113                     $CHAR2.                             
      @2436   CPTM1_114                     $CHAR2.                             
      @2438   CPTM1_115                     $CHAR2.                             
      @2440   CPTM1_116                     $CHAR2.                             
      @2442   CPTM1_117                     $CHAR2.                             
      @2444   CPTM1_118                     $CHAR2.                             
      @2446   CPTM1_119                     $CHAR2.                             
      @2448   CPTM1_120                     $CHAR2.                             
      @2450   CPTM1_121                     $CHAR2.                             
      @2452   CPTM1_122                     $CHAR2.                             
      @2454   CPTM1_123                     $CHAR2.                             
      @2456   CPTM1_124                     $CHAR2.                             
      @2458   CPTM1_125                     $CHAR2.                             
      @2460   CPTM1_126                     $CHAR2.                             
      @2462   CPTM1_127                     $CHAR2.                             
      @2464   CPTM1_128                     $CHAR2.                             
      @2466   CPTM1_129                     $CHAR2.                             
      @2468   CPTM1_130                     $CHAR2.                             
      @2470   CPTM1_131                     $CHAR2.                             
      @2472   CPTM1_132                     $CHAR2.                             
      @2474   CPTM1_133                     $CHAR2.                             
      @2476   CPTM1_134                     $CHAR2.                             
      @2478   CPTM1_135                     $CHAR2.                             
      @2480   CPTM1_136                     $CHAR2.                             
      @2482   CPTM1_137                     $CHAR2.                             
      @2484   CPTM1_138                     $CHAR2.                             
      @2486   CPTM1_139                     $CHAR2.                             
      @2488   CPTM1_140                     $CHAR2.                             
      @2490   CPTM1_141                     $CHAR2.                             
      @2492   CPTM1_142                     $CHAR2.                             
      @2494   CPTM1_143                     $CHAR2.                             
      @2496   CPTM1_144                     $CHAR2.                             
      @2498   CPTM1_145                     $CHAR2.                             
      @2500   CPTM1_146                     $CHAR2.                             
      @2502   CPTM1_147                     $CHAR2.                             
      @2504   CPTM1_148                     $CHAR2.                             
      @2506   CPTM1_149                     $CHAR2.                             
      @2508   CPTM1_150                     $CHAR2.                             
      @2510   CPTM1_151                     $CHAR2.                             
      @2512   CPTM1_152                     $CHAR2.                             
      @2514   CPTM1_153                     $CHAR2.                             
      @2516   CPTM1_154                     $CHAR2.                             
      @2518   CPTM1_155                     $CHAR2.                             
      @2520   CPTM1_156                     $CHAR2.                             
      @2522   CPTM1_157                     $CHAR2.                             
      @2524   CPTM1_158                     $CHAR2.                             
      @2526   CPTM1_159                     $CHAR2.                             
      @2528   CPTM1_160                     $CHAR2.                             
      @2530   CPTM1_161                     $CHAR2.                             
      @2532   CPTM1_162                     $CHAR2.                             
      @2534   CPTM1_163                     $CHAR2.                             
      @2536   CPTM1_164                     $CHAR2.                             
      @2538   CPTM1_165                     $CHAR2.                             
      @2540   CPTM1_166                     $CHAR2.                             
      @2542   CPTM1_167                     $CHAR2.                             
      @2544   CPTM1_168                     $CHAR2.                             
      @2546   CPTM1_169                     $CHAR2.                             
      @2548   CPTM1_170                     $CHAR2.                             
      @2550   CPTM1_171                     $CHAR2.                             
      @2552   CPTM1_172                     $CHAR2.                             
      @2554   CPTM1_173                     $CHAR2.                             
      @2556   CPTM1_174                     $CHAR2.                             
      @2558   CPTM1_175                     $CHAR2.                             
      @2560   CPTM1_176                     $CHAR2.                             
      @2562   CPTM1_177                     $CHAR2.                             
      @2564   CPTM1_178                     $CHAR2.                             
      @2566   CPTM1_179                     $CHAR2.                             
      @2568   CPTM1_180                     $CHAR2.                             
      @2570   CPTM1_181                     $CHAR2.                             
      @2572   CPTM1_182                     $CHAR2.                             
      @2574   CPTM1_183                     $CHAR2.                             
      @2576   CPTM1_184                     $CHAR2.                             
      @2578   CPTM1_185                     $CHAR2.                             
      @2580   CPTM1_186                     $CHAR2.                             
      @2582   CPTM1_187                     $CHAR2.                             
      @2584   CPTM1_188                     $CHAR2.                             
      @2586   CPTM1_189                     $CHAR2.                             
      @2588   CPTM1_190                     $CHAR2.                             
      @2590   CPTM1_191                     $CHAR2.                             
      @2592   CPTM1_192                     $CHAR2.                             
      @2594   CPTM1_193                     $CHAR2.                             
      @2596   CPTM1_194                     $CHAR2.                             
      @2598   CPTM1_195                     $CHAR2.                             
      @2600   CPTM1_196                     $CHAR2.                             
      @2602   CPTM1_197                     $CHAR2.                             
      @2604   CPTM1_198                     $CHAR2.                             
      @2606   CPTM1_199                     $CHAR2.                             
      @2608   CPTM1_200                     $CHAR2.                             
      @2610   CPTM2_1                       $CHAR2.                             
      @2612   CPTM2_2                       $CHAR2.                             
      @2614   CPTM2_3                       $CHAR2.                             
      @2616   CPTM2_4                       $CHAR2.                             
      ...
      @2804   CPTM2_98                      $CHAR2.                             
      @2806   CPTM2_99                      $CHAR2.                             
      @2808   CPTM2_100                     $CHAR2.                             
      @2810   CPTM2_101                     $CHAR2.                             
      @2812   CPTM2_102                     $CHAR2.                             
      @2814   CPTM2_103                     $CHAR2.                             
      @2816   CPTM2_104                     $CHAR2.                             
      @2818   CPTM2_105                     $CHAR2.                             
      @2820   CPTM2_106                     $CHAR2.                             
      @2822   CPTM2_107                     $CHAR2.                             
      @2824   CPTM2_108                     $CHAR2.                             
      @2826   CPTM2_109                     $CHAR2.                             
      @2828   CPTM2_110                     $CHAR2.                             
      @2830   CPTM2_111                     $CHAR2.                             
      @2832   CPTM2_112                     $CHAR2.                             
      @2834   CPTM2_113                     $CHAR2.                             
      @2836   CPTM2_114                     $CHAR2.                             
      @2838   CPTM2_115                     $CHAR2.                             
      @2840   CPTM2_116                     $CHAR2.                             
      @2842   CPTM2_117                     $CHAR2.                             
      @2844   CPTM2_118                     $CHAR2.                             
      @2846   CPTM2_119                     $CHAR2.                             
      @2848   CPTM2_120                     $CHAR2.                             
      @2850   CPTM2_121                     $CHAR2.                             
      @2852   CPTM2_122                     $CHAR2.                             
      @2854   CPTM2_123                     $CHAR2.                             
      @2856   CPTM2_124                     $CHAR2.                             
      @2858   CPTM2_125                     $CHAR2.                             
      @2860   CPTM2_126                     $CHAR2.                             
      @2862   CPTM2_127                     $CHAR2.                             
      @2864   CPTM2_128                     $CHAR2.                             
      @2866   CPTM2_129                     $CHAR2.                             
      @2868   CPTM2_130                     $CHAR2.                             
      @2870   CPTM2_131                     $CHAR2.                             
      @2872   CPTM2_132                     $CHAR2.                             
      @2874   CPTM2_133                     $CHAR2.                             
      @2876   CPTM2_134                     $CHAR2.                             
      @2878   CPTM2_135                     $CHAR2.                             
      @2880   CPTM2_136                     $CHAR2.                             
      @2882   CPTM2_137                     $CHAR2.                             
      @2884   CPTM2_138                     $CHAR2.                             
      @2886   CPTM2_139                     $CHAR2.                             
      @2888   CPTM2_140                     $CHAR2.                             
      @2890   CPTM2_141                     $CHAR2.                             
      @2892   CPTM2_142                     $CHAR2.                             
      @2894   CPTM2_143                     $CHAR2.                             
      @2896   CPTM2_144                     $CHAR2.                             
      @2898   CPTM2_145                     $CHAR2.                             
      @2900   CPTM2_146                     $CHAR2.                             
      @2902   CPTM2_147                     $CHAR2.                             
      @2904   CPTM2_148                     $CHAR2.                             
      @2906   CPTM2_149                     $CHAR2.                             
      @2908   CPTM2_150                     $CHAR2.                             
      @2910   CPTM2_151                     $CHAR2.                             
      @2912   CPTM2_152                     $CHAR2.                             
      @2914   CPTM2_153                     $CHAR2.                             
      @2916   CPTM2_154                     $CHAR2.                             
      @2918   CPTM2_155                     $CHAR2.                             
      @2920   CPTM2_156                     $CHAR2.                             
      @2922   CPTM2_157                     $CHAR2.                             
      @2924   CPTM2_158                     $CHAR2.                             
      @2926   CPTM2_159                     $CHAR2.                             
      @2928   CPTM2_160                     $CHAR2.                             
      @2930   CPTM2_161                     $CHAR2.                             
      @2932   CPTM2_162                     $CHAR2.                             
      @2934   CPTM2_163                     $CHAR2.                             
      @2936   CPTM2_164                     $CHAR2.                             
      @2938   CPTM2_165                     $CHAR2.                             
      @2940   CPTM2_166                     $CHAR2.                             
      @2942   CPTM2_167                     $CHAR2.                             
      @2944   CPTM2_168                     $CHAR2.                             
      @2946   CPTM2_169                     $CHAR2.                             
      @2948   CPTM2_170                     $CHAR2.                             
      @2950   CPTM2_171                     $CHAR2.                             
      @2952   CPTM2_172                     $CHAR2.                             
      @2954   CPTM2_173                     $CHAR2.                             
      @2956   CPTM2_174                     $CHAR2.                             
      @2958   CPTM2_175                     $CHAR2.                             
      @2960   CPTM2_176                     $CHAR2.                             
      @2962   CPTM2_177                     $CHAR2.                             
      @2964   CPTM2_178                     $CHAR2.                             
      @2966   CPTM2_179                     $CHAR2.                             
      @2968   CPTM2_180                     $CHAR2.                             
      @2970   CPTM2_181                     $CHAR2.                             
      @2972   CPTM2_182                     $CHAR2.                             
      @2974   CPTM2_183                     $CHAR2.                             
      @2976   CPTM2_184                     $CHAR2.                             
      @2978   CPTM2_185                     $CHAR2.                             
      @2980   CPTM2_186                     $CHAR2.                             
      @2982   CPTM2_187                     $CHAR2.                             
      @2984   CPTM2_188                     $CHAR2.                             
      @2986   CPTM2_189                     $CHAR2.                             
      @2988   CPTM2_190                     $CHAR2.                             
      @2990   CPTM2_191                     $CHAR2.                             
      @2992   CPTM2_192                     $CHAR2.                             
      @2994   CPTM2_193                     $CHAR2.                             
      @2996   CPTM2_194                     $CHAR2.                             
      @2998   CPTM2_195                     $CHAR2.                             
      @3000   CPTM2_196                     $CHAR2.                             
      @3002   CPTM2_197                     $CHAR2.                             
      @3004   CPTM2_198                     $CHAR2.                             
      @3006   CPTM2_199                     $CHAR2.                             
      @3008   CPTM2_200                     $CHAR2.                             
      @3010   DaysToEvent                   N6PF.                               
      @3016   DIED                          N2PF.                               
      @3018   DISP_X                        $CHAR2.                             
      @3020   DISPUB04                      N2PF.                               
      @3022   DISPUNIFORM                   N2PF.                               
      @3024   DMONTH                        N2PF.                               
      @3026   DQTR                          N2PF.                               
      @3028   FEMALE                        N2PF.                               
      @3030   HCUP_ED                       N2PF.                               
      @3032   HCUP_OS                       N2PF.                               
      @3034   HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @3039   HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @3044   Homeless                      N2PF.                               
      @3046   HOSPST                        $CHAR2.                             
      @3048   I10_DX_Visit_Reason1          $CHAR7.                             
      @3055   I10_DX_Visit_Reason2          $CHAR7.                             
      @3062   I10_DX_Visit_Reason3          $CHAR7.                             
      @3069   I10_DX1                       $CHAR7.                             
      @3076   I10_DX2                       $CHAR7.                             
      @3083   I10_DX3                       $CHAR7.                             
      @3090   I10_DX4                       $CHAR7.                             
      ...
      @3399   PL_RUCC                       N2PF.                               
      @3401   PL_UIC                        N2PF.                               
      @3403   PL_UR_CAT4                    N2PF.                               
      @3405   PointOfOrigin_X               $CHAR1.                             
      @3406   PointOfOriginUB04             $CHAR1.                             
      @3407   PSTATE                        $CHAR2.                             
      @3409   PSTATE_GEO                    $CHAR2.                             
      @3411   PSTCO                         N5PF.                               
      @3416   PSTCO_GEO                     N5PF.                               
      @3421   RACE                          N2PF.                               
      @3423   RACE_X                        $CHAR15.                            
      ...
      @3440   STATE_ED                      N2PF.                               
      @3442   STATE_OS                      N2PF.                               
      @3444   SUBSTATE_REGION_X             $CHAR3.                             
      @3447   TOTCHG                        N10PF.                              
      @3457   TOTCHG_X                      N15P2F.                             
      @3472   VisitLink                     N9PF.                               
      @3481   YEAR                          N4PF.                               
      @3485   ZIP                           $CHAR5.                             
      @3490   ZIP3                          $CHAR3.                             
      @3493   ZIPINC_QRTL                   N3PF.                               
      @3496   HOSPID                        N5PF.                               
      @3501   AYEAR                         N4PF.                               
      @3505   BMONTH                        N2PF.                               
      @3507   BYEAR                         N4PF.                               
