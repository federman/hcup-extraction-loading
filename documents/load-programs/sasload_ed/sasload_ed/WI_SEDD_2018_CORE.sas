...
*  Data Step                  *;                                                
*******************************;                                                
DATA WI_SEDDC_2018_CORE;                                                        
INFILE 'WI_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 1988;                         
...
INPUT                                                                           
      ...
      @1534   DMONTH                        N2PF.                               
      @1536   DQTR                          N2PF.                               
      @1538   DSHOSPID                      $CHAR17.                            
      @1555   FEMALE                        N2PF.                               
      @1557   HCUP_ED                       N2PF.                               
      @1559   HCUP_OS                       N2PF.                               
      @1561   HISPANIC                      N2PF.                               
      @1563   HISPANIC_X                    $CHAR1.                             
      @1564   Homeless                      N2PF.                               
      @1566   HOSP_NPI                      $CHAR10.                            
      @1576   HOSPST                        $CHAR2.                             
      @1578   I10_DX_Visit_Reason1          $CHAR7.                             
      @1585   I10_DX_Visit_Reason2          $CHAR7.                             
      @1592   I10_DX_Visit_Reason3          $CHAR7.                             
      @1599   I10_DX1                       $CHAR7.                             
      @1606   I10_DX2                       $CHAR7.                             
      @1613   I10_DX3                       $CHAR7.                             
      @1620   I10_DX4                       $CHAR7.                             
      ...
      @1900   PL_RUCC                       N2PF.                               
      @1902   PL_UIC                        N2PF.                               
      @1904   PL_UR_CAT4                    N2PF.                               
      @1906   PointOfOrigin_X               $CHAR1.                             
      @1907   PointOfOriginUB04             $CHAR1.                             
      @1908   PSTATE                        $CHAR2.                             
      @1910   PSTCO                         N5PF.                               
      @1915   PSTCO2                        N5PF.                               
      @1920   RACE                          N2PF.                               
      ...
      @1928   STATE_OS                      N2PF.                               
      @1930   TOTCHG                        N10PF.                              
      @1940   TOTCHG_X                      N15P2F.                             
      @1955   VisitLink                     N9PF.                               
      @1964   YEAR                          N4PF.                               
      @1968   ZIP                           $CHAR5.                             
      @1973   ZIP3                          $CHAR3.                             
      @1976   ZIPINC_QRTL                   N3PF.                               
      @1979   AYEAR                         N4PF.                               
      @1983   BMONTH                        N2PF.                               
      @1985   BYEAR                         N4PF.                               
      ;                                                                         
