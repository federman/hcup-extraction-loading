...
*  Data Step                  *;                                                
*******************************;                                                
DATA KY_SEDDC_2019_CORE;                                                        
INFILE 'KY_SEDD_2019_CORE.ASC' FIRSTOBS=3 LRECL = 1944;                         
...
INPUT                                                                           
      ...
      @1520   DIED                          N2PF.                               
      @1522   DISPUB04                      N2PF.                               
      @1524   DISPUNIFORM                   N2PF.                               
      @1526   DISP_X                        $CHAR2.                             
      @1528   DMONTH                        N2PF.                               
      @1530   DQTR                          N2PF.                               
      @1532   DSHOSPID                      $CHAR17.                            
      @1549   FEMALE                        N2PF.                               
      @1551   HCUP_ED                       N2PF.                               
      @1553   HCUP_OS                       N2PF.                               
      @1555   HISPANIC                      N2PF.                               
      @1557   HISPANIC_X                    $CHAR2.                             
      @1559   HOSPST                        $CHAR2.                             
      @1561   HOSP_NPI                      $CHAR10.                            
      @1571   I10_DX1                       $CHAR7.                             
      @1578   I10_DX2                       $CHAR7.                             
      @1585   I10_DX3                       $CHAR7.                             
      @1592   I10_DX4                       $CHAR7.                             
      ...
      @1753   I10_DX27                      $CHAR7.                             
      @1760   I10_DX28                      $CHAR7.                             
      @1767   I10_DX_Visit_Reason1          $CHAR7.                             
      @1774   I10_DX_Visit_Reason2          $CHAR7.                             
      @1781   I10_DX_Visit_Reason3          $CHAR7.                             
      @1788   I10_NDX                       N3PF.                               
      @1791   I10_PROCTYPE                  N3PF.                               
      @1794   KEY                           15.                                 
      @1809   LOS                           N5PF.                               
      @1814   LOS_X                         N6PF.                               
      @1820   MEDINCSTQ                     N2PF.                               
      ...
      @1863   PL_RUCC                       N2PF.                               
      @1865   PL_UIC                        N2PF.                               
      @1867   PL_UR_CAT4                    N2PF.                               
      @1869   PSTATE                        $CHAR2.                             
      @1871   PSTATE_GEO                    $CHAR2.                             
      @1873   PSTCO                         N5PF.                               
      @1878   PSTCO_GEO                     N5PF.                               
      @1883   PointOfOriginUB04             $CHAR1.                             
      @1884   PointOfOrigin_X               $CHAR1.                             
      @1885   RACE                          N2PF.                               
      @1887   RACE_X                        $CHAR2.                             
      @1889   STATE_AS                      N2PF.                               
      @1891   STATE_ED                      N2PF.                               
