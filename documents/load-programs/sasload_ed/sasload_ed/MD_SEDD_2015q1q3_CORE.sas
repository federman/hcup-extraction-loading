...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SEDDC_2015q1q3_CORE;                                                    
INFILE 'MD_SEDD_2015q1q3_CORE.ASC' FIRSTOBS=3 LRECL = 1270;                     
...
INPUT                                                                           
      ...
      @1110   LOS                           N5PF.                               
      @1115   LOS_X                         N6PF.                               
      @1121   MARITALSTATUS_X               $CHAR1.                             
      @1122   MARITALSTATUSUB04             $CHAR1.                             
      @1123   MDNUM1_R                      N9PF.                               
      @1132   MEDINCSTQ                     N2PF.                               
      @1134   MRN_R                         N9PF.                               
      @1143   NCHRONIC                      N3PF.                               
