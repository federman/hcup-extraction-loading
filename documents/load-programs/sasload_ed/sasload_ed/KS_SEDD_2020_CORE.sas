...
*  Data Step                  *;                                                
*******************************;                                                
DATA KS_SEDDC_2020_CORE;                                                        
INFILE 'KS_SEDD_2020_CORE.ASC' FIRSTOBS=3 LRECL = 3493;                         
...
INPUT                                                                           
      ...
      @3048   HCUP_ED                       N2PF.                               
      @3050   HCUP_OS                       N2PF.                               
      @3052   HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @3057   HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @3062   HISPANIC                      N2PF.                               
      @3064   HISPANIC_X                    $CHAR1.                             
      @3065   HOSPST                        $CHAR2.                             
      @3067   I10_DX1                       $CHAR7.                             
      @3074   I10_DX2                       $CHAR7.                             
      @3081   I10_DX3                       $CHAR7.                             
      ...
      @3332   I10_PR8                       $CHAR7.                             
      @3339   I10_PR9                       $CHAR7.                             
      @3346   I10_PROCTYPE                  N3PF.                               
      @3349   KEY                           15.                                 
      @3364   LOS                           N5PF.                               
      @3369   LOS_X                         N6PF.                               
      @3375   MEDINCSTQ                     N2PF.                               
      @3377   NCPT                          N4PF.                               
      @3381   OPservice                     $CHAR1.                             
      @3382   OS_TIME                       N11P2F.                             
      @3393   PAY1                          N2PF.                               
      @3395   PAY1_X                        $CHAR3.                             
      @3398   PAY2                          N2PF.                               
      ...
      @3413   PL_RUCC                       N2PF.                               
      @3415   PL_UIC                        N2PF.                               
      @3417   PL_UR_CAT4                    N2PF.                               
      @3419   PointOfOrigin_X               $CHAR1.                             
      @3420   PointOfOriginUB04             $CHAR1.                             
      @3421   PSTATE                        $CHAR2.                             
      @3423   PSTATE_GEO                    $CHAR2.                             
      @3425   PSTCO                         N5PF.                               
      @3430   PSTCO_GEO                     N5PF.                               
      @3435   RACE                          N2PF.                               
      @3437   RACE_X                        $CHAR1.                             
