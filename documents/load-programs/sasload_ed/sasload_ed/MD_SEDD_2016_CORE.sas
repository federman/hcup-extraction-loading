...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SEDDC_2016_CORE;                                                        
INFILE 'MD_SEDD_2016_CORE.ASC' FIRSTOBS=3 LRECL = 1120;                         
...
INPUT                                                                           
      ...
      @852    I10_DX28                      $CHAR7.                             
      @859    I10_DX29                      $CHAR7.                             
      @866    I10_ECAUSE1                   $CHAR7.                             
      @873    I10_ECAUSE2                   $CHAR7.                             
      @880    I10_ECAUSE3                   $CHAR7.                             
      @887    I10_ECAUSE4                   $CHAR7.                             
      @894    I10_ECAUSE5                   $CHAR7.                             
      @901    I10_ECAUSE6                   $CHAR7.                             
      @908    I10_ECAUSE7                   $CHAR7.                             
      @915    I10_ECAUSE8                   $CHAR7.                             
      @922    I10_ECAUSE9                   $CHAR7.                             
      @929    I10_ECAUSE10                  $CHAR7.                             
      @936    I10_ECAUSE11                  $CHAR7.                             
      @943    I10_ECAUSE12                  $CHAR7.                             
      @950    I10_NDX                       N3PF.                               
      @953    I10_NECAUSE                   N2PF.                               
      @955    I10_PROCTYPE                  N3PF.                               
      @958    KEY                           15.                                 
      @973    LOS                           N5PF.                               
      @978    LOS_X                         N6PF.                               
      @984    MARITALSTATUS_X               $CHAR1.                             
      @985    MARITALSTATUSUB04             $CHAR1.                             
      @986    MDNUM1_R                      N9PF.                               
      @995    MEDINCSTQ                     N2PF.                               
      @997    MRN_R                         N9PF.                               
      @1006   NCPT                          N4PF.                               
      @1010   OPservice                     $CHAR2.                             
      @1012   OS_TIME                       N11P2F.                             
      @1023   PAY1                          N2PF.                               
      @1025   PAY1_X                        $CHAR2.                             
      @1027   PAY2                          N2PF.                               
      ...
      @1061   RACE                          N2PF.                               
      @1063   RACE_X                        $CHAR1.                             
      @1064   SpannedServiceCount           N3PF.                               
      @1067   STATE_AS                      N2PF.                               
      @1069   STATE_ED                      N2PF.                               
      @1071   STATE_OS                      N2PF.                               
      @1073   TOTCHG                        N10PF.                              
      @1083   TOTCHG_X                      N15P2F.                             
      @1098   VisitLink                     N9PF.                               
      @1107   YEAR                          N4PF.                               
      @1111   ZIP3                          $CHAR3.                             
      @1114   ZIPINC_QRTL                   N3PF.                               
      @1117   AYEAR                         N4PF.                               
      ;                                                                         
