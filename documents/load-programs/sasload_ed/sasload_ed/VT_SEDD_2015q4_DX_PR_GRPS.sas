...
*  Data Step                  *;                                                
*******************************;                                                
DATA VT_SEDDC_2015q4_DX_PR_GRPS;                                                
INFILE 'VT_SEDD_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 700;                  
...
INPUT                                                                           
      ...
      @411    I10_ECauseMCCS11              $CHAR11.                            
      @422    I10_INJURY                    N2PF.                               
      @424    I10_MULTINJURY                N2PF.                               
      @426    I10_PCLASS1                   N2PF.                               
      @428    I10_PCLASS2                   N2PF.                               
      @430    I10_PCLASS3                   N2PF.                               
      @432    I10_PCLASS4                   N2PF.                               
      @434    I10_PCLASS5                   N2PF.                               
      @436    I10_PCLASS6                   N2PF.                               
      @438    I10_PCLASS7                   N2PF.                               
      @440    I10_PCLASS8                   N2PF.                               
      @442    I10_PCLASS9                   N2PF.                               
      @444    I10_PCLASS10                  N2PF.                               
      @446    I10_PCLASS11                  N2PF.                               
      @448    I10_PCLASS12                  N2PF.                               
      @450    I10_PCLASS13                  N2PF.                               
      @452    I10_PCLASS14                  N2PF.                               
      @454    I10_PCLASS15                  N2PF.                               
      @456    I10_PCLASS16                  N2PF.                               
      @458    I10_PCLASS17                  N2PF.                               
      @460    I10_PCLASS18                  N2PF.                               
      @462    I10_PCLASS19                  N2PF.                               
      @464    I10_PCLASS20                  N2PF.                               
      @466    I10_PRMCCS1                   $CHAR8.                             
      @474    I10_PRMCCS2                   $CHAR8.                             
      @482    I10_PRMCCS3                   $CHAR8.                             
      @490    I10_PRMCCS4                   $CHAR8.                             
      @498    I10_PRMCCS5                   $CHAR8.                             
      @506    I10_PRMCCS6                   $CHAR8.                             
      @514    I10_PRMCCS7                   $CHAR8.                             
      @522    I10_PRMCCS8                   $CHAR8.                             
      @530    I10_PRMCCS9                   $CHAR8.                             
      @538    I10_PRMCCS10                  $CHAR8.                             
      @546    I10_PRMCCS11                  $CHAR8.                             
      @554    I10_PRMCCS12                  $CHAR8.                             
      @562    I10_PRMCCS13                  $CHAR8.                             
      @570    I10_PRMCCS14                  $CHAR8.                             
      @578    I10_PRMCCS15                  $CHAR8.                             
      @586    I10_PRMCCS16                  $CHAR8.                             
      @594    I10_PRMCCS17                  $CHAR8.                             
      @602    I10_PRMCCS18                  $CHAR8.                             
      @610    I10_PRMCCS19                  $CHAR8.                             
      @618    I10_PRMCCS20                  $CHAR8.                             
      @626    I10_U_BLOOD                   N2PF.                               
      @628    I10_U_CATH                    N2PF.                               
      @630    I10_U_CTSCAN                  N2PF.                               
      @632    I10_U_EKG                     N2PF.                               
      @634    I10_U_MHSA                    N2PF.                               
      @636    I10_U_MRT                     N2PF.                               
      @638    I10_U_PACEMAKER               N2PF.                               
      @640    I10_U_PHYTHERAPY              N2PF.                               
      @642    I10_U_RADTHERAPY              N2PF.                               
      @644    I10_U_STRESS                  N2PF.                               
      @646    KEY                           15.                                 
      @661    U_CCU                         N2PF.                               
      @663    U_CHESTXRAY                   N2PF.                               
      @665    U_DIALYSIS                    N2PF.                               
      @667    U_ECHO                        N2PF.                               
      @669    U_ED                          N2PF.                               
      @671    U_EEG                         N2PF.                               
      ...
      @683    U_NEWBN4L                     N2PF.                               
      @685    U_NUCMED                      N2PF.                               
      @687    U_OBSERVATION                 N2PF.                               
      @689    U_OCCTHERAPY                  N2PF.                               
      @691    U_ORGANACQ                    N2PF.                               
      @693    U_OTHIMPLANTS                 N2PF.                               
      @695    U_RESPTHERAPY                 N2PF.                               
      @697    U_SPEECHTHERAPY               N2PF.                               
      @699    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
