...
*  Data Step                  *;                                                
*******************************;                                                
DATA ME_SEDDC_2013_CORE;                                                        
INFILE 'ME_SEDD_2013_CORE.ASC' FIRSTOBS=3 LRECL = 1066;                         
...
INPUT                                                                           
      ...
      @1007   PL_CBSA                       N3PF.                               
      @1010   PL_NCHS                       N2PF.                               
      @1012   PL_RUCA4_2005                 N2PF.                               
      @1014   PL_UIC                        N2PF.                               
      @1016   PL_UR_CAT4                    N2PF.                               
      @1018   PROCTYPE                      N3PF.                               
      @1021   PSTATE                        $CHAR2.                             
      @1023   PSTCO                         N5PF.                               
      @1028   PSTCO2                        N5PF.                               
      @1033   PointOfOriginUB04             $CHAR1.                             
      @1034   STATE_AS                      N2PF.                               
      @1036   STATE_ED                      N2PF.                               
      @1038   STATE_OS                      N2PF.                               
      @1040   YEAR                          N4PF.                               
      @1044   ZIP3                          $CHAR3.                             
      @1047   ZIPINC_QRTL                   N3PF.                               
      @1050   ZIP_S                         $CHAR5.                             
      @1055   AGEGROUP                      N3PF.                               
      @1058   HOSPID                        N5PF.                               
      @1063   AYEAR                         N4PF.                               
