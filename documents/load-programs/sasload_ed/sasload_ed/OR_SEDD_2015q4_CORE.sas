...
*  Data Step                  *;                                                
*******************************;                                                
DATA OR_SEDDC_2015q4_CORE;                                                      
INFILE 'OR_SEDD_2015q4_CORE.ASC' FIRSTOBS=3 LRECL = 2136;                       
...
INPUT                                                                           
      ...
      @1514   CPTM2_98                      $CHAR2.                             
      @1516   CPTM2_99                      $CHAR2.                             
      @1518   CPTM2_100                     $CHAR2.                             
      @1520   DHOUR                         N4PF.                               
      @1524   DIED                          N2PF.                               
      @1526   DISP_X                        $CHAR2.                             
      @1528   DISPUB04                      N2PF.                               
      @1530   DISPUNIFORM                   N2PF.                               
      @1532   DMONTH                        N2PF.                               
      @1534   DQTR                          N2PF.                               
      @1536   DSHOSPID                      $CHAR17.                            
      @1553   DURATION                      N6PF.                               
      @1559   DXVER                         N3PF.                               
      @1562   FEMALE                        N2PF.                               
      @1564   HCUP_ED                       N2PF.                               
      @1566   HCUP_OS                       N2PF.                               
      @1568   HISPANIC                      N2PF.                               
      @1570   HISPANIC_X                    $CHAR2.                             
      @1572   HOSPST                        $CHAR2.                             
      @1574   I10_DX_Visit_Reason1          $CHAR7.                             
      @1581   I10_DX_Visit_Reason2          $CHAR7.                             
      @1588   I10_DX_Visit_Reason3          $CHAR7.                             
      @1595   I10_DX1                       $CHAR7.                             
      @1602   I10_DX2                       $CHAR7.                             
      @1609   I10_DX3                       $CHAR7.                             
      @1616   I10_DX4                       $CHAR7.                             
      ...
      @1756   I10_DX24                      $CHAR7.                             
      @1763   I10_DX25                      $CHAR7.                             
      @1770   I10_DXCCS1                    N4PF.                               
      @1774   I10_DXCCS2                    N4PF.                               
      @1778   I10_DXCCS3                    N4PF.                               
      @1782   I10_DXCCS4                    N4PF.                               
      @1786   I10_DXCCS5                    N4PF.                               
      @1790   I10_DXCCS6                    N4PF.                               
      @1794   I10_DXCCS7                    N4PF.                               
      @1798   I10_DXCCS8                    N4PF.                               
      @1802   I10_DXCCS9                    N4PF.                               
      @1806   I10_DXCCS10                   N4PF.                               
      @1810   I10_DXCCS11                   N4PF.                               
      @1814   I10_DXCCS12                   N4PF.                               
      @1818   I10_DXCCS13                   N4PF.                               
      @1822   I10_DXCCS14                   N4PF.                               
      @1826   I10_DXCCS15                   N4PF.                               
      @1830   I10_DXCCS16                   N4PF.                               
      @1834   I10_DXCCS17                   N4PF.                               
      @1838   I10_DXCCS18                   N4PF.                               
      @1842   I10_DXCCS19                   N4PF.                               
      @1846   I10_DXCCS20                   N4PF.                               
      @1850   I10_DXCCS21                   N4PF.                               
      @1854   I10_DXCCS22                   N4PF.                               
      @1858   I10_DXCCS23                   N4PF.                               
      @1862   I10_DXCCS24                   N4PF.                               
      @1866   I10_DXCCS25                   N4PF.                               
      @1870   I10_ECAUSE1                   $CHAR7.                             
      @1877   I10_ECAUSE2                   $CHAR7.                             
      @1884   I10_ECAUSE3                   $CHAR7.                             
      @1891   I10_ECAUSE4                   $CHAR7.                             
      @1898   I10_ECAUSE5                   $CHAR7.                             
      @1905   I10_ECAUSE6                   $CHAR7.                             
      @1912   I10_ECAUSE7                   $CHAR7.                             
      @1919   I10_ECAUSE8                   $CHAR7.                             
      @1926   I10_ECauseCCS1                N4PF.                               
      @1930   I10_ECauseCCS2                N4PF.                               
      @1934   I10_ECauseCCS3                N4PF.                               
      @1938   I10_ECauseCCS4                N4PF.                               
      @1942   I10_ECauseCCS5                N4PF.                               
      @1946   I10_ECauseCCS6                N4PF.                               
      @1950   I10_ECauseCCS7                N4PF.                               
      @1954   I10_ECauseCCS8                N4PF.                               
      @1958   I10_HOSPBRTH                  N3PF.                               
      @1961   I10_NCHRONIC                  N3PF.                               
      @1964   I10_NDX                       N3PF.                               
      @1967   I10_NECAUSE                   N2PF.                               
      @1969   I10_NEOMAT                    N2PF.                               
      @1971   I10_PROCTYPE                  N3PF.                               
      @1974   KEY                           15.                                 
      @1989   LOS                           N5PF.                               
      @1994   LOS_X                         N6PF.                               
      @2000   MEDINCSTQ                     N2PF.                               
      @2002   NCPT                          N4PF.                               
      @2006   OPservice                     $CHAR1.                             
      @2007   OS_TIME                       N11P2F.                             
      @2018   PAY1                          N2PF.                               
      @2020   PAY1_X                        $CHAR9.                             
      @2029   PAY2                          N2PF.                               
      ...
      @2056   PL_RUCC                       N2PF.                               
      @2058   PL_UIC                        N2PF.                               
      @2060   PL_UR_CAT4                    N2PF.                               
      @2062   PointOfOrigin_X               $CHAR2.                             
      @2064   PointOfOriginUB04             $CHAR1.                             
      @2065   PSTATE                        $CHAR2.                             
      @2067   PSTCO                         N5PF.                               
      @2072   PSTCO2                        N5PF.                               
      @2077   RACE                          N2PF.                               
      ...
      @2085   STATE_OS                      N2PF.                               
      @2087   TOTCHG                        N10PF.                              
      @2097   TOTCHG_X                      N15P2F.                             
      @2112   YEAR                          N4PF.                               
      @2116   ZIP                           $CHAR5.                             
      @2121   ZIP3                          $CHAR3.                             
      @2124   ZIPINC_QRTL                   N3PF.                               
      @2127   AYEAR                         N4PF.                               
      @2131   BMONTH                        N2PF.                               
      @2133   BYEAR                         N4PF.                               
      ;                                                                         
