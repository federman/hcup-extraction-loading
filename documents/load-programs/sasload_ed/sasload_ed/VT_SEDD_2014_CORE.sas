...
*  Data Step                  *;                                                
*******************************;                                                
DATA VT_SEDDC_2014_CORE;                                                        
INFILE 'VT_SEDD_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1760;                         
...
INPUT                                                                           
      ...
      @1019   DXCCS20                       N4PF.                               
      @1023   DXVER                         N3PF.                               
      @1026   DX_Visit_Reason1              $CHAR7.                             
      @1033   DX_Visit_Reason2              $CHAR7.                             
      @1040   DaysToEvent                   N6PF.                               
      @1046   ECODE1                        $CHAR7.                             
      @1053   ECODE2                        $CHAR7.                             
      @1060   ECODE3                        $CHAR7.                             
      @1067   ECODE4                        $CHAR7.                             
      ...
      @1136   HCUP_ED                       N2PF.                               
      @1138   HCUP_OS                       N2PF.                               
      @1140   HISPANIC_X                    $CHAR1.                             
      @1141   HOSPBRTH                      N3PF.                               
      @1144   HOSPST                        $CHAR2.                             
      @1146   HOSP_NPI                      $CHAR10.                            
      @1156   KEY                           15.                                 
      @1171   LOS                           N5PF.                               
      @1176   LOS_X                         N6PF.                               
      @1182   MEDINCSTQ                     N2PF.                               
      ...
      @1555   PSTCO                         N5PF.                               
      @1560   PSTCO2                        N5PF.                               
      @1565   PointOfOriginUB04             $CHAR1.                             
      @1566   PointOfOrigin_X               $CHAR1.                             
      @1567   RACE                          N2PF.                               
      @1569   RACE_X                        $CHAR1.                             
      @1570   READMIT                       N2PF.                               
      @1572   STATE_AS                      N2PF.                               
      ...
      @1576   STATE_OS                      N2PF.                               
      @1578   TOTCHG                        N10PF.                              
      @1588   TOTCHG_X                      N15P2F.                             
      @1603   VisitLink                     N9PF.                               
      @1612   YEAR                          N4PF.                               
      @1616   ZIP                           $CHAR5.                             
      @1621   ZIP3                          $CHAR3.                             
      @1624   ZIPINC_QRTL                   N3PF.                               
      @1627   TOWN                          $CHAR4.                             
      @1631   AYEAR                         N4PF.                               
      @1635   BMONTH                        N2PF.                               
      @1637   BYEAR                         N4PF.                               
