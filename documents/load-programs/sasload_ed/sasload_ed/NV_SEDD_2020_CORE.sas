...
*  Data Step                  *;                                                
*******************************;                                                
DATA NV_SEDDC_2020_CORE;                                                        
INFILE 'NV_SEDD_2020_CORE.ASC' FIRSTOBS=3 LRECL = 1187;                         
...
INPUT                                                                           
      ...
      @785    HCUP_ED                       N2PF.                               
      @787    HCUP_OS                       N2PF.                               
      @789    HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @794    HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @799    HISPANIC                      N2PF.                               
      @801    HOSPST                        $CHAR2.                             
      @803    I10_DX1                       $CHAR7.                             
      @810    I10_DX2                       $CHAR7.                             
      ...
      @1027   I10_DX33                      $CHAR7.                             
      @1034   I10_NDX                       N3PF.                               
      @1037   I10_PROCTYPE                  N3PF.                               
      @1040   KEY                           15.                                 
      @1055   LOS                           N5PF.                               
      @1060   LOS_X                         N6PF.                               
      @1066   MARITALSTATUS_X               $CHAR1.                             
      @1067   MARITALSTATUSUB04             $CHAR1.                             
      @1068   MDNUM1_R                      N9PF.                               
      @1077   MDNUM2_R                      N9PF.                               
      @1086   MDNUMTYPE1                    $CHAR1.                             
      @1087   MDNUMTYPE2                    $CHAR1.                             
      @1088   MEDINCSTQ                     N2PF.                               
      @1090   NCPT                          N4PF.                               
      @1094   OS_TIME                       N11P2F.                             
      @1105   PAY1                          N2PF.                               
      ...
      @1119   PL_RUCC                       N2PF.                               
      @1121   PL_UIC                        N2PF.                               
      @1123   PL_UR_CAT4                    N2PF.                               
      @1125   PointOfOrigin_X               $CHAR2.                             
      @1127   PointOfOriginUB04             $CHAR1.                             
      @1128   PSTATE                        $CHAR2.                             
      @1130   PSTATE_GEO                    $CHAR2.                             
      @1132   PSTCO                         N5PF.                               
      @1137   PSTCO_GEO                     N5PF.                               
      @1142   RACE                          N2PF.                               
      @1144   RACE_X                        $CHAR2.                             
      ...
      @1150   STATE_OS                      N2PF.                               
      @1152   TOTCHG                        N10PF.                              
      @1162   TOTCHG_X                      N15P2F.                             
      @1177   YEAR                          N4PF.                               
      @1181   ZIPINC_QRTL                   N3PF.                               
      @1184   AYEAR                         N4PF.                               
      ;                                                                         
