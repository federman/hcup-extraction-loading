...
*  Data Step                  *;                                                
*******************************;                                                
DATA KY_SEDDC_2015q4_CORE;                                                      
INFILE 'KY_SEDD_2015q4_CORE.ASC' FIRSTOBS=3 LRECL = 1369;                       
...
INPUT                                                                           
      ...
      @806    HCUP_OS                       N2PF.                               
      @808    HISPANIC                      N2PF.                               
      @810    HISPANIC_X                    $CHAR2.                             
      @812    HOSP_NPI                      $CHAR10.                            
      @822    HOSPST                        $CHAR2.                             
      @824    I10_DX_Visit_Reason1          $CHAR7.                             
      @831    I10_DX_Visit_Reason2          $CHAR7.                             
      @838    I10_DX_Visit_Reason3          $CHAR7.                             
      @845    I10_DX1                       $CHAR7.                             
      @852    I10_DX2                       $CHAR7.                             
      @859    I10_DX3                       $CHAR7.                             
      @866    I10_DX4                       $CHAR7.                             
      ...
      @1006   I10_DX24                      $CHAR7.                             
      @1013   I10_DX25                      $CHAR7.                             
      @1020   I10_DXCCS1                    N4PF.                               
      @1024   I10_DXCCS2                    N4PF.                               
      @1028   I10_DXCCS3                    N4PF.                               
      @1032   I10_DXCCS4                    N4PF.                               
      @1036   I10_DXCCS5                    N4PF.                               
      @1040   I10_DXCCS6                    N4PF.                               
      @1044   I10_DXCCS7                    N4PF.                               
      @1048   I10_DXCCS8                    N4PF.                               
      @1052   I10_DXCCS9                    N4PF.                               
      @1056   I10_DXCCS10                   N4PF.                               
      @1060   I10_DXCCS11                   N4PF.                               
      @1064   I10_DXCCS12                   N4PF.                               
      @1068   I10_DXCCS13                   N4PF.                               
      @1072   I10_DXCCS14                   N4PF.                               
      @1076   I10_DXCCS15                   N4PF.                               
      @1080   I10_DXCCS16                   N4PF.                               
      @1084   I10_DXCCS17                   N4PF.                               
      @1088   I10_DXCCS18                   N4PF.                               
      @1092   I10_DXCCS19                   N4PF.                               
      @1096   I10_DXCCS20                   N4PF.                               
      @1100   I10_DXCCS21                   N4PF.                               
      @1104   I10_DXCCS22                   N4PF.                               
      @1108   I10_DXCCS23                   N4PF.                               
      @1112   I10_DXCCS24                   N4PF.                               
      @1116   I10_DXCCS25                   N4PF.                               
      @1120   I10_ECAUSE1                   $CHAR7.                             
      @1127   I10_ECAUSE2                   $CHAR7.                             
      @1134   I10_ECAUSE3                   $CHAR7.                             
      @1141   I10_ECAUSE4                   $CHAR7.                             
      @1148   I10_ECAUSE5                   $CHAR7.                             
      @1155   I10_ECAUSE6                   $CHAR7.                             
      @1162   I10_ECAUSE7                   $CHAR7.                             
      @1169   I10_ECAUSE8                   $CHAR7.                             
      @1176   I10_ECauseCCS1                N4PF.                               
      @1180   I10_ECauseCCS2                N4PF.                               
      @1184   I10_ECauseCCS3                N4PF.                               
      @1188   I10_ECauseCCS4                N4PF.                               
      @1192   I10_ECauseCCS5                N4PF.                               
      @1196   I10_ECauseCCS6                N4PF.                               
      @1200   I10_ECauseCCS7                N4PF.                               
      @1204   I10_ECauseCCS8                N4PF.                               
      @1208   I10_HOSPBRTH                  N3PF.                               
      @1211   I10_NCHRONIC                  N3PF.                               
      @1214   I10_NDX                       N3PF.                               
      @1217   I10_NECAUSE                   N2PF.                               
      @1219   I10_NEOMAT                    N2PF.                               
      @1221   I10_PROCTYPE                  N3PF.                               
      @1224   KEY                           15.                                 
      @1239   LOS                           N5PF.                               
      @1244   LOS_X                         N6PF.                               
      @1250   MEDINCSTQ                     N2PF.                               
      ...
      @1293   PL_RUCC                       N2PF.                               
      @1295   PL_UIC                        N2PF.                               
      @1297   PL_UR_CAT4                    N2PF.                               
      @1299   PointOfOrigin_X               $CHAR1.                             
      ...
      @1321   STATE_OS                      N2PF.                               
      @1323   TOTCHG                        N10PF.                              
      @1333   TOTCHG_X                      N15P2F.                             
      @1348   YEAR                          N4PF.                               
      @1352   ZIP                           $CHAR5.                             
      @1357   ZIPINC_QRTL                   N3PF.                               
      @1360   AYEAR                         N4PF.                               
      @1364   BMONTH                        N2PF.                               
      @1366   BYEAR                         N4PF.                               
      ;                                                                         
