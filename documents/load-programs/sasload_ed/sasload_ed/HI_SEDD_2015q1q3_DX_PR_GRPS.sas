...
*   HI_SEDD_2015q1q3_DX_PR_GRPS.SAS:                                            
...
*  Data Step                  *;                                                
*******************************;                                                
DATA HI_SEDDC_2015q1q3_DX_PR_GRPS;                                              
INFILE 'HI_SEDD_2015q1q3_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 865;                
...
INPUT                                                                           
      ...
      @509    INJURY                        N2PF.                               
      @511    INJURY_CUT                    N2PF.                               
      @513    INJURY_DROWN                  N2PF.                               
      @515    INJURY_FALL                   N2PF.                               
      @517    INJURY_FIRE                   N2PF.                               
      @519    INJURY_FIREARM                N2PF.                               
      @521    INJURY_MACHINERY              N2PF.                               
      @523    INJURY_MVT                    N2PF.                               
      @525    INJURY_NATURE                 N2PF.                               
      @527    INJURY_POISON                 N2PF.                               
      @529    INJURY_STRUCK                 N2PF.                               
      @531    INJURY_SUFFOCATION            N2PF.                               
      @533    INTENT_ASSAULT                N2PF.                               
      @535    INTENT_SELF_HARM              N2PF.                               
      @537    INTENT_UNINTENTIONAL          N2PF.                               
      @539    KEY                           15.                                 
      @554    MULTINJURY                    N2PF.                               
      @556    PCLASS1                       N2PF.                               
      @558    PCLASS2                       N2PF.                               
      ...
      @840    U_NEWBN4L                     N2PF.                               
      @842    U_NUCMED                      N2PF.                               
      @844    U_OBSERVATION                 N2PF.                               
      @846    U_OCCTHERAPY                  N2PF.                               
      @848    U_ORGANACQ                    N2PF.                               
      @850    U_OTHIMPLANTS                 N2PF.                               
      @852    U_PACEMAKER                   N2PF.                               
      @854    U_PHYTHERAPY                  N2PF.                               
      @856    U_RADTHERAPY                  N2PF.                               
      @858    U_RESPTHERAPY                 N2PF.                               
      @860    U_SPEECHTHERAPY               N2PF.                               
      @862    U_STRESS                      N2PF.                               
      @864    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
