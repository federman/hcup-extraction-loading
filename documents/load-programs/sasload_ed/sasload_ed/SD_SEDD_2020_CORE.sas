...
*  Data Step                  *;                                                
*******************************;                                                
DATA SD_SEDDC_2020_CORE;                                                        
INFILE 'SD_SEDD_2020_CORE.ASC' FIRSTOBS=3 LRECL = 3518;                         
...
INPUT                                                                           
      ...
      @3044   HISPANIC                      N2PF.                               
      @3046   HISPANIC_X                    $CHAR1.                             
      @3047   HOSPST                        $CHAR2.                             
      @3049   I10_DX_Visit_Reason1          $CHAR7.                             
      @3056   I10_DX_Visit_Reason2          $CHAR7.                             
      @3063   I10_DX_Visit_Reason3          $CHAR7.                             
      @3070   I10_DX1                       $CHAR7.                             
      @3077   I10_DX2                       $CHAR7.                             
      @3084   I10_DX3                       $CHAR7.                             
      @3091   I10_DX4                       $CHAR7.                             
      ...
      @3433   PL_RUCC                       N2PF.                               
      @3435   PL_UIC                        N2PF.                               
      @3437   PL_UR_CAT4                    N2PF.                               
      @3439   PointOfOrigin_X               $CHAR1.                             
      @3440   PointOfOriginUB04             $CHAR1.                             
      @3441   PSTATE                        $CHAR2.                             
      @3443   PSTATE_GEO                    $CHAR2.                             
      @3445   PSTCO                         N5PF.                               
      @3450   PSTCO_GEO                     N5PF.                               
      @3455   RACE                          N2PF.                               
      @3457   RACE_X                        $CHAR1.                             
      ...
      @3462   STATE_OS                      N2PF.                               
      @3464   TOTCHG                        N10PF.                              
      @3474   TOTCHG_X                      N15P2F.                             
      @3489   YEAR                          N4PF.                               
      @3493   ZIP                           $CHAR5.                             
      @3498   ZIP3                          $CHAR3.                             
      @3501   ZIPINC_QRTL                   N3PF.                               
      @3504   HOSPID                        N5PF.                               
      @3509   AYEAR                         N4PF.                               
      @3513   BMONTH                        N2PF.                               
      @3515   BYEAR                         N4PF.                               
