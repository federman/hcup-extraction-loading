...
*  Data Step                  *;                                                
*******************************;                                                
DATA NY_SEDDC_2017_CORE;                                                        
INFILE 'NY_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 2179;                         
...
INPUT                                                                           
      ...
      @1515   CPTM2_98                      $CHAR2.                             
      @1517   CPTM2_99                      $CHAR2.                             
      @1519   CPTM2_100                     $CHAR2.                             
      @1521   DaysToEvent                   N6PF.                               
      @1527   DHOUR                         N4PF.                               
      @1531   DIED                          N2PF.                               
      @1533   DISP_X                        $CHAR2.                             
      @1535   DISPUB04                      N2PF.                               
      @1537   DISPUNIFORM                   N2PF.                               
      @1539   DMONTH                        N2PF.                               
      @1541   DQTR                          N2PF.                               
      @1543   DSHOSPID                      $CHAR17.                            
      @1560   DURATION                      N6PF.                               
      @1566   DXVER                         N3PF.                               
      @1569   FEMALE                        N2PF.                               
      @1571   HCUP_ED                       N2PF.                               
      @1573   HCUP_OS                       N2PF.                               
      @1575   HISPANIC                      N2PF.                               
      @1577   HISPANIC_X                    $CHAR49.                            
      @1626   Homeless                      N2PF.                               
      @1628   HOSP_NPI                      $CHAR10.                            
      @1638   HOSPST                        $CHAR2.                             
      @1640   I10_DX_Visit_Reason1          $CHAR7.                             
      @1647   I10_DX_Visit_Reason2          $CHAR7.                             
      @1654   I10_DX_Visit_Reason3          $CHAR7.                             
      @1661   I10_DX1                       $CHAR7.                             
      @1668   I10_DX2                       $CHAR7.                             
      @1675   I10_DX3                       $CHAR7.                             
      @1682   I10_DX4                       $CHAR7.                             
      ...
      @2119   STATE_OS                      N2PF.                               
      @2121   TOTCHG                        N10PF.                              
      @2131   TOTCHG_X                      N15P2F.                             
      @2146   VisitLink                     N9PF.                               
      @2155   YEAR                          N4PF.                               
      @2159   ZIP                           $CHAR5.                             
      @2164   ZIP3                          $CHAR3.                             
      @2167   ZIPINC_QRTL                   N3PF.                               
      @2170   AYEAR                         N4PF.                               
      @2174   BMONTH                        N2PF.                               
      @2176   BYEAR                         N4PF.                               
      ;                                                                         
