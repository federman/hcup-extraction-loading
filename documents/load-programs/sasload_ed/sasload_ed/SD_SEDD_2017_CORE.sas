...
*  Data Step                  *;                                                
*******************************;                                                
DATA SD_SEDDC_2017_CORE;                                                        
INFILE 'SD_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1939;                         
...
INPUT                                                                           
      ...
      @1535   HCUP_OS                       N2PF.                               
      @1537   HISPANIC                      N2PF.                               
      @1539   HISPANIC_X                    $CHAR1.                             
      @1540   HOSPST                        $CHAR2.                             
      @1542   I10_DX_Visit_Reason1          $CHAR7.                             
      @1549   I10_DX_Visit_Reason2          $CHAR7.                             
      @1556   I10_DX_Visit_Reason3          $CHAR7.                             
      @1563   I10_DX1                       $CHAR7.                             
      @1570   I10_DX2                       $CHAR7.                             
      @1577   I10_DX3                       $CHAR7.                             
      @1584   I10_DX4                       $CHAR7.                             
