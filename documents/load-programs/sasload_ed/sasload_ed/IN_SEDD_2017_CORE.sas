...
*  Data Step                  *;                                                
*******************************;                                                
DATA IN_SEDDC_2017_CORE;                                                        
INFILE 'IN_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1558;                         
...
INPUT                                                                           
      ...
      @585    HCUP_OS                       N2PF.                               
      @587    HISPANIC                      N2PF.                               
      @589    HISPANIC_X                    $CHAR1.                             
      @590    HOSPST                        $CHAR2.                             
      @592    I10_DX_Visit_Reason1          $CHAR7.                             
      @599    I10_DX1                       $CHAR7.                             
      @606    I10_DX2                       $CHAR7.                             
      @613    I10_DX3                       $CHAR7.                             
      @620    I10_DX4                       $CHAR7.                             
      ...
      @1218   PL_RUCC                       N2PF.                               
      @1220   PL_UIC                        N2PF.                               
      @1222   PL_UR_CAT4                    N2PF.                               
      @1224   POA_Disch_Edit1               N2PF.                               
      @1226   POA_Disch_Edit2               N2PF.                               
      @1228   POA_Hosp_Edit1                N2PF.                               
      @1230   POA_Hosp_Edit2                N2PF.                               
      @1232   POA_Hosp_Edit3                N2PF.                               
      @1234   POA_Hosp_Edit3_Value          N8P2F.                              
      @1242   PointOfOrigin_X               $CHAR2.                             
      @1244   PointOfOriginUB04             $CHAR1.                             
      @1245   PRDAY1                        N5PF.                               
      @1250   PRDAY2                        N5PF.                               
      @1255   PRDAY3                        N5PF.                               
      @1260   PRDAY4                        N5PF.                               
      ...
      @1367   STATE_OS                      N2PF.                               
      @1369   TOTCHG                        N10PF.                              
      @1379   TOTCHG_X                      N15P2F.                             
      @1394   VisitLink                     N9PF.                               
      @1403   YEAR                          N4PF.                               
      @1407   ZIP                           $CHAR5.                             
      @1412   ZIP3                          $CHAR3.                             
      @1415   ZIPINC_QRTL                   N3PF.                               
      @1418   HOSPID                        N5PF.                               
      @1423   AYEAR                         N4PF.                               
      @1427   BMONTH                        N2PF.                               
      @1429   BYEAR                         N4PF.                               
