...
*  Data Step                  *;                                                
*******************************;                                                
DATA AZ_SEDDC_2018_CORE;                                                        
INFILE 'AZ_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 612;                          
...
INPUT                                                                           
      ...
      @197    HCUP_OS                       N2PF.                               
      @199    HISPANIC                      N2PF.                               
      @201    HISPANIC_X                    $CHAR1.                             
      @202    Homeless                      N2PF.                               
      @204    HOSP_NPI                      $CHAR10.                            
      @214    HOSPST                        $CHAR2.                             
      @216    I10_DX_Visit_Reason1          $CHAR7.                             
      @223    I10_DX_Visit_Reason2          $CHAR7.                             
      @230    I10_DX_Visit_Reason3          $CHAR7.                             
      @237    I10_DX1                       $CHAR7.                             
      @244    I10_DX2                       $CHAR7.                             
      @251    I10_DX3                       $CHAR7.                             
      @258    I10_DX4                       $CHAR7.                             
