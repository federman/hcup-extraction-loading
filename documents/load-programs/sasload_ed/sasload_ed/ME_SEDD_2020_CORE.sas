...
*  Data Step                  *;                                                
*******************************;                                                
DATA ME_SEDDC_2020_CORE;                                                        
INFILE 'ME_SEDD_2020_CORE.ASC' FIRSTOBS=3 LRECL = 1870;                         
...
INPUT                                                                           
      ...
      @1521   HCUP_ED                       N2PF.                               
      @1523   HCUP_OS                       N2PF.                               
      @1525   HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @1530   HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @1535   HOSPST                        $CHAR2.                             
      @1537   I10_DX_Visit_Reason1          $CHAR7.                             
      @1544   I10_DX_Visit_Reason2          $CHAR7.                             
      @1551   I10_DX_Visit_Reason3          $CHAR7.                             
      @1558   I10_DX1                       $CHAR7.                             
      @1565   I10_DX2                       $CHAR7.                             
      @1572   I10_DX3                       $CHAR7.                             
      @1579   I10_DX4                       $CHAR7.                             
      ...
      @1822   PL_NCHS                       N2PF.                               
      @1824   PL_UIC                        N2PF.                               
      @1826   PL_UR_CAT4                    N2PF.                               
      @1828   PointOfOriginUB04             $CHAR1.                             
      @1829   PSTATE                        $CHAR2.                             
      @1831   PSTATE_GEO                    $CHAR2.                             
      @1833   PSTCO                         N5PF.                               
      @1838   PSTCO_GEO                     N5PF.                               
      @1843   STATE_AS                      N2PF.                               
      @1845   STATE_ED                      N2PF.                               
