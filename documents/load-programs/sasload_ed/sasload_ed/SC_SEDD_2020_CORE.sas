...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SEDDC_2020_CORE;                                                        
INFILE 'SC_SEDD_2020_CORE.ASC' FIRSTOBS=3 LRECL = 1325;                         
...
INPUT                                                                           
      ...
      @1049   DISP_X                        $CHAR2.                             
      @1051   DISPUB04                      N2PF.                               
      @1053   DISPUNIFORM                   N2PF.                               
      @1055   DMONTH                        N2PF.                               
      @1057   DQTR                          N2PF.                               
      @1059   FEMALE                        N2PF.                               
      @1061   HCUP_ED                       N2PF.                               
      @1063   HCUP_OS                       N2PF.                               
      @1065   HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @1070   HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @1075   HOSPST                        $CHAR2.                             
      @1077   I10_DX_Visit_Reason1          $CHAR7.                             
      @1084   I10_DX_Visit_Reason2          $CHAR7.                             
      @1091   I10_DX_Visit_Reason3          $CHAR7.                             
      @1098   I10_DX1                       $CHAR7.                             
      @1105   I10_DX2                       $CHAR7.                             
      @1112   I10_DX3                       $CHAR7.                             
      @1119   I10_DX4                       $CHAR7.                             
      ...
      @1263   PAY1_X                        $CHAR2.                             
      @1265   PL_NCHS                       N2PF.                               
      @1267   PointOfOrigin_X               $CHAR1.                             
      @1268   PointOfOriginUB04             $CHAR1.                             
      @1269   PSTATE                        $CHAR2.                             
      @1271   PSTATE_GEO                    $CHAR2.                             
      @1273   PSTCO                         N5PF.                               
      @1278   RACE                          N2PF.                               
      @1280   RACE_X                        $CHAR1.                             
      @1281   STATE_AS                      N2PF.                               
      ...
      @1285   STATE_OS                      N2PF.                               
      @1287   TOTCHG                        N10PF.                              
      @1297   TOTCHG_X                      N15P2F.                             
      @1312   YEAR                          N4PF.                               
      @1316   ZIPINC_QRTL                   N3PF.                               
      @1319   AGEGROUP                      N3PF.                               
      @1322   AYEAR                         N4PF.                               
      ;                                                                         
