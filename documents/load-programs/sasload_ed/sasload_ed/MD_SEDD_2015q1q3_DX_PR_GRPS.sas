...
*   MD_SEDD_2015q1q3_DX_PR_GRPS.SAS:                                            
...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SEDDC_2015q1q3_DX_PR_GRPS;                                              
INFILE 'MD_SEDD_2015q1q3_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 652;                
...
INPUT                                                                           
      ...
      @546    INJURY                        N2PF.                               
      @548    INJURY_CUT                    N2PF.                               
      @550    INJURY_DROWN                  N2PF.                               
      @552    INJURY_FALL                   N2PF.                               
      @554    INJURY_FIRE                   N2PF.                               
      @556    INJURY_FIREARM                N2PF.                               
      @558    INJURY_MACHINERY              N2PF.                               
      @560    INJURY_MVT                    N2PF.                               
      @562    INJURY_NATURE                 N2PF.                               
      @564    INJURY_POISON                 N2PF.                               
      @566    INJURY_STRUCK                 N2PF.                               
      @568    INJURY_SUFFOCATION            N2PF.                               
      @570    INTENT_ASSAULT                N2PF.                               
      @572    INTENT_SELF_HARM              N2PF.                               
      @574    INTENT_UNINTENTIONAL          N2PF.                               
      @576    KEY                           15.                                 
      @591    MULTINJURY                    N2PF.                               
      @593    U_BLOOD                       N2PF.                               
      @595    U_CATH                        N2PF.                               
      @597    U_CCU                         N2PF.                               
      @599    U_CHESTXRAY                   N2PF.                               
      @601    U_CTSCAN                      N2PF.                               
      @603    U_DIALYSIS                    N2PF.                               
      @605    U_ECHO                        N2PF.                               
      @607    U_ED                          N2PF.                               
      ...
      @627    U_NEWBN4L                     N2PF.                               
      @629    U_NUCMED                      N2PF.                               
      @631    U_OBSERVATION                 N2PF.                               
      @633    U_OCCTHERAPY                  N2PF.                               
      @635    U_ORGANACQ                    N2PF.                               
      @637    U_OTHIMPLANTS                 N2PF.                               
      @639    U_PACEMAKER                   N2PF.                               
      @641    U_PHYTHERAPY                  N2PF.                               
      @643    U_RADTHERAPY                  N2PF.                               
      @645    U_RESPTHERAPY                 N2PF.                               
      @647    U_SPEECHTHERAPY               N2PF.                               
      @649    U_STRESS                      N2PF.                               
