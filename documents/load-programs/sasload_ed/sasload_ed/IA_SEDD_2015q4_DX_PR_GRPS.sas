...
*  Data Step                  *;                                                
*******************************;                                                
DATA IA_SEDDC_2015q4_DX_PR_GRPS;                                                
INFILE 'IA_SEDD_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 617;                  
...
INPUT                                                                           
      ...
      @539    I10_INJURY                    N2PF.                               
      @541    I10_MULTINJURY                N2PF.                               
      @543    I10_U_BLOOD                   N2PF.                               
      @545    I10_U_CATH                    N2PF.                               
      @547    I10_U_CTSCAN                  N2PF.                               
      @549    I10_U_EKG                     N2PF.                               
      @551    I10_U_MHSA                    N2PF.                               
      @553    I10_U_MRT                     N2PF.                               
      @555    I10_U_PACEMAKER               N2PF.                               
      @557    I10_U_PHYTHERAPY              N2PF.                               
      @559    I10_U_RADTHERAPY              N2PF.                               
      @561    I10_U_STRESS                  N2PF.                               
      @563    KEY                           15.                                 
      @578    U_CCU                         N2PF.                               
      @580    U_CHESTXRAY                   N2PF.                               
      @582    U_DIALYSIS                    N2PF.                               
      @584    U_ECHO                        N2PF.                               
      @586    U_ED                          N2PF.                               
      @588    U_EEG                         N2PF.                               
      ...
      @600    U_NEWBN4L                     N2PF.                               
      @602    U_NUCMED                      N2PF.                               
      @604    U_OBSERVATION                 N2PF.                               
      @606    U_OCCTHERAPY                  N2PF.                               
      @608    U_ORGANACQ                    N2PF.                               
      @610    U_OTHIMPLANTS                 N2PF.                               
      @612    U_RESPTHERAPY                 N2PF.                               
      @614    U_SPEECHTHERAPY               N2PF.                               
