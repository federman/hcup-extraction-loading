...
*  Data Step                  *;                                                
*******************************;                                                
DATA GA_SEDDC_2012_CORE;                                                        
INFILE 'GA_SEDD_2012_CORE.ASC' FIRSTOBS=3 LRECL = 2011;                         
...
ATTRIB                                                                          
  ...
  E_POA19                    LENGTH=$1                                          
  LABEL="E Code 19, present on admission indicator"                             
                                                                                
  E_POA20                    LENGTH=$1                                          
  LABEL="E Code 20, present on admission indicator"                             
...
INPUT                                                                           
      ...
      @1369   PAY3_X                        $CHAR4.                             
      @1373   PL_CBSA                       N3PF.                               
      @1376   PL_MSA1993                    N3PF.                               
      @1379   PL_NCHS2006                   N2PF.                               
      @1381   PL_RUCA10_2005                N2PF.                               
      @1383   PL_RUCA2005                   N4P1F.                              
      @1387   PL_RUCA4_2005                 N2PF.                               
      @1389   PL_RUCC2003                   N2PF.                               
      @1391   PL_UIC2003                    N2PF.                               
      @1393   PL_UR_CAT4                    N2PF.                               
      @1395   PR1                           $CHAR7.                             
      @1402   PR2                           $CHAR7.                             
      @1409   PR3                           $CHAR7.                             
      @1416   PR4                           $CHAR7.                             
      ...
      @1775   PSTCO                         N5PF.                               
      @1780   PSTCO2                        N5PF.                               
      @1785   PointOfOriginUB04             $CHAR1.                             
      @1786   PointOfOrigin_X               $CHAR1.                             
      @1787   RACE                          N2PF.                               
      @1789   RACE_X                        $CHAR1.                             
      @1790   STATE_AS                      N2PF.                               
      @1792   STATE_ED                      N2PF.                               
      @1794   STATE_OS                      N2PF.                               
      @1796   TOTCHG                        N10PF.                              
      @1806   TOTCHG_X                      N15P2F.                             
      @1821   VisitLink                     N9PF.                               
      @1830   YEAR                          N4PF.                               
      @1834   ZIP3                          $CHAR3.                             
      @1837   ZIPINC_QRTL                   N3PF.                               
      @1840   HOSPID                        N5PF.                               
      @1845   ZIP                           $CHAR5.                             
      @1850   AYEAR                         N4PF.                               
      @1854   DMONTH                        N2PF.                               
