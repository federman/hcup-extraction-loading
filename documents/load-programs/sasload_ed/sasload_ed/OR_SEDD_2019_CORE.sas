...
*  Data Step                  *;                                                
*******************************;                                                
DATA OR_SEDDC_2019_CORE;                                                        
INFILE 'OR_SEDD_2019_CORE.ASC' FIRSTOBS=3 LRECL = 2294;                         
...
INPUT                                                                           
      ...
      @2053   I10_DX27                      $CHAR7.                             
      @2060   I10_DX28                      $CHAR7.                             
      @2067   I10_DX_Visit_Reason1          $CHAR7.                             
      @2074   I10_DX_Visit_Reason2          $CHAR7.                             
      @2081   I10_DX_Visit_Reason3          $CHAR7.                             
      @2088   I10_NDX                       N3PF.                               
      @2091   I10_PROCTYPE                  N3PF.                               
      @2094   KEY                           15.                                 
      @2109   LOS                           N5PF.                               
      @2114   LOS_X                         N6PF.                               
      @2120   MDNUM1_R                      N9PF.                               
      ...
      @2212   PL_RUCC                       N2PF.                               
      @2214   PL_UIC                        N2PF.                               
      @2216   PL_UR_CAT4                    N2PF.                               
      @2218   PSTATE                        $CHAR2.                             
      @2220   PSTATE_GEO                    $CHAR2.                             
      @2222   PSTCO                         N5PF.                               
      @2227   PSTCO_GEO                     N5PF.                               
      @2232   PointOfOriginUB04             $CHAR1.                             
      @2233   PointOfOrigin_X               $CHAR2.                             
      @2235   RACE                          N2PF.                               
      @2237   RACE_X                        $CHAR2.                             
      @2239   STATE_AS                      N2PF.                               
      @2241   STATE_ED                      N2PF.                               
      @2243   STATE_OS                      N2PF.                               
      @2245   TOTCHG                        N10PF.                              
      @2255   TOTCHG_X                      N15P2F.                             
      @2270   YEAR                          N4PF.                               
      @2274   ZIP                           $CHAR5.                             
      @2279   ZIP3                          $CHAR3.                             
      @2282   ZIPINC_QRTL                   N3PF.                               
      @2285   AYEAR                         N4PF.                               
      @2289   BMONTH                        N2PF.                               
      @2291   BYEAR                         N4PF.                               
      ;                                                                         
