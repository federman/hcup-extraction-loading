...
*  Data Step                  *;                                                
*******************************;                                                
DATA ME_SEDDC_2015q1q3_CORE;                                                    
INFILE 'ME_SEDD_2015q1q3_CORE.ASC' FIRSTOBS=3 LRECL = 1285;                     
...
INPUT                                                                           
      ...
      @765    DMONTH                        N2PF.                               
      @767    DQTR                          N2PF.                               
      @769    DX_Visit_Reason1              $CHAR7.                             
      @776    DX_Visit_Reason2              $CHAR7.                             
      @783    DX_Visit_Reason3              $CHAR7.                             
      @790    DX1                           $CHAR7.                             
      @797    DX2                           $CHAR7.                             
      @804    DX3                           $CHAR7.                             
      @811    DX4                           $CHAR7.                             
      ...
      @1236   PL_NCHS                       N2PF.                               
      @1238   PL_UIC                        N2PF.                               
      @1240   PL_UR_CAT4                    N2PF.                               
      @1242   PointOfOriginUB04             $CHAR1.                             
      @1243   PROCTYPE                      N3PF.                               
      @1246   PSTATE                        $CHAR2.                             
      @1248   PSTCO                         N5PF.                               
      @1253   PSTCO2                        N5PF.                               
