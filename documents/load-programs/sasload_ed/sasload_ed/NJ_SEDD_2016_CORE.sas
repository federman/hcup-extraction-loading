...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SEDDC_2016_CORE;                                                        
INFILE 'NJ_SEDD_2016_CORE.ASC' FIRSTOBS=3 LRECL = 1509;                         
...
INPUT                                                                           
      ...
      @706    HCUP_OS                       N2PF.                               
      @708    HISPANIC                      N2PF.                               
      @710    HISPANIC_X                    $CHAR5.                             
      @715    Homeless                      N2PF.                               
      @717    HOSPST                        $CHAR2.                             
      @719    I10_DX_Visit_Reason1          $CHAR7.                             
      @726    I10_DX_Visit_Reason2          $CHAR7.                             
      @733    I10_DX_Visit_Reason3          $CHAR7.                             
      @740    I10_DX1                       $CHAR7.                             
      @747    I10_DX2                       $CHAR7.                             
      @754    I10_DX3                       $CHAR7.                             
      @761    I10_DX4                       $CHAR7.                             
      ...
      @901    I10_DX24                      $CHAR7.                             
      @908    I10_DX25                      $CHAR7.                             
      @915    I10_ECAUSE1                   $CHAR7.                             
      @922    I10_ECAUSE2                   $CHAR7.                             
      @929    I10_ECAUSE3                   $CHAR7.                             
      @936    I10_ECAUSE4                   $CHAR7.                             
      @943    I10_ECAUSE5                   $CHAR7.                             
      @950    I10_ECAUSE6                   $CHAR7.                             
      @957    I10_ECAUSE7                   $CHAR7.                             
      @964    I10_ECAUSE8                   $CHAR7.                             
      @971    I10_ECAUSE9                   $CHAR7.                             
      @978    I10_NDX                       N3PF.                               
      @981    I10_NECAUSE                   N2PF.                               
      @983    I10_NPR                       N3PF.                               
      @986    I10_PR1                       $CHAR7.                             
      @993    I10_PR2                       $CHAR7.                             
      @1000   I10_PR3                       $CHAR7.                             
      ...
      @1352   STATE_OS                      N2PF.                               
      @1354   TOTCHG                        N10PF.                              
      @1364   TOTCHG_X                      N15P2F.                             
      @1379   YEAR                          N4PF.                               
      @1383   ZIP                           $CHAR5.                             
      @1388   ZIP3                          $CHAR3.                             
      @1391   ZIPINC_QRTL                   N3PF.                               
      @1394   TOWN                          $CHAR4.                             
      @1398   AYEAR                         N4PF.                               
      @1402   BMONTH                        N2PF.                               
      @1404   BYEAR                         N4PF.                               
