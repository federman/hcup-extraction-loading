...
*  Data Step                  *;                                                
*******************************;                                                
DATA AZ_SEDDC_2014_CORE;                                                        
INFILE 'AZ_SEDD_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1006;                         
...
INPUT                                                                           
      ...
      @464    DXCCS25                       N4PF.                               
      @468    DXVER                         N3PF.                               
      @471    DX_Visit_Reason1              $CHAR7.                             
      @478    DX_Visit_Reason2              $CHAR7.                             
      @485    DX_Visit_Reason3              $CHAR7.                             
      @492    ECODE1                        $CHAR7.                             
      @499    ECODE2                        $CHAR7.                             
      @506    ECODE3                        $CHAR7.                             
      @513    ECODE4                        $CHAR7.                             
      ...
      @869    PSTATE                        $CHAR2.                             
      @871    PSTCO2                        N5PF.                               
      @876    PointOfOriginUB04             $CHAR1.                             
      @877    PointOfOrigin_X               $CHAR1.                             
      @878    RACE                          N2PF.                               
      @880    RACE_X                        $CHAR3.                             
      @883    SPLIT_IPED                    N2PF.                               
      @885    STATE_AS                      N2PF.                               
