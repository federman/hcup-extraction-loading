...
*  Data Step                  *;                                                
*******************************;                                                
DATA AZ_SEDDC_2015q1q3_CORE;                                                    
INFILE 'AZ_SEDD_2015q1q3_CORE.ASC' FIRSTOBS=3 LRECL = 1009;                     
...
INPUT                                                                           
      ...
      @170    DSHOSPID                      $CHAR17.                            
      @187    DURATION                      N6PF.                               
      @193    DX_Visit_Reason1              $CHAR7.                             
      @200    DX_Visit_Reason2              $CHAR7.                             
      @207    DX_Visit_Reason3              $CHAR7.                             
      @214    DX1                           $CHAR7.                             
      @221    DX2                           $CHAR7.                             
      @228    DX3                           $CHAR7.                             
      @235    DX4                           $CHAR7.                             
