...
*  Data Step                  *;                                                
*******************************;                                                
DATA MN_SEDDC_2021_CORE;                                                        
INFILE 'MN_SEDD_2021_CORE.ASC' FIRSTOBS=3 LRECL = 3758;                         
...
INPUT                                                                           
      ...
      @3087   HCUP_ED                       N2PF.                               
      @3089   HCUP_OS                       N2PF.                               
      @3091   HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @3096   HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @3101   HISPANIC                      N2PF.                               
      @3103   HISPANIC_X                    $CHAR2.                             
      @3105   HOSPST                        $CHAR2.                             
      @3107   I10_DX_Visit_Reason1          $CHAR7.                             
      @3114   I10_DX1                       $CHAR7.                             
      @3121   I10_DX2                       $CHAR7.                             
      @3128   I10_DX3                       $CHAR7.                             
      @3135   I10_DX4                       $CHAR7.                             
      ...
      @3540   PL_RUCC                       N2PF.                               
      @3542   PL_UIC                        N2PF.                               
      @3544   PL_UR_CAT4                    N2PF.                               
      @3546   POA_Disch_Edit1               N2PF.                               
      @3548   POA_Disch_Edit2               N2PF.                               
      @3550   POA_Hosp_Edit1                N2PF.                               
      @3552   POA_Hosp_Edit2                N2PF.                               
      @3554   POA_Hosp_Edit3                N2PF.                               
      @3556   POA_Hosp_Edit3_Value          N8P2F.                              
      @3564   PointOfOrigin_X               $CHAR1.                             
      @3565   PointOfOriginUB04             $CHAR1.                             
      @3566   PRDAY1                        N5PF.                               
      @3571   PRDAY2                        N5PF.                               
      @3576   PRDAY3                        N5PF.                               
      @3581   PRDAY4                        N5PF.                               
      ...
      @3606   PrimLang                      $CHAR3.                             
      @3609   PSTATE                        $CHAR2.                             
      @3611   PSTATE_GEO                    $CHAR2.                             
      @3613   PSTCO_GEO                     N5PF.                               
      @3618   RACE                          N2PF.                               
      @3620   RACE_PCT_MISS_HOSP            N7P2F.                              
      @3627   RACE_X                        $CHAR20.                            
      @3647   SASD_SEDD                     N2PF.                               
      @3649   STATE_AS                      N2PF.                               
      @3651   STATE_ED                      N2PF.                               
      @3653   STATE_OS                      N2PF.                               
      @3655   TOTCHG                        N10PF.                              
      @3665   TOTCHG_X                      N15P2F.                             
      @3680   YEAR                          N4PF.                               
      @3684   ZIP                           $CHAR5.                             
      @3689   ZIP3                          $CHAR3.                             
      @3692   ZIPINC_QRTL                   N3PF.                               
      @3695   AYEAR                         N4PF.                               
      @3699   BMONTH                        N2PF.                               
      @3701   BYEAR                         N4PF.                               
      @3705   PRMONTH1                      N2PF.                               
