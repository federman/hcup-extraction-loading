...
*  Data Step                  *;                                                
*******************************;                                                
DATA MN_SEDDC_2015q4_CORE;                                                      
INFILE 'MN_SEDD_2015q4_CORE.ASC' FIRSTOBS=3 LRECL = 1637;                       
...
INPUT                                                                           
      ...
      @836    HCUP_OS                       N2PF.                               
      @838    HOSPST                        $CHAR2.                             
      @840    I10_DX_Visit_Reason1          $CHAR7.                             
      @847    I10_DX1                       $CHAR7.                             
      @854    I10_DX2                       $CHAR7.                             
      @861    I10_DX3                       $CHAR7.                             
      @868    I10_DX4                       $CHAR7.                             
      ...
      @1008   I10_DX24                      $CHAR7.                             
      @1015   I10_DX25                      $CHAR7.                             
      @1022   I10_DXCCS1                    N4PF.                               
      @1026   I10_DXCCS2                    N4PF.                               
      @1030   I10_DXCCS3                    N4PF.                               
      @1034   I10_DXCCS4                    N4PF.                               
      @1038   I10_DXCCS5                    N4PF.                               
      @1042   I10_DXCCS6                    N4PF.                               
      @1046   I10_DXCCS7                    N4PF.                               
      @1050   I10_DXCCS8                    N4PF.                               
      @1054   I10_DXCCS9                    N4PF.                               
      @1058   I10_DXCCS10                   N4PF.                               
      @1062   I10_DXCCS11                   N4PF.                               
      @1066   I10_DXCCS12                   N4PF.                               
      @1070   I10_DXCCS13                   N4PF.                               
      @1074   I10_DXCCS14                   N4PF.                               
      @1078   I10_DXCCS15                   N4PF.                               
      @1082   I10_DXCCS16                   N4PF.                               
      @1086   I10_DXCCS17                   N4PF.                               
      @1090   I10_DXCCS18                   N4PF.                               
      @1094   I10_DXCCS19                   N4PF.                               
      @1098   I10_DXCCS20                   N4PF.                               
      @1102   I10_DXCCS21                   N4PF.                               
      @1106   I10_DXCCS22                   N4PF.                               
      @1110   I10_DXCCS23                   N4PF.                               
      @1114   I10_DXCCS24                   N4PF.                               
      @1118   I10_DXCCS25                   N4PF.                               
      @1122   I10_ECAUSE1                   $CHAR7.                             
      @1129   I10_ECAUSE2                   $CHAR7.                             
      @1136   I10_ECAUSE3                   $CHAR7.                             
      @1143   I10_ECAUSE4                   $CHAR7.                             
      @1150   I10_ECAUSE5                   $CHAR7.                             
      @1157   I10_ECAUSE6                   $CHAR7.                             
      @1164   I10_ECAUSE7                   $CHAR7.                             
      @1171   I10_ECAUSE8                   $CHAR7.                             
      @1178   I10_ECauseCCS1                N4PF.                               
      @1182   I10_ECauseCCS2                N4PF.                               
      @1186   I10_ECauseCCS3                N4PF.                               
      @1190   I10_ECauseCCS4                N4PF.                               
      @1194   I10_ECauseCCS5                N4PF.                               
      @1198   I10_ECauseCCS6                N4PF.                               
      @1202   I10_ECauseCCS7                N4PF.                               
      @1206   I10_ECauseCCS8                N4PF.                               
      @1210   I10_HOSPBRTH                  N3PF.                               
      @1213   I10_NCHRONIC                  N3PF.                               
      @1216   I10_NDX                       N3PF.                               
      @1219   I10_NECAUSE                   N2PF.                               
      @1221   I10_NEOMAT                    N2PF.                               
      @1223   I10_NPR                       N3PF.                               
      @1226   I10_ORPROC                    N2PF.                               
      @1228   I10_PR1                       $CHAR7.                             
      @1235   I10_PR2                       $CHAR7.                             
      @1242   I10_PR3                       $CHAR7.                             
      @1249   I10_PR4                       $CHAR7.                             
      ...
      @1291   I10_PR10                      $CHAR7.                             
      @1298   I10_PR11                      $CHAR7.                             
      @1305   I10_PRCCS1                    N3PF.                               
      @1308   I10_PRCCS2                    N3PF.                               
      @1311   I10_PRCCS3                    N3PF.                               
      @1314   I10_PRCCS4                    N3PF.                               
      @1317   I10_PRCCS5                    N3PF.                               
      @1320   I10_PRCCS6                    N3PF.                               
      @1323   I10_PRCCS7                    N3PF.                               
      @1326   I10_PRCCS8                    N3PF.                               
      @1329   I10_PRCCS9                    N3PF.                               
      @1332   I10_PRCCS10                   N3PF.                               
      @1335   I10_PRCCS11                   N3PF.                               
      @1338   I10_PROCTYPE                  N3PF.                               
      @1341   KEY                           15.                                 
      @1356   LOS                           N5PF.                               
      @1361   LOS_X                         N6PF.                               
      @1367   MEDINCSTQ                     N2PF.                               
      ...
      @1425   PL_RUCC                       N2PF.                               
      @1427   PL_UIC                        N2PF.                               
      @1429   PL_UR_CAT4                    N2PF.                               
      @1431   POA_Disch_Edit1               N2PF.                               
      @1433   POA_Disch_Edit2               N2PF.                               
      @1435   POA_Hosp_Edit1                N2PF.                               
      @1437   POA_Hosp_Edit2                N2PF.                               
      @1439   POA_Hosp_Edit3                N2PF.                               
      @1441   POA_Hosp_Edit3_Value          N8P2F.                              
      @1449   PointOfOrigin_X               $CHAR1.                             
      @1450   PointOfOriginUB04             $CHAR1.                             
      @1451   PRDAY1                        N5PF.                               
      @1456   PRDAY2                        N5PF.                               
      @1461   PRDAY3                        N5PF.                               
      @1466   PRDAY4                        N5PF.                               
