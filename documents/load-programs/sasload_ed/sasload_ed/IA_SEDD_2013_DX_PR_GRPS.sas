...
*  Data Step                  *;                                                
*******************************;                                                
DATA IA_SEDDC_2013_DX_PR_GRPS;                                                  
INFILE 'IA_SEDD_2013_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 739;                    
...
INPUT                                                                           
      ...
      @633    INJURY                        N2PF.                               
      @635    INJURY_CUT                    N2PF.                               
      @637    INJURY_DROWN                  N2PF.                               
      @639    INJURY_FALL                   N2PF.                               
      @641    INJURY_FIRE                   N2PF.                               
      @643    INJURY_FIREARM                N2PF.                               
      @645    INJURY_MACHINERY              N2PF.                               
      @647    INJURY_MVT                    N2PF.                               
      @649    INJURY_NATURE                 N2PF.                               
      @651    INJURY_POISON                 N2PF.                               
      @653    INJURY_STRUCK                 N2PF.                               
      @655    INJURY_SUFFOCATION            N2PF.                               
      @657    INTENT_ASSAULT                N2PF.                               
      @659    INTENT_SELF_HARM              N2PF.                               
      @661    INTENT_UNINTENTIONAL          N2PF.                               
      @663    KEY                           15.                                 
      @678    MULTINJURY                    N2PF.                               
      @680    U_BLOOD                       N2PF.                               
      @682    U_CATH                        N2PF.                               
      @684    U_CCU                         N2PF.                               
      @686    U_CHESTXRAY                   N2PF.                               
      @688    U_CTSCAN                      N2PF.                               
      @690    U_DIALYSIS                    N2PF.                               
      @692    U_ECHO                        N2PF.                               
      @694    U_ED                          N2PF.                               
      ...
      @726    U_PACEMAKER                   N2PF.                               
      @728    U_PHYTHERAPY                  N2PF.                               
      @730    U_RADTHERAPY                  N2PF.                               
      @732    U_RESPTHERAPY                 N2PF.                               
      @734    U_SPEECHTHERAPY               N2PF.                               
      @736    U_STRESS                      N2PF.                               
      @738    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
