...
*  Data Step                  *;                                                
*******************************;                                                
DATA NY_SEDDC_2020_CORE;                                                        
INFILE 'NY_SEDD_2020_CORE.ASC' FIRSTOBS=3 LRECL = 3673;                         
...
INPUT                                                                           
      ...
      @3081   HCUP_ED                       N2PF.                               
      @3083   HCUP_OS                       N2PF.                               
      @3085   HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @3090   HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @3095   HEART_RATE_X                  N4PF.                               
      @3099   HISPANIC                      N2PF.                               
      @3101   HISPANIC_X                    $CHAR85.                            
      @3186   Homeless                      N2PF.                               
      @3188   HOSP_NPI                      $CHAR10.                            
      @3198   HOSPST                        $CHAR2.                             
      @3200   I10_DX_Visit_Reason1          $CHAR7.                             
      @3207   I10_DX_Visit_Reason2          $CHAR7.                             
      @3214   I10_DX_Visit_Reason3          $CHAR7.                             
      @3221   I10_DX1                       $CHAR7.                             
      @3228   I10_DX2                       $CHAR7.                             
      @3235   I10_DX3                       $CHAR7.                             
      @3242   I10_DX4                       $CHAR7.                             
      ...
      @3431   I10_DX31                      $CHAR7.                             
      @3438   I10_NDX                       N3PF.                               
      @3441   I10_PROCTYPE                  N3PF.                               
      @3444   KEY                           15.                                 
      @3459   LOS                           N5PF.                               
      @3464   LOS_X                         N6PF.                               
      @3470   MARITALSTATUS_X               $CHAR1.                             
      @3471   MARITALSTATUSUB04             $CHAR1.                             
      @3472   MDNUM1_R                      N9PF.                               
      @3481   MDNUM2_R                      N9PF.                               
      @3490   MEDINCSTQ                     N2PF.                               
      @3492   NCPT                          N4PF.                               
      @3496   OPservice                     $CHAR1.                             
      @3497   OS_TIME                       N11P2F.                             
      @3508   PAY1                          N2PF.                               
      @3510   PAY1_X                        $CHAR5.                             
      @3515   PAY2                          N2PF.                               
      ...
      @3534   PL_RUCC                       N2PF.                               
      @3536   PL_UIC                        N2PF.                               
      @3538   PL_UR_CAT4                    N2PF.                               
      @3540   PointOfOrigin_X               $CHAR1.                             
      @3541   PointOfOriginUB04             $CHAR1.                             
      @3542   PSTATE                        $CHAR2.                             
      @3544   PSTATE_GEO                    $CHAR2.                             
      @3546   PSTCO                         N5PF.                               
      @3551   PSTCO_GEO                     N5PF.                               
      @3556   RACE                          N2PF.                               
      @3558   RACE_X                        $CHAR51.                            
      ...
      @3613   STATE_OS                      N2PF.                               
      @3615   TOTCHG                        N10PF.                              
      @3625   TOTCHG_X                      N15P2F.                             
      @3640   VisitLink                     N9PF.                               
      @3649   YEAR                          N4PF.                               
      @3653   ZIP                           $CHAR5.                             
      @3658   ZIP3                          $CHAR3.                             
      @3661   ZIPINC_QRTL                   N3PF.                               
      @3664   AYEAR                         N4PF.                               
      @3668   BMONTH                        N2PF.                               
      @3670   BYEAR                         N4PF.                               
      ;                                                                         
