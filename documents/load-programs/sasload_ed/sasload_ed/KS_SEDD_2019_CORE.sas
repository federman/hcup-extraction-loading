...
*  Data Step                  *;                                                
*******************************;                                                
DATA KS_SEDDC_2019_CORE;                                                        
INFILE 'KS_SEDD_2019_CORE.ASC' FIRSTOBS=3 LRECL = 2041;                         
...
INPUT                                                                           
      ...
      @1880   I10_PR16                      $CHAR7.                             
      @1887   I10_PR17                      $CHAR7.                             
      @1894   I10_PROCTYPE                  N3PF.                               
      @1897   KEY                           15.                                 
      @1912   LOS                           N5PF.                               
      @1917   LOS_X                         N6PF.                               
      @1923   MEDINCSTQ                     N2PF.                               
      @1925   NCPT                          N4PF.                               
      @1929   OPservice                     $CHAR1.                             
      @1930   OS_TIME                       N11P2F.                             
      @1941   PAY1                          N2PF.                               
      @1943   PAY1_X                        $CHAR3.                             
      @1946   PAY2                          N2PF.                               
      ...
      @1961   PL_RUCC                       N2PF.                               
      @1963   PL_UIC                        N2PF.                               
      @1965   PL_UR_CAT4                    N2PF.                               
      @1967   PSTATE                        $CHAR2.                             
      @1969   PSTATE_GEO                    $CHAR2.                             
      @1971   PSTCO                         N5PF.                               
      @1976   PSTCO_GEO                     N5PF.                               
      @1981   PointOfOriginUB04             $CHAR1.                             
      @1982   PointOfOrigin_X               $CHAR1.                             
      @1983   RACE                          N2PF.                               
      @1985   RACE_X                        $CHAR1.                             
      @1986   STATE_AS                      N2PF.                               
      @1988   STATE_ED                      N2PF.                               
      @1990   STATE_OS                      N2PF.                               
      @1992   TOTCHG                        N10PF.                              
      @2002   TOTCHG_X                      N15P2F.                             
      @2017   YEAR                          N4PF.                               
      @2021   ZIP3                          $CHAR3.                             
      @2024   ZIPINC_QRTL                   N3PF.                               
      @2027   HOSPID                        N5PF.                               
      @2032   AYEAR                         N4PF.                               
      @2036   BMONTH                        N2PF.                               
      @2038   BYEAR                         N4PF.                               
