...
*  Data Step                  *;                                                
*******************************;                                                
DATA RI_SEDDC_2021_CORE;                                                        
INFILE 'RI_SEDD_2021_CORE.ASC' FIRSTOBS=3 LRECL = 441;                          
...
INPUT                                                                           
      ...
      @176    HCUP_ED                       N2PF.                               
      @178    HCUP_OS                       N2PF.                               
      @180    HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @185    HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @190    HISPANIC                      N2PF.                               
      @192    HISPANIC_X                    $CHAR3.                             
      @195    HOSPST                        $CHAR2.                             
      @197    I10_DX_Visit_Reason1          $CHAR7.                             
      @204    I10_DX1                       $CHAR7.                             
      @211    I10_DX2                       $CHAR7.                             
      @218    I10_DX3                       $CHAR7.                             
      @225    I10_DX4                       $CHAR7.                             
      ...
      @363    PL_UIC                        N2PF.                               
      @365    PL_UR_CAT4                    N2PF.                               
      @367    PointOfOrigin_X               $CHAR1.                             
      @368    PointOfOriginUB04             $CHAR1.                             
      @369    PSTATE                        $CHAR2.                             
      @371    PSTATE_GEO                    $CHAR2.                             
      @373    PSTCO                         N5PF.                               
      @378    PSTCO_GEO                     N5PF.                               
      @383    RACE                          N2PF.                               
      @385    RACE_PCT_MISS_HOSP            N7P2F.                              
      @392    RACE_X                        $CHAR1.                             
      @393    SASD_SEDD                     N2PF.                               
      @395    STATE_AS                      N2PF.                               
      @397    STATE_ED                      N2PF.                               
