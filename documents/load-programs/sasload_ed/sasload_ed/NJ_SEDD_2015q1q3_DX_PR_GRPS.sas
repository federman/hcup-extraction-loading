...
*   NJ_SEDD_2015q1q3_DX_PR_GRPS.SAS:                                            
...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SEDDC_2015q1q3_DX_PR_GRPS;                                              
INFILE 'NJ_SEDD_2015q1q3_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 853;                
...
INPUT                                                                           
      ...
      @497    INJURY                        N2PF.                               
      @499    INJURY_CUT                    N2PF.                               
      @501    INJURY_DROWN                  N2PF.                               
      @503    INJURY_FALL                   N2PF.                               
      @505    INJURY_FIRE                   N2PF.                               
      @507    INJURY_FIREARM                N2PF.                               
      @509    INJURY_MACHINERY              N2PF.                               
      @511    INJURY_MVT                    N2PF.                               
      @513    INJURY_NATURE                 N2PF.                               
      @515    INJURY_POISON                 N2PF.                               
      @517    INJURY_STRUCK                 N2PF.                               
      @519    INJURY_SUFFOCATION            N2PF.                               
      @521    INTENT_ASSAULT                N2PF.                               
      @523    INTENT_SELF_HARM              N2PF.                               
      @525    INTENT_UNINTENTIONAL          N2PF.                               
      @527    KEY                           15.                                 
      @542    MULTINJURY                    N2PF.                               
      @544    PCLASS1                       N2PF.                               
      @546    PCLASS2                       N2PF.                               
      ...
      @840    U_PACEMAKER                   N2PF.                               
      @842    U_PHYTHERAPY                  N2PF.                               
      @844    U_RADTHERAPY                  N2PF.                               
      @846    U_RESPTHERAPY                 N2PF.                               
      @848    U_SPEECHTHERAPY               N2PF.                               
      @850    U_STRESS                      N2PF.                               
      @852    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
