...
*  Data Step                  *;                                                
*******************************;                                                
DATA KY_SEDDC_2021_CORE;                                                        
INFILE 'KY_SEDD_2021_CORE.ASC' FIRSTOBS=3 LRECL = 3463;                         
...
INPUT                                                                           
      ...
      @3022   DISP_X                        $CHAR2.                             
      @3024   DISPUB04                      N2PF.                               
      @3026   DISPUNIFORM                   N2PF.                               
      @3028   DMONTH                        N2PF.                               
      @3030   DQTR                          N2PF.                               
      @3032   DSHOSPID                      $CHAR17.                            
      @3049   FEMALE                        N2PF.                               
      @3051   HCUP_ED                       N2PF.                               
      @3053   HCUP_OS                       N2PF.                               
      @3055   HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @3060   HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @3065   HISPANIC                      N2PF.                               
      @3067   HISPANIC_X                    $CHAR2.                             
      @3069   HOSP_NPI                      $CHAR10.                            
      @3079   HOSPST                        $CHAR2.                             
      @3081   I10_DX_Visit_Reason1          $CHAR7.                             
      @3088   I10_DX_Visit_Reason2          $CHAR7.                             
      @3095   I10_DX_Visit_Reason3          $CHAR7.                             
      @3102   I10_DX1                       $CHAR7.                             
      @3109   I10_DX2                       $CHAR7.                             
      @3116   I10_DX3                       $CHAR7.                             
      @3123   I10_DX4                       $CHAR7.                             
      ...
      @3373   PL_RUCC                       N2PF.                               
      @3375   PL_UIC                        N2PF.                               
      @3377   PL_UR_CAT4                    N2PF.                               
      @3379   PointOfOrigin_X               $CHAR1.                             
      @3380   PointOfOriginUB04             $CHAR1.                             
      @3381   PSTATE                        $CHAR2.                             
      @3383   PSTATE_GEO                    $CHAR2.                             
      @3385   PSTCO                         N5PF.                               
      @3390   PSTCO_GEO                     N5PF.                               
      @3395   RACE                          N2PF.                               
      @3397   RACE_PCT_MISS_HOSP            N7P2F.                              
      @3404   RACE_X                        $CHAR2.                             
      @3406   SASD_SEDD                     N2PF.                               
      @3408   STATE_AS                      N2PF.                               
      @3410   STATE_ED                      N2PF.                               
      @3412   STATE_OS                      N2PF.                               
      @3414   TOTCHG                        N10PF.                              
      @3424   TOTCHG_X                      N15P2F.                             
      @3439   YEAR                          N4PF.                               
      @3443   ZIP                           $CHAR5.                             
      @3448   ZIP3                          $CHAR3.                             
      @3451   ZIPINC_QRTL                   N3PF.                               
      @3454   AYEAR                         N4PF.                               
      @3458   BMONTH                        N2PF.                               
      @3460   BYEAR                         N4PF.                               
      ;                                                                         
