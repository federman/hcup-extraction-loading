...
*  Data Step                  *;                                                
*******************************;                                                
DATA NY_SEDDC_2014_CORE;                                                        
INFILE 'NY_SEDD_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1397;                         
...
INPUT                                                                           
      ...
      @1085   DXCCS25                       N4PF.                               
      @1089   DXVER                         N3PF.                               
      @1092   DX_Visit_Reason1              $CHAR7.                             
      @1099   DaysToEvent                   N6PF.                               
      @1105   ECODE1                        $CHAR7.                             
      @1112   ECODE2                        $CHAR7.                             
      @1119   ECODE3                        $CHAR7.                             
      @1126   ECODE4                        $CHAR7.                             
      ...
      @1337   STATE_OS                      N2PF.                               
      @1339   TOTCHG                        N10PF.                              
      @1349   TOTCHG_X                      N15P2F.                             
      @1364   VisitLink                     N9PF.                               
      @1373   YEAR                          N4PF.                               
      @1377   ZIP                           $CHAR5.                             
      @1382   ZIP3                          $CHAR3.                             
      @1385   ZIPINC_QRTL                   N3PF.                               
      @1388   AYEAR                         N4PF.                               
      @1392   BMONTH                        N2PF.                               
      @1394   BYEAR                         N4PF.                               
      ;                                                                         
