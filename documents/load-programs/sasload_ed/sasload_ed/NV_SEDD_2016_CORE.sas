...
*  Data Step                  *;                                                
*******************************;                                                
DATA NV_SEDDC_2016_CORE;                                                        
INFILE 'NV_SEDD_2016_CORE.ASC' FIRSTOBS=3 LRECL = 1236;                         
...
INPUT                                                                           
      ...
      @1013   I10_DX32                      $CHAR7.                             
      @1020   I10_DX33                      $CHAR7.                             
      @1027   I10_ECAUSE1                   $CHAR7.                             
      @1034   I10_ECAUSE2                   $CHAR7.                             
      @1041   I10_ECAUSE3                   $CHAR7.                             
      @1048   I10_ECAUSE4                   $CHAR7.                             
      @1055   I10_ECAUSE5                   $CHAR7.                             
      @1062   I10_ECAUSE6                   $CHAR7.                             
      @1069   I10_ECAUSE7                   $CHAR7.                             
      @1076   I10_ECAUSE8                   $CHAR7.                             
      @1083   I10_NDX                       N3PF.                               
      @1086   I10_NECAUSE                   N2PF.                               
      @1088   I10_PROCTYPE                  N3PF.                               
      @1091   KEY                           15.                                 
      @1106   LOS                           N5PF.                               
      @1111   LOS_X                         N6PF.                               
      @1117   MARITALSTATUS_X               $CHAR1.                             
      @1118   MARITALSTATUSUB04             $CHAR1.                             
      @1119   MDNUM1_R                      N9PF.                               
      @1128   MDNUM2_R                      N9PF.                               
      @1137   MDNUMTYPE1                    $CHAR1.                             
      @1138   MDNUMTYPE2                    $CHAR1.                             
      @1139   MEDINCSTQ                     N2PF.                               
      @1141   NCPT                          N4PF.                               
      @1145   OS_TIME                       N11P2F.                             
      @1156   PAY1                          N2PF.                               
      ...
      @1170   PL_RUCC                       N2PF.                               
      @1172   PL_UIC                        N2PF.                               
      @1174   PL_UR_CAT4                    N2PF.                               
      @1176   PointOfOrigin_X               $CHAR2.                             
      @1178   PointOfOriginUB04             $CHAR1.                             
      @1179   PSTATE                        $CHAR2.                             
      @1181   PSTCO                         N5PF.                               
      @1186   PSTCO2                        N5PF.                               
      @1191   RACE                          N2PF.                               
      ...
      @1199   STATE_OS                      N2PF.                               
      @1201   TOTCHG                        N10PF.                              
      @1211   TOTCHG_X                      N15P2F.                             
      @1226   YEAR                          N4PF.                               
      @1230   ZIPINC_QRTL                   N3PF.                               
      @1233   AYEAR                         N4PF.                               
      ;                                                                         
