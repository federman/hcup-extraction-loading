...
*  Data Step                  *;                                                
*******************************;                                                
DATA WI_SEDDC_2015q4_DX_PR_GRPS;                                                
INFILE 'WI_SEDD_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 1450;                 
...
INPUT                                                                           
      ...
      @850    I10_ECauseMCCS10              $CHAR11.                            
      @861    I10_ECauseMCCS11              $CHAR11.                            
      @872    I10_INJURY                    N2PF.                               
      @874    I10_MULTINJURY                N2PF.                               
      @876    I10_PCLASS1                   N2PF.                               
      @878    I10_PCLASS2                   N2PF.                               
      @880    I10_PCLASS3                   N2PF.                               
      @882    I10_PCLASS4                   N2PF.                               
      @884    I10_PCLASS5                   N2PF.                               
      @886    I10_PCLASS6                   N2PF.                               
      @888    I10_PCLASS7                   N2PF.                               
      @890    I10_PCLASS8                   N2PF.                               
      @892    I10_PCLASS9                   N2PF.                               
      @894    I10_PCLASS10                  N2PF.                               
      @896    I10_PCLASS11                  N2PF.                               
      @898    I10_PCLASS12                  N2PF.                               
      @900    I10_PCLASS13                  N2PF.                               
      @902    I10_PCLASS14                  N2PF.                               
      @904    I10_PCLASS15                  N2PF.                               
      @906    I10_PCLASS16                  N2PF.                               
      @908    I10_PCLASS17                  N2PF.                               
      @910    I10_PCLASS18                  N2PF.                               
      @912    I10_PCLASS19                  N2PF.                               
      @914    I10_PCLASS20                  N2PF.                               
      @916    I10_PCLASS21                  N2PF.                               
      @918    I10_PCLASS22                  N2PF.                               
      @920    I10_PCLASS23                  N2PF.                               
      @922    I10_PCLASS24                  N2PF.                               
      @924    I10_PCLASS25                  N2PF.                               
      @926    I10_PCLASS26                  N2PF.                               
      @928    I10_PCLASS27                  N2PF.                               
      @930    I10_PCLASS28                  N2PF.                               
      @932    I10_PCLASS29                  N2PF.                               
      @934    I10_PCLASS30                  N2PF.                               
      @936    I10_PCLASS31                  N2PF.                               
      @938    I10_PCLASS32                  N2PF.                               
      @940    I10_PCLASS33                  N2PF.                               
      @942    I10_PCLASS34                  N2PF.                               
      @944    I10_PCLASS35                  N2PF.                               
      @946    I10_PCLASS36                  N2PF.                               
      @948    I10_PCLASS37                  N2PF.                               
      @950    I10_PCLASS38                  N2PF.                               
      @952    I10_PCLASS39                  N2PF.                               
      @954    I10_PCLASS40                  N2PF.                               
      @956    I10_PCLASS41                  N2PF.                               
      @958    I10_PCLASS42                  N2PF.                               
      @960    I10_PCLASS43                  N2PF.                               
      @962    I10_PCLASS44                  N2PF.                               
      @964    I10_PCLASS45                  N2PF.                               
      @966    I10_PCLASS46                  N2PF.                               
      @968    I10_PCLASS47                  N2PF.                               
      @970    I10_PCLASS48                  N2PF.                               
      @972    I10_PCLASS49                  N2PF.                               
      @974    I10_PCLASS50                  N2PF.                               
      @976    I10_PRMCCS1                   $CHAR8.                             
      @984    I10_PRMCCS2                   $CHAR8.                             
      @992    I10_PRMCCS3                   $CHAR8.                             
      @1000   I10_PRMCCS4                   $CHAR8.                             
      @1008   I10_PRMCCS5                   $CHAR8.                             
      @1016   I10_PRMCCS6                   $CHAR8.                             
      @1024   I10_PRMCCS7                   $CHAR8.                             
      @1032   I10_PRMCCS8                   $CHAR8.                             
      @1040   I10_PRMCCS9                   $CHAR8.                             
      @1048   I10_PRMCCS10                  $CHAR8.                             
      @1056   I10_PRMCCS11                  $CHAR8.                             
      @1064   I10_PRMCCS12                  $CHAR8.                             
      @1072   I10_PRMCCS13                  $CHAR8.                             
      @1080   I10_PRMCCS14                  $CHAR8.                             
      @1088   I10_PRMCCS15                  $CHAR8.                             
      @1096   I10_PRMCCS16                  $CHAR8.                             
      @1104   I10_PRMCCS17                  $CHAR8.                             
      @1112   I10_PRMCCS18                  $CHAR8.                             
      @1120   I10_PRMCCS19                  $CHAR8.                             
      @1128   I10_PRMCCS20                  $CHAR8.                             
      @1136   I10_PRMCCS21                  $CHAR8.                             
      @1144   I10_PRMCCS22                  $CHAR8.                             
      @1152   I10_PRMCCS23                  $CHAR8.                             
      @1160   I10_PRMCCS24                  $CHAR8.                             
      @1168   I10_PRMCCS25                  $CHAR8.                             
      @1176   I10_PRMCCS26                  $CHAR8.                             
      @1184   I10_PRMCCS27                  $CHAR8.                             
      @1192   I10_PRMCCS28                  $CHAR8.                             
      @1200   I10_PRMCCS29                  $CHAR8.                             
      @1208   I10_PRMCCS30                  $CHAR8.                             
      @1216   I10_PRMCCS31                  $CHAR8.                             
      @1224   I10_PRMCCS32                  $CHAR8.                             
      @1232   I10_PRMCCS33                  $CHAR8.                             
      @1240   I10_PRMCCS34                  $CHAR8.                             
      @1248   I10_PRMCCS35                  $CHAR8.                             
      @1256   I10_PRMCCS36                  $CHAR8.                             
      @1264   I10_PRMCCS37                  $CHAR8.                             
      @1272   I10_PRMCCS38                  $CHAR8.                             
      @1280   I10_PRMCCS39                  $CHAR8.                             
      @1288   I10_PRMCCS40                  $CHAR8.                             
      @1296   I10_PRMCCS41                  $CHAR8.                             
      @1304   I10_PRMCCS42                  $CHAR8.                             
      @1312   I10_PRMCCS43                  $CHAR8.                             
      @1320   I10_PRMCCS44                  $CHAR8.                             
      @1328   I10_PRMCCS45                  $CHAR8.                             
      @1336   I10_PRMCCS46                  $CHAR8.                             
      @1344   I10_PRMCCS47                  $CHAR8.                             
      @1352   I10_PRMCCS48                  $CHAR8.                             
      @1360   I10_PRMCCS49                  $CHAR8.                             
      @1368   I10_PRMCCS50                  $CHAR8.                             
      @1376   I10_U_BLOOD                   N2PF.                               
      @1378   I10_U_CATH                    N2PF.                               
      @1380   I10_U_CTSCAN                  N2PF.                               
      @1382   I10_U_EKG                     N2PF.                               
      @1384   I10_U_MHSA                    N2PF.                               
      @1386   I10_U_MRT                     N2PF.                               
      @1388   I10_U_PACEMAKER               N2PF.                               
      @1390   I10_U_PHYTHERAPY              N2PF.                               
      @1392   I10_U_RADTHERAPY              N2PF.                               
      @1394   I10_U_STRESS                  N2PF.                               
      @1396   KEY                           15.                                 
      @1411   U_CCU                         N2PF.                               
      @1413   U_CHESTXRAY                   N2PF.                               
      @1415   U_DIALYSIS                    N2PF.                               
      @1417   U_ECHO                        N2PF.                               
      @1419   U_ED                          N2PF.                               
      @1421   U_EEG                         N2PF.                               
      @1423   U_EPO                         N2PF.                               
      @1425   U_ICU                         N2PF.                               
      @1427   U_LITHOTRIPSY                 N2PF.                               
      @1429   U_NEWBN2L                     N2PF.                               
      @1431   U_NEWBN3L                     N2PF.                               
      @1433   U_NEWBN4L                     N2PF.                               
      @1435   U_NUCMED                      N2PF.                               
      @1437   U_OBSERVATION                 N2PF.                               
      @1439   U_OCCTHERAPY                  N2PF.                               
      @1441   U_ORGANACQ                    N2PF.                               
      @1443   U_OTHIMPLANTS                 N2PF.                               
      @1445   U_RESPTHERAPY                 N2PF.                               
      @1447   U_SPEECHTHERAPY               N2PF.                               
      @1449   U_ULTRASOUND                  N2PF.                               
      ;                                                                         
