...
*  Data Step                  *;                                                
*******************************;                                                
DATA NV_SEDDC_2019_CORE;                                                        
INFILE 'NV_SEDD_2019_CORE.ASC' FIRSTOBS=3 LRECL = 1177;                         
...
INPUT                                                                           
      ...
      @1017   I10_DX33                      $CHAR7.                             
      @1024   I10_NDX                       N3PF.                               
      @1027   I10_PROCTYPE                  N3PF.                               
      @1030   KEY                           15.                                 
      @1045   LOS                           N5PF.                               
      @1050   LOS_X                         N6PF.                               
      @1056   MARITALSTATUSUB04             $CHAR1.                             
      @1057   MARITALSTATUS_X               $CHAR1.                             
      @1058   MDNUM1_R                      N9PF.                               
      @1067   MDNUM2_R                      N9PF.                               
      @1076   MDNUMTYPE1                    $CHAR1.                             
      @1077   MDNUMTYPE2                    $CHAR1.                             
      @1078   MEDINCSTQ                     N2PF.                               
      @1080   NCPT                          N4PF.                               
      @1084   OS_TIME                       N11P2F.                             
      @1095   PAY1                          N2PF.                               
      ...
      @1140   STATE_OS                      N2PF.                               
      @1142   TOTCHG                        N10PF.                              
      @1152   TOTCHG_X                      N15P2F.                             
      @1167   YEAR                          N4PF.                               
      @1171   ZIPINC_QRTL                   N3PF.                               
      @1174   AYEAR                         N4PF.                               
      ;                                                                         
