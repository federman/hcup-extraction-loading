...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SEDDC_2014_DX_PR_GRPS;                                                  
INFILE 'NJ_SEDD_2014_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 799;                    
...
INPUT                                                                           
      ...
      @493    INJURY                        N2PF.                               
      @495    INJURY_CUT                    N2PF.                               
      @497    INJURY_DROWN                  N2PF.                               
      @499    INJURY_FALL                   N2PF.                               
      @501    INJURY_FIRE                   N2PF.                               
      @503    INJURY_FIREARM                N2PF.                               
      @505    INJURY_MACHINERY              N2PF.                               
      @507    INJURY_MVT                    N2PF.                               
      @509    INJURY_NATURE                 N2PF.                               
      @511    INJURY_POISON                 N2PF.                               
      @513    INJURY_STRUCK                 N2PF.                               
      @515    INJURY_SUFFOCATION            N2PF.                               
      @517    INTENT_ASSAULT                N2PF.                               
      @519    INTENT_SELF_HARM              N2PF.                               
      @521    INTENT_UNINTENTIONAL          N2PF.                               
      @523    KEY                           15.                                 
      @538    MULTINJURY                    N2PF.                               
      @540    PCLASS1                       N2PF.                               
      @542    PCLASS2                       N2PF.                               
      ...
      @774    U_NEWBN4L                     N2PF.                               
      @776    U_NUCMED                      N2PF.                               
      @778    U_OBSERVATION                 N2PF.                               
      @780    U_OCCTHERAPY                  N2PF.                               
      @782    U_ORGANACQ                    N2PF.                               
      @784    U_OTHIMPLANTS                 N2PF.                               
      @786    U_PACEMAKER                   N2PF.                               
      @788    U_PHYTHERAPY                  N2PF.                               
      @790    U_RADTHERAPY                  N2PF.                               
      @792    U_RESPTHERAPY                 N2PF.                               
      @794    U_SPEECHTHERAPY               N2PF.                               
      @796    U_STRESS                      N2PF.                               
      @798    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
