...
*  Data Step                  *;                                                
*******************************;                                                
DATA IA_SEDDC_2018_CORE;                                                        
INFILE 'IA_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 2178;                         
...
INPUT                                                                           
      ...
      @1516   DaysToEvent                   N6PF.                               
      @1522   DIED                          N2PF.                               
      @1524   DISP_X                        $CHAR2.                             
      @1526   DISPUB04                      N2PF.                               
      @1528   DISPUNIFORM                   N2PF.                               
      @1530   DMONTH                        N2PF.                               
      @1532   DQTR                          N2PF.                               
      @1534   FEMALE                        N2PF.                               
      @1536   HCUP_ED                       N2PF.                               
      @1538   HCUP_OS                       N2PF.                               
      @1540   HISPANIC                      N2PF.                               
      @1542   HISPANIC_X                    $CHAR1.                             
      @1543   HOSPST                        $CHAR2.                             
      @1545   I10_DX_Visit_Reason1          $CHAR7.                             
      @1552   I10_DX_Visit_Reason2          $CHAR7.                             
      @1559   I10_DX_Visit_Reason3          $CHAR7.                             
      @1566   I10_DX1                       $CHAR7.                             
      @1573   I10_DX2                       $CHAR7.                             
      @1580   I10_DX3                       $CHAR7.                             
      @1587   I10_DX4                       $CHAR7.                             
      ...
      @2085   PL_RUCC                       N2PF.                               
      @2087   PL_UIC                        N2PF.                               
      @2089   PL_UR_CAT4                    N2PF.                               
      @2091   PointOfOrigin_X               $CHAR1.                             
      @2092   PointOfOriginUB04             $CHAR1.                             
      @2093   PrimLang                      $CHAR3.                             
      @2096   PSTATE                        $CHAR2.                             
      @2098   PSTCO                         N5PF.                               
      @2103   PSTCO2                        N5PF.                               
      ...
      @2118   STATE_OS                      N2PF.                               
      @2120   TOTCHG                        N10PF.                              
      @2130   TOTCHG_X                      N15P2F.                             
      @2145   VisitLink                     N9PF.                               
      @2154   YEAR                          N4PF.                               
      @2158   ZIP                           $CHAR5.                             
      @2163   ZIP3                          $CHAR3.                             
      @2166   ZIPINC_QRTL                   N3PF.                               
      @2169   AYEAR                         N4PF.                               
      @2173   BMONTH                        N2PF.                               
      @2175   BYEAR                         N4PF.                               
      ;                                                                         
