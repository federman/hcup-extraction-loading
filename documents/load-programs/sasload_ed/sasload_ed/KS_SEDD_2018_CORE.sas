...
*  Data Step                  *;                                                
*******************************;                                                
DATA KS_SEDDC_2018_CORE;                                                        
INFILE 'KS_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 2044;                         
...
INPUT                                                                           
      ...
      @1885   I10_PR17                      $CHAR7.                             
      @1892   I10_PR18                      $CHAR7.                             
      @1899   I10_PROCTYPE                  N3PF.                               
      @1902   KEY                           15.                                 
      @1917   LOS                           N5PF.                               
      @1922   LOS_X                         N6PF.                               
      @1928   MEDINCSTQ                     N2PF.                               
      @1930   NCPT                          N4PF.                               
      @1934   OPservice                     $CHAR1.                             
      @1935   OS_TIME                       N11P2F.                             
      @1946   PAY1                          N2PF.                               
      @1948   PAY1_X                        $CHAR3.                             
      @1951   PAY2                          N2PF.                               
      ...
      @1966   PL_RUCC                       N2PF.                               
      @1968   PL_UIC                        N2PF.                               
      @1970   PL_UR_CAT4                    N2PF.                               
      @1972   PointOfOrigin_X               $CHAR1.                             
      @1973   PointOfOriginUB04             $CHAR1.                             
      @1974   PSTATE                        $CHAR2.                             
      @1976   PSTCO                         N5PF.                               
      @1981   PSTCO2                        N5PF.                               
      @1986   RACE                          N2PF.                               
      ...
      @1993   STATE_OS                      N2PF.                               
      @1995   TOTCHG                        N10PF.                              
      @2005   TOTCHG_X                      N15P2F.                             
      @2020   YEAR                          N4PF.                               
      @2024   ZIP3                          $CHAR3.                             
      @2027   ZIPINC_QRTL                   N3PF.                               
      @2030   HOSPID                        N5PF.                               
      @2035   AYEAR                         N4PF.                               
      @2039   BMONTH                        N2PF.                               
      @2041   BYEAR                         N4PF.                               
