...
*  Data Step                  *;                                                
*******************************;                                                
DATA KS_SEDDC_2014_DX_PR_GRPS;                                                  
INFILE 'KS_SEDD_2014_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 1060;                   
...
ATTRIB                                                                          
  ...
  E_MCCS19                   LENGTH=$11                                         
  LABEL="Multi-Level CCS:  E Code 19"                                           
                                                                                
  E_MCCS20                   LENGTH=$11                                         
  LABEL="Multi-Level CCS:  E Code 20"                                           
                                                                                
  E_MCCS21                   LENGTH=$11                                         
  LABEL="Multi-Level CCS:  E Code 21"                                           
                                                                                
  E_MCCS22                   LENGTH=$11                                         
  LABEL="Multi-Level CCS:  E Code 22"                                           
                                                                                
  E_MCCS23                   LENGTH=$11                                         
  LABEL="Multi-Level CCS:  E Code 23"                                           
...
INPUT                                                                           
      ...
      @704    INJURY                        N2PF.                               
      @706    INJURY_CUT                    N2PF.                               
      @708    INJURY_DROWN                  N2PF.                               
      @710    INJURY_FALL                   N2PF.                               
      @712    INJURY_FIRE                   N2PF.                               
      @714    INJURY_FIREARM                N2PF.                               
      @716    INJURY_MACHINERY              N2PF.                               
      @718    INJURY_MVT                    N2PF.                               
      @720    INJURY_NATURE                 N2PF.                               
      @722    INJURY_POISON                 N2PF.                               
      @724    INJURY_STRUCK                 N2PF.                               
      @726    INJURY_SUFFOCATION            N2PF.                               
      @728    INTENT_ASSAULT                N2PF.                               
      @730    INTENT_SELF_HARM              N2PF.                               
      @732    INTENT_UNINTENTIONAL          N2PF.                               
      @734    KEY                           15.                                 
      @749    MULTINJURY                    N2PF.                               
      @751    PCLASS1                       N2PF.                               
      @753    PCLASS2                       N2PF.                               
      ...
      @1003   U_CATH                        N2PF.                               
      @1005   U_CCU                         N2PF.                               
      @1007   U_CHESTXRAY                   N2PF.                               
      @1009   U_CTSCAN                      N2PF.                               
      @1011   U_DIALYSIS                    N2PF.                               
      @1013   U_ECHO                        N2PF.                               
      @1015   U_ED                          N2PF.                               
      @1017   U_EEG                         N2PF.                               
      @1019   U_EKG                         N2PF.                               
      ...
      @1035   U_NEWBN4L                     N2PF.                               
      @1037   U_NUCMED                      N2PF.                               
      @1039   U_OBSERVATION                 N2PF.                               
      @1041   U_OCCTHERAPY                  N2PF.                               
      @1043   U_ORGANACQ                    N2PF.                               
      @1045   U_OTHIMPLANTS                 N2PF.                               
      @1047   U_PACEMAKER                   N2PF.                               
      @1049   U_PHYTHERAPY                  N2PF.                               
      @1051   U_RADTHERAPY                  N2PF.                               
      @1053   U_RESPTHERAPY                 N2PF.                               
      @1055   U_SPEECHTHERAPY               N2PF.                               
      @1057   U_STRESS                      N2PF.                               
      @1059   U_ULTRASOUND                  N2PF.                               
      ;                                                                         
