...
*  Data Step                  *;                                                
*******************************;                                                
DATA NE_SEDDC_2018_CORE;                                                        
INFILE 'NE_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 1929;                         
...
INPUT                                                                           
      ...
      @1556   HCUP_OS                       N2PF.                               
      @1558   HOSPST                        $CHAR2.                             
      @1560   I10_DX_Visit_Reason1          $CHAR7.                             
      @1567   I10_DX1                       $CHAR7.                             
      @1574   I10_DX2                       $CHAR7.                             
      @1581   I10_DX3                       $CHAR7.                             
      @1588   I10_DX4                       $CHAR7.                             
      ...
      @1815   PL_RUCC                       N2PF.                               
      @1817   PL_UIC                        N2PF.                               
      @1819   PL_UR_CAT4                    N2PF.                               
      @1821   PointOfOrigin_X               $CHAR1.                             
      @1822   PointOfOriginUB04             $CHAR1.                             
      @1823   PSTATE                        $CHAR2.                             
      @1825   PSTCO                         N5PF.                               
      @1830   PSTCO2                        N5PF.                               
      @1835   STATE_AS                      N2PF.                               
      ...
      @1839   STATE_OS                      N2PF.                               
      @1841   TOTCHG                        N10PF.                              
      @1851   TOTCHG_X                      N15P2F.                             
      @1866   VisitLink                     N9PF.                               
      @1875   YEAR                          N4PF.                               
      @1879   ZIP                           $CHAR5.                             
      @1884   ZIP3                          $CHAR3.                             
      @1887   ZIPINC_QRTL                   N3PF.                               
      @1890   TOWN                          $CHAR30.                            
      @1920   AYEAR                         N4PF.                               
      @1924   BMONTH                        N2PF.                               
      @1926   BYEAR                         N4PF.                               
