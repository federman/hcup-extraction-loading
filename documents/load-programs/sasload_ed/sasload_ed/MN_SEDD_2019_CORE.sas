...
*  Data Step                  *;                                                
*******************************;                                                
DATA MN_SEDDC_2019_CORE;                                                        
INFILE 'MN_SEDD_2019_CORE.ASC' FIRSTOBS=3 LRECL = 2199;                         
...
INPUT                                                                           
      ...
      @1518   CPTM2_98                      $CHAR2.                             
      @1520   CPTM2_99                      $CHAR2.                             
      @1522   CPTM2_100                     $CHAR2.                             
      @1524   DHOUR                         N4PF.                               
      @1528   DIED                          N2PF.                               
      @1530   DISPUB04                      N2PF.                               
      @1532   DISPUNIFORM                   N2PF.                               
      @1534   DISP_X                        $CHAR2.                             
      @1536   DMONTH                        N2PF.                               
      @1538   DQTR                          N2PF.                               
      @1540   DURATION                      N6PF.                               
      ...
      @1856   I10_DX38                      $CHAR7.                             
      @1863   I10_DX39                      $CHAR7.                             
      @1870   I10_DX_Visit_Reason1          $CHAR7.                             
      @1877   I10_NDX                       N3PF.                               
      @1880   I10_NPR                       N3PF.                               
      @1883   I10_ORPROC                    N2PF.                               
      @1885   I10_PR1                       $CHAR7.                             
      @1892   I10_PR2                       $CHAR7.                             
      @1899   I10_PR3                       $CHAR7.                             
      @1906   I10_PR4                       $CHAR7.                             
      ...
      @2018   PL_RUCC                       N2PF.                               
      @2020   PL_UIC                        N2PF.                               
      @2022   PL_UR_CAT4                    N2PF.                               
      @2024   POA_Disch_Edit1               N2PF.                               
      @2026   POA_Disch_Edit2               N2PF.                               
      @2028   POA_Hosp_Edit1                N2PF.                               
      @2030   POA_Hosp_Edit2                N2PF.                               
      @2032   POA_Hosp_Edit3                N2PF.                               
      @2034   POA_Hosp_Edit3_Value          N8P2F.                              
      @2042   PRDAY1                        N5PF.                               
      @2047   PRDAY2                        N5PF.                               
      @2052   PRDAY3                        N5PF.                               
      @2057   PRDAY4                        N5PF.                               
      ...
      @2067   PRDAY6                        N5PF.                               
      @2072   PSTATE                        $CHAR2.                             
      @2074   PSTATE_GEO                    $CHAR2.                             
      @2076   PSTCO_GEO                     N5PF.                               
      @2081   PointOfOriginUB04             $CHAR1.                             
      @2082   PointOfOrigin_X               $CHAR1.                             
      @2083   PrimLang                      $CHAR3.                             
      @2086   RACE                          N2PF.                               
      @2088   RACE_X                        $CHAR20.                            
      @2108   STATE_AS                      N2PF.                               
      ...
      @2112   STATE_OS                      N2PF.                               
      @2114   TOTCHG                        N10PF.                              
      @2124   TOTCHG_X                      N15P2F.                             
      @2139   YEAR                          N4PF.                               
      @2143   ZIP                           $CHAR5.                             
      @2148   ZIP3                          $CHAR3.                             
      @2151   ZIPINC_QRTL                   N3PF.                               
      @2154   AYEAR                         N4PF.                               
      @2158   BMONTH                        N2PF.                               
      @2160   BYEAR                         N4PF.                               
      @2164   PRMONTH1                      N2PF.                               
