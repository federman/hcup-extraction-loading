...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SEDDC_2021_CORE;                                                        
INFILE 'MD_SEDD_2021_CORE.ASC' FIRSTOBS=3 LRECL = 1277;                         
...
INPUT                                                                           
      ...
      @1065   I10_DX58                      $CHAR7.                             
      @1072   I10_NDX                       N3PF.                               
      @1075   I10_PROCTYPE                  N3PF.                               
      @1078   KEY                           15.                                 
      @1093   LOS                           N5PF.                               
      @1098   LOS_X                         N6PF.                               
      @1104   MARITALSTATUS_X               $CHAR1.                             
      @1105   MARITALSTATUSUB04             $CHAR1.                             
      @1106   MDNUM1_R                      N9PF.                               
      @1115   MDNUM2_R                      N9PF.                               
      @1124   MEDINCSTQ                     N2PF.                               
      @1126   MRN_R                         N9PF.                               
      @1135   NCPT                          N4PF.                               
      @1139   OPservice                     $CHAR2.                             
      @1141   OS_TIME                       N11P2F.                             
      @1152   PAY1                          N2PF.                               
      @1154   PAY1_X                        $CHAR2.                             
      @1156   PAY2                          N2PF.                               
      ...
      @1178   PL_RUCC                       N2PF.                               
      @1180   PL_UIC                        N2PF.                               
      @1182   PL_UR_CAT4                    N2PF.                               
      @1184   PointOfOrigin_X               $CHAR2.                             
      @1186   PointOfOriginUB04             $CHAR1.                             
      @1187   PrimLang                      $CHAR3.                             
      @1190   PSTATE                        $CHAR2.                             
      @1192   PSTATE_GEO                    $CHAR2.                             
      @1194   PSTCO                         N5PF.                               
      @1199   PSTCO_GEO                     N5PF.                               
      @1204   RACE                          N2PF.                               
      @1206   RACE_PCT_MISS_HOSP            N7P2F.                              
      @1213   RACE_X                        $CHAR1.                             
      @1214   SASD_SEDD                     N2PF.                               
      @1216   SpannedServiceCount           N3PF.                               
      @1219   STATE_AS                      N2PF.                               
      @1221   STATE_ED                      N2PF.                               
      @1223   STATE_OS                      N2PF.                               
      @1225   TOTCHG                        N10PF.                              
      @1235   TOTCHG_X                      N15P2F.                             
      @1250   VisitLink                     N9PF.                               
      @1259   YEAR                          N4PF.                               
      @1263   ZIP                           $CHAR5.                             
      @1268   ZIP3                          $CHAR3.                             
