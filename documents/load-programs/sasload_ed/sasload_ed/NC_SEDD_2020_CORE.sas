...
*  Data Step                  *;                                                
*******************************;                                                
DATA NC_SEDDC_2020_CORE;                                                        
INFILE 'NC_SEDD_2020_CORE.ASC' FIRSTOBS=3 LRECL = 634;                          
...
INPUT                                                                           
      ...
      @254    HCUP_ED                       N2PF.                               
      @256    HCUP_OS                       N2PF.                               
      @258    HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @263    HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @268    HISPANIC                      N2PF.                               
      @270    HISPANIC_X                    $CHAR3.                             
      @273    HOSPST                        $CHAR2.                             
      @275    I10_DX_Visit_Reason1          $CHAR7.                             
      @282    I10_DX1                       $CHAR7.                             
      @289    I10_DX2                       $CHAR7.                             
      @296    I10_DX3                       $CHAR7.                             
      @303    I10_DX4                       $CHAR7.                             
      ...
      @534    PL_UIC                        N2PF.                               
      @536    PL_UR_CAT4                    N2PF.                               
      @538    POA_Disch_Edit1               N2PF.                               
      @540    POA_Disch_Edit2               N2PF.                               
      @542    POA_Hosp_Edit1                N2PF.                               
      @544    POA_Hosp_Edit2                N2PF.                               
      @546    POA_Hosp_Edit3                N2PF.                               
      @548    POA_Hosp_Edit3_Value          N8P2F.                              
      @556    PointOfOrigin_X               $CHAR3.                             
      @559    PointOfOriginUB04             $CHAR1.                             
      @560    PSTATE                        $CHAR2.                             
      @562    PSTATE_GEO                    $CHAR2.                             
      @564    PSTCO                         N5PF.                               
      @569    PSTCO_GEO                     N5PF.                               
      @574    RACE                          N2PF.                               
      @576    RACE_X                        $CHAR3.                             
