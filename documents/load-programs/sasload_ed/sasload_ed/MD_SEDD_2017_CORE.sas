...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SEDDC_2017_CORE;                                                        
INFILE 'MD_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1041;                         
...
INPUT                                                                           
      ...
      @866    I10_DX30                      $CHAR7.                             
      @873    I10_NDX                       N3PF.                               
      @876    I10_PROCTYPE                  N3PF.                               
      @879    KEY                           15.                                 
      @894    LOS                           N5PF.                               
      @899    LOS_X                         N6PF.                               
      @905    MARITALSTATUS_X               $CHAR1.                             
      @906    MARITALSTATUSUB04             $CHAR1.                             
      @907    MDNUM1_R                      N9PF.                               
      @916    MEDINCSTQ                     N2PF.                               
      @918    MRN_R                         N9PF.                               
      @927    NCPT                          N4PF.                               
      ...
      @982    RACE                          N2PF.                               
      @984    RACE_X                        $CHAR1.                             
      @985    SpannedServiceCount           N3PF.                               
      @988    STATE_AS                      N2PF.                               
      @990    STATE_ED                      N2PF.                               
      @992    STATE_OS                      N2PF.                               
      @994    TOTCHG                        N10PF.                              
      @1004   TOTCHG_X                      N15P2F.                             
      @1019   VisitLink                     N9PF.                               
      @1028   YEAR                          N4PF.                               
      @1032   ZIP3                          $CHAR3.                             
      @1035   ZIPINC_QRTL                   N3PF.                               
      @1038   AYEAR                         N4PF.                               
      ;                                                                         
