...
*  Data Step                  *;                                                
*******************************;                                                
DATA MN_SEDDC_2018_CORE;                                                        
INFILE 'MN_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 2231;                         
...
INPUT                                                                           
      ...
      @1580   HCUP_OS                       N2PF.                               
      @1582   HISPANIC                      N2PF.                               
      @1584   HISPANIC_X                    $CHAR20.                            
      @1604   HOSPST                        $CHAR2.                             
      @1606   I10_DX_Visit_Reason1          $CHAR7.                             
      @1613   I10_DX1                       $CHAR7.                             
      @1620   I10_DX2                       $CHAR7.                             
      @1627   I10_DX3                       $CHAR7.                             
      @1634   I10_DX4                       $CHAR7.                             
      ...
      @1997   PL_RUCC                       N2PF.                               
      @1999   PL_UIC                        N2PF.                               
      @2001   PL_UR_CAT4                    N2PF.                               
      @2003   POA_Disch_Edit1               N2PF.                               
      @2005   POA_Disch_Edit2               N2PF.                               
      @2007   POA_Hosp_Edit1                N2PF.                               
      @2009   POA_Hosp_Edit2                N2PF.                               
      @2011   POA_Hosp_Edit3                N2PF.                               
      @2013   POA_Hosp_Edit3_Value          N8P2F.                              
      @2021   PointOfOrigin_X               $CHAR1.                             
      @2022   PointOfOriginUB04             $CHAR1.                             
      @2023   PRDAY1                        N5PF.                               
      @2028   PRDAY2                        N5PF.                               
      @2033   PRDAY3                        N5PF.                               
      @2038   PRDAY4                        N5PF.                               
      ...
      @2114   STATE_OS                      N2PF.                               
      @2116   TOTCHG                        N10PF.                              
      @2126   TOTCHG_X                      N15P2F.                             
      @2141   YEAR                          N4PF.                               
      @2145   ZIP                           $CHAR5.                             
      @2150   ZIP3                          $CHAR3.                             
      @2153   ZIPINC_QRTL                   N3PF.                               
      @2156   AYEAR                         N4PF.                               
      @2160   BMONTH                        N2PF.                               
      @2162   BYEAR                         N4PF.                               
      @2166   PRMONTH1                      N2PF.                               
