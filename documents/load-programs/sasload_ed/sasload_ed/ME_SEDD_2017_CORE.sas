...
*  Data Step                  *;                                                
*******************************;                                                
DATA ME_SEDDC_2017_CORE;                                                        
INFILE 'ME_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1144;                         
...
INPUT                                                                           
      ...
      @1098   PL_NCHS                       N2PF.                               
      @1100   PL_UIC                        N2PF.                               
      @1102   PL_UR_CAT4                    N2PF.                               
      @1104   PointOfOriginUB04             $CHAR1.                             
      @1105   PSTATE                        $CHAR2.                             
      @1107   PSTCO                         N5PF.                               
      @1112   PSTCO2                        N5PF.                               
      @1117   STATE_AS                      N2PF.                               
