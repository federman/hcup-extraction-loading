...
*  Data Step                  *;                                                
*******************************;                                                
DATA CO_SEDDC_2017_CORE;                                                        
INFILE 'CO_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1789;                         
...
INPUT                                                                           
      ...
      @1307   CPTM1_98                      $CHAR2.                             
      @1309   CPTM1_99                      $CHAR2.                             
      @1311   CPTM1_100                     $CHAR2.                             
      @1313   DIED                          N2PF.                               
      @1315   DISP_X                        $CHAR2.                             
      @1317   DISPUB04                      N2PF.                               
      @1319   DISPUNIFORM                   N2PF.                               
      @1321   DMONTH                        N2PF.                               
      @1323   DQTR                          N2PF.                               
      @1325   DXVER                         N3PF.                               
      @1328   FEMALE                        N2PF.                               
      ...
      @1334   Homeless                      N2PF.                               
      @1336   HOSPST                        $CHAR2.                             
      @1338   I10_DX_Visit_Reason1          $CHAR7.                             
      @1345   I10_DX_Visit_Reason2          $CHAR7.                             
      @1352   I10_DX_Visit_Reason3          $CHAR7.                             
      @1359   I10_DX1                       $CHAR7.                             
      @1366   I10_DX2                       $CHAR7.                             
      @1373   I10_DX3                       $CHAR7.                             
      @1380   I10_DX4                       $CHAR7.                             
      ...
      @1689   PL_RUCC                       N2PF.                               
      @1691   PL_UIC                        N2PF.                               
      @1693   PL_UR_CAT4                    N2PF.                               
      @1695   PointOfOrigin_X               $CHAR1.                             
      @1696   PointOfOriginUB04             $CHAR1.                             
      @1697   PSTATE                        $CHAR2.                             
      @1699   PSTCO                         N5PF.                               
      @1704   PSTCO2                        N5PF.                               
      @1709   RACE                          N2PF.                               
      ...
      @1730   STATE_OS                      N2PF.                               
      @1732   TOTCHG                        N10PF.                              
      @1742   TOTCHG_X                      N15P2F.                             
      @1757   YEAR                          N4PF.                               
      @1761   ZIP                           $CHAR5.                             
      @1766   ZIP3                          $CHAR3.                             
      @1769   ZIPINC_QRTL                   N3PF.                               
      @1772   SUBSTATE_REGION_X             $CHAR3.                             
      @1775   HOSPID                        N5PF.                               
      @1780   AYEAR                         N4PF.                               
      @1784   BMONTH                        N2PF.                               
      @1786   BYEAR                         N4PF.                               
