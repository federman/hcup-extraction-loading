...
*  Data Step                  *;                                                
*******************************;                                                
DATA IN_SEDDC_2020_CORE;                                                        
INFILE 'IN_SEDD_2020_CORE.ASC' FIRSTOBS=3 LRECL = 1522;                         
...
INPUT                                                                           
      ...
      @494    CPTCCS59                      N3PF.                               
      @497    CPTCCS60                      N3PF.                               
      @500    DaysToEvent                   N6PF.                               
      @506    DIED                          N2PF.                               
      @508    DISP_X                        $CHAR2.                             
      @510    DISPUB04                      N2PF.                               
      @512    DISPUNIFORM                   N2PF.                               
      @514    DMONTH                        N2PF.                               
      @516    DQTR                          N2PF.                               
      @518    DXPOA1                        $CHAR1.                             
      @519    DXPOA2                        $CHAR1.                             
      ...
      @580    HCUP_ED                       N2PF.                               
      @582    HCUP_OS                       N2PF.                               
      @584    HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @589    HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @594    HISPANIC                      N2PF.                               
      @596    HISPANIC_X                    $CHAR1.                             
      @597    HOSPST                        $CHAR2.                             
      @599    I10_DX_Visit_Reason1          $CHAR7.                             
      @606    I10_DX1                       $CHAR7.                             
      @613    I10_DX2                       $CHAR7.                             
      @620    I10_DX3                       $CHAR7.                             
      @627    I10_DX4                       $CHAR7.                             
      ...
      @1204   PL_RUCC                       N2PF.                               
      @1206   PL_UIC                        N2PF.                               
      @1208   PL_UR_CAT4                    N2PF.                               
      @1210   POA_Disch_Edit1               N2PF.                               
      @1212   POA_Disch_Edit2               N2PF.                               
      @1214   POA_Hosp_Edit1                N2PF.                               
      @1216   POA_Hosp_Edit2                N2PF.                               
      @1218   POA_Hosp_Edit3                N2PF.                               
      @1220   POA_Hosp_Edit3_Value          N8P2F.                              
      @1228   PointOfOrigin_X               $CHAR2.                             
      @1230   PointOfOriginUB04             $CHAR1.                             
      @1231   PRDAY1                        N5PF.                               
      @1236   PRDAY2                        N5PF.                               
      @1241   PRDAY3                        N5PF.                               
      @1246   PRDAY4                        N5PF.                               
      ...
      @1349   STATE_OS                      N2PF.                               
      @1351   TOTCHG                        N10PF.                              
      @1361   TOTCHG_X                      N15P2F.                             
      @1376   VisitLink                     N9PF.                               
      @1385   YEAR                          N4PF.                               
      @1389   ZIP                           $CHAR5.                             
      @1394   ZIP3                          $CHAR3.                             
      @1397   ZIPINC_QRTL                   N3PF.                               
      @1400   HOSPID                        N5PF.                               
      @1405   AYEAR                         N4PF.                               
      @1409   BMONTH                        N2PF.                               
      @1411   BYEAR                         N4PF.                               
