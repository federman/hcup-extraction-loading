...
*  Data Step                  *;                                                
*******************************;                                                
DATA AZ_SEDDC_2010_CORE;                                                        
INFILE 'AZ_SEDD_2010_CORE.ASC' LRECL = 900;                                     
...
INPUT                                                                           
      ...
      @760    PSTATE                   $CHAR2.                                  
      @762    PSTCO2                   N5PF.                                    
      @767    PointOfOriginUB04        $CHAR1.                                  
      @768    PointOfOrigin_X          $CHAR1.                                  
      @769    RACE                     N2PF.                                    
      @771    RACE_X                   $CHAR4.                                  
      @775    SPLIT_IPED               N2PF.                                    
      @777    STATE_AS                 N2PF.                                    
