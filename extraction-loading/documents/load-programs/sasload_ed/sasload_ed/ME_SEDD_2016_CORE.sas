...
*  Data Step                  *;                                                
*******************************;                                                
DATA ME_SEDDC_2016_CORE;                                                        
INFILE 'ME_SEDD_2016_CORE.ASC' FIRSTOBS=3 LRECL = 1146;                         
...
INPUT                                                                           
      ...
      @962    I10_DX24                      $CHAR7.                             
      @969    I10_DX25                      $CHAR7.                             
      @976    I10_ECAUSE1                   $CHAR7.                             
      @983    I10_ECAUSE2                   $CHAR7.                             
      @990    I10_ECAUSE3                   $CHAR7.                             
      @997    I10_ECAUSE4                   $CHAR7.                             
      @1004   I10_ECAUSE5                   $CHAR7.                             
      @1011   I10_ECAUSE6                   $CHAR7.                             
      @1018   I10_ECAUSE7                   $CHAR7.                             
      @1025   I10_ECAUSE8                   $CHAR7.                             
      @1032   I10_NDX                       N3PF.                               
      @1035   I10_NECAUSE                   N2PF.                               
      ...
      @1100   PL_NCHS                       N2PF.                               
      @1102   PL_UIC                        N2PF.                               
      @1104   PL_UR_CAT4                    N2PF.                               
      @1106   PointOfOriginUB04             $CHAR1.                             
      @1107   PSTATE                        $CHAR2.                             
      @1109   PSTCO                         N5PF.                               
      @1114   PSTCO2                        N5PF.                               
      @1119   STATE_AS                      N2PF.                               
