...
*  Data Step                  *;                                                
*******************************;                                                
DATA NE_SEDDC_2020_CORE;                                                        
INFILE 'NE_SEDD_2020_CORE.ASC' FIRSTOBS=3 LRECL = 1962;                         
...
INPUT                                                                           
      ...
      @1524   DaysToEvent                   N6PF.                               
      @1530   DHOUR                         N4PF.                               
      @1534   DIED                          N2PF.                               
      @1536   DISP_X                        $CHAR2.                             
      @1538   DISPUB04                      N2PF.                               
      @1540   DISPUNIFORM                   N2PF.                               
      @1542   DMONTH                        N2PF.                               
      @1544   DQTR                          N2PF.                               
      @1546   DURATION                      N6PF.                               
      @1552   FEMALE                        N2PF.                               
      @1554   HCUP_ED                       N2PF.                               
      @1556   HCUP_OS                       N2PF.                               
      @1558   HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @1563   HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @1568   Homeless                      N2PF.                               
      @1570   HOSPST                        $CHAR2.                             
      @1572   I10_DX_Visit_Reason1          $CHAR7.                             
      @1579   I10_DX_Visit_Reason2          $CHAR7.                             
      @1586   I10_DX_Visit_Reason3          $CHAR7.                             
      @1593   I10_DX1                       $CHAR7.                             
      @1600   I10_DX2                       $CHAR7.                             
      @1607   I10_DX3                       $CHAR7.                             
      @1614   I10_DX4                       $CHAR7.                             
      ...
      @1782   I10_DX28                      $CHAR7.                             
      @1789   I10_NDX                       N3PF.                               
      @1792   I10_PROCTYPE                  N3PF.                               
      @1795   KEY                           15.                                 
      @1810   LOS                           N5PF.                               
      @1815   LOS_X                         N6PF.                               
      @1821   MEDINCSTQ                     N2PF.                               
      @1823   NCPT                          N4PF.                               
      @1827   OPservice                     $CHAR1.                             
      @1828   OS_TIME                       N11P2F.                             
      @1839   PAY1                          N2PF.                               
      @1841   PAY1_X                        $CHAR2.                             
      @1843   PAY2                          N2PF.                               
      ...
      @1856   PL_RUCC                       N2PF.                               
      @1858   PL_UIC                        N2PF.                               
      @1860   PL_UR_CAT4                    N2PF.                               
      @1862   PointOfOrigin_X               $CHAR1.                             
      @1863   PointOfOriginUB04             $CHAR1.                             
      @1864   PSTATE                        $CHAR2.                             
      @1866   PSTATE_GEO                    $CHAR2.                             
      @1868   PSTCO                         N5PF.                               
      @1873   PSTCO_GEO                     N5PF.                               
      @1878   STATE_AS                      N2PF.                               
      @1880   STATE_ED                      N2PF.                               
      @1882   STATE_OS                      N2PF.                               
      @1884   TOTCHG                        N10PF.                              
      @1894   TOTCHG_X                      N15P2F.                             
      @1909   VisitLink                     N9PF.                               
      @1918   YEAR                          N4PF.                               
      @1922   ZIP                           $CHAR5.                             
      @1927   ZIP3                          $CHAR3.                             
      @1930   ZIPINC_QRTL                   N3PF.                               
      @1933   TOWN                          $CHAR20.                            
      @1953   AYEAR                         N4PF.                               
      @1957   BMONTH                        N2PF.                               
      @1959   BYEAR                         N4PF.                               
