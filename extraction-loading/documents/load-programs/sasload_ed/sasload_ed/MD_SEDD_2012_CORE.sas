...
INFILE 'MD_SEDD_2012_CORE.ASC' FIRSTOBS=3 LRECL = 1256;                         
...
INPUT                                                                           
      ...
      @1072   HCUP_ED                       N2PF.                               
      @1074   HCUP_OS                       N2PF.                               
      @1076   HISPANIC_X                    $CHAR1.                             
      @1077   HOSPBRTH                      N3PF.                               
      @1080   HOSPST                        $CHAR2.                             
      @1082   KEY                           15.                                 
      @1097   LOS                           N5PF.                               
      @1102   LOS_X                         N6PF.                               
      @1108   MARITALSTATUSUB04             $CHAR1.                             
      @1109   MARITALSTATUS_X               $CHAR1.                             
      @1110   MDNUM1_R                      N9PF.                               
      @1119   MEDINCSTQ                     N2PF.                               
      @1121   MRN_R                         N9PF.                               
      @1130   NCHRONIC                      N3PF.                               
      ...
      @1167   PAYER2_X                      $CHAR2.                             
      @1169   PL_CBSA                       N3PF.                               
      @1172   PL_MSA1993                    N3PF.                               
      @1175   PL_NCHS2006                   N2PF.                               
      @1177   PL_RUCA10_2005                N2PF.                               
      @1179   PL_RUCA2005                   N4P1F.                              
      @1183   PL_RUCA4_2005                 N2PF.                               
      @1185   PL_RUCC2003                   N2PF.                               
      @1187   PL_UIC2003                    N2PF.                               
      @1189   PL_UR_CAT4                    N2PF.                               
      @1191   PROCTYPE                      N3PF.                               
      @1194   PSTATE                        $CHAR2.                             
      @1196   PSTCO                         N5PF.                               
      @1201   PSTCO2                        N5PF.                               
      ...
      @1211   STATE_ED                      N2PF.                               
      @1213   STATE_OS                      N2PF.                               
      @1215   SpannedServiceCount           N3PF.                               
      @1218   TOTCHG                        N10PF.                              
      @1228   TOTCHG_X                      N15P2F.                             
      @1243   YEAR                          N4PF.                               
      @1247   ZIP3                          $CHAR3.                             
      @1250   ZIPINC_QRTL                   N3PF.                               
      @1253   AYEAR                         N4PF.                               
      ;                                                                         
