...
*  Data Step                  *;                                                
*******************************;                                                
DATA MN_SEDDC_2014_CORE;                                                        
INFILE 'MN_SEDD_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1861;                         
...
INPUT                                                                           
      ...
      @1240   LOS                           N5PF.                               
      @1245   LOS_X                         N6PF.                               
      @1251   MARITALSTATUSUB04             $CHAR1.                             
      @1252   MARITALSTATUS_X               $CHAR1.                             
      @1253   MEDINCSTQ                     N2PF.                               
      @1255   MRN_R                         N9PF.                               
      @1264   NCHRONIC                      N3PF.                               
      @1267   NCPT                          N4PF.                               
      ...
      @1326   PL_RUCC                       N2PF.                               
      @1328   PL_UIC                        N2PF.                               
      @1330   PL_UR_CAT4                    N2PF.                               
      @1332   POA_Disch_Edit1               N2PF.                               
      @1334   POA_Disch_Edit2               N2PF.                               
      @1336   POA_Hosp_Edit1                N2PF.                               
      @1338   POA_Hosp_Edit2                N2PF.                               
      @1340   POA_Hosp_Edit3                N2PF.                               
      @1342   POA_Hosp_Edit3_Value          N8P2F.                              
      @1350   PR1                           $CHAR7.                             
      @1357   PR2                           $CHAR7.                             
      @1364   PR3                           $CHAR7.                             
      @1371   PR4                           $CHAR7.                             
      ...
      @1671   PSTATE                        $CHAR2.                             
      @1673   PSTCO2                        N5PF.                               
      @1678   PointOfOriginUB04             $CHAR1.                             
      @1679   PointOfOrigin_X               $CHAR1.                             
      @1680   STATE_AS                      N2PF.                               
      @1682   STATE_ED                      N2PF.                               
      @1684   STATE_OS                      N2PF.                               
      @1686   TOTCHG                        N10PF.                              
      @1696   TOTCHG_X                      N15P2F.                             
      @1711   YEAR                          N4PF.                               
      @1715   ZIP                           $CHAR5.                             
      @1720   ZIP3                          $CHAR3.                             
      @1723   ZIPINC_QRTL                   N3PF.                               
      @1726   AYEAR                         N4PF.                               
      @1730   BMONTH                        N2PF.                               
      @1732   BYEAR                         N4PF.                               
      @1736   PRMONTH1                      N2PF.                               
