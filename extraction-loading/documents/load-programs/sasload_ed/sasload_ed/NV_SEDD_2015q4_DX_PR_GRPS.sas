...
*  Data Step                  *;                                                
*******************************;                                                
DATA NV_SEDDC_2015q4_DX_PR_GRPS;                                                
INFILE 'NV_SEDD_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 673;                  
...
INPUT                                                                           
      ...
      @573    I10_ECauseMCCS8               $CHAR11.                            
      @584    I10_ECauseMCCS9               $CHAR11.                            
      @595    I10_INJURY                    N2PF.                               
      @597    I10_MULTINJURY                N2PF.                               
      @599    I10_U_BLOOD                   N2PF.                               
      @601    I10_U_CATH                    N2PF.                               
      @603    I10_U_CTSCAN                  N2PF.                               
      @605    I10_U_EKG                     N2PF.                               
      @607    I10_U_MHSA                    N2PF.                               
      @609    I10_U_MRT                     N2PF.                               
      @611    I10_U_PACEMAKER               N2PF.                               
      @613    I10_U_PHYTHERAPY              N2PF.                               
      @615    I10_U_RADTHERAPY              N2PF.                               
      @617    I10_U_STRESS                  N2PF.                               
      @619    KEY                           15.                                 
      @634    U_CCU                         N2PF.                               
      @636    U_CHESTXRAY                   N2PF.                               
      @638    U_DIALYSIS                    N2PF.                               
      @640    U_ECHO                        N2PF.                               
      @642    U_ED                          N2PF.                               
      @644    U_EEG                         N2PF.                               
      @646    U_EPO                         N2PF.                               
      @648    U_ICU                         N2PF.                               
      @650    U_LITHOTRIPSY                 N2PF.                               
      @652    U_NEWBN2L                     N2PF.                               
      @654    U_NEWBN3L                     N2PF.                               
      @656    U_NEWBN4L                     N2PF.                               
      @658    U_NUCMED                      N2PF.                               
      @660    U_OBSERVATION                 N2PF.                               
      @662    U_OCCTHERAPY                  N2PF.                               
      @664    U_ORGANACQ                    N2PF.                               
      @666    U_OTHIMPLANTS                 N2PF.                               
      @668    U_RESPTHERAPY                 N2PF.                               
      @670    U_SPEECHTHERAPY               N2PF.                               
      @672    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
