...
*  Data Step                  *;                                                
*******************************;                                                
DATA GA_SEDDC_2017_CORE;                                                        
INFILE 'GA_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 2332;                         
...
INPUT                                                                           
      ...
      @1799   I10_PR26                      $CHAR7.                             
      @1806   I10_PR27                      $CHAR7.                             
      @1813   I10_PROCTYPE                  N3PF.                               
      @1816   KEY                           15.                                 
      @1831   LOS                           N5PF.                               
      @1836   LOS_X                         N6PF.                               
      @1842   MARITALSTATUS_X               $CHAR1.                             
      @1843   MARITALSTATUSUB04             $CHAR1.                             
      @1844   MDNUM1_R                      N9PF.                               
      @1853   MDNUM2_R                      N9PF.                               
      @1862   MDNUM3_R                      N9PF.                               
      @1871   MDNUM4_R                      N9PF.                               
      ...
      @1922   PL_RUCC                       N2PF.                               
      @1924   PL_UIC                        N2PF.                               
      @1926   PL_UR_CAT4                    N2PF.                               
      @1928   POA_Disch_Edit1               N2PF.                               
      @1930   POA_Disch_Edit2               N2PF.                               
      @1932   POA_Hosp_Edit1                N2PF.                               
      @1934   POA_Hosp_Edit2                N2PF.                               
      @1936   POA_Hosp_Edit3                N2PF.                               
      @1938   POA_Hosp_Edit3_Value          N8P2F.                              
      @1946   PointOfOrigin_X               $CHAR1.                             
      @1947   PointOfOriginUB04             $CHAR1.                             
      @1948   PRDAY1                        N5PF.                               
      @1953   PRDAY2                        N5PF.                               
      @1958   PRDAY3                        N5PF.                               
      @1963   PRDAY4                        N5PF.                               
