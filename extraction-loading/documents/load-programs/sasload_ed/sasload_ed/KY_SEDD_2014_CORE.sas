...
*  Data Step                  *;                                                
*******************************;                                                
DATA KY_SEDDC_2014_CORE;                                                        
INFILE 'KY_SEDD_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1355;                         
...
INPUT                                                                           
      ...
      @1070   DXCCS25                       N4PF.                               
      @1074   DXVER                         N3PF.                               
      @1077   DX_Visit_Reason1              $CHAR7.                             
      @1084   DX_Visit_Reason2              $CHAR7.                             
      @1091   DX_Visit_Reason3              $CHAR7.                             
      @1098   ECODE1                        $CHAR7.                             
      @1105   ECODE2                        $CHAR7.                             
      @1112   ECODE3                        $CHAR7.                             
      @1119   ECODE4                        $CHAR7.                             
      ...
      @1188   HCUP_ED                       N2PF.                               
      @1190   HCUP_OS                       N2PF.                               
      @1192   HISPANIC_X                    $CHAR2.                             
      @1194   HOSPBRTH                      N3PF.                               
      @1197   HOSPST                        $CHAR2.                             
      @1199   HOSP_NPI                      $CHAR10.                            
      @1209   KEY                           15.                                 
      @1224   LOS                           N5PF.                               
      @1229   LOS_X                         N6PF.                               
      @1235   MEDINCSTQ                     N2PF.                               
      ...
      @1275   PL_RUCC                       N2PF.                               
      @1277   PL_UIC                        N2PF.                               
      @1279   PL_UR_CAT4                    N2PF.                               
      @1281   PROCTYPE                      N3PF.                               
      @1284   PSTATE                        $CHAR2.                             
      @1286   PSTCO                         N5PF.                               
      @1291   PSTCO2                        N5PF.                               
      @1296   PointOfOriginUB04             $CHAR1.                             
      @1297   PointOfOrigin_X               $CHAR2.                             
      @1299   RACE                          N2PF.                               
      @1301   RACE_X                        $CHAR2.                             
      @1303   STATE_AS                      N2PF.                               
      @1305   STATE_ED                      N2PF.                               
      @1307   STATE_OS                      N2PF.                               
      @1309   TOTCHG                        N10PF.                              
      @1319   TOTCHG_X                      N15P2F.                             
      @1334   YEAR                          N4PF.                               
      @1338   ZIP                           $CHAR5.                             
      @1343   ZIPINC_QRTL                   N3PF.                               
      @1346   AYEAR                         N4PF.                               
      @1350   BMONTH                        N2PF.                               
      @1352   BYEAR                         N4PF.                               
      ;                                                                         
