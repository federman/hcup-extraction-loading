...
*  Data Step                  *;                                                
*******************************;                                                
DATA MI_SEDDC_2018_CORE;                                                        
INFILE 'MI_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 711;                          
...
INPUT                                                                           
      ...
      @362    HCUP_OS                       N2PF.                               
      @364    HISPANIC                      N2PF.                               
      @366    HISPANIC_X                    $CHAR1.                             
      @367    HOSPST                        $CHAR2.                             
      @369    I10_DX_Visit_Reason1          $CHAR7.                             
      @376    I10_DX1                       $CHAR7.                             
      @383    I10_DX2                       $CHAR7.                             
      @390    I10_DX3                       $CHAR7.                             
      @397    I10_DX4                       $CHAR7.                             
