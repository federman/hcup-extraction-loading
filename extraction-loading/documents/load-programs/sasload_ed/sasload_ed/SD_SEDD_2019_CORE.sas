...
*  Data Step                  *;                                                
*******************************;                                                
DATA SD_SEDDC_2019_CORE;                                                        
INFILE 'SD_SEDD_2019_CORE.ASC' FIRSTOBS=3 LRECL = 1994;                         
...
INPUT                                                                           
      ...
      @1777   I10_DX35                      $CHAR7.                             
      @1784   I10_DX36                      $CHAR7.                             
      @1791   I10_DX_Visit_Reason1          $CHAR7.                             
      @1798   I10_DX_Visit_Reason2          $CHAR7.                             
      @1805   I10_DX_Visit_Reason3          $CHAR7.                             
      @1812   I10_NDX                       N3PF.                               
      @1815   I10_PROCTYPE                  N3PF.                               
      @1818   KEY                           15.                                 
      @1833   LOS                           N5PF.                               
      @1838   LOS_X                         N6PF.                               
      @1844   MDNUM1_R                      N9PF.                               
      ...
      @1909   PL_RUCC                       N2PF.                               
      @1911   PL_UIC                        N2PF.                               
      @1913   PL_UR_CAT4                    N2PF.                               
      @1915   PSTATE                        $CHAR2.                             
      @1917   PSTATE_GEO                    $CHAR2.                             
      @1919   PSTCO                         N5PF.                               
      @1924   PSTCO_GEO                     N5PF.                               
      @1929   PointOfOriginUB04             $CHAR1.                             
      @1930   PointOfOrigin_X               $CHAR1.                             
      @1931   RACE                          N2PF.                               
      @1933   RACE_X                        $CHAR1.                             
      @1934   STATE_AS                      N2PF.                               
      @1936   STATE_ED                      N2PF.                               
      @1938   STATE_OS                      N2PF.                               
      @1940   TOTCHG                        N10PF.                              
      @1950   TOTCHG_X                      N15P2F.                             
      @1965   YEAR                          N4PF.                               
      @1969   ZIP                           $CHAR5.                             
      @1974   ZIP3                          $CHAR3.                             
      @1977   ZIPINC_QRTL                   N3PF.                               
      @1980   HOSPID                        N5PF.                               
      @1985   AYEAR                         N4PF.                               
      @1989   BMONTH                        N2PF.                               
      @1991   BYEAR                         N4PF.                               
