...
*  Data Step                  *;                                                
*******************************;                                                
DATA NE_SEDDC_2017_CORE;                                                        
INFILE 'NE_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1177;                         
...
INPUT                                                                           
      ...
      @1068   PL_RUCC                       N2PF.                               
      @1070   PL_UIC                        N2PF.                               
      @1072   PL_UR_CAT4                    N2PF.                               
      @1074   PointOfOrigin_X               $CHAR1.                             
      @1075   PointOfOriginUB04             $CHAR1.                             
      @1076   PSTATE                        $CHAR2.                             
      @1078   PSTCO2                        N5PF.                               
      @1083   STATE_AS                      N2PF.                               
      @1085   STATE_ED                      N2PF.                               
      @1087   STATE_OS                      N2PF.                               
      @1089   TOTCHG                        N10PF.                              
      @1099   TOTCHG_X                      N15P2F.                             
      @1114   VisitLink                     N9PF.                               
      @1123   YEAR                          N4PF.                               
      @1127   ZIP                           $CHAR5.                             
      @1132   ZIP3                          $CHAR3.                             
      @1135   ZIPINC_QRTL                   N3PF.                               
      @1138   TOWN                          $CHAR30.                            
      @1168   AYEAR                         N4PF.                               
      @1172   BMONTH                        N2PF.                               
      @1174   BYEAR                         N4PF.                               
