...
*   UT_SEDD_2015q1q3_DX_PR_GRPS.SAS:                                            
...
*  Data Step                  *;                                                
*******************************;                                                
DATA UT_SEDDC_2015q1q3_DX_PR_GRPS;                                              
INFILE 'UT_SEDD_2015q1q3_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 603;                
...
INPUT                                                                           
      ...
      @437    INJURY                        N2PF.                               
      @439    INJURY_CUT                    N2PF.                               
      @441    INJURY_DROWN                  N2PF.                               
      @443    INJURY_FALL                   N2PF.                               
      @445    INJURY_FIRE                   N2PF.                               
      @447    INJURY_FIREARM                N2PF.                               
      @449    INJURY_MACHINERY              N2PF.                               
      @451    INJURY_MVT                    N2PF.                               
      @453    INJURY_NATURE                 N2PF.                               
      @455    INJURY_POISON                 N2PF.                               
      @457    INJURY_STRUCK                 N2PF.                               
      @459    INJURY_SUFFOCATION            N2PF.                               
      @461    INTENT_ASSAULT                N2PF.                               
      @463    INTENT_SELF_HARM              N2PF.                               
      @465    INTENT_UNINTENTIONAL          N2PF.                               
      @467    KEY                           15.                                 
      @482    MULTINJURY                    N2PF.                               
      @484    PCLASS1                       N2PF.                               
      @486    PCLASS2                       N2PF.                               
      ...
      @578    U_NEWBN4L                     N2PF.                               
      @580    U_NUCMED                      N2PF.                               
      @582    U_OBSERVATION                 N2PF.                               
      @584    U_OCCTHERAPY                  N2PF.                               
      @586    U_ORGANACQ                    N2PF.                               
      @588    U_OTHIMPLANTS                 N2PF.                               
      @590    U_PACEMAKER                   N2PF.                               
      @592    U_PHYTHERAPY                  N2PF.                               
      @594    U_RADTHERAPY                  N2PF.                               
      @596    U_RESPTHERAPY                 N2PF.                               
      @598    U_SPEECHTHERAPY               N2PF.                               
      @600    U_STRESS                      N2PF.                               
      @602    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
