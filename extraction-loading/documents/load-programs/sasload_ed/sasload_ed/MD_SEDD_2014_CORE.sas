...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SEDDC_2014_CORE;                                                        
INFILE 'MD_SEDD_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1448;                         
...
INPUT                                                                           
      ...
      @1284   LOS                           N5PF.                               
      @1289   LOS_X                         N6PF.                               
      @1295   MARITALSTATUSUB04             $CHAR1.                             
      @1296   MARITALSTATUS_X               $CHAR1.                             
      @1297   MDNUM1_R                      N9PF.                               
      @1306   MEDINCSTQ                     N2PF.                               
      @1308   MRN_R                         N9PF.                               
      @1317   NCHRONIC                      N3PF.                               
      ...
      @1394   STATE_ED                      N2PF.                               
      @1396   STATE_OS                      N2PF.                               
      @1398   SpannedServiceCount           N3PF.                               
      @1401   TOTCHG                        N10PF.                              
      @1411   TOTCHG_X                      N15P2F.                             
      @1426   VisitLink                     N9PF.                               
      @1435   YEAR                          N4PF.                               
      @1439   ZIP3                          $CHAR3.                             
      @1442   ZIPINC_QRTL                   N3PF.                               
      @1445   AYEAR                         N4PF.                               
      ;                                                                         
