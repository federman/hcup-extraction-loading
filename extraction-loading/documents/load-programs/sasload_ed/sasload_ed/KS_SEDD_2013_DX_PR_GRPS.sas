...
*  Data Step                  *;                                                
*******************************;                                                
DATA KS_SEDDC_2013_DX_PR_GRPS;                                                  
INFILE 'KS_SEDD_2013_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 956;                    
...
INPUT                                                                           
      ...
      @660    INJURY                        N2PF.                               
      @662    INJURY_CUT                    N2PF.                               
      @664    INJURY_DROWN                  N2PF.                               
      @666    INJURY_FALL                   N2PF.                               
      @668    INJURY_FIRE                   N2PF.                               
      @670    INJURY_FIREARM                N2PF.                               
      @672    INJURY_MACHINERY              N2PF.                               
      @674    INJURY_MVT                    N2PF.                               
      @676    INJURY_NATURE                 N2PF.                               
      @678    INJURY_POISON                 N2PF.                               
      @680    INJURY_STRUCK                 N2PF.                               
      @682    INJURY_SUFFOCATION            N2PF.                               
      @684    INTENT_ASSAULT                N2PF.                               
      @686    INTENT_SELF_HARM              N2PF.                               
      @688    INTENT_UNINTENTIONAL          N2PF.                               
      @690    KEY                           15.                                 
      @705    MULTINJURY                    N2PF.                               
      @707    PCLASS1                       N2PF.                               
      @709    PCLASS2                       N2PF.                               
