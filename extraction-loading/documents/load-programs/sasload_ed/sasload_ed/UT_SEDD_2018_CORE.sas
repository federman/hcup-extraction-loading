...
*  Data Step                  *;                                                
*******************************;                                                
DATA UT_SEDDC_2018_CORE;                                                        
INFILE 'UT_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 1849;                         
...
INPUT                                                                           
      ...
      @1066   CPTM1_98                      $CHAR2.                             
      @1068   CPTM1_99                      $CHAR2.                             
      @1070   CPTM1_100                     $CHAR2.                             
      @1072   CPTM1_101                     $CHAR2.                             
      @1074   CPTM1_102                     $CHAR2.                             
      @1076   CPTM1_103                     $CHAR2.                             
      @1078   CPTM1_104                     $CHAR2.                             
      @1080   CPTM1_105                     $CHAR2.                             
      @1082   CPTM1_106                     $CHAR2.                             
      @1084   CPTM2_1                       $CHAR2.                             
      @1086   CPTM2_2                       $CHAR2.                             
      @1088   CPTM2_3                       $CHAR2.                             
      @1090   CPTM2_4                       $CHAR2.                             
      ...
      @1278   CPTM2_98                      $CHAR2.                             
      @1280   CPTM2_99                      $CHAR2.                             
      @1282   CPTM2_100                     $CHAR2.                             
      @1284   CPTM2_101                     $CHAR2.                             
      @1286   CPTM2_102                     $CHAR2.                             
      @1288   CPTM2_103                     $CHAR2.                             
      @1290   CPTM2_104                     $CHAR2.                             
      @1292   CPTM2_105                     $CHAR2.                             
      @1294   CPTM2_106                     $CHAR2.                             
      @1296   DaysToEvent                   N6PF.                               
      @1302   DHOUR                         N4PF.                               
      @1306   DIED                          N2PF.                               
      @1308   DISP_X                        $CHAR2.                             
      @1310   DISPUB04                      N2PF.                               
      @1312   DISPUNIFORM                   N2PF.                               
      @1314   DMONTH                        N2PF.                               
      @1316   DQTR                          N2PF.                               
      @1318   DSHOSPID                      $CHAR17.                            
      @1335   DURATION                      N6PF.                               
      @1341   FEMALE                        N2PF.                               
      @1343   HCUP_ED                       N2PF.                               
      @1345   HCUP_OS                       N2PF.                               
      @1347   HISPANIC                      N2PF.                               
      @1349   HISPANIC_X                    $CHAR6.                             
      @1355   HOSPST                        $CHAR2.                             
      @1357   I10_DX_Visit_Reason1          $CHAR7.                             
      @1364   I10_DX_Visit_Reason2          $CHAR7.                             
      @1371   I10_DX_Visit_Reason3          $CHAR7.                             
      @1378   I10_DX1                       $CHAR7.                             
      @1385   I10_DX2                       $CHAR7.                             
      @1392   I10_DX3                       $CHAR7.                             
      @1399   I10_DX4                       $CHAR7.                             
      ...
      @1552   I10_PR5                       $CHAR7.                             
      @1559   I10_PR6                       $CHAR7.                             
      @1566   I10_PROCTYPE                  N3PF.                               
      @1569   KEY                           15.                                 
      @1584   LOS                           N5PF.                               
      @1589   LOS_X                         N6PF.                               
      @1595   MARITALSTATUS_X               $CHAR1.                             
      @1596   MARITALSTATUSUB04             $CHAR1.                             
      @1597   MDNUM1_R                      N9PF.                               
      @1606   MDNUM2_R                      N9PF.                               
      @1615   MDNUM3_R                      N9PF.                               
      @1624   MDNUM4_R                      N9PF.                               
      ...
      @1696   PL_RUCC                       N2PF.                               
      @1698   PL_UIC                        N2PF.                               
      @1700   PL_UR_CAT4                    N2PF.                               
      @1702   PointOfOrigin_X               $CHAR1.                             
      @1703   PointOfOriginUB04             $CHAR1.                             
      @1704   PRDAY1                        N5PF.                               
      @1709   PRDAY2                        N5PF.                               
      @1714   PRDAY3                        N5PF.                               
      @1719   PRDAY4                        N5PF.                               
      ...
      @1753   STATE_OS                      N2PF.                               
      @1755   TOTCHG                        N10PF.                              
      @1765   TOTCHG_X                      N15P2F.                             
      @1780   VisitLink                     N9PF.                               
      @1789   YEAR                          N4PF.                               
      @1793   ZIP                           $CHAR5.                             
      @1798   ZIP3                          $CHAR3.                             
      @1801   ZIPINC_QRTL                   N3PF.                               
      @1804   AYEAR                         N4PF.                               
      @1808   BMONTH                        N2PF.                               
      @1810   BYEAR                         N4PF.                               
      @1814   PRMONTH1                      N2PF.                               
