...
INFILE 'MD_SEDD_2008_CORE.ASC' FIRSTOBS=3 LRECL = 697;                          
...
INPUT                                                                           
      ...
      @527    HCUP_ED                       N2PF.                               
      @529    HCUP_OS                       N2PF.                               
      @531    HISPANIC_X                    $CHAR1.                             
      @532    HOSPBRTH                      N3PF.                               
      @535    HOSPST                        $CHAR2.                             
      @537    KEY                           15.                                 
      @552    LOS                           N5PF.                               
      @557    LOS_X                         N6PF.                               
      @563    MARITALSTATUSUB04             $CHAR1.                             
      ...
      @610    PL_CBSA                       N3PF.                               
      @613    PL_MSA1993                    N3PF.                               
      @616    PL_NCHS2006                   N2PF.                               
      @618    PL_RUCA10_2005                N2PF.                               
      @620    PL_RUCA2005                   N4P1F.                              
      @624    PL_RUCA4_2005                 N2PF.                               
      @626    PL_RUCC2003                   N2PF.                               
      @628    PL_UIC2003                    N2PF.                               
      @630    PL_UR_CAT4                    N2PF.                               
      @632    PROCTYPE                      N3PF.                               
      @635    PSTATE                        $CHAR2.                             
