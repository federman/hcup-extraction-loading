...
*  Data Step                  *;                                                
*******************************;                                                
DATA KS_SEDDC_2016_CORE;                                                        
INFILE 'KS_SEDD_2016_CORE.ASC' FIRSTOBS=3 LRECL = 1485;                         
...
INPUT                                                                           
      ...
      @1056   I10_DX29                      $CHAR7.                             
      @1063   I10_DX30                      $CHAR7.                             
      @1070   I10_ECAUSE1                   $CHAR7.                             
      @1077   I10_ECAUSE2                   $CHAR7.                             
      @1084   I10_ECAUSE3                   $CHAR7.                             
      @1091   I10_ECAUSE4                   $CHAR7.                             
      @1098   I10_ECAUSE5                   $CHAR7.                             
      @1105   I10_ECAUSE6                   $CHAR7.                             
      @1112   I10_ECAUSE7                   $CHAR7.                             
      @1119   I10_ECAUSE8                   $CHAR7.                             
      @1126   I10_ECAUSE9                   $CHAR7.                             
      @1133   I10_ECAUSE10                  $CHAR7.                             
      @1140   I10_ECAUSE11                  $CHAR7.                             
      @1147   I10_ECAUSE12                  $CHAR7.                             
      @1154   I10_NDX                       N3PF.                               
      @1157   I10_NECAUSE                   N2PF.                               
      @1159   I10_NPR                       N3PF.                               
      @1162   I10_PR1                       $CHAR7.                             
      @1169   I10_PR2                       $CHAR7.                             
      @1176   I10_PR3                       $CHAR7.                             
      ...
      @1323   I10_PR24                      $CHAR7.                             
      @1330   I10_PR25                      $CHAR7.                             
      @1337   I10_PROCTYPE                  N3PF.                               
      @1340   KEY                           15.                                 
      @1355   LOS                           N5PF.                               
      @1360   LOS_X                         N6PF.                               
      @1366   MEDINCSTQ                     N2PF.                               
      @1368   NCPT                          N4PF.                               
      @1372   OPservice                     $CHAR1.                             
      @1373   OS_TIME                       N11P2F.                             
      @1384   PAY1                          N2PF.                               
      @1386   PAY1_X                        $CHAR3.                             
      @1389   PAY2                          N2PF.                               
      ...
      @1404   PL_RUCC                       N2PF.                               
      @1406   PL_UIC                        N2PF.                               
      @1408   PL_UR_CAT4                    N2PF.                               
      @1410   PointOfOrigin_X               $CHAR1.                             
      @1411   PointOfOriginUB04             $CHAR1.                             
      @1412   PRVER                         N3PF.                               
      @1415   PSTATE                        $CHAR2.                             
      @1417   PSTCO                         N5PF.                               
      @1422   PSTCO2                        N5PF.                               
      ...
      @1434   STATE_OS                      N2PF.                               
      @1436   TOTCHG                        N10PF.                              
      @1446   TOTCHG_X                      N15P2F.                             
      @1461   YEAR                          N4PF.                               
      @1465   ZIP3                          $CHAR3.                             
      @1468   ZIPINC_QRTL                   N3PF.                               
      @1471   HOSPID                        N5PF.                               
      @1476   AYEAR                         N4PF.                               
      @1480   BMONTH                        N2PF.                               
      @1482   BYEAR                         N4PF.                               
