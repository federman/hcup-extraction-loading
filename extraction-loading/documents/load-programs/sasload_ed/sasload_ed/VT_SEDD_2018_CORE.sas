...
*  Data Step                  *;                                                
*******************************;                                                
DATA VT_SEDDC_2018_CORE;                                                        
INFILE 'VT_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 2297;                         
...
INPUT                                                                           
      ...
      @1578   HOSP_NPI                      $CHAR10.                            
      @1588   HOSPST                        $CHAR2.                             
      @1590   I10_DX_Visit_Reason1          $CHAR7.                             
      @1597   I10_DX_Visit_Reason2          $CHAR7.                             
      @1604   I10_DX1                       $CHAR7.                             
      @1611   I10_DX2                       $CHAR7.                             
      @1618   I10_DX3                       $CHAR7.                             
      @1625   I10_DX4                       $CHAR7.                             
      ...
      @1897   I10_PR19                      $CHAR7.                             
      @1904   I10_PR20                      $CHAR7.                             
      @1911   I10_PROCTYPE                  N3PF.                               
      @1914   KEY                           15.                                 
      @1929   LOS                           N5PF.                               
      @1934   LOS_X                         N6PF.                               
      @1940   MEDINCSTQ                     N2PF.                               
      @1942   NCPT                          N4PF.                               
      @1946   OBSERVATION                   N4PF.                               
      @1950   OPservice                     $CHAR1.                             
      @1951   PAY1                          N2PF.                               
      @1953   PAY1_X                        $CHAR2.                             
      @1955   PAY2                          N2PF.                               
      @1957   PAY2_X                        $CHAR2.                             
      ...
      @1986   PL_RUCC                       N2PF.                               
      @1988   PL_UIC                        N2PF.                               
      @1990   PL_UR_CAT4                    N2PF.                               
      @1992   PointOfOrigin_X               $CHAR1.                             
      @1993   PointOfOriginUB04             $CHAR1.                             
      @1994   PRDAY1                        N5PF.                               
      @1999   PRDAY2                        N5PF.                               
      @2004   PRDAY3                        N5PF.                               
      @2009   PRDAY4                        N5PF.                               
      ...
      @2113   STATE_OS                      N2PF.                               
      @2115   TOTCHG                        N10PF.                              
      @2125   TOTCHG_X                      N15P2F.                             
      @2140   VisitLink                     N9PF.                               
      @2149   YEAR                          N4PF.                               
      @2153   ZIP                           $CHAR5.                             
      @2158   ZIP3                          $CHAR3.                             
      @2161   ZIPINC_QRTL                   N3PF.                               
      @2164   TOWN                          $CHAR4.                             
      @2168   AYEAR                         N4PF.                               
      @2172   BMONTH                        N2PF.                               
      @2174   BYEAR                         N4PF.                               
