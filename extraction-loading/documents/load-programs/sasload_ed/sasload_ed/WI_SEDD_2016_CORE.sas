...
*  Data Step                  *;                                                
*******************************;                                                
DATA WI_SEDDC_2016_CORE;                                                        
INFILE 'WI_SEDD_2016_CORE.ASC' FIRSTOBS=3 LRECL = 1273;                         
...
INPUT                                                                           
      ...
      @1041   I10_DX49                      $CHAR7.                             
      @1048   I10_DX50                      $CHAR7.                             
      @1055   I10_ECAUSE1                   $CHAR7.                             
      @1062   I10_ECAUSE2                   $CHAR7.                             
      @1069   I10_ECAUSE3                   $CHAR7.                             
      @1076   I10_ECAUSE4                   $CHAR7.                             
      @1083   I10_ECAUSE5                   $CHAR7.                             
      @1090   I10_ECAUSE6                   $CHAR7.                             
      @1097   I10_ECAUSE7                   $CHAR7.                             
      @1104   I10_NDX                       N3PF.                               
      @1107   I10_NECAUSE                   N2PF.                               
      @1109   I10_PROCTYPE                  N3PF.                               
      @1112   KEY                           15.                                 
      @1127   LOS                           N5PF.                               
      @1132   LOS_X                         N6PF.                               
      @1138   MDSPEC1                       $CHAR3.                             
      ...
      @1196   PointOfOrigin_X               $CHAR1.                             
      @1197   PointOfOriginUB04             $CHAR1.                             
      @1198   PSTATE                        $CHAR2.                             
      @1200   PSTCO2                        N5PF.                               
      @1205   RACE                          N2PF.                               
      @1207   RACE_X                        $CHAR2.                             
      ...
      @1213   STATE_OS                      N2PF.                               
      @1215   TOTCHG                        N10PF.                              
      @1225   TOTCHG_X                      N15P2F.                             
      @1240   VisitLink                     N9PF.                               
      @1249   YEAR                          N4PF.                               
      @1253   ZIP                           $CHAR5.                             
      @1258   ZIP3                          $CHAR3.                             
      @1261   ZIPINC_QRTL                   N3PF.                               
      @1264   AYEAR                         N4PF.                               
      @1268   BMONTH                        N2PF.                               
      @1270   BYEAR                         N4PF.                               
      ;                                                                         
