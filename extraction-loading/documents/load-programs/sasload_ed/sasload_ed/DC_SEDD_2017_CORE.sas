...
*  Data Step                  *;                                                
*******************************;                                                
DATA DC_SEDDC_2017_CORE;                                                        
INFILE 'DC_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1035;                         
...
INPUT                                                                           
      ...
      @603    HCUP_OS                       N2PF.                               
      @605    HOSPST                        $CHAR2.                             
      @607    I10_DX_Visit_Reason1          $CHAR7.                             
      @614    I10_DX1                       $CHAR7.                             
      @621    I10_DX2                       $CHAR7.                             
      @628    I10_DX3                       $CHAR7.                             
      @635    I10_DX4                       $CHAR7.                             
      ...
      @950    PL_UIC                        N2PF.                               
      @952    PL_UR_CAT4                    N2PF.                               
      @954    PointOfOrigin_X               $CHAR3.                             
      @957    PointOfOriginUB04             $CHAR1.                             
      @958    PSTATE                        $CHAR2.                             
      @960    PSTCO                         N5PF.                               
      @965    PSTCO2                        N5PF.                               
      @970    RACE                          N2PF.                               
