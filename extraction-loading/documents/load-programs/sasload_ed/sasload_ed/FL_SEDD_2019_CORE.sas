...
*  Data Step                  *;                                                
*******************************;                                                
DATA FL_SEDDC_2019_CORE;                                                        
INFILE 'FL_SEDD_2019_CORE.ASC' FIRSTOBS=3 LRECL = 605;                          
...
INPUT                                                                           
      ...
      @304    DSHOSPID                      $CHAR17.                            
      @321    DURATION                      N6PF.                               
      @327    DaysToEvent                   N6PF.                               
      @333    FEMALE                        N2PF.                               
      @335    HCUP_ED                       N2PF.                               
      @337    HCUP_OS                       N2PF.                               
      @339    HISPANIC                      N2PF.                               
      @341    HISPANIC_X                    $CHAR2.                             
      @343    HOSPST                        $CHAR2.                             
      @345    Homeless                      N2PF.                               
      @347    I10_DX1                       $CHAR7.                             
      @354    I10_DX2                       $CHAR7.                             
      ...
      @424    I10_DX12                      $CHAR7.                             
      @431    I10_DX13                      $CHAR7.                             
      @438    I10_DX_Visit_Reason1          $CHAR7.                             
      @445    I10_NDX                       N3PF.                               
      @448    I10_PROCTYPE                  N3PF.                               
      @451    KEY                           15.                                 
      @466    LOS                           N5PF.                               
      @471    LOS_X                         N6PF.                               
      @477    MDNUM1_R                      N9PF.                               
      ...
      @525    PL_UR_CAT4                    N2PF.                               
      @527    PSTATE                        $CHAR2.                             
      @529    PSTATE_GEO                    $CHAR2.                             
      @531    PSTCO                         N5PF.                               
      @536    PSTCO_GEO                     N5PF.                               
      @541    PointOfOriginUB04             $CHAR1.                             
      @542    PointOfOrigin_X               $CHAR2.                             
      @544    RACE                          N2PF.                               
      @546    RACE_X                        $CHAR1.                             
      @547    STATE_AS                      N2PF.                               
      @549    STATE_ED                      N2PF.                               
