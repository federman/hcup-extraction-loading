...
*  Data Step                  *;                                                
*******************************;                                                
DATA NE_SEDDC_2015q1q3_CORE;                                                    
INFILE 'NE_SEDD_2015q1q3_CORE.ASC' FIRSTOBS=3 LRECL = 1195;                     
...
INPUT                                                                           
      ...
      @1029   LOS                           N5PF.                               
      @1034   LOS_X                         N6PF.                               
      @1040   MARITALSTATUS_X               $CHAR1.                             
      @1041   MARITALSTATUSUB04             $CHAR1.                             
      @1042   MEDINCSTQ                     N2PF.                               
      @1044   NCHRONIC                      N3PF.                               
      @1047   NCPT                          N4PF.                               
      @1051   NDX                           N3PF.                               
      ...
      @1086   PL_RUCC                       N2PF.                               
      @1088   PL_UIC                        N2PF.                               
      @1090   PL_UR_CAT4                    N2PF.                               
      @1092   PointOfOrigin_X               $CHAR1.                             
      ...
      @1108   STATE_OS                      N2PF.                               
      @1110   TOTCHG                        N10PF.                              
      @1120   TOTCHG_X                      N15P2F.                             
      @1135   VisitLink                     N9PF.                               
      @1144   YEAR                          N4PF.                               
      @1148   ZIP                           $CHAR5.                             
      @1153   ZIPINC_QRTL                   N3PF.                               
      @1156   TOWN                          $CHAR30.                            
      @1186   AYEAR                         N4PF.                               
      @1190   BMONTH                        N2PF.                               
      @1192   BYEAR                         N4PF.                               
