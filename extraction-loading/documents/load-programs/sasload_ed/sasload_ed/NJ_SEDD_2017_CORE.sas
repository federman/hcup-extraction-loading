...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SEDDC_2017_CORE;                                                        
INFILE 'NJ_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 2042;                         
...
INPUT                                                                           
      ...
      @1302   HCUP_OS                       N2PF.                               
      @1304   HISPANIC                      N2PF.                               
      @1306   HISPANIC_X                    $CHAR5.                             
      @1311   Homeless                      N2PF.                               
      @1313   HOSPST                        $CHAR2.                             
      @1315   I10_DX_Visit_Reason1          $CHAR7.                             
      @1322   I10_DX_Visit_Reason2          $CHAR7.                             
      @1329   I10_DX_Visit_Reason3          $CHAR7.                             
      @1336   I10_DX1                       $CHAR7.                             
      @1343   I10_DX2                       $CHAR7.                             
      @1350   I10_DX3                       $CHAR7.                             
      @1357   I10_DX4                       $CHAR7.                             
      ...
      @1636   I10_PR13                      $CHAR7.                             
      @1643   I10_PR14                      $CHAR7.                             
      @1650   I10_PROCTYPE                  N3PF.                               
      @1653   KEY                           15.                                 
      @1668   LOS                           N5PF.                               
      @1673   LOS_X                         N6PF.                               
      @1679   MARITALSTATUS_X               $CHAR1.                             
      @1680   MARITALSTATUSUB04             $CHAR1.                             
      @1681   MDNUM1_R                      N9PF.                               
      @1690   MDNUM2_R                      N9PF.                               
      @1699   MEDINCSTQ                     N2PF.                               
      @1701   MOMNUM_R                      N9PF.                               
      ...
      @1776   PL_RUCC                       N2PF.                               
      @1778   PL_UIC                        N2PF.                               
      @1780   PL_UR_CAT4                    N2PF.                               
      @1782   POA_Disch_Edit1               N2PF.                               
      @1784   POA_Disch_Edit2               N2PF.                               
      @1786   POA_Hosp_Edit1                N2PF.                               
      @1788   POA_Hosp_Edit2                N2PF.                               
      @1790   POA_Hosp_Edit3                N2PF.                               
      @1792   POA_Hosp_Edit3_Value          N8P2F.                              
      @1800   PointOfOrigin_X               $CHAR1.                             
      ...
      @1903   STATE_OS                      N2PF.                               
      @1905   TOTCHG                        N10PF.                              
      @1915   TOTCHG_X                      N15P2F.                             
      @1930   YEAR                          N4PF.                               
      @1934   ZIP                           $CHAR5.                             
      @1939   ZIP3                          $CHAR3.                             
      @1942   ZIPINC_QRTL                   N3PF.                               
      @1945   TOWN                          $CHAR4.                             
      @1949   AYEAR                         N4PF.                               
      @1953   BMONTH                        N2PF.                               
      @1955   BYEAR                         N4PF.                               
