...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SEDDC_2015q4_DX_PR_GRPS;                                                
INFILE 'SC_SEDD_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 533;                  
...
INPUT                                                                           
      ...
      @314    I10_ECauseMCCS9               $CHAR11.                            
      @325    I10_INJURY                    N2PF.                               
      @327    I10_MULTINJURY                N2PF.                               
      @329    I10_PCLASS1                   N2PF.                               
      @331    I10_PCLASS2                   N2PF.                               
      @333    I10_PCLASS3                   N2PF.                               
      @335    I10_PCLASS4                   N2PF.                               
      @337    I10_PCLASS5                   N2PF.                               
      @339    I10_PCLASS6                   N2PF.                               
      @341    I10_PCLASS7                   N2PF.                               
      @343    I10_PCLASS8                   N2PF.                               
      @345    I10_PCLASS9                   N2PF.                               
      @347    I10_PCLASS10                  N2PF.                               
      @349    I10_PCLASS11                  N2PF.                               
      @351    I10_PCLASS12                  N2PF.                               
      @353    I10_PCLASS13                  N2PF.                               
      @355    I10_PRMCCS1                   $CHAR8.                             
      @363    I10_PRMCCS2                   $CHAR8.                             
      @371    I10_PRMCCS3                   $CHAR8.                             
      @379    I10_PRMCCS4                   $CHAR8.                             
      @387    I10_PRMCCS5                   $CHAR8.                             
      @395    I10_PRMCCS6                   $CHAR8.                             
      @403    I10_PRMCCS7                   $CHAR8.                             
      @411    I10_PRMCCS8                   $CHAR8.                             
      @419    I10_PRMCCS9                   $CHAR8.                             
      @427    I10_PRMCCS10                  $CHAR8.                             
      @435    I10_PRMCCS11                  $CHAR8.                             
      @443    I10_PRMCCS12                  $CHAR8.                             
      @451    I10_PRMCCS13                  $CHAR8.                             
      @459    I10_U_BLOOD                   N2PF.                               
      @461    I10_U_CATH                    N2PF.                               
      @463    I10_U_CTSCAN                  N2PF.                               
      @465    I10_U_EKG                     N2PF.                               
      @467    I10_U_MHSA                    N2PF.                               
      @469    I10_U_MRT                     N2PF.                               
      @471    I10_U_PACEMAKER               N2PF.                               
      @473    I10_U_PHYTHERAPY              N2PF.                               
      @475    I10_U_RADTHERAPY              N2PF.                               
      @477    I10_U_STRESS                  N2PF.                               
      @479    KEY                           15.                                 
      @494    U_CCU                         N2PF.                               
      @496    U_CHESTXRAY                   N2PF.                               
      @498    U_DIALYSIS                    N2PF.                               
      @500    U_ECHO                        N2PF.                               
      @502    U_ED                          N2PF.                               
      @504    U_EEG                         N2PF.                               
      ...
      @528    U_RESPTHERAPY                 N2PF.                               
      @530    U_SPEECHTHERAPY               N2PF.                               
      @532    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
