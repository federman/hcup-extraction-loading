...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SEDDC_2018_CORE;                                                        
INFILE 'NJ_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 2080;                         
...
INPUT                                                                           
      ...
      @1300   HCUP_OS                       N2PF.                               
      @1302   HISPANIC                      N2PF.                               
      @1304   HISPANIC_X                    $CHAR5.                             
      @1309   Homeless                      N2PF.                               
      @1311   HOSPST                        $CHAR2.                             
      @1313   I10_DX_Visit_Reason1          $CHAR7.                             
      @1320   I10_DX_Visit_Reason2          $CHAR7.                             
      @1327   I10_DX_Visit_Reason3          $CHAR7.                             
      @1334   I10_DX1                       $CHAR7.                             
      @1341   I10_DX2                       $CHAR7.                             
      @1348   I10_DX3                       $CHAR7.                             
      @1355   I10_DX4                       $CHAR7.                             
      ...
      @1655   I10_PR15                      $CHAR7.                             
      @1662   I10_PR16                      $CHAR7.                             
      @1669   I10_PROCTYPE                  N3PF.                               
      @1672   KEY                           15.                                 
      @1687   LOS                           N5PF.                               
      @1692   LOS_X                         N6PF.                               
      @1698   MARITALSTATUS_X               $CHAR1.                             
      @1699   MARITALSTATUSUB04             $CHAR1.                             
      @1700   MDNUM1_R                      N9PF.                               
      @1709   MDNUM2_R                      N9PF.                               
      @1718   MEDINCSTQ                     N2PF.                               
      @1720   MOMNUM_R                      N9PF.                               
      ...
      @1795   PL_RUCC                       N2PF.                               
      @1797   PL_UIC                        N2PF.                               
      @1799   PL_UR_CAT4                    N2PF.                               
      @1801   POA_Disch_Edit1               N2PF.                               
      @1803   POA_Disch_Edit2               N2PF.                               
      @1805   POA_Hosp_Edit1                N2PF.                               
      @1807   POA_Hosp_Edit2                N2PF.                               
      @1809   POA_Hosp_Edit3                N2PF.                               
      @1811   POA_Hosp_Edit3_Value          N8P2F.                              
      @1819   PointOfOrigin_X               $CHAR1.                             
      @1820   PointOfOriginUB04             $CHAR1.                             
      @1821   PRDAY1                        N5PF.                               
      @1826   PRDAY2                        N5PF.                               
      @1831   PRDAY3                        N5PF.                               
      @1836   PRDAY4                        N5PF.                               
      ...
      @1929   STATE_OS                      N2PF.                               
      @1931   TOTCHG                        N10PF.                              
      @1941   TOTCHG_X                      N15P2F.                             
      @1956   YEAR                          N4PF.                               
      @1960   ZIP                           $CHAR5.                             
      @1965   ZIP3                          $CHAR3.                             
      @1968   ZIPINC_QRTL                   N3PF.                               
      @1971   TOWN                          $CHAR4.                             
      @1975   AYEAR                         N4PF.                               
      @1979   BMONTH                        N2PF.                               
      @1981   BYEAR                         N4PF.                               
