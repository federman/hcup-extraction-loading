...
*  Data Step                  *;                                                
*******************************;                                                
DATA FL_SEDDC_2018_CORE;                                                        
INFILE 'FL_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 603;                          
...
INPUT                                                                           
      ...
      @343    Homeless                      N2PF.                               
      @345    HOSPST                        $CHAR2.                             
      @347    I10_DX_Visit_Reason1          $CHAR7.                             
      @354    I10_DX1                       $CHAR7.                             
      @361    I10_DX2                       $CHAR7.                             
      @368    I10_DX3                       $CHAR7.                             
      @375    I10_DX4                       $CHAR7.                             
