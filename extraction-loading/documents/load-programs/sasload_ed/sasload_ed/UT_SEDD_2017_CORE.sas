...
*  Data Step                  *;                                                
*******************************;                                                
DATA UT_SEDDC_2017_CORE;                                                        
INFILE 'UT_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1588;                         
...
INPUT                                                                           
      ...
      @1146   DMONTH                        N2PF.                               
      @1148   DQTR                          N2PF.                               
      @1150   DSHOSPID                      $CHAR17.                            
      @1167   DURATION                      N6PF.                               
      @1173   DXVER                         N3PF.                               
      @1176   FEMALE                        N2PF.                               
      @1178   HCUP_ED                       N2PF.                               
      @1180   HCUP_OS                       N2PF.                               
      @1182   HISPANIC_X                    $CHAR1.                             
      @1183   Homeless                      N2PF.                               
      @1185   HOSPST                        $CHAR2.                             
      @1187   I10_DX_Visit_Reason1          $CHAR7.                             
      @1194   I10_DX_Visit_Reason2          $CHAR7.                             
      @1201   I10_DX_Visit_Reason3          $CHAR7.                             
      @1208   I10_DX1                       $CHAR7.                             
      @1215   I10_DX2                       $CHAR7.                             
      @1222   I10_DX3                       $CHAR7.                             
      @1229   I10_DX4                       $CHAR7.                             
      ...
      @1348   I10_DX21                      $CHAR7.                             
      @1355   I10_NDX                       N3PF.                               
      @1358   I10_PROCTYPE                  N3PF.                               
      @1361   KEY                           15.                                 
      @1376   LOS                           N5PF.                               
      @1381   LOS_X                         N6PF.                               
      @1387   MARITALSTATUS_X               $CHAR1.                             
      @1388   MARITALSTATUSUB04             $CHAR1.                             
      @1389   MDNUM1_R                      N9PF.                               
      @1398   MDNUM2_R                      N9PF.                               
      @1407   MDNUM3_R                      N9PF.                               
      @1416   MDNUM4_R                      N9PF.                               
      ...
      @1508   PL_RUCC                       N2PF.                               
      @1510   PL_UIC                        N2PF.                               
      @1512   PL_UR_CAT4                    N2PF.                               
      @1514   PointOfOrigin_X               $CHAR1.                             
      @1515   PointOfOriginUB04             $CHAR1.                             
      @1516   PSTATE                        $CHAR2.                             
      @1518   PSTCO2                        N5PF.                               
      @1523   RACE_X                        $CHAR1.                             
      @1524   STATE_AS                      N2PF.                               
