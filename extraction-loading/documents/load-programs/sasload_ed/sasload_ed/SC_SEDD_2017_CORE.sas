...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SEDDC_2017_CORE;                                                        
INFILE 'SC_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1156;                         
...
INPUT                                                                           
      ...
      @906    HCUP_OS                       N2PF.                               
      @908    HOSPST                        $CHAR2.                             
      @910    I10_DX_Visit_Reason1          $CHAR7.                             
      @917    I10_DX_Visit_Reason2          $CHAR7.                             
      @924    I10_DX_Visit_Reason3          $CHAR7.                             
      @931    I10_DX1                       $CHAR7.                             
      @938    I10_DX2                       $CHAR7.                             
      @945    I10_DX3                       $CHAR7.                             
      @952    I10_DX4                       $CHAR7.                             
      ...
      @1096   PAY1_X                        $CHAR2.                             
      @1098   PL_NCHS                       N2PF.                               
      @1100   PointOfOrigin_X               $CHAR1.                             
      @1101   PointOfOriginUB04             $CHAR1.                             
      @1102   PSTATE                        $CHAR2.                             
      @1104   PSTCO                         N5PF.                               
      @1109   RACE                          N2PF.                               
      @1111   RACE_X                        $CHAR1.                             
      ...
      @1116   STATE_OS                      N2PF.                               
      @1118   TOTCHG                        N10PF.                              
      @1128   TOTCHG_X                      N15P2F.                             
      @1143   YEAR                          N4PF.                               
      @1147   ZIPINC_QRTL                   N3PF.                               
      @1150   AGEGROUP                      N3PF.                               
      @1153   AYEAR                         N4PF.                               
      ;                                                                         
