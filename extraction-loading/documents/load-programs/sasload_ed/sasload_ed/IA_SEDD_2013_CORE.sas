...
*  Data Step                  *;                                                
*******************************;                                                
DATA IA_SEDDC_2013_CORE;                                                        
INFILE 'IA_SEDD_2013_CORE.ASC' FIRSTOBS=3 LRECL = 1416;                         
...
INPUT                                                                           
      ...
      @1103   DXCCS36                       N4PF.                               
      @1107   DXCCS37                       N4PF.                               
      @1111   DX_Visit_Reason1              $CHAR5.                             
      @1116   DX_Visit_Reason2              $CHAR5.                             
      @1121   DX_Visit_Reason3              $CHAR5.                             
      @1126   DaysToEvent                   N6PF.                               
      @1132   ECODE1                        $CHAR5.                             
      @1137   ECODE2                        $CHAR5.                             
      @1142   ECODE3                        $CHAR5.                             
      @1147   ECODE4                        $CHAR5.                             
      ...
      @1310   PL_CBSA                       N3PF.                               
      @1313   PL_NCHS                       N2PF.                               
      @1315   PL_RUCA10_2005                N2PF.                               
      @1317   PL_RUCA2005                   N4P1F.                              
      @1321   PL_RUCA4_2005                 N2PF.                               
      @1323   PL_RUCC                       N2PF.                               
      @1325   PL_UIC                        N2PF.                               
      @1327   PL_UR_CAT4                    N2PF.                               
      @1329   PROCTYPE                      N3PF.                               
      @1332   PSTATE                        $CHAR2.                             
      @1334   PSTCO                         N5PF.                               
      @1339   PSTCO2                        N5PF.                               
      @1344   PointOfOriginUB04             $CHAR1.                             
      @1345   PointOfOrigin_X               $CHAR1.                             
      @1346   RACE                          N2PF.                               
      @1348   RACE_X                        $CHAR4.                             
      @1352   STATE_AS                      N2PF.                               
      @1354   STATE_ED                      N2PF.                               
      @1356   STATE_OS                      N2PF.                               
      @1358   TOTCHG                        N10PF.                              
      @1368   TOTCHG_X                      N15P2F.                             
      @1383   VisitLink                     N9PF.                               
      @1392   YEAR                          N4PF.                               
      @1396   ZIP3                          $CHAR3.                             
      @1399   ZIPINC_QRTL                   N3PF.                               
      @1402   ZIP                           $CHAR5.                             
      @1407   AYEAR                         N4PF.                               
      @1411   BMONTH                        N2PF.                               
      @1413   BYEAR                         N4PF.                               
