...
*  Data Step                  *;                                                
*******************************;                                                
DATA MA_SEDDC_2015q4_DX_PR_GRPS;                                                
INFILE 'MA_SEDD_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 828;                  
...
INPUT                                                                           
      ...
      @569    I10_ECauseMCCS9               $CHAR11.                            
      @580    I10_INJURY                    N2PF.                               
      @582    I10_MULTINJURY                N2PF.                               
      @584    I10_PCLASS1                   N2PF.                               
      @586    I10_PCLASS2                   N2PF.                               
      @588    I10_PCLASS3                   N2PF.                               
      @590    I10_PCLASS4                   N2PF.                               
      @592    I10_PCLASS5                   N2PF.                               
      @594    I10_PCLASS6                   N2PF.                               
      @596    I10_PCLASS7                   N2PF.                               
      @598    I10_PCLASS8                   N2PF.                               
      @600    I10_PCLASS9                   N2PF.                               
      @602    I10_PCLASS10                  N2PF.                               
      @604    I10_PCLASS11                  N2PF.                               
      @606    I10_PCLASS12                  N2PF.                               
      @608    I10_PCLASS13                  N2PF.                               
      @610    I10_PCLASS14                  N2PF.                               
      @612    I10_PCLASS15                  N2PF.                               
      @614    I10_PCLASS16                  N2PF.                               
      @616    I10_PCLASS17                  N2PF.                               
      @618    I10_PCLASS18                  N2PF.                               
      @620    I10_PCLASS19                  N2PF.                               
      @622    I10_PCLASS20                  N2PF.                               
      @624    I10_PCLASS21                  N2PF.                               
      @626    I10_PCLASS22                  N2PF.                               
      @628    I10_PCLASS23                  N2PF.                               
      @630    I10_PRMCCS1                   $CHAR8.                             
      @638    I10_PRMCCS2                   $CHAR8.                             
      @646    I10_PRMCCS3                   $CHAR8.                             
      @654    I10_PRMCCS4                   $CHAR8.                             
      @662    I10_PRMCCS5                   $CHAR8.                             
      @670    I10_PRMCCS6                   $CHAR8.                             
      @678    I10_PRMCCS7                   $CHAR8.                             
      @686    I10_PRMCCS8                   $CHAR8.                             
      @694    I10_PRMCCS9                   $CHAR8.                             
      @702    I10_PRMCCS10                  $CHAR8.                             
      @710    I10_PRMCCS11                  $CHAR8.                             
      @718    I10_PRMCCS12                  $CHAR8.                             
      @726    I10_PRMCCS13                  $CHAR8.                             
      @734    I10_PRMCCS14                  $CHAR8.                             
      @742    I10_PRMCCS15                  $CHAR8.                             
      @750    I10_PRMCCS16                  $CHAR8.                             
      @758    I10_PRMCCS17                  $CHAR8.                             
      @766    I10_PRMCCS18                  $CHAR8.                             
      @774    I10_PRMCCS19                  $CHAR8.                             
      @782    I10_PRMCCS20                  $CHAR8.                             
      @790    I10_PRMCCS21                  $CHAR8.                             
      @798    I10_PRMCCS22                  $CHAR8.                             
      @806    I10_PRMCCS23                  $CHAR8.                             
      @814    KEY                           15.                                 
      ;                                                                         
