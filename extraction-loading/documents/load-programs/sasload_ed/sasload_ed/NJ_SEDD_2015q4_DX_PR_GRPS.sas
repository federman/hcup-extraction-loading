...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SEDDC_2015q4_DX_PR_GRPS;                                                
INFILE 'NJ_SEDD_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 825;                  
...
INPUT                                                                           
      ...
      @497    I10_INJURY                    N2PF.                               
      @499    I10_MULTINJURY                N2PF.                               
      @501    I10_PCLASS1                   N2PF.                               
      @503    I10_PCLASS2                   N2PF.                               
      @505    I10_PCLASS3                   N2PF.                               
      @507    I10_PCLASS4                   N2PF.                               
      @509    I10_PCLASS5                   N2PF.                               
      @511    I10_PCLASS6                   N2PF.                               
      @513    I10_PCLASS7                   N2PF.                               
      @515    I10_PCLASS8                   N2PF.                               
      @517    I10_PCLASS9                   N2PF.                               
      @519    I10_PCLASS10                  N2PF.                               
      @521    I10_PCLASS11                  N2PF.                               
      @523    I10_PCLASS12                  N2PF.                               
      @525    I10_PCLASS13                  N2PF.                               
      @527    I10_PCLASS14                  N2PF.                               
      @529    I10_PCLASS15                  N2PF.                               
      @531    I10_PCLASS16                  N2PF.                               
      @533    I10_PCLASS17                  N2PF.                               
      @535    I10_PCLASS18                  N2PF.                               
      @537    I10_PCLASS19                  N2PF.                               
      @539    I10_PCLASS20                  N2PF.                               
      @541    I10_PCLASS21                  N2PF.                               
      @543    I10_PCLASS22                  N2PF.                               
      @545    I10_PCLASS23                  N2PF.                               
      @547    I10_PCLASS24                  N2PF.                               
      @549    I10_PCLASS25                  N2PF.                               
      @551    I10_PRMCCS1                   $CHAR8.                             
      @559    I10_PRMCCS2                   $CHAR8.                             
      @567    I10_PRMCCS3                   $CHAR8.                             
      @575    I10_PRMCCS4                   $CHAR8.                             
      @583    I10_PRMCCS5                   $CHAR8.                             
      @591    I10_PRMCCS6                   $CHAR8.                             
      @599    I10_PRMCCS7                   $CHAR8.                             
      @607    I10_PRMCCS8                   $CHAR8.                             
      @615    I10_PRMCCS9                   $CHAR8.                             
      @623    I10_PRMCCS10                  $CHAR8.                             
      @631    I10_PRMCCS11                  $CHAR8.                             
      @639    I10_PRMCCS12                  $CHAR8.                             
      @647    I10_PRMCCS13                  $CHAR8.                             
      @655    I10_PRMCCS14                  $CHAR8.                             
      @663    I10_PRMCCS15                  $CHAR8.                             
      @671    I10_PRMCCS16                  $CHAR8.                             
      @679    I10_PRMCCS17                  $CHAR8.                             
      @687    I10_PRMCCS18                  $CHAR8.                             
      @695    I10_PRMCCS19                  $CHAR8.                             
      @703    I10_PRMCCS20                  $CHAR8.                             
      @711    I10_PRMCCS21                  $CHAR8.                             
      @719    I10_PRMCCS22                  $CHAR8.                             
      @727    I10_PRMCCS23                  $CHAR8.                             
      @735    I10_PRMCCS24                  $CHAR8.                             
      @743    I10_PRMCCS25                  $CHAR8.                             
      @751    I10_U_BLOOD                   N2PF.                               
      @753    I10_U_CATH                    N2PF.                               
      @755    I10_U_CTSCAN                  N2PF.                               
      @757    I10_U_EKG                     N2PF.                               
      @759    I10_U_MHSA                    N2PF.                               
      @761    I10_U_MRT                     N2PF.                               
      @763    I10_U_PACEMAKER               N2PF.                               
      @765    I10_U_PHYTHERAPY              N2PF.                               
      @767    I10_U_RADTHERAPY              N2PF.                               
      @769    I10_U_STRESS                  N2PF.                               
      @771    KEY                           15.                                 
      @786    U_CCU                         N2PF.                               
      @788    U_CHESTXRAY                   N2PF.                               
      @790    U_DIALYSIS                    N2PF.                               
      @792    U_ECHO                        N2PF.                               
      @794    U_ED                          N2PF.                               
      @796    U_EEG                         N2PF.                               
      @798    U_EPO                         N2PF.                               
      @800    U_ICU                         N2PF.                               
      @802    U_LITHOTRIPSY                 N2PF.                               
      @804    U_NEWBN2L                     N2PF.                               
      @806    U_NEWBN3L                     N2PF.                               
      @808    U_NEWBN4L                     N2PF.                               
      @810    U_NUCMED                      N2PF.                               
      @812    U_OBSERVATION                 N2PF.                               
      @814    U_OCCTHERAPY                  N2PF.                               
      @816    U_ORGANACQ                    N2PF.                               
      @818    U_OTHIMPLANTS                 N2PF.                               
      @820    U_RESPTHERAPY                 N2PF.                               
      @822    U_SPEECHTHERAPY               N2PF.                               
      @824    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
