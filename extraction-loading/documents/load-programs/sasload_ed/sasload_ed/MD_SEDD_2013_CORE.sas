...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SEDDC_2013_CORE;                                                        
INFILE 'MD_SEDD_2013_CORE.ASC' FIRSTOBS=3 LRECL = 1436;                         
...
INPUT                                                                           
      ...
      @1110   DXCCS28                       N4PF.                               
      @1114   DXCCS29                       N4PF.                               
      @1118   DX_Visit_Reason1              $CHAR7.                             
      @1125   DaysToEvent                   N6PF.                               
      @1131   ECODE1                        $CHAR7.                             
      @1138   ECODE2                        $CHAR7.                             
      @1145   ECODE3                        $CHAR7.                             
      @1152   ECODE4                        $CHAR7.                             
      ...
      @1243   HCUP_ED                       N2PF.                               
      @1245   HCUP_OS                       N2PF.                               
      @1247   HISPANIC_X                    $CHAR1.                             
      @1248   HOSPBRTH                      N3PF.                               
      @1251   HOSPST                        $CHAR2.                             
      @1253   KEY                           15.                                 
      @1268   LOS                           N5PF.                               
      @1273   LOS_X                         N6PF.                               
      @1279   MARITALSTATUSUB04             $CHAR1.                             
      @1280   MARITALSTATUS_X               $CHAR1.                             
      @1281   MDNUM1_R                      N9PF.                               
      @1290   MEDINCSTQ                     N2PF.                               
      @1292   MRN_R                         N9PF.                               
      @1301   NCHRONIC                      N3PF.                               
      ...
      @1340   PL_CBSA                       N3PF.                               
      @1343   PL_NCHS                       N2PF.                               
      @1345   PL_RUCA10_2005                N2PF.                               
      @1347   PL_RUCA2005                   N4P1F.                              
      @1351   PL_RUCA4_2005                 N2PF.                               
      @1353   PL_RUCC                       N2PF.                               
      @1355   PL_UIC                        N2PF.                               
