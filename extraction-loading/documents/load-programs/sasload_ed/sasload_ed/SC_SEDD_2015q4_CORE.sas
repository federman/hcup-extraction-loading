...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SEDDC_2015q4_CORE;                                                      
INFILE 'SC_SEDD_2015q4_CORE.ASC' FIRSTOBS=3 LRECL = 1034;                       
...
INPUT                                                                           
      ...
      @426    HCUP_OS                       N2PF.                               
      @428    HOSPST                        $CHAR2.                             
      @430    I10_DX_Visit_Reason1          $CHAR7.                             
      @437    I10_DX_Visit_Reason2          $CHAR7.                             
      @444    I10_DX_Visit_Reason3          $CHAR7.                             
      @451    I10_DX1                       $CHAR7.                             
      @458    I10_DX2                       $CHAR7.                             
      @465    I10_DX3                       $CHAR7.                             
      @472    I10_DX4                       $CHAR7.                             
      ...
      @584    I10_DXCCS8                    N4PF.                               
      @588    I10_DXCCS9                    N4PF.                               
      @592    I10_DXCCS10                   N4PF.                               
      @596    I10_DXCCS11                   N4PF.                               
      @600    I10_DXCCS12                   N4PF.                               
      @604    I10_DXCCS13                   N4PF.                               
      @608    I10_DXCCS14                   N4PF.                               
      @612    I10_DXCCS15                   N4PF.                               
      @616    I10_ECAUSE1                   $CHAR7.                             
      @623    I10_ECAUSE2                   $CHAR7.                             
      @630    I10_ECAUSE3                   $CHAR7.                             
      @637    I10_ECAUSE4                   $CHAR7.                             
      @644    I10_ECAUSE5                   $CHAR7.                             
      @651    I10_ECAUSE6                   $CHAR7.                             
      @658    I10_ECAUSE7                   $CHAR7.                             
      @665    I10_ECAUSE8                   $CHAR7.                             
      @672    I10_ECAUSE9                   $CHAR7.                             
      @679    I10_ECauseCCS1                N4PF.                               
      @683    I10_ECauseCCS2                N4PF.                               
      @687    I10_ECauseCCS3                N4PF.                               
      @691    I10_ECauseCCS4                N4PF.                               
      @695    I10_ECauseCCS5                N4PF.                               
      @699    I10_ECauseCCS6                N4PF.                               
      @703    I10_ECauseCCS7                N4PF.                               
      @707    I10_ECauseCCS8                N4PF.                               
      @711    I10_ECauseCCS9                N4PF.                               
      @715    I10_HOSPBRTH                  N3PF.                               
      @718    I10_NCHRONIC                  N3PF.                               
      @721    I10_NDX                       N3PF.                               
      @724    I10_NECAUSE                   N2PF.                               
      @726    I10_NEOMAT                    N2PF.                               
      @728    I10_NPR                       N3PF.                               
      @731    I10_ORPROC                    N2PF.                               
      @733    I10_PR1                       $CHAR7.                             
      ...
      @845    I10_PRCCS8                    N3PF.                               
      @848    I10_PRCCS9                    N3PF.                               
      @851    I10_PRCCS10                   N3PF.                               
      @854    I10_PRCCS11                   N3PF.                               
      @857    I10_PRCCS12                   N3PF.                               
      @860    I10_PRCCS13                   N3PF.                               
      @863    I10_PROCTYPE                  N3PF.                               
      @866    KEY                           15.                                 
      @881    LOS                           N5PF.                               
      @886    LOS_X                         N6PF.                               
      @892    MDSPEC1                       $CHAR3.                             
