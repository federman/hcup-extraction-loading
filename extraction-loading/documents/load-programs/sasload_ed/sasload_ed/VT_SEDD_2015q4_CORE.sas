...
*  Data Step                  *;                                                
*******************************;                                                
DATA VT_SEDDC_2015q4_CORE;                                                      
INFILE 'VT_SEDD_2015q4_CORE.ASC' FIRSTOBS=3 LRECL = 1795;                       
...
INPUT                                                                           
      ...
      @816    HCUP_OS                       N2PF.                               
      @818    HISPANIC                      N2PF.                               
      @820    HISPANIC_X                    $CHAR1.                             
      @821    HOSP_NPI                      $CHAR10.                            
      @831    HOSPST                        $CHAR2.                             
      @833    I10_DX_Visit_Reason1          $CHAR7.                             
      @840    I10_DX_Visit_Reason2          $CHAR7.                             
      @847    I10_DX1                       $CHAR7.                             
      @854    I10_DX2                       $CHAR7.                             
      @861    I10_DX3                       $CHAR7.                             
      @868    I10_DX4                       $CHAR7.                             
      ...
      @995    I10_DXCCS3                    N4PF.                               
      @999    I10_DXCCS4                    N4PF.                               
      @1003   I10_DXCCS5                    N4PF.                               
      @1007   I10_DXCCS6                    N4PF.                               
      @1011   I10_DXCCS7                    N4PF.                               
      @1015   I10_DXCCS8                    N4PF.                               
      @1019   I10_DXCCS9                    N4PF.                               
      @1023   I10_DXCCS10                   N4PF.                               
      @1027   I10_DXCCS11                   N4PF.                               
      @1031   I10_DXCCS12                   N4PF.                               
      @1035   I10_DXCCS13                   N4PF.                               
      @1039   I10_DXCCS14                   N4PF.                               
      @1043   I10_DXCCS15                   N4PF.                               
      @1047   I10_DXCCS16                   N4PF.                               
      @1051   I10_DXCCS17                   N4PF.                               
      @1055   I10_DXCCS18                   N4PF.                               
      @1059   I10_DXCCS19                   N4PF.                               
      @1063   I10_DXCCS20                   N4PF.                               
      @1067   I10_ECAUSE1                   $CHAR7.                             
      @1074   I10_ECAUSE2                   $CHAR7.                             
      @1081   I10_ECAUSE3                   $CHAR7.                             
      @1088   I10_ECAUSE4                   $CHAR7.                             
      @1095   I10_ECAUSE5                   $CHAR7.                             
      @1102   I10_ECAUSE6                   $CHAR7.                             
      @1109   I10_ECAUSE7                   $CHAR7.                             
      @1116   I10_ECAUSE8                   $CHAR7.                             
      @1123   I10_ECAUSE9                   $CHAR7.                             
      @1130   I10_ECAUSE10                  $CHAR7.                             
      @1137   I10_ECAUSE11                  $CHAR7.                             
      @1144   I10_ECauseCCS1                N4PF.                               
      @1148   I10_ECauseCCS2                N4PF.                               
      @1152   I10_ECauseCCS3                N4PF.                               
      @1156   I10_ECauseCCS4                N4PF.                               
      @1160   I10_ECauseCCS5                N4PF.                               
      @1164   I10_ECauseCCS6                N4PF.                               
      @1168   I10_ECauseCCS7                N4PF.                               
      @1172   I10_ECauseCCS8                N4PF.                               
      @1176   I10_ECauseCCS9                N4PF.                               
      @1180   I10_ECauseCCS10               N4PF.                               
      @1184   I10_ECauseCCS11               N4PF.                               
      @1188   I10_HOSPBRTH                  N3PF.                               
      @1191   I10_NCHRONIC                  N3PF.                               
      @1194   I10_NDX                       N3PF.                               
      @1197   I10_NECAUSE                   N2PF.                               
      @1199   I10_NEOMAT                    N2PF.                               
      @1201   I10_NPR                       N3PF.                               
      @1204   I10_ORPROC                    N2PF.                               
      @1206   I10_PR1                       $CHAR7.                             
      @1213   I10_PR2                       $CHAR7.                             
      @1220   I10_PR3                       $CHAR7.                             
      @1227   I10_PR4                       $CHAR7.                             
      ...
      @1332   I10_PR19                      $CHAR7.                             
      @1339   I10_PR20                      $CHAR7.                             
      @1346   I10_PRCCS1                    N3PF.                               
      @1349   I10_PRCCS2                    N3PF.                               
      @1352   I10_PRCCS3                    N3PF.                               
      @1355   I10_PRCCS4                    N3PF.                               
      @1358   I10_PRCCS5                    N3PF.                               
      @1361   I10_PRCCS6                    N3PF.                               
      @1364   I10_PRCCS7                    N3PF.                               
      @1367   I10_PRCCS8                    N3PF.                               
      @1370   I10_PRCCS9                    N3PF.                               
      @1373   I10_PRCCS10                   N3PF.                               
      @1376   I10_PRCCS11                   N3PF.                               
      @1379   I10_PRCCS12                   N3PF.                               
      @1382   I10_PRCCS13                   N3PF.                               
      @1385   I10_PRCCS14                   N3PF.                               
      @1388   I10_PRCCS15                   N3PF.                               
      @1391   I10_PRCCS16                   N3PF.                               
      @1394   I10_PRCCS17                   N3PF.                               
      @1397   I10_PRCCS18                   N3PF.                               
      @1400   I10_PRCCS19                   N3PF.                               
      @1403   I10_PRCCS20                   N3PF.                               
      @1406   I10_PROCTYPE                  N3PF.                               
      @1409   KEY                           15.                                 
      @1424   LOS                           N5PF.                               
      @1429   LOS_X                         N6PF.                               
      @1435   MEDINCSTQ                     N2PF.                               
      ...
      @1611   STATE_OS                      N2PF.                               
      @1613   TOTCHG                        N10PF.                              
      @1623   TOTCHG_X                      N15P2F.                             
      @1638   VisitLink                     N9PF.                               
      @1647   YEAR                          N4PF.                               
      @1651   ZIP                           $CHAR5.                             
      @1656   ZIP3                          $CHAR3.                             
      @1659   ZIPINC_QRTL                   N3PF.                               
      @1662   TOWN                          $CHAR4.                             
      @1666   AYEAR                         N4PF.                               
      @1670   BMONTH                        N2PF.                               
      @1672   BYEAR                         N4PF.                               
