...
*  Data Step                  *;                                                
*******************************;                                                
DATA KY_SEDDC_2015q1q3_CORE;                                                    
INFILE 'KY_SEDD_2015q1q3_CORE.ASC' FIRSTOBS=3 LRECL = 1369;                     
...
INPUT                                                                           
      ...
      @780    DQTR                          N2PF.                               
      @782    DSHOSPID                      $CHAR17.                            
      @799    DX_Visit_Reason1              $CHAR7.                             
      @806    DX_Visit_Reason2              $CHAR7.                             
      @813    DX_Visit_Reason3              $CHAR7.                             
      @820    DX1                           $CHAR7.                             
      @827    DX2                           $CHAR7.                             
      @834    DX3                           $CHAR7.                             
      @841    DX4                           $CHAR7.                             
      ...
      @1190   HCUP_OS                       N2PF.                               
      @1192   HISPANIC                      N2PF.                               
      @1194   HISPANIC_X                    $CHAR2.                             
      @1196   HOSP_NPI                      $CHAR10.                            
      @1206   HOSPBRTH                      N3PF.                               
      @1209   HOSPST                        $CHAR2.                             
      @1211   KEY                           15.                                 
      @1226   LOS                           N5PF.                               
      ...
      @1290   PL_RUCC                       N2PF.                               
      @1292   PL_UIC                        N2PF.                               
      @1294   PL_UR_CAT4                    N2PF.                               
      @1296   PointOfOrigin_X               $CHAR1.                             
      @1297   PointOfOriginUB04             $CHAR1.                             
      @1298   PROCTYPE                      N3PF.                               
      @1301   PSTATE                        $CHAR2.                             
      @1303   PSTCO                         N5PF.                               
      @1308   PSTCO2                        N5PF.                               
