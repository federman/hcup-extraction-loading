...
*  Data Step                  *;                                                
*******************************;                                                
DATA WI_SEDDC_2017_CORE;                                                        
INFILE 'WI_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1278;                         
...
INPUT                                                                           
      ...
      @619    CPTM2_49                      $CHAR2.                             
      @621    CPTM2_50                      $CHAR2.                             
      @623    DaysToEvent                   N6PF.                               
      @629    DIED                          N2PF.                               
      @631    DISP_X                        $CHAR2.                             
      @633    DISPUB04                      N2PF.                               
      @635    DISPUNIFORM                   N2PF.                               
      @637    DMONTH                        N2PF.                               
      @639    DQTR                          N2PF.                               
      @641    DSHOSPID                      $CHAR17.                            
      @658    DXVER                         N3PF.                               
      ...
      @672    HOSP_NPI                      $CHAR10.                            
      @682    HOSPST                        $CHAR2.                             
      @684    I10_DX_Visit_Reason1          $CHAR7.                             
      @691    I10_DX_Visit_Reason2          $CHAR7.                             
      @698    I10_DX_Visit_Reason3          $CHAR7.                             
      @705    I10_DX1                       $CHAR7.                             
      @712    I10_DX2                       $CHAR7.                             
      @719    I10_DX3                       $CHAR7.                             
      @726    I10_DX4                       $CHAR7.                             
      ...
      @1195   PL_RUCC                       N2PF.                               
      @1197   PL_UIC                        N2PF.                               
      @1199   PL_UR_CAT4                    N2PF.                               
      @1201   PointOfOrigin_X               $CHAR1.                             
      ...
      @1218   STATE_OS                      N2PF.                               
      @1220   TOTCHG                        N10PF.                              
      @1230   TOTCHG_X                      N15P2F.                             
      @1245   VisitLink                     N9PF.                               
      @1254   YEAR                          N4PF.                               
      @1258   ZIP                           $CHAR5.                             
      @1263   ZIP3                          $CHAR3.                             
      @1266   ZIPINC_QRTL                   N3PF.                               
      @1269   AYEAR                         N4PF.                               
      @1273   BMONTH                        N2PF.                               
      @1275   BYEAR                         N4PF.                               
      ;                                                                         
