...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SEDDC_2015q1q3_CORE;                                                    
INFILE 'NJ_SEDD_2015q1q3_CORE.ASC' FIRSTOBS=3 LRECL = 1867;                     
...
INPUT                                                                           
      ...
      @642    DSHOSPID                      $CHAR17.                            
      @659    DURATION                      N6PF.                               
      @665    DX_Visit_Reason1              $CHAR7.                             
      @672    DX_Visit_Reason2              $CHAR7.                             
      @679    DX_Visit_Reason3              $CHAR7.                             
      @686    DX1                           $CHAR7.                             
      @693    DX2                           $CHAR7.                             
      @700    DX3                           $CHAR7.                             
      @707    DX4                           $CHAR7.                             
      ...
      @1257   PL_RUCC                       N2PF.                               
      @1259   PL_UIC                        N2PF.                               
      @1261   PL_UR_CAT4                    N2PF.                               
      @1263   POA_Disch_Edit1               N2PF.                               
      @1265   POA_Disch_Edit2               N2PF.                               
      @1267   POA_Hosp_Edit1                N2PF.                               
      @1269   POA_Hosp_Edit2                N2PF.                               
      @1271   POA_Hosp_Edit3                N2PF.                               
      @1273   POA_Hosp_Edit3_Value          N8P2F.                              
      @1281   PointOfOrigin_X               $CHAR1.                             
      @1282   PointOfOriginUB04             $CHAR1.                             
      @1283   PR1                           $CHAR7.                             
      @1290   PR2                           $CHAR7.                             
      @1297   PR3                           $CHAR7.                             
      @1304   PR4                           $CHAR7.                             
      ...
      @1692   STATE_OS                      N2PF.                               
      @1694   TOTCHG                        N10PF.                              
      @1704   TOTCHG_X                      N15P2F.                             
      @1719   YEAR                          N4PF.                               
      @1723   ZIP                           $CHAR5.                             
      @1728   ZIP3                          $CHAR3.                             
      @1731   ZIPINC_QRTL                   N3PF.                               
      @1734   TOWN                          $CHAR4.                             
      @1738   AYEAR                         N4PF.                               
      @1742   BMONTH                        N2PF.                               
      @1744   BYEAR                         N4PF.                               
