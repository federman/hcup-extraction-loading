...
INFILE 'NC_SEDD_2011_CORE.ASC' FIRSTOBS=3 LRECL = 913;                          
...
INPUT                                                                           
      ...
      @506    HCUP_ED                  N2PF.                                    
      @508    HCUP_OS                  N2PF.                                    
      @510    HCUP_SURGERY_BROAD       N2PF.                                    
      @512    HCUP_SURGERY_NARROW      N2PF.                                    
      @514    HISPANIC_X               $CHAR2.                                  
      @516    HOSPBRTH                 N3PF.                                    
      @519    HOSPST                   $CHAR2.                                  
      @521    KEY                      15.                                      
      @536    LOS                      N5PF.                                    
      ...
      @574    PL_CBSA                  N3PF.                                    
      @577    PL_MSA1993               N3PF.                                    
      @580    PL_NCHS2006              N2PF.                                    
      @582    PL_RUCA10_2005           N2PF.                                    
      @584    PL_RUCA2005              N4P1F.                                   
      @588    PL_RUCA4_2005            N2PF.                                    
      @590    PL_RUCC2003              N2PF.                                    
      @592    PL_UIC2003               N2PF.                                    
      @594    PL_UR_CAT4               N2PF.                                    
      @596    PR1                      $CHAR4.                                  
      @600    PR2                      $CHAR4.                                  
      ...
      @841    PSTCO                    N5PF.                                    
      @846    PSTCO2                   N5PF.                                    
      @851    PointOfOriginUB04        $CHAR1.                                  
      @852    PointOfOrigin_X          $CHAR1.                                  
      @853    RACE                     N2PF.                                    
      @855    RACE_X                   $CHAR1.                                  
      @856    STATE_AS                 N2PF.                                    
      @858    STATE_ED                 N2PF.                                    
