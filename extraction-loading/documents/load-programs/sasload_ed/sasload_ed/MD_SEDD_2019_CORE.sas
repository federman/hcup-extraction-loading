...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SEDDC_2019_CORE;                                                        
INFILE 'MD_SEDD_2019_CORE.ASC' FIRSTOBS=3 LRECL = 1199;                         
...
INPUT                                                                           
      ...
      @603    DIED                          N2PF.                               
      @605    DISPUB04                      N2PF.                               
      @607    DISPUNIFORM                   N2PF.                               
      @609    DISP_X                        $CHAR2.                             
      @611    DQTR                          N2PF.                               
      @613    DSHOSPID                      $CHAR17.                            
      @630    DaysToEvent                   N6PF.                               
      @636    FEMALE                        N2PF.                               
      @638    HCUP_ED                       N2PF.                               
      @640    HCUP_OS                       N2PF.                               
      @642    HISPANIC                      N2PF.                               
      @644    HISPANIC_X                    $CHAR1.                             
      @645    HOSPST                        $CHAR2.                             
      @647    Homeless                      N2PF.                               
      @649    I10_DX1                       $CHAR7.                             
      @656    I10_DX2                       $CHAR7.                             
      ...
      @985    I10_DX49                      $CHAR7.                             
      @992    I10_DX50                      $CHAR7.                             
      @999    I10_DX_Visit_Reason1          $CHAR7.                             
      @1006   I10_NDX                       N3PF.                               
      @1009   I10_PROCTYPE                  N3PF.                               
      @1012   KEY                           15.                                 
      @1027   LOS                           N5PF.                               
      @1032   LOS_X                         N6PF.                               
      @1038   MARITALSTATUSUB04             $CHAR1.                             
      @1039   MARITALSTATUS_X               $CHAR1.                             
      @1040   MDNUM1_R                      N9PF.                               
      @1049   MDNUM2_R                      N9PF.                               
      @1058   MEDINCSTQ                     N2PF.                               
      @1060   MRN_R                         N9PF.                               
      @1069   NCPT                          N4PF.                               
      @1073   OPservice                     $CHAR2.                             
      @1075   OS_TIME                       N11P2F.                             
      @1086   PAY1                          N2PF.                               
      @1088   PAY1_X                        $CHAR2.                             
      @1090   PAY2                          N2PF.                               
      ...
      @1109   PL_RUCC                       N2PF.                               
      @1111   PL_UIC                        N2PF.                               
      @1113   PL_UR_CAT4                    N2PF.                               
      @1115   PSTATE                        $CHAR2.                             
      @1117   PSTATE_GEO                    $CHAR2.                             
      @1119   PSTCO                         N5PF.                               
      @1124   PSTCO_GEO                     N5PF.                               
      @1129   PointOfOriginUB04             $CHAR1.                             
      @1130   PointOfOrigin_X               $CHAR2.                             
      @1132   PrimLang                      $CHAR3.                             
      @1135   RACE                          N2PF.                               
      @1137   RACE_X                        $CHAR1.                             
      @1138   STATE_AS                      N2PF.                               
      @1140   STATE_ED                      N2PF.                               
      @1142   STATE_OS                      N2PF.                               
      @1144   SpannedServiceCount           N3PF.                               
      @1147   TOTCHG                        N10PF.                              
      @1157   TOTCHG_X                      N15P2F.                             
      @1172   VisitLink                     N9PF.                               
      @1181   YEAR                          N4PF.                               
      @1185   ZIP                           $CHAR5.                             
      @1190   ZIP3                          $CHAR3.                             
