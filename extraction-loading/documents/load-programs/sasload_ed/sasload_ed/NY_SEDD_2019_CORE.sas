...
*  Data Step                  *;                                                
*******************************;                                                
DATA NY_SEDDC_2019_CORE;                                                        
INFILE 'NY_SEDD_2019_CORE.ASC' FIRSTOBS=3 LRECL = 3674;                         
...
INPUT                                                                           
      ...
      @3089   HISPANIC                      N2PF.                               
      @3091   HISPANIC_X                    $CHAR75.                            
      @3166   Homeless                      N2PF.                               
      @3168   HOSP_NPI                      $CHAR10.                            
      @3178   HOSPST                        $CHAR2.                             
      @3180   I10_DX_Visit_Reason1          $CHAR7.                             
      @3187   I10_DX_Visit_Reason2          $CHAR7.                             
      @3194   I10_DX_Visit_Reason3          $CHAR7.                             
      @3201   I10_DX1                       $CHAR7.                             
      @3208   I10_DX2                       $CHAR7.                             
      @3215   I10_DX3                       $CHAR7.                             
      @3222   I10_DX4                       $CHAR7.                             
      ...
      @3432   I10_DX34                      $CHAR7.                             
      @3439   I10_NDX                       N3PF.                               
      @3442   I10_PROCTYPE                  N3PF.                               
      @3445   KEY                           15.                                 
      @3460   LOS                           N5PF.                               
      @3465   LOS_X                         N6PF.                               
      @3471   MARITALSTATUS_X               $CHAR1.                             
      @3472   MARITALSTATUSUB04             $CHAR1.                             
      @3473   MDNUM1_R                      N9PF.                               
      @3482   MDNUM2_R                      N9PF.                               
      @3491   MEDINCSTQ                     N2PF.                               
      @3493   NCPT                          N4PF.                               
      @3497   OPservice                     $CHAR1.                             
      @3498   OS_TIME                       N11P2F.                             
      @3509   PAY1                          N2PF.                               
      @3511   PAY1_X                        $CHAR5.                             
      @3516   PAY2                          N2PF.                               
      ...
      @3535   PL_RUCC                       N2PF.                               
      @3537   PL_UIC                        N2PF.                               
      @3539   PL_UR_CAT4                    N2PF.                               
      @3541   PointOfOrigin_X               $CHAR1.                             
      @3542   PointOfOriginUB04             $CHAR1.                             
      @3543   PSTATE                        $CHAR2.                             
      @3545   PSTATE_GEO                    $CHAR2.                             
      @3547   PSTCO                         N5PF.                               
      @3552   PSTCO_GEO                     N5PF.                               
      @3557   RACE                          N2PF.                               
      @3559   RACE_X                        $CHAR51.                            
      ...
      @3614   STATE_OS                      N2PF.                               
      @3616   TOTCHG                        N10PF.                              
      @3626   TOTCHG_X                      N15P2F.                             
      @3641   VisitLink                     N9PF.                               
      @3650   YEAR                          N4PF.                               
      @3654   ZIP                           $CHAR5.                             
      @3659   ZIP3                          $CHAR3.                             
      @3662   ZIPINC_QRTL                   N3PF.                               
      @3665   AYEAR                         N4PF.                               
      @3669   BMONTH                        N2PF.                               
      @3671   BYEAR                         N4PF.                               
      ;                                                                         
