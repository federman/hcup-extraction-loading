...
*  Data Step                  *;                                                
*******************************;                                                
DATA GA_SEDDC_2012_DX_PR_GRPS;                                                  
INFILE 'GA_SEDD_2012_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 1102;                   
...
INPUT                                                                           
      ...
      @746    INJURY                        N2PF.                               
      @748    INJURY_CUT                    N2PF.                               
      @750    INJURY_DROWN                  N2PF.                               
      @752    INJURY_FALL                   N2PF.                               
      @754    INJURY_FIRE                   N2PF.                               
      @756    INJURY_FIREARM                N2PF.                               
      @758    INJURY_MACHINERY              N2PF.                               
      @760    INJURY_MVT                    N2PF.                               
      @762    INJURY_NATURE                 N2PF.                               
      @764    INJURY_POISON                 N2PF.                               
      @766    INJURY_STRUCK                 N2PF.                               
      @768    INJURY_SUFFOCATION            N2PF.                               
      @770    INTENT_ASSAULT                N2PF.                               
      @772    INTENT_SELF_HARM              N2PF.                               
      @774    INTENT_UNINTENTIONAL          N2PF.                               
      @776    KEY                           15.                                 
      @791    MULTINJURY                    N2PF.                               
      @793    PCLASS1                       N2PF.                               
      @795    PCLASS2                       N2PF.                               
      ...
      @1045   U_CATH                        N2PF.                               
      @1047   U_CCU                         N2PF.                               
      @1049   U_CHESTXRAY                   N2PF.                               
      @1051   U_CTSCAN                      N2PF.                               
      @1053   U_DIALYSIS                    N2PF.                               
      @1055   U_ECHO                        N2PF.                               
      @1057   U_ED                          N2PF.                               
      @1059   U_EEG                         N2PF.                               
      @1061   U_EKG                         N2PF.                               
      ...
      @1077   U_NEWBN4L                     N2PF.                               
      @1079   U_NUCMED                      N2PF.                               
      @1081   U_OBSERVATION                 N2PF.                               
      @1083   U_OCCTHERAPY                  N2PF.                               
      @1085   U_ORGANACQ                    N2PF.                               
      @1087   U_OTHIMPLANTS                 N2PF.                               
      @1089   U_PACEMAKER                   N2PF.                               
      @1091   U_PHYTHERAPY                  N2PF.                               
      @1093   U_RADTHERAPY                  N2PF.                               
      @1095   U_RESPTHERAPY                 N2PF.                               
      @1097   U_SPEECHTHERAPY               N2PF.                               
      @1099   U_STRESS                      N2PF.                               
      @1101   U_ULTRASOUND                  N2PF.                               
      ;                                                                         
