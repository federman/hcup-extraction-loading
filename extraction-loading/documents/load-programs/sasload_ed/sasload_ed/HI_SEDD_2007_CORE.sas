...
INFILE 'HI_SEDD_2007_CORE.ASC' FIRSTOBS=3 LRECL = 696;                          
...
INPUT                                                                           
      ...
      @424    PL_RUCA10_2005           N2PF.                                    
      @426    PL_RUCA2005              N4P1F.                                   
      @430    PL_RUCA4_2005            N2PF.                                    
      ...
      @561    PSTATE                   $CHAR2.                                  
      @563    PSTCO2                   N5PF.                                    
      @568    PointOfOriginUB04        $CHAR1.                                  
      @569    PointOfOrigin_X          $CHAR1.                                  
      @570    RACE                     N2PF.                                    
      @572    RACE_X                   $CHAR2.                                  
      @574    STATE_AS                 N2PF.                                    
      @576    STATE_ED                 N2PF.                                    
