...
*  Data Step                  *;                                                
*******************************;                                                
DATA VT_SEDDC_2015q1q3_CORE;                                                    
INFILE 'VT_SEDD_2015q1q3_CORE.ASC' FIRSTOBS=3 LRECL = 1795;                     
...
INPUT                                                                           
      ...
      @790    DQTR                          N2PF.                               
      @792    DSHOSPID                      $CHAR17.                            
      @809    DX_Visit_Reason1              $CHAR7.                             
      @816    DX_Visit_Reason2              $CHAR7.                             
      @823    DX1                           $CHAR7.                             
      @830    DX2                           $CHAR7.                             
      @837    DX3                           $CHAR7.                             
      @844    DX4                           $CHAR7.                             
      ...
      @1171   HCUP_OS                       N2PF.                               
      @1173   HISPANIC                      N2PF.                               
      @1175   HISPANIC_X                    $CHAR1.                             
      @1176   HOSP_NPI                      $CHAR10.                            
      @1186   HOSPBRTH                      N3PF.                               
      @1189   HOSPST                        $CHAR2.                             
      @1191   KEY                           15.                                 
      @1206   LOS                           N5PF.                               
      ...
      @1276   PL_RUCC                       N2PF.                               
      @1278   PL_UIC                        N2PF.                               
      @1280   PL_UR_CAT4                    N2PF.                               
      @1282   PointOfOrigin_X               $CHAR1.                             
      @1283   PointOfOriginUB04             $CHAR1.                             
      @1284   PR1                           $CHAR7.                             
      @1291   PR2                           $CHAR7.                             
      @1298   PR3                           $CHAR7.                             
      @1305   PR4                           $CHAR7.                             
