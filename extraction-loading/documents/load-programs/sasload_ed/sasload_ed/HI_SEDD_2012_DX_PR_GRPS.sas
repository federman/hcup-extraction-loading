...
*  Data Step                  *;                                                
*******************************;                                                
DATA HI_SEDDC_2012_DX_PR_GRPS;                                                  
INFILE 'HI_SEDD_2012_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 434;                    
...
INPUT                                                                           
      ...
      @228    INJURY                        N2PF.                               
      @230    INJURY_CUT                    N2PF.                               
      @232    INJURY_DROWN                  N2PF.                               
      @234    INJURY_FALL                   N2PF.                               
      @236    INJURY_FIRE                   N2PF.                               
      @238    INJURY_FIREARM                N2PF.                               
      @240    INJURY_MACHINERY              N2PF.                               
      @242    INJURY_MVT                    N2PF.                               
      @244    INJURY_NATURE                 N2PF.                               
      @246    INJURY_POISON                 N2PF.                               
      @248    INJURY_STRUCK                 N2PF.                               
      @250    INJURY_SUFFOCATION            N2PF.                               
      @252    INTENT_ASSAULT                N2PF.                               
      @254    INTENT_SELF_HARM              N2PF.                               
      @256    INTENT_UNINTENTIONAL          N2PF.                               
      @258    KEY                           15.                                 
      @273    MULTINJURY                    N2PF.                               
      @275    PCLASS1                       N2PF.                               
      @277    PCLASS2                       N2PF.                               
      ...
      @409    U_NEWBN4L                     N2PF.                               
      @411    U_NUCMED                      N2PF.                               
      @413    U_OBSERVATION                 N2PF.                               
      @415    U_OCCTHERAPY                  N2PF.                               
      @417    U_ORGANACQ                    N2PF.                               
      @419    U_OTHIMPLANTS                 N2PF.                               
      @421    U_PACEMAKER                   N2PF.                               
      @423    U_PHYTHERAPY                  N2PF.                               
      @425    U_RADTHERAPY                  N2PF.                               
      @427    U_RESPTHERAPY                 N2PF.                               
      @429    U_SPEECHTHERAPY               N2PF.                               
      @431    U_STRESS                      N2PF.                               
      @433    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
