...
*  Data Step                  *;                                                
*******************************;                                                
DATA NV_SEDDC_2018_CORE;                                                        
INFILE 'NV_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 1175;                         
...
INPUT                                                                           
      ...
      @1115   PointOfOrigin_X               $CHAR2.                             
      @1117   PointOfOriginUB04             $CHAR1.                             
      @1118   PSTATE                        $CHAR2.                             
      @1120   PSTCO                         N5PF.                               
      @1125   PSTCO2                        N5PF.                               
      @1130   RACE                          N2PF.                               
      ...
      @1138   STATE_OS                      N2PF.                               
      @1140   TOTCHG                        N10PF.                              
      @1150   TOTCHG_X                      N15P2F.                             
      @1165   YEAR                          N4PF.                               
      @1169   ZIPINC_QRTL                   N3PF.                               
      @1172   AYEAR                         N4PF.                               
      ;                                                                         
