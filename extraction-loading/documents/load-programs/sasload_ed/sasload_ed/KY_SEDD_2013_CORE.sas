...
*  Data Step                  *;                                                
*******************************;                                                
DATA KY_SEDDC_2013_CORE;                                                        
INFILE 'KY_SEDD_2013_CORE.ASC' FIRSTOBS=3 LRECL = 1289;                         
...
INPUT                                                                           
      ...
      @1016   DXCCS24                  N4PF.                                    
      @1020   DXCCS25                  N4PF.                                    
      @1024   DX_Visit_Reason1         $CHAR5.                                  
      @1029   DX_Visit_Reason2         $CHAR5.                                  
      @1034   DX_Visit_Reason3         $CHAR5.                                  
      @1039   ECODE1                   $CHAR5.                                  
      @1044   ECODE2                   $CHAR5.                                  
      @1049   ECODE3                   $CHAR5.                                  
      @1054   ECODE4                   $CHAR5.                                  
      ...
      @1104   HCUP_ED                  N2PF.                                    
      @1106   HCUP_OS                  N2PF.                                    
      @1108   HISPANIC_X               $CHAR2.                                  
      @1110   HOSPBRTH                 N3PF.                                    
      @1113   HOSPST                   $CHAR2.                                  
      @1115   HOSP_NPI                 $CHAR10.                                 
      @1125   KEY                      15.                                      
      @1140   LOS                      N5PF.                                    
      @1145   LOS_X                    N6PF.                                    
      @1151   MEDINCSTQ                N2PF.                                    
      ...
      @1196   PL_CBSA                  N3PF.                                    
      @1199   PL_NCHS                  N2PF.                                    
      @1201   PL_RUCA10_2005           N2PF.                                    
      @1203   PL_RUCA2005              N4P1F.                                   
      @1207   PL_RUCA4_2005            N2PF.                                    
      @1209   PL_RUCC                  N2PF.                                    
      @1211   PL_UIC                   N2PF.                                    
      @1213   PL_UR_CAT4               N2PF.                                    
      @1215   PROCTYPE                 N3PF.                                    
      @1218   PSTATE                   $CHAR2.                                  
      @1220   PSTCO                    N5PF.                                    
      @1225   PSTCO2                   N5PF.                                    
      @1230   PointOfOriginUB04        $CHAR1.                                  
      @1231   PointOfOrigin_X          $CHAR2.                                  
      @1233   RACE                     N2PF.                                    
      @1235   RACE_X                   $CHAR2.                                  
      @1237   STATE_AS                 N2PF.                                    
      @1239   STATE_ED                 N2PF.                                    
