...
*  Data Step                  *;                                                
*******************************;                                                
DATA KY_SEDDC_2018_CORE;                                                        
INFILE 'KY_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 1942;                         
...
INPUT                                                                           
      ...
      @1559   HOSP_NPI                      $CHAR10.                            
      @1569   HOSPST                        $CHAR2.                             
      @1571   I10_DX_Visit_Reason1          $CHAR7.                             
      @1578   I10_DX_Visit_Reason2          $CHAR7.                             
      @1585   I10_DX_Visit_Reason3          $CHAR7.                             
      @1592   I10_DX1                       $CHAR7.                             
      @1599   I10_DX2                       $CHAR7.                             
      @1606   I10_DX3                       $CHAR7.                             
      @1613   I10_DX4                       $CHAR7.                             
      ...
      @1869   PointOfOrigin_X               $CHAR1.                             
      @1870   PointOfOriginUB04             $CHAR1.                             
      @1871   PSTATE                        $CHAR2.                             
      @1873   PSTCO                         N5PF.                               
      @1878   PSTCO2                        N5PF.                               
      @1883   RACE                          N2PF.                               
