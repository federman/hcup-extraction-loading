...
*  Data Step                  *;                                                
*******************************;                                                
DATA DC_SEDDC_2018_CORE;                                                        
INFILE 'DC_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 1666;                         
...
INPUT                                                                           
      ...
      @1150   HCUP_OS                       N2PF.                               
      @1152   HOSPST                        $CHAR2.                             
      @1154   I10_DX_Visit_Reason1          $CHAR7.                             
      @1161   I10_DX1                       $CHAR7.                             
      @1168   I10_DX2                       $CHAR7.                             
      @1175   I10_DX3                       $CHAR7.                             
      @1182   I10_DX4                       $CHAR7.                             
      ...
      @1579   PL_RUCC                       N2PF.                               
      @1581   PL_UIC                        N2PF.                               
      @1583   PL_UR_CAT4                    N2PF.                               
      @1585   PointOfOrigin_X               $CHAR3.                             
      @1588   PointOfOriginUB04             $CHAR1.                             
      @1589   PSTATE                        $CHAR2.                             
      @1591   PSTCO                         N5PF.                               
      @1596   PSTCO2                        N5PF.                               
      @1601   RACE                          N2PF.                               
      ...
      @1610   STATE_OS                      N2PF.                               
      @1612   TOTCHG                        N10PF.                              
      @1622   TOTCHG_X                      N15P2F.                             
      @1637   YEAR                          N4PF.                               
      @1641   ZIP                           $CHAR5.                             
      @1646   ZIP3                          $CHAR3.                             
      @1649   ZIPINC_QRTL                   N3PF.                               
      @1652   HOSPID                        N5PF.                               
      @1657   AYEAR                         N4PF.                               
      @1661   BMONTH                        N2PF.                               
      @1663   BYEAR                         N4PF.                               
