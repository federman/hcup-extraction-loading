...
*  Data Step                  *;                                                
*******************************;                                                
DATA NV_SEDDC_2013_CORE;                                                        
INFILE 'NV_SEDD_2013_CORE.ASC' FIRSTOBS=3 LRECL = 1169;                         
...
INPUT                                                                           
      ...
      @1022   LOS                           N5PF.                               
      @1027   LOS_X                         N6PF.                               
      @1033   MARITALSTATUSUB04             $CHAR1.                             
      @1034   MARITALSTATUS_X               $CHAR1.                             
      @1035   MDNUM1_R                      N9PF.                               
      @1044   MDNUM2_R                      N9PF.                               
      @1053   MDNUMTYPE1                    $CHAR1.                             
      @1054   MDNUMTYPE2                    $CHAR1.                             
      @1055   MEDINCSTQ                     N2PF.                               
      @1057   NCHRONIC                      N3PF.                               
      @1060   NCPT                          N3PF.                               
      @1063   NDX                           N3PF.                               
      ...
      @1088   PAY3_X                        $CHAR2.                             
      @1090   PL_NCHS                       N2PF.                               
      @1092   PL_RUCA10_2005                N2PF.                               
      @1094   PL_RUCA2005                   N4P1F.                              
      @1098   PL_RUCA4_2005                 N2PF.                               
      @1100   PL_RUCC                       N2PF.                               
      @1102   PL_UIC                        N2PF.                               
      ...
      @1132   STATE_OS                      N2PF.                               
      @1134   TOTCHG                        N10PF.                              
      @1144   TOTCHG_X                      N15P2F.                             
      @1159   YEAR                          N4PF.                               
      @1163   ZIPINC_QRTL                   N3PF.                               
      @1166   AYEAR                         N4PF.                               
      ;                                                                         
