...
*  Data Step                  *;                                                
*******************************;                                                
DATA AZ_SEDDC_2013_CORE;                                                        
INFILE 'AZ_SEDD_2013_CORE.ASC' FIRSTOBS=3 LRECL = 902;                          
...
INPUT                                                                           
      ...
      @410    DXCCS24                  N4PF.                                    
      @414    DXCCS25                  N4PF.                                    
      @418    DX_Visit_Reason1         $CHAR5.                                  
      @423    DX_Visit_Reason2         $CHAR5.                                  
      @428    DX_Visit_Reason3         $CHAR5.                                  
      @433    ECODE1                   $CHAR5.                                  
      @438    ECODE2                   $CHAR5.                                  
      @443    ECODE3                   $CHAR5.                                  
      @448    ECODE4                   $CHAR5.                                  
      ...
      @764    PSTATE                   $CHAR2.                                  
      @766    PSTCO2                   N5PF.                                    
      @771    PointOfOriginUB04        $CHAR1.                                  
      @772    PointOfOrigin_X          $CHAR1.                                  
      @773    RACE                     N2PF.                                    
      @775    RACE_X                   $CHAR4.                                  
      @779    SPLIT_IPED               N2PF.                                    
      @781    STATE_AS                 N2PF.                                    
