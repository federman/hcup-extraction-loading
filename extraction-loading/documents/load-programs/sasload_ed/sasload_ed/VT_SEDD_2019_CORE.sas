...
*  Data Step                  *;                                                
*******************************;                                                
DATA VT_SEDDC_2019_CORE;                                                        
INFILE 'VT_SEDD_2019_CORE.ASC' FIRSTOBS=3 LRECL = 1936;                         
...
INPUT                                                                           
      ...
      @1536   DMONTH                        N2PF.                               
      @1538   DQTR                          N2PF.                               
      @1540   DSHOSPID                      $CHAR17.                            
      @1557   DURATION                      N6PF.                               
      @1563   DaysToEvent                   N6PF.                               
      @1569   FEMALE                        N2PF.                               
      @1571   HCUP_ED                       N2PF.                               
      @1573   HCUP_OS                       N2PF.                               
      @1575   HISPANIC                      N2PF.                               
      @1577   HISPANIC_X                    $CHAR1.                             
      @1578   HOSPST                        $CHAR2.                             
      @1580   HOSP_NPI                      $CHAR10.                            
      @1590   I10_DX1                       $CHAR7.                             
      @1597   I10_DX2                       $CHAR7.                             
      @1604   I10_DX3                       $CHAR7.                             
      @1611   I10_DX4                       $CHAR7.                             
      ...
      @1737   I10_DX22                      $CHAR7.                             
      @1744   I10_DX23                      $CHAR7.                             
      @1751   I10_DX_Visit_Reason1          $CHAR7.                             
      @1758   I10_DX_Visit_Reason2          $CHAR7.                             
      @1765   I10_NDX                       N3PF.                               
      @1768   I10_PROCTYPE                  N3PF.                               
      @1771   KEY                           15.                                 
      @1786   LOS                           N5PF.                               
      @1791   LOS_X                         N6PF.                               
      @1797   MEDINCSTQ                     N2PF.                               
      @1799   NCPT                          N4PF.                               
      @1803   OBSERVATION                   N4PF.                               
      @1807   OPservice                     $CHAR1.                             
      @1808   PAY1                          N2PF.                               
      @1810   PAY1_X                        $CHAR2.                             
      @1812   PAY2                          N2PF.                               
      @1814   PAY2_X                        $CHAR2.                             
      ...
      @1843   PL_RUCC                       N2PF.                               
      @1845   PL_UIC                        N2PF.                               
      @1847   PL_UR_CAT4                    N2PF.                               
      @1849   PSTATE                        $CHAR2.                             
      @1851   PSTATE_GEO                    $CHAR2.                             
      @1853   PSTCO                         N5PF.                               
      @1858   PSTCO_GEO                     N5PF.                               
      @1863   PointOfOriginUB04             $CHAR1.                             
      @1864   PointOfOrigin_X               $CHAR1.                             
      @1865   RACE                          N2PF.                               
      @1867   RACE_X                        $CHAR1.                             
      @1868   STATE_AS                      N2PF.                               
      @1870   STATE_ED                      N2PF.                               
      @1872   STATE_OS                      N2PF.                               
      @1874   TOTCHG                        N10PF.                              
      @1884   TOTCHG_X                      N15P2F.                             
      @1899   VisitLink                     N9PF.                               
      @1908   YEAR                          N4PF.                               
      @1912   ZIP                           $CHAR5.                             
      @1917   ZIP3                          $CHAR3.                             
      @1920   ZIPINC_QRTL                   N3PF.                               
      @1923   TOWN                          $CHAR4.                             
      @1927   AYEAR                         N4PF.                               
      @1931   BMONTH                        N2PF.                               
      @1933   BYEAR                         N4PF.                               
