...
*  Data Step                  *;                                                
*******************************;                                                
DATA IA_SEDDC_2020_CORE;                                                        
INFILE 'IA_SEDD_2020_CORE.ASC' FIRSTOBS=3 LRECL = 3585;                         
...
INPUT                                                                           
      ...
      @3490   PL_RUCC                       N2PF.                               
      @3492   PL_UIC                        N2PF.                               
      @3494   PL_UR_CAT4                    N2PF.                               
      @3496   PointOfOrigin_X               $CHAR1.                             
      @3497   PointOfOriginUB04             $CHAR1.                             
      @3498   PrimLang                      $CHAR3.                             
      @3501   PSTATE                        $CHAR2.                             
      @3503   PSTATE_GEO                    $CHAR2.                             
      @3505   PSTCO                         N5PF.                               
      @3510   PSTCO_GEO                     N5PF.                               
      @3515   RACE                          N2PF.                               
      @3517   RACE_X                        $CHAR4.                             
      ...
      @3525   STATE_OS                      N2PF.                               
      @3527   TOTCHG                        N10PF.                              
      @3537   TOTCHG_X                      N15P2F.                             
      @3552   VisitLink                     N9PF.                               
      @3561   YEAR                          N4PF.                               
      @3565   ZIP                           $CHAR5.                             
      @3570   ZIP3                          $CHAR3.                             
      @3573   ZIPINC_QRTL                   N3PF.                               
      @3576   AYEAR                         N4PF.                               
      @3580   BMONTH                        N2PF.                               
      @3582   BYEAR                         N4PF.                               
      ;                                                                         
