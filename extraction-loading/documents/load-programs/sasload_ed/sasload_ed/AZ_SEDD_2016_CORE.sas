...
*  Data Step                  *;                                                
*******************************;                                                
DATA AZ_SEDDC_2016_CORE;                                                        
INFILE 'AZ_SEDD_2016_CORE.ASC' FIRSTOBS=3 LRECL = 617;                          
...
INPUT                                                                           
      ...
      @401    I10_DX24                      $CHAR7.                             
      @408    I10_DX25                      $CHAR7.                             
      @415    I10_ECAUSE1                   $CHAR7.                             
      @422    I10_ECAUSE2                   $CHAR7.                             
      @429    I10_ECAUSE3                   $CHAR7.                             
      @436    I10_ECAUSE4                   $CHAR7.                             
      @443    I10_ECAUSE5                   $CHAR7.                             
      @450    I10_ECAUSE6                   $CHAR7.                             
      @457    I10_NDX                       N3PF.                               
      @460    I10_NECAUSE                   N2PF.                               
      @462    I10_PROCTYPE                  N3PF.                               
      @465    KEY                           15.                                 
      @480    LOS                           N5PF.                               
      @485    LOS_X                         N6PF.                               
      @491    MARITALSTATUSUB04             $CHAR1.                             
      @492    MDBOARD1                      $CHAR1.                             
      @493    MDBOARD2                      $CHAR1.                             
      @494    MDNUM1_R                      N9PF.                               
      @503    MDNUM2_R                      N9PF.                               
      ...
      @548    PL_UIC                        N2PF.                               
      @550    PL_UR_CAT4                    N2PF.                               
      @552    PointOfOrigin_X               $CHAR1.                             
      @553    PointOfOriginUB04             $CHAR1.                             
      @554    PSTATE                        $CHAR2.                             
      @556    PSTCO2                        N5PF.                               
      @561    RACE                          N2PF.                               
      @563    RACE_X                        $CHAR3.                             
