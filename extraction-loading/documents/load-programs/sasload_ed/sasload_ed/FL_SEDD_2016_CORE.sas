...
*  Data Step                  *;                                                
*******************************;                                                
DATA FL_SEDDC_2016_CORE;                                                        
INFILE 'FL_SEDD_2016_CORE.ASC' FIRSTOBS=3 LRECL = 644;                          
...
INPUT                                                                           
      ...
      @340    HCUP_OS                       N2PF.                               
      @342    HISPANIC                      N2PF.                               
      @344    HISPANIC_X                    $CHAR2.                             
      @346    Homeless                      N2PF.                               
      @348    HOSPST                        $CHAR2.                             
      @350    I10_DX_Visit_Reason1          $CHAR7.                             
      @357    I10_DX1                       $CHAR7.                             
      @364    I10_DX2                       $CHAR7.                             
      @371    I10_DX3                       $CHAR7.                             
      @378    I10_DX4                       $CHAR7.                             
      ...
      @413    I10_DX9                       $CHAR7.                             
      @420    I10_DX10                      $CHAR7.                             
      @427    I10_ECAUSE1                   $CHAR7.                             
      @434    I10_ECAUSE2                   $CHAR7.                             
      @441    I10_ECAUSE3                   $CHAR7.                             
      @448    I10_NDX                       N3PF.                               
      @451    I10_NECAUSE                   N2PF.                               
      @453    I10_NPR                       N3PF.                               
      @456    I10_PR1                       $CHAR7.                             
      @463    I10_PR2                       $CHAR7.                             
      @470    I10_PR3                       $CHAR7.                             
