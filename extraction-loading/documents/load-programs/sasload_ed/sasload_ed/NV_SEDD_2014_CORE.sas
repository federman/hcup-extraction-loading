...
*  Data Step                  *;                                                
*******************************;                                                
DATA NV_SEDDC_2014_CORE;                                                        
INFILE 'NV_SEDD_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1242;                         
...
INPUT                                                                           
      ...
      @1099   LOS                           N5PF.                               
      @1104   LOS_X                         N6PF.                               
      @1110   MARITALSTATUSUB04             $CHAR1.                             
      @1111   MARITALSTATUS_X               $CHAR1.                             
      @1112   MDNUM1_R                      N9PF.                               
      @1121   MDNUM2_R                      N9PF.                               
      @1130   MDNUMTYPE1                    $CHAR1.                             
      @1131   MDNUMTYPE2                    $CHAR1.                             
      @1132   MEDINCSTQ                     N2PF.                               
      @1134   NCHRONIC                      N3PF.                               
      @1137   NCPT                          N4PF.                               
      @1141   NDX                           N3PF.                               
      ...
      @1173   PL_RUCC                       N2PF.                               
      @1175   PL_UIC                        N2PF.                               
      @1177   PL_UR_CAT4                    N2PF.                               
      @1179   PROCTYPE                      N3PF.                               
      @1182   PSTATE                        $CHAR2.                             
      @1184   PSTCO                         N5PF.                               
      @1189   PSTCO2                        N5PF.                               
      @1194   PointOfOriginUB04             $CHAR1.                             
      @1195   PointOfOrigin_X               $CHAR2.                             
      @1197   RACE                          N2PF.                               
      @1199   RACE_X                        $CHAR2.                             
      @1201   STATE_AS                      N2PF.                               
      @1203   STATE_ED                      N2PF.                               
      @1205   STATE_OS                      N2PF.                               
      @1207   TOTCHG                        N10PF.                              
      @1217   TOTCHG_X                      N15P2F.                             
      @1232   YEAR                          N4PF.                               
      @1236   ZIPINC_QRTL                   N3PF.                               
      @1239   AYEAR                         N4PF.                               
      ;                                                                         
