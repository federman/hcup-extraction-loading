...
*  Data Step                  *;                                                
*******************************;                                                
DATA NE_SEDDC_2014_CORE;                                                        
INFILE 'NE_SEDD_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1027;                         
...
INPUT                                                                           
      ...
      @741    DXCCS9                        N4PF.                               
      @745    DXVER                         N3PF.                               
      @748    DX_Visit_Reason1              $CHAR7.                             
      @755    DaysToEvent                   N6PF.                               
      @761    ECODE1                        $CHAR7.                             
      @768    ECODE2                        $CHAR7.                             
      @775    ECODE3                        $CHAR7.                             
      @782    ECODE4                        $CHAR7.                             
      ...
      @864    LOS                           N5PF.                               
      @869    LOS_X                         N6PF.                               
      @875    MARITALSTATUSUB04             $CHAR1.                             
      @876    MARITALSTATUS_X               $CHAR1.                             
      @877    MEDINCSTQ                     N2PF.                               
      @879    NCHRONIC                      N3PF.                               
      @882    NCPT                          N4PF.                               
      @886    NDX                           N3PF.                               
