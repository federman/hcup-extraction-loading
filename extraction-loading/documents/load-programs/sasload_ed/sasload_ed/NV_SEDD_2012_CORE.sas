...
*  Data Step                  *;                                                
*******************************;                                                
DATA NV_SEDDC_2012_CORE;                                                        
INFILE 'NV_SEDD_2012_CORE.ASC' FIRSTOBS=3 LRECL = 1101;                         
...
INPUT                                                                           
      ...
      @953    LOS                      N5PF.                                    
      @958    LOS_X                    N6PF.                                    
      @964    MARITALSTATUSUB04        $CHAR1.                                  
      @965    MARITALSTATUS_X          $CHAR1.                                  
      @966    MDNUM1_R                 N9PF.                                    
      @975    MDNUM2_R                 N9PF.                                    
      @984    MDNUMTYPE1               $CHAR1.                                  
      @985    MDNUMTYPE2               $CHAR1.                                  
      @986    MEDINCSTQ                N2PF.                                    
      @988    NCHRONIC                 N3PF.                                    
      @991    NCPT                     N3PF.                                    
      @994    NDX                      N2PF.                                    
      ...
      @1016   PAY3                     N2PF.                                    
      @1018   PAY3_X                   $CHAR2.                                  
      @1020   PL_NCHS2006              N2PF.                                    
      @1022   PL_RUCA10_2005           N2PF.                                    
      @1024   PL_RUCA2005              N4P1F.                                   
      @1028   PL_RUCA4_2005            N2PF.                                    
      @1030   PL_RUCC2003              N2PF.                                    
      @1032   PL_UIC2003               N2PF.                                    
      @1034   PL_UR_CAT4               N2PF.                                    
      @1036   PROCTYPE                 N3PF.                                    
      @1039   PSTATE                   $CHAR2.                                  
      @1041   PSTCO                    N5PF.                                    
      @1046   PSTCO2                   N5PF.                                    
      @1051   PointOfOriginUB04        $CHAR1.                                  
      @1052   PointOfOrigin_X          $CHAR2.                                  
      @1054   RACE                     N2PF.                                    
      @1056   RACE_X                   $CHAR2.                                  
      @1058   STATE_AS                 N2PF.                                    
      @1060   STATE_ED                 N2PF.                                    
