...
*  Data Step                  *;                                                
*******************************;                                                
DATA ME_SEDDC_2018_CORE;                                                        
INFILE 'ME_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 1856;                         
...
INPUT                                                                           
      ...
      @1523   HCUP_OS                       N2PF.                               
      @1525   HOSPST                        $CHAR2.                             
      @1527   I10_DX_Visit_Reason1          $CHAR7.                             
      @1534   I10_DX_Visit_Reason2          $CHAR7.                             
      @1541   I10_DX_Visit_Reason3          $CHAR7.                             
      @1548   I10_DX1                       $CHAR7.                             
      @1555   I10_DX2                       $CHAR7.                             
      @1562   I10_DX3                       $CHAR7.                             
      @1569   I10_DX4                       $CHAR7.                             
