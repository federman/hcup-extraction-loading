...
*  Data Step                  *;                                                
*******************************;                                                
DATA AR_SEDDC_2016_CORE;                                                        
INFILE 'AR_SEDD_2016_CORE.ASC' FIRSTOBS=3 LRECL = 1278;                         
...
INPUT                                                                           
      ...
      @660    HCUP_OS                       N2PF.                               
      @662    HISPANIC                      N2PF.                               
      @664    HISPANIC_X                    $CHAR1.                             
      @665    HOSPST                        $CHAR2.                             
      @667    I10_DX_Visit_Reason1          $CHAR7.                             
      @674    I10_DX1                       $CHAR7.                             
      @681    I10_DX2                       $CHAR7.                             
      @688    I10_DX3                       $CHAR7.                             
      @695    I10_DX4                       $CHAR7.                             
      ...
      @849    I10_DX26                      $CHAR7.                             
      @856    I10_DX27                      $CHAR7.                             
      @863    I10_ECAUSE1                   $CHAR7.                             
      @870    I10_ECAUSE2                   $CHAR7.                             
      @877    I10_ECAUSE3                   $CHAR7.                             
      @884    I10_ECAUSE4                   $CHAR7.                             
      @891    I10_ECAUSE5                   $CHAR7.                             
      @898    I10_ECAUSE6                   $CHAR7.                             
      @905    I10_ECAUSE7                   $CHAR7.                             
      @912    I10_ECAUSE8                   $CHAR7.                             
      @919    I10_ECAUSE9                   $CHAR7.                             
      @926    I10_ECAUSE10                  $CHAR7.                             
      @933    I10_NDX                       N3PF.                               
      @936    I10_NECAUSE                   N2PF.                               
      @938    I10_NPR                       N3PF.                               
      @941    I10_PR1                       $CHAR7.                             
      @948    I10_PR2                       $CHAR7.                             
      @955    I10_PR3                       $CHAR7.                             
      ...
      @983    I10_PR7                       $CHAR7.                             
      @990    I10_PR8                       $CHAR7.                             
      @997    I10_PROCTYPE                  N3PF.                               
      @1000   KEY                           15.                                 
      @1015   LOS                           N5PF.                               
      @1020   LOS_X                         N6PF.                               
      @1026   MARITALSTATUS_X               $CHAR1.                             
      @1027   MARITALSTATUSUB04             $CHAR1.                             
      @1028   MDNUM1_R                      N9PF.                               
      @1037   MDNUM2_R                      N9PF.                               
      @1046   MDNUM3_R                      N9PF.                               
      @1055   MDNUM4_R                      N9PF.                               
      @1064   MDNUMTYPE1                    $CHAR1.                             
      @1065   MEDINCSTQ                     N2PF.                               
      @1067   MRN_R                         N9PF.                               
      @1076   NCPT                          N4PF.                               
      @1080   OS_TIME                       N11P2F.                             
      ...
      @1175   STATE_OS                      N2PF.                               
      @1177   TOTCHG                        N10PF.                              
      @1187   TOTCHG_X                      N15P2F.                             
      @1202   VisitLink                     N9PF.                               
      @1211   YEAR                          N4PF.                               
      @1215   ZIP3                          $CHAR3.                             
      @1218   ZIPINC_QRTL                   N3PF.                               
      @1221   AYEAR                         N4PF.                               
      @1225   BMONTH                        N2PF.                               
      @1227   BYEAR                         N4PF.                               
      @1231   PRMONTH1                      N2PF.                               
