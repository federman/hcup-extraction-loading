...
*  Data Step                  *;                                                
*******************************;                                                
DATA OR_SEDDC_2018_CORE;                                                        
INFILE 'OR_SEDD_2018_CORE.ASC' FIRSTOBS=3 LRECL = 2292;                         
...
INPUT                                                                           
      ...
      @1869   HOSPST                        $CHAR2.                             
      @1871   I10_DX_Visit_Reason1          $CHAR7.                             
      @1878   I10_DX_Visit_Reason2          $CHAR7.                             
      @1885   I10_DX_Visit_Reason3          $CHAR7.                             
      @1892   I10_DX1                       $CHAR7.                             
      @1899   I10_DX2                       $CHAR7.                             
      @1906   I10_DX3                       $CHAR7.                             
      @1913   I10_DX4                       $CHAR7.                             
      ...
      @2218   PointOfOrigin_X               $CHAR2.                             
      @2220   PointOfOriginUB04             $CHAR1.                             
      @2221   PSTATE                        $CHAR2.                             
      @2223   PSTCO                         N5PF.                               
      @2228   PSTCO2                        N5PF.                               
      @2233   RACE                          N2PF.                               
      ...
      @2241   STATE_OS                      N2PF.                               
      @2243   TOTCHG                        N10PF.                              
      @2253   TOTCHG_X                      N15P2F.                             
      @2268   YEAR                          N4PF.                               
      @2272   ZIP                           $CHAR5.                             
      @2277   ZIP3                          $CHAR3.                             
      @2280   ZIPINC_QRTL                   N3PF.                               
      @2283   AYEAR                         N4PF.                               
      @2287   BMONTH                        N2PF.                               
      @2289   BYEAR                         N4PF.                               
      ;                                                                         
