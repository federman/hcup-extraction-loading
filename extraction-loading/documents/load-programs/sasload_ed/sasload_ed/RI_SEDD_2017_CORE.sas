...
*  Data Step                  *;                                                
*******************************;                                                
DATA RI_SEDDC_2017_CORE;                                                        
INFILE 'RI_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 443;                          
...
INPUT                                                                           
      ...
      @367    PL_UIC                        N2PF.                               
      @369    PL_UR_CAT4                    N2PF.                               
      @371    PointOfOrigin_X               $CHAR1.                             
      @372    PointOfOriginUB04             $CHAR1.                             
      @373    PSTATE                        $CHAR2.                             
      @375    PSTCO                         N5PF.                               
      @380    PSTCO2                        N5PF.                               
      @385    RACE                          N2PF.                               
