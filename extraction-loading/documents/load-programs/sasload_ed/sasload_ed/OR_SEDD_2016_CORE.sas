...
*  Data Step                  *;                                                
*******************************;                                                
DATA OR_SEDDC_2016_CORE;                                                        
INFILE 'OR_SEDD_2016_CORE.ASC' FIRSTOBS=3 LRECL = 2025;                         
...
INPUT                                                                           
      ...
      @1756   I10_DX24                      $CHAR7.                             
      @1763   I10_DX25                      $CHAR7.                             
      @1770   I10_ECAUSE1                   $CHAR7.                             
      @1777   I10_ECAUSE2                   $CHAR7.                             
      @1784   I10_ECAUSE3                   $CHAR7.                             
      @1791   I10_ECAUSE4                   $CHAR7.                             
      @1798   I10_ECAUSE5                   $CHAR7.                             
      @1805   I10_ECAUSE6                   $CHAR7.                             
      @1812   I10_ECAUSE7                   $CHAR7.                             
      @1819   I10_NDX                       N3PF.                               
      @1822   I10_NECAUSE                   N2PF.                               
      @1824   I10_PROCTYPE                  N3PF.                               
      @1827   KEY                           15.                                 
      @1842   LOS                           N5PF.                               
      @1847   LOS_X                         N6PF.                               
      @1853   MDNUM1_R                      N9PF.                               
      ...
      @1945   PL_RUCC                       N2PF.                               
      @1947   PL_UIC                        N2PF.                               
      @1949   PL_UR_CAT4                    N2PF.                               
      @1951   PointOfOrigin_X               $CHAR2.                             
      @1953   PointOfOriginUB04             $CHAR1.                             
      @1954   PSTATE                        $CHAR2.                             
      @1956   PSTCO                         N5PF.                               
      @1961   PSTCO2                        N5PF.                               
      @1966   RACE                          N2PF.                               
      ...
      @1974   STATE_OS                      N2PF.                               
      @1976   TOTCHG                        N10PF.                              
      @1986   TOTCHG_X                      N15P2F.                             
      @2001   YEAR                          N4PF.                               
      @2005   ZIP                           $CHAR5.                             
      @2010   ZIP3                          $CHAR3.                             
      @2013   ZIPINC_QRTL                   N3PF.                               
      @2016   AYEAR                         N4PF.                               
      @2020   BMONTH                        N2PF.                               
      @2022   BYEAR                         N4PF.                               
      ;                                                                         
