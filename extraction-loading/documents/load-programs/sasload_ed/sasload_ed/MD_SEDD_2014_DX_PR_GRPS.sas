...
*  Data Step                  *;                                                
*******************************;                                                
DATA MD_SEDDC_2014_DX_PR_GRPS;                                                  
INFILE 'MD_SEDD_2014_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 663;                    
...
INPUT                                                                           
      ...
      @557    INJURY                        N2PF.                               
      @559    INJURY_CUT                    N2PF.                               
      @561    INJURY_DROWN                  N2PF.                               
      @563    INJURY_FALL                   N2PF.                               
      @565    INJURY_FIRE                   N2PF.                               
      @567    INJURY_FIREARM                N2PF.                               
      @569    INJURY_MACHINERY              N2PF.                               
      @571    INJURY_MVT                    N2PF.                               
      @573    INJURY_NATURE                 N2PF.                               
      @575    INJURY_POISON                 N2PF.                               
      @577    INJURY_STRUCK                 N2PF.                               
      @579    INJURY_SUFFOCATION            N2PF.                               
      @581    INTENT_ASSAULT                N2PF.                               
      @583    INTENT_SELF_HARM              N2PF.                               
      @585    INTENT_UNINTENTIONAL          N2PF.                               
      @587    KEY                           15.                                 
      @602    MULTINJURY                    N2PF.                               
      @604    U_BLOOD                       N2PF.                               
      @606    U_CATH                        N2PF.                               
      @608    U_CCU                         N2PF.                               
      @610    U_CHESTXRAY                   N2PF.                               
      @612    U_CTSCAN                      N2PF.                               
      @614    U_DIALYSIS                    N2PF.                               
      @616    U_ECHO                        N2PF.                               
      @618    U_ED                          N2PF.                               
      ...
      @638    U_NEWBN4L                     N2PF.                               
      @640    U_NUCMED                      N2PF.                               
      @642    U_OBSERVATION                 N2PF.                               
      @644    U_OCCTHERAPY                  N2PF.                               
      @646    U_ORGANACQ                    N2PF.                               
      @648    U_OTHIMPLANTS                 N2PF.                               
      @650    U_PACEMAKER                   N2PF.                               
      @652    U_PHYTHERAPY                  N2PF.                               
      @654    U_RADTHERAPY                  N2PF.                               
      @656    U_RESPTHERAPY                 N2PF.                               
      @658    U_SPEECHTHERAPY               N2PF.                               
      @660    U_STRESS                      N2PF.                               
      @662    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
