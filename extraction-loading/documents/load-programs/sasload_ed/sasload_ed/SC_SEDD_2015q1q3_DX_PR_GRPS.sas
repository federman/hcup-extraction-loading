...
*   SC_SEDD_2015q1q3_DX_PR_GRPS.SAS:                                            
...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SEDDC_2015q1q3_DX_PR_GRPS;                                              
INFILE 'SC_SEDD_2015q1q3_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 561;                
...
INPUT                                                                           
      ...
      @325    INJURY                        N2PF.                               
      @327    INJURY_CUT                    N2PF.                               
      @329    INJURY_DROWN                  N2PF.                               
      @331    INJURY_FALL                   N2PF.                               
      @333    INJURY_FIRE                   N2PF.                               
      @335    INJURY_FIREARM                N2PF.                               
      @337    INJURY_MACHINERY              N2PF.                               
      @339    INJURY_MVT                    N2PF.                               
      @341    INJURY_NATURE                 N2PF.                               
      @343    INJURY_POISON                 N2PF.                               
      @345    INJURY_STRUCK                 N2PF.                               
      @347    INJURY_SUFFOCATION            N2PF.                               
      @349    INTENT_ASSAULT                N2PF.                               
      @351    INTENT_SELF_HARM              N2PF.                               
      @353    INTENT_UNINTENTIONAL          N2PF.                               
      @355    KEY                           15.                                 
      @370    MULTINJURY                    N2PF.                               
      @372    PCLASS1                       N2PF.                               
      @374    PCLASS2                       N2PF.                               
      ...
      @536    U_NEWBN4L                     N2PF.                               
      @538    U_NUCMED                      N2PF.                               
      @540    U_OBSERVATION                 N2PF.                               
      @542    U_OCCTHERAPY                  N2PF.                               
      @544    U_ORGANACQ                    N2PF.                               
      @546    U_OTHIMPLANTS                 N2PF.                               
      @548    U_PACEMAKER                   N2PF.                               
      @550    U_PHYTHERAPY                  N2PF.                               
      @552    U_RADTHERAPY                  N2PF.                               
      @554    U_RESPTHERAPY                 N2PF.                               
      @556    U_SPEECHTHERAPY               N2PF.                               
      @558    U_STRESS                      N2PF.                               
      @560    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
