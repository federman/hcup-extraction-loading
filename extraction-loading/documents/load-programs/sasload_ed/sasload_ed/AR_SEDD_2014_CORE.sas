...
*  Data Step                  *;                                                
*******************************;                                                
DATA AR_SEDDC_2014_CORE;                                                        
INFILE 'AR_SEDD_2014_CORE.ASC' FIRSTOBS=3 LRECL = 1221;                         
...
INPUT                                                                           
      ...
      @721    DXCCS18                       N4PF.                               
      @725    DXVER                         N3PF.                               
      @728    DX_Visit_Reason1              $CHAR7.                             
      @735    DaysToEvent                   N6PF.                               
      @741    ECODE1                        $CHAR7.                             
      @748    ECODE2                        $CHAR7.                             
      @755    ECODE3                        $CHAR7.                             
      @762    ECODE4                        $CHAR7.                             
      ...
      @842    HCUP_ED                       N2PF.                               
      @844    HCUP_OS                       N2PF.                               
      @846    HISPANIC_X                    $CHAR1.                             
      @847    HOSPBRTH                      N3PF.                               
      @850    HOSPST                        $CHAR2.                             
      @852    KEY                           15.                                 
      @867    LOS                           N5PF.                               
      @872    LOS_X                         N6PF.                               
      @878    MARITALSTATUSUB04             $CHAR1.                             
      @879    MARITALSTATUS_X               $CHAR1.                             
      @880    MDNUM1_R                      N9PF.                               
      @889    MDNUM2_R                      N9PF.                               
      @898    MDNUM3_R                      N9PF.                               
      @907    MDNUM4_R                      N9PF.                               
      @916    MDNUMTYPE1                    $CHAR1.                             
      @917    MEDINCSTQ                     N2PF.                               
      @919    MRN_R                         N9PF.                               
      @928    NCHRONIC                      N3PF.                               
      @931    NCPT                          N4PF.                               
      ...
      @1106   PSTCO                         N5PF.                               
      @1111   PSTCO2                        N5PF.                               
      @1116   PointOfOriginUB04             $CHAR1.                             
      @1117   PointOfOrigin_X               $CHAR1.                             
      @1118   RACE                          N2PF.                               
      @1120   RACE_X                        $CHAR1.                             
      @1121   STATE_AS                      N2PF.                               
      @1123   STATE_ED                      N2PF.                               
