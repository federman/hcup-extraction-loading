...
*  Data Step                  *;                                                
*******************************;                                                
DATA RI_SEDDC_2019_CORE;                                                        
INFILE 'RI_SEDD_2019_CORE.ASC' FIRSTOBS=3 LRECL = 442;                          
...
INPUT                                                                           
      ...
      @178    HCUP_OS                       N2PF.                               
      @180    HISPANIC                      N2PF.                               
      @182    HISPANIC_X                    $CHAR4.                             
      @186    HOSPST                        $CHAR2.                             
      @188    I10_DX_Visit_Reason1          $CHAR7.                             
      @195    I10_DX1                       $CHAR7.                             
      @202    I10_DX2                       $CHAR7.                             
      @209    I10_DX3                       $CHAR7.                             
      @216    I10_DX4                       $CHAR7.                             
      ...
      @369    PointOfOriginUB04             $CHAR1.                             
      @370    PSTATE                        $CHAR2.                             
      @372    PSTATE_GEO                    $CHAR2.                             
      @374    PSTCO                         N5PF.                               
      @379    PSTCO_GEO                     N5PF.                               
      @384    RACE                          N2PF.                               
      @386    RACE_X                        $CHAR8.                             
