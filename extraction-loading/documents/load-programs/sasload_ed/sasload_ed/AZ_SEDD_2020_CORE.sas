...
*  Data Step                  *;                                                
*******************************;                                                
DATA AZ_SEDDC_2020_CORE;                                                        
INFILE 'AZ_SEDD_2020_CORE.ASC' FIRSTOBS=3 LRECL = 624;                          
...
INPUT                                                                           
      ...
      @195    HCUP_ED                       N2PF.                               
      @197    HCUP_OS                       N2PF.                               
      @199    HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @204    HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @209    HISPANIC                      N2PF.                               
      @211    HISPANIC_X                    $CHAR1.                             
      @212    Homeless                      N2PF.                               
      @214    HOSP_NPI                      $CHAR10.                            
      @224    HOSPST                        $CHAR2.                             
      @226    I10_DX_Visit_Reason1          $CHAR7.                             
      @233    I10_DX_Visit_Reason2          $CHAR7.                             
      @240    I10_DX_Visit_Reason3          $CHAR7.                             
      @247    I10_DX1                       $CHAR7.                             
      @254    I10_DX2                       $CHAR7.                             
      @261    I10_DX3                       $CHAR7.                             
      @268    I10_DX4                       $CHAR7.                             
      ...
      @457    I10_DX31                      $CHAR7.                             
      @464    I10_NDX                       N3PF.                               
      @467    I10_PROCTYPE                  N3PF.                               
      @470    KEY                           15.                                 
      @485    LOS                           N5PF.                               
      @490    LOS_X                         N6PF.                               
      @496    MARITALSTATUSUB04             $CHAR1.                             
      @497    MDBOARD1                      $CHAR1.                             
      @498    MDBOARD2                      $CHAR1.                             
      @499    MDNUM1_R                      N9PF.                               
      @508    MDNUM2_R                      N9PF.                               
      ...
      @553    PL_UIC                        N2PF.                               
      @555    PL_UR_CAT4                    N2PF.                               
      @557    PointOfOrigin_X               $CHAR1.                             
      @558    PointOfOriginUB04             $CHAR1.                             
      @559    PSTATE                        $CHAR2.                             
      @561    PSTATE_GEO                    $CHAR2.                             
      @563    PSTCO_GEO                     N5PF.                               
      @568    RACE                          N2PF.                               
      @570    RACE_X                        $CHAR3.                             
      @573    SPLIT_IPED                    N2PF.                               
