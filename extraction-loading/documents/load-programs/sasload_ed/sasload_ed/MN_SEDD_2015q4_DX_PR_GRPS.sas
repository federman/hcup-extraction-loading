...
*  Data Step                  *;                                                
*******************************;                                                
DATA MN_SEDDC_2015q4_DX_PR_GRPS;                                                
INFILE 'MN_SEDD_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 652;                  
...
INPUT                                                                           
      ...
      @464    I10_INJURY                    N2PF.                               
      @466    I10_MULTINJURY                N2PF.                               
      @468    I10_PCLASS1                   N2PF.                               
      @470    I10_PCLASS2                   N2PF.                               
      @472    I10_PCLASS3                   N2PF.                               
      @474    I10_PCLASS4                   N2PF.                               
      @476    I10_PCLASS5                   N2PF.                               
      @478    I10_PCLASS6                   N2PF.                               
      @480    I10_PCLASS7                   N2PF.                               
      @482    I10_PCLASS8                   N2PF.                               
      @484    I10_PCLASS9                   N2PF.                               
      @486    I10_PCLASS10                  N2PF.                               
      @488    I10_PCLASS11                  N2PF.                               
      @490    I10_PRMCCS1                   $CHAR8.                             
      @498    I10_PRMCCS2                   $CHAR8.                             
      @506    I10_PRMCCS3                   $CHAR8.                             
      @514    I10_PRMCCS4                   $CHAR8.                             
      @522    I10_PRMCCS5                   $CHAR8.                             
      @530    I10_PRMCCS6                   $CHAR8.                             
      @538    I10_PRMCCS7                   $CHAR8.                             
      @546    I10_PRMCCS8                   $CHAR8.                             
      @554    I10_PRMCCS9                   $CHAR8.                             
      @562    I10_PRMCCS10                  $CHAR8.                             
      @570    I10_PRMCCS11                  $CHAR8.                             
      @578    I10_U_BLOOD                   N2PF.                               
      @580    I10_U_CATH                    N2PF.                               
      @582    I10_U_CTSCAN                  N2PF.                               
      @584    I10_U_EKG                     N2PF.                               
      @586    I10_U_MHSA                    N2PF.                               
      @588    I10_U_MRT                     N2PF.                               
      @590    I10_U_PACEMAKER               N2PF.                               
      @592    I10_U_PHYTHERAPY              N2PF.                               
      @594    I10_U_RADTHERAPY              N2PF.                               
      @596    I10_U_STRESS                  N2PF.                               
      @598    KEY                           15.                                 
      @613    U_CCU                         N2PF.                               
      ...
      @625    U_EPO                         N2PF.                               
      @627    U_ICU                         N2PF.                               
      @629    U_LITHOTRIPSY                 N2PF.                               
      @631    U_NEWBN2L                     N2PF.                               
      @633    U_NEWBN3L                     N2PF.                               
      @635    U_NEWBN4L                     N2PF.                               
      @637    U_NUCMED                      N2PF.                               
      @639    U_OBSERVATION                 N2PF.                               
      @641    U_OCCTHERAPY                  N2PF.                               
      @643    U_ORGANACQ                    N2PF.                               
      @645    U_OTHIMPLANTS                 N2PF.                               
      @647    U_RESPTHERAPY                 N2PF.                               
      @649    U_SPEECHTHERAPY               N2PF.                               
      @651    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
