...
*  Data Step                  *;                                                
*******************************;                                                
DATA NE_SEDDC_2015q4_DX_PR_GRPS;                                                
INFILE 'NE_SEDD_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 520;                  
...
INPUT                                                                           
      ...
      @446    I10_U_BLOOD                   N2PF.                               
      @448    I10_U_CATH                    N2PF.                               
      @450    I10_U_CTSCAN                  N2PF.                               
      @452    I10_U_EKG                     N2PF.                               
      @454    I10_U_MHSA                    N2PF.                               
      @456    I10_U_MRT                     N2PF.                               
      @458    I10_U_PACEMAKER               N2PF.                               
      @460    I10_U_PHYTHERAPY              N2PF.                               
      @462    I10_U_RADTHERAPY              N2PF.                               
      @464    I10_U_STRESS                  N2PF.                               
      @466    KEY                           15.                                 
      @481    U_CCU                         N2PF.                               
      ...
      @493    U_EPO                         N2PF.                               
      @495    U_ICU                         N2PF.                               
      @497    U_LITHOTRIPSY                 N2PF.                               
      @499    U_NEWBN2L                     N2PF.                               
      @501    U_NEWBN3L                     N2PF.                               
      @503    U_NEWBN4L                     N2PF.                               
      @505    U_NUCMED                      N2PF.                               
      @507    U_OBSERVATION                 N2PF.                               
      @509    U_OCCTHERAPY                  N2PF.                               
      @511    U_ORGANACQ                    N2PF.                               
      @513    U_OTHIMPLANTS                 N2PF.                               
      @515    U_RESPTHERAPY                 N2PF.                               
      @517    U_SPEECHTHERAPY               N2PF.                               
      @519    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
