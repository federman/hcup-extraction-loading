...
*  Data Step                  *;                                                
*******************************;                                                
DATA CA_SEDDC_2020_CORE;                                                        
INFILE 'CA_SEDD_2020_CORE.ASC' FIRSTOBS=3 LRECL = 662;                          
...
INPUT                                                                           
      ...
      @208    CPTCCS24                      N3PF.                               
      @211    CPTCCS25                      N3PF.                               
      @214    DaysToEvent                   N6PF.                               
      @220    DIED                          N2PF.                               
      @222    DISP_X                        $CHAR2.                             
      @224    DISPUB04                      N2PF.                               
      @226    DISPUNIFORM                   N2PF.                               
      @228    DMONTH                        N2PF.                               
      @230    DQTR                          N2PF.                               
      @232    DSHOSPID                      $CHAR17.                            
      @249    FEMALE                        N2PF.                               
      @251    HCUP_ED                       N2PF.                               
      @253    HCUP_OS                       N2PF.                               
      @255    HCUP_SURGERY_BROAD_CPT        N5PF.                               
      @260    HCUP_SURGERY_NARROW_CPT       N5PF.                               
      @265    HISPANIC                      N2PF.                               
      @267    HISPANIC_X                    $CHAR2.                             
      @269    Homeless                      N2PF.                               
      @271    HOSPST                        $CHAR2.                             
      @273    I10_DX1                       $CHAR7.                             
      @280    I10_DX2                       $CHAR7.                             
