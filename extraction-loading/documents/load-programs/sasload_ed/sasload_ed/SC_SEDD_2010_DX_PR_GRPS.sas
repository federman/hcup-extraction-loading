...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SEDDC_2010_DX_PR_GRPS;                                                  
INFILE 'SC_SEDD_2010_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 413;                    
...
INPUT                                                                           
      ...
      @388    U_NEWBN4L                     N2PF.                               
      @390    U_NUCMED                      N2PF.                               
      @392    U_OBSERVATION                 N2PF.                               
      @394    U_OCCTHERAPY                  N2PF.                               
      @396    U_ORGANACQ                    N2PF.                               
      @398    U_OTHIMPLANTS                 N2PF.                               
      @400    U_PACEMAKER                   N2PF.                               
      @402    U_PHYTHERAPY                  N2PF.                               
      @404    U_RADTHERAPY                  N2PF.                               
      @406    U_RESPTHERAPY                 N2PF.                               
      @408    U_SPEECHTHERAPY               N2PF.                               
      @410    U_STRESS                      N2PF.                               
      @412    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
