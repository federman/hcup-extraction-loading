...
*  Data Step                  *;                                                
*******************************;                                                
DATA NV_SEDDC_2017_CORE;                                                        
INFILE 'NV_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1178;                         
...
INPUT                                                                           
      ...
      @1061   MDNUM1_R                      N9PF.                               
      @1070   MDNUM2_R                      N9PF.                               
      @1079   MDNUMTYPE1                    $CHAR1.                             
      @1080   MDNUMTYPE2                    $CHAR1.                             
      @1081   MEDINCSTQ                     N2PF.                               
      @1083   NCPT                          N4PF.                               
      @1087   OS_TIME                       N11P2F.                             
      @1098   PAY1                          N2PF.                               
      ...
      @1112   PL_RUCC                       N2PF.                               
      @1114   PL_UIC                        N2PF.                               
      @1116   PL_UR_CAT4                    N2PF.                               
      @1118   PointOfOrigin_X               $CHAR2.                             
