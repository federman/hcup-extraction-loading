...
*  Data Step                  *;                                                
*******************************;                                                
DATA AR_SEDDC_2015q4_DX_PR_GRPS;                                                
INFILE 'AR_SEDD_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 674;                  
...
INPUT                                                                           
      ...
      @97     I10_CHRON22                   N2PF.                               
      @99     I10_CHRON23                   N2PF.                               
      @101    I10_CHRON24                   N2PF.                               
      @103    I10_CHRON25                   N2PF.                               
      @105    I10_CHRON26                   N2PF.                               
      @107    I10_CHRON27                   N2PF.                               
      @109    I10_DXMCCS1                   $CHAR11.                            
      @120    I10_DXMCCS2                   $CHAR11.                            
      @131    I10_DXMCCS3                   $CHAR11.                            
      @142    I10_DXMCCS4                   $CHAR11.                            
      @153    I10_DXMCCS5                   $CHAR11.                            
      @164    I10_DXMCCS6                   $CHAR11.                            
      @175    I10_DXMCCS7                   $CHAR11.                            
      @186    I10_DXMCCS8                   $CHAR11.                            
      @197    I10_DXMCCS9                   $CHAR11.                            
      @208    I10_DXMCCS10                  $CHAR11.                            
      @219    I10_DXMCCS11                  $CHAR11.                            
      @230    I10_DXMCCS12                  $CHAR11.                            
      @241    I10_DXMCCS13                  $CHAR11.                            
      @252    I10_DXMCCS14                  $CHAR11.                            
      @263    I10_DXMCCS15                  $CHAR11.                            
      @274    I10_DXMCCS16                  $CHAR11.                            
      @285    I10_DXMCCS17                  $CHAR11.                            
      @296    I10_DXMCCS18                  $CHAR11.                            
      @307    I10_DXMCCS19                  $CHAR11.                            
      @318    I10_DXMCCS20                  $CHAR11.                            
      @329    I10_DXMCCS21                  $CHAR11.                            
      @340    I10_DXMCCS22                  $CHAR11.                            
      @351    I10_DXMCCS23                  $CHAR11.                            
      @362    I10_DXMCCS24                  $CHAR11.                            
      @373    I10_DXMCCS25                  $CHAR11.                            
      @384    I10_DXMCCS26                  $CHAR11.                            
      @395    I10_DXMCCS27                  $CHAR11.                            
      @406    I10_ECauseMCCS1               $CHAR11.                            
      @417    I10_ECauseMCCS2               $CHAR11.                            
      @428    I10_ECauseMCCS3               $CHAR11.                            
      @439    I10_ECauseMCCS4               $CHAR11.                            
      @450    I10_ECauseMCCS5               $CHAR11.                            
      @461    I10_ECauseMCCS6               $CHAR11.                            
      @472    I10_ECauseMCCS7               $CHAR11.                            
      @483    I10_ECauseMCCS8               $CHAR11.                            
      @494    I10_ECauseMCCS9               $CHAR11.                            
      @505    I10_ECauseMCCS10              $CHAR11.                            
      @516    I10_INJURY                    N2PF.                               
      @518    I10_MULTINJURY                N2PF.                               
      @520    I10_PCLASS1                   N2PF.                               
      @522    I10_PCLASS2                   N2PF.                               
      @524    I10_PCLASS3                   N2PF.                               
      @526    I10_PCLASS4                   N2PF.                               
      @528    I10_PCLASS5                   N2PF.                               
      @530    I10_PCLASS6                   N2PF.                               
      @532    I10_PCLASS7                   N2PF.                               
      @534    I10_PCLASS8                   N2PF.                               
      @536    I10_PRMCCS1                   $CHAR8.                             
      @544    I10_PRMCCS2                   $CHAR8.                             
      @552    I10_PRMCCS3                   $CHAR8.                             
      @560    I10_PRMCCS4                   $CHAR8.                             
      @568    I10_PRMCCS5                   $CHAR8.                             
      @576    I10_PRMCCS6                   $CHAR8.                             
      @584    I10_PRMCCS7                   $CHAR8.                             
      @592    I10_PRMCCS8                   $CHAR8.                             
      @600    I10_U_BLOOD                   N2PF.                               
      @602    I10_U_CATH                    N2PF.                               
      @604    I10_U_CTSCAN                  N2PF.                               
      @606    I10_U_EKG                     N2PF.                               
      @608    I10_U_MHSA                    N2PF.                               
      @610    I10_U_MRT                     N2PF.                               
      @612    I10_U_PACEMAKER               N2PF.                               
      @614    I10_U_PHYTHERAPY              N2PF.                               
      @616    I10_U_RADTHERAPY              N2PF.                               
      @618    I10_U_STRESS                  N2PF.                               
      @620    KEY                           15.                                 
      @635    U_CCU                         N2PF.                               
      @637    U_CHESTXRAY                   N2PF.                               
      @639    U_DIALYSIS                    N2PF.                               
      @641    U_ECHO                        N2PF.                               
      @643    U_ED                          N2PF.                               
      @645    U_EEG                         N2PF.                               
      @647    U_EPO                         N2PF.                               
      @649    U_ICU                         N2PF.                               
      @651    U_LITHOTRIPSY                 N2PF.                               
      @653    U_NEWBN2L                     N2PF.                               
      @655    U_NEWBN3L                     N2PF.                               
      @657    U_NEWBN4L                     N2PF.                               
      @659    U_NUCMED                      N2PF.                               
      @661    U_OBSERVATION                 N2PF.                               
      @663    U_OCCTHERAPY                  N2PF.                               
      @665    U_ORGANACQ                    N2PF.                               
      @667    U_OTHIMPLANTS                 N2PF.                               
      @669    U_RESPTHERAPY                 N2PF.                               
      @671    U_SPEECHTHERAPY               N2PF.                               
      @673    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
