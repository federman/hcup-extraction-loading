...
*  Data Step                  *;                                                
*******************************;                                                
DATA MA_SEDDC_2017_CORE;                                                        
INFILE 'MA_SEDD_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1814;                         
...
INPUT                                                                           
      ...
      @814    CPTCCS99                      N3PF.                               
      @817    CPTCCS100                     N3PF.                               
      @820    DaysBetweenVisits             N4PF.                               
      @824    DaysToEvent                   N6PF.                               
      @830    DHOUR                         N4PF.                               
      @834    DIED                          N2PF.                               
      @836    DISP_X                        $CHAR1.                             
      @837    DISPUNIFORM                   N2PF.                               
      @839    DMONTH                        N2PF.                               
      @841    DNR                           N2PF.                               
      @843    DQTR                          N2PF.                               
      @845    DSHOSPID                      $CHAR17.                            
      ...
      @1716   PAY2_X                        $CHAR3.                             
      @1719   PL_CBSA                       N3PF.                               
      @1722   PL_UR_CAT4                    N2PF.                               
      @1724   POA_Disch_Edit1               N2PF.                               
      @1726   POA_Disch_Edit2               N2PF.                               
      @1728   POA_Hosp_Edit1                N2PF.                               
      @1730   POA_Hosp_Edit2                N2PF.                               
      @1732   POA_Hosp_Edit3                N2PF.                               
      @1734   POA_Hosp_Edit3_Value          N8P2F.                              
      @1742   PRVER                         N3PF.                               
      @1745   PSTATE                        $CHAR2.                             
      @1747   PSTCO2                        N5PF.                               
      @1752   RACE                          N2PF.                               
      ...
      @1763   STATE_OS                      N2PF.                               
      @1765   TOTCHG                        N10PF.                              
      @1775   TOTCHG_X                      N15P2F.                             
      @1790   TransportToHosp               N2PF.                               
      @1792   VisitLink                     N9PF.                               
      @1801   YEAR                          N4PF.                               
      @1805   ZIP3                          $CHAR3.                             
