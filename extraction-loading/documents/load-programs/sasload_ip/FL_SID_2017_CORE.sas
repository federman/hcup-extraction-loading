...
*  Data Step                  *;                                                
*******************************;                                                
DATA FL_SIDC_2017_CORE;                                                         
INFILE 'FL_SID_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1036;                          
...
INPUT                                                                           
      ...
      @678    PointOfOrigin_X               $CHAR2.                             
      @680    PointOfOriginUB04             $CHAR1.                             
      @681    PRDAY1                        N5PF.                               
      @686    PRDAY2                        N5PF.                               
      @691    PRDAY3                        N5PF.                               
      @696    PRDAY4                        N5PF.                               
