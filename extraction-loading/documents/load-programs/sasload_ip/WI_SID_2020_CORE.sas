...
*  Data Step                  *;                                                
*******************************;                                                
DATA WI_SIDC_2020_CORE;                                                         
INFILE 'WI_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 2532;                          
...
INPUT                                                                           
      ...
      @1614   CPTCCS199                     N3PF.                               
      @1617   CPTCCS200                     N3PF.                               
      @1620   DaysToEvent                   N6PF.                               
      @1626   DIED                          N2PF.                               
      @1628   DISP_X                        $CHAR2.                             
      @1630   DISPUB04                      N2PF.                               
      @1632   DISPUNIFORM                   N2PF.                               
      @1634   DMONTH                        N2PF.                               
      @1636   DQTR                          N2PF.                               
      @1638   DRG                           N3PF.                               
      @1641   DRG_NoPOA                     N3PF.                               
      @1644   DRGVER                        N2PF.                               
      @1646   DSHOSPID                      $CHAR17.                            
      @1663   DXPOA1                        $CHAR1.                             
      @1664   DXPOA2                        $CHAR1.                             
      @1665   DXPOA3                        $CHAR1.                             
      @1666   DXPOA4                        $CHAR1.                             
      ...
      @1722   HCUP_OS                       N2PF.                               
      @1724   HISPANIC                      N2PF.                               
      @1726   HISPANIC_X                    $CHAR1.                             
      @1727   Homeless                      N2PF.                               
      @1729   HOSP_NPI                      $CHAR10.                            
      @1739   HOSPST                        $CHAR2.                             
      @1741   I10_BIRTH                     N3PF.                               
      @1744   I10_DELIVERY                  N3PF.                               
      @1747   I10_DX_Admitting              $CHAR7.                             
      @1754   I10_DX1                       $CHAR7.                             
      @1761   I10_DX2                       $CHAR7.                             
      @1768   I10_DX3                       $CHAR7.                             
      @1775   I10_DX4                       $CHAR7.                             
      ...
      @2306   I10_PR24                      $CHAR7.                             
      @2313   I10_PR25                      $CHAR7.                             
      @2320   I10_PROCTYPE                  N3PF.                               
      @2323   I10_SERVICELINE               N2PF.                               
      @2325   KEY                           15.                                 
      @2340   LOS                           N5PF.                               
      @2345   LOS_X                         N6PF.                               
      @2351   MDC                           N2PF.                               
      ...
      @2394   PAY2                          N2PF.                               
      @2396   PAY2_X                        $CHAR5.                             
      @2401   PCLASS_ORPROC                 N2PF.                               
      @2403   PL_CBSA                       N3PF.                               
      @2406   PL_NCHS                       N2PF.                               
      @2408   PL_RUCC                       N2PF.                               
      @2410   PL_UIC                        N2PF.                               
      @2412   PL_UR_CAT4                    N2PF.                               
      @2414   POA_Disch_Edit1               N2PF.                               
      @2416   POA_Disch_Edit2               N2PF.                               
      @2418   POA_Hosp_Edit1                N2PF.                               
      @2420   POA_Hosp_Edit2                N2PF.                               
      @2422   POA_Hosp_Edit3                N2PF.                               
      @2424   POA_Hosp_Edit3_Value          N8P2F.                              
      @2432   PointOfOrigin_X               $CHAR1.                             
      @2433   PointOfOriginUB04             $CHAR1.                             
      @2434   PRDAY1                        N5PF.                               
      @2439   PSTATE                        $CHAR2.                             
      @2441   PSTATE_GEO                    $CHAR2.                             
      @2443   PSTCO                         N5PF.                               
      @2448   PSTCO_GEO                     N5PF.                               
      @2453   RACE                          N2PF.                               
      @2455   RACE_PCT_MISS_HOSP            N7P2F.                              
      @2462   RACE_X                        $CHAR2.                             
      @2464   TOTCHG                        N10PF.                              
      @2474   TOTCHG_X                      N15P2F.                             
      @2489   TRAN_IN                       N2PF.                               
      @2491   TRAN_OUT                      N2PF.                               
      @2493   VisitLink                     N9PF.                               
      @2502   YEAR                          N4PF.                               
