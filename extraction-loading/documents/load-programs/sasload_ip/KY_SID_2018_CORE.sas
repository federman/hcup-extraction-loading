...
*  Data Step                  *;                                                
*******************************;                                                
DATA KY_SIDC_2018_CORE;                                                         
INFILE 'KY_SID_2018_CORE.ASC' FIRSTOBS=3 LRECL = 1117;                          
...
INPUT                                                                           
      ...
      @747    PL_UIC                        N2PF.                               
      @749    PL_UR_CAT4                    N2PF.                               
      @751    POA_Disch_Edit1               N2PF.                               
      @753    POA_Disch_Edit2               N2PF.                               
      @755    POA_Hosp_Edit1                N2PF.                               
      @757    POA_Hosp_Edit2                N2PF.                               
      @759    POA_Hosp_Edit3                N2PF.                               
      @761    POA_Hosp_Edit3_Value          N8P2F.                              
      @769    PointOfOrigin_X               $CHAR1.                             
