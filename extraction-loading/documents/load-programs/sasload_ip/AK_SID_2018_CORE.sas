...
*  Data Step                  *;                                                
*******************************;                                                
DATA AK_SIDC_2018_CORE;                                                         
INFILE 'AK_SID_2018_CORE.ASC' FIRSTOBS=3 LRECL = 2026;                          
...
INPUT                                                                           
      ...
      @1115   CPTDAY99                      N3PF.                               
      @1118   CPTDAY100                     N3PF.                               
      @1121   DaysToEvent                   N6PF.                               
      @1127   DHOUR                         N4PF.                               
      @1131   DIED                          N2PF.                               
      @1133   DISP_X                        $CHAR2.                             
      @1135   DISPUB04                      N2PF.                               
      @1137   DISPUNIFORM                   N2PF.                               
      @1139   DMONTH                        N2PF.                               
      @1141   DQTR                          N2PF.                               
      @1143   DRG                           N3PF.                               
      @1146   DRG_NoPOA                     N3PF.                               
      ...
      @1185   HCUP_OS                       N2PF.                               
      @1187   HISPANIC                      N2PF.                               
      @1189   HISPANIC_X                    $CHAR1.                             
      @1190   HospitalUnit                  N2PF.                               
      @1192   HOSPST                        $CHAR2.                             
      @1194   I10_DX_Admitting              $CHAR7.                             
      @1201   I10_DX1                       $CHAR7.                             
      @1208   I10_DX2                       $CHAR7.                             
      @1215   I10_DX3                       $CHAR7.                             
      @1222   I10_DX4                       $CHAR7.                             
      ...
      @1625   MEDINCSTQ                     N2PF.                               
      @1627   NCPT                          N4PF.                               
      @1631   OBSERVATION                   N4PF.                               
      @1635   OS_TIME                       N11P2F.                             
      @1646   P7EDSRC_X                     $CHAR2.                             
      @1648   PAY1                          N2PF.                               
      @1650   PAY1_X                        $CHAR2.                             
      @1652   PAY2                          N2PF.                               
      @1654   PAY2_X                        $CHAR2.                             
      ...
      @1660   PL_CBSA                       N3PF.                               
      @1663   PL_NCHS                       N2PF.                               
      @1665   POA_Disch_Edit1               N2PF.                               
      @1667   POA_Disch_Edit2               N2PF.                               
      @1669   POA_Hosp_Edit1                N2PF.                               
      @1671   POA_Hosp_Edit2                N2PF.                               
      @1673   POA_Hosp_Edit3                N2PF.                               
      @1675   POA_Hosp_Edit3_Value          N8P2F.                              
      @1683   PointOfOrigin_X               $CHAR1.                             
      @1684   PointOfOriginUB04             $CHAR1.                             
      @1685   PRDAY1                        N5PF.                               
      @1690   PRDAY2                        N5PF.                               
      @1695   PRDAY3                        N5PF.                               
      @1700   PRDAY4                        N5PF.                               
      ...
      @1816   RACE_X                        $CHAR1.                             
      @1817   TOTCHG                        N10PF.                              
      @1827   TOTCHG_X                      N15P2F.                             
      @1842   TRAN_IN                       N2PF.                               
      @1844   TRAN_OUT                      N2PF.                               
      @1846   VisitLink                     N9PF.                               
      @1855   YEAR                          N4PF.                               
      @1859   ZIPINC_QRTL                   N3PF.                               
      @1862   HOSPID                        N5PF.                               
      @1867   AYEAR                         N4PF.                               
      @1871   BMONTH                        N2PF.                               
      @1873   BYEAR                         N4PF.                               
