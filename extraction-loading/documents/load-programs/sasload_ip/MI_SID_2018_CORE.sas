...
*  Data Step                  *;                                                
*******************************;                                                
DATA MI_SIDC_2018_CORE;                                                         
INFILE 'MI_SID_2018_CORE.ASC' FIRSTOBS=3 LRECL = 1014;                          
