...
*  Data Step                  *;                                                
*******************************;                                                
DATA NC_SIDC_2020_CORE;                                                         
INFILE 'NC_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 728;                           
...
INPUT                                                                           
      ...
      @431    I10_PR19                      $CHAR7.                             
      @438    I10_PR20                      $CHAR7.                             
      @445    I10_PROCTYPE                  N3PF.                               
      @448    I10_SERVICELINE               N2PF.                               
      @450    KEY                           15.                                 
      @465    LOS                           N5PF.                               
      @470    LOS_X                         N6PF.                               
      @476    MDC                           N2PF.                               
      ...
      @507    PAY3                          N2PF.                               
      @509    PAY3_X                        $CHAR5.                             
      @514    PCLASS_ORPROC                 N2PF.                               
      @516    PL_CBSA                       N3PF.                               
      @519    PL_NCHS                       N2PF.                               
      @521    PL_RUCC                       N2PF.                               
      @523    PL_UIC                        N2PF.                               
      @525    PL_UR_CAT4                    N2PF.                               
      @527    POA_Disch_Edit1               N2PF.                               
      @529    POA_Disch_Edit2               N2PF.                               
      @531    POA_Hosp_Edit1                N2PF.                               
      @533    POA_Hosp_Edit2                N2PF.                               
      @535    POA_Hosp_Edit3                N2PF.                               
      @537    POA_Hosp_Edit3_Value          N8P2F.                              
      @545    PointOfOrigin_X               $CHAR3.                             
      ...
      @644    PRDAY20                       N5PF.                               
      @649    PSTATE                        $CHAR2.                             
      @651    PSTATE_GEO                    $CHAR2.                             
      @653    PSTCO                         N5PF.                               
      @658    PSTCO_GEO                     N5PF.                               
      @663    RACE                          N2PF.                               
      @665    RACE_PCT_MISS_HOSP            N7P2F.                              
      @672    RACE_X                        $CHAR3.                             
      @675    TOTCHG                        N10PF.                              
      @685    TOTCHG_X                      N15P2F.                             
      @700    TRAN_IN                       N2PF.                               
