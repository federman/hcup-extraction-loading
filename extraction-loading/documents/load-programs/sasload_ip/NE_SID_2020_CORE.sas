...
*  Data Step                  *;                                                
*******************************;                                                
DATA NE_SIDC_2020_CORE;                                                         
INFILE 'NE_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 954;                           
...
INPUT                                                                           
      ...
      @96     HOSPST                        $CHAR2.                             
      @98     I10_BIRTH                     N3PF.                               
      @101    I10_DELIVERY                  N3PF.                               
      @104    I10_DX_Admitting              $CHAR7.                             
      @111    I10_DX1                       $CHAR7.                             
      @118    I10_DX2                       $CHAR7.                             
      @125    I10_DX3                       $CHAR7.                             
      @132    I10_DX4                       $CHAR7.                             
      ...
      @579    PointOfOrigin_X               $CHAR1.                             
      @580    PointOfOriginUB04             $CHAR1.                             
      @581    PRDAY1                        N5PF.                               
      @586    PRDAY2                        N5PF.                               
      @591    PRDAY3                        N5PF.                               
      @596    PRDAY4                        N5PF.                               
