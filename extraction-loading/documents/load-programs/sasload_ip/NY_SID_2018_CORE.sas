...
*  Data Step                  *;                                                
*******************************;                                                
DATA NY_SIDC_2018_CORE;                                                         
INFILE 'NY_SID_2018_CORE.ASC' FIRSTOBS=3 LRECL = 1136;                          
...
INPUT                                                                           
      ...
      @130    HISPANIC                      N2PF.                               
      @132    HISPANIC_X                    $CHAR39.                            
      @171    Homeless                      N2PF.                               
      @173    HOSP_NPI                      $CHAR10.                            
      @183    HOSPST                        $CHAR2.                             
      @185    I10_DX_Admitting              $CHAR7.                             
      @192    I10_DX1                       $CHAR7.                             
      @199    I10_DX2                       $CHAR7.                             
      @206    I10_DX3                       $CHAR7.                             
      @213    I10_DX4                       $CHAR7.                             
      ...
      @604    I10_PR24                      $CHAR7.                             
      @611    I10_PR25                      $CHAR7.                             
      @618    I10_PROCTYPE                  N3PF.                               
      @621    KEY                           15.                                 
      @636    LOS                           N5PF.                               
      @641    LOS_X                         N6PF.                               
      @647    MARITALSTATUS_X               $CHAR1.                             
      @648    MARITALSTATUSUB04             $CHAR1.                             
      @649    MDC                           N2PF.                               
      @651    MDC_NoPOA                     N2PF.                               
      @653    MDNUM1_R                      N9PF.                               
      @662    MDNUM2_R                      N9PF.                               
      ...
      @714    PL_UIC                        N2PF.                               
      @716    PL_UR_CAT4                    N2PF.                               
      @718    POA_Disch_Edit1               N2PF.                               
      @720    POA_Disch_Edit2               N2PF.                               
      @722    POA_Hosp_Edit1                N2PF.                               
      @724    POA_Hosp_Edit2                N2PF.                               
      @726    POA_Hosp_Edit3                N2PF.                               
      @728    POA_Hosp_Edit3_Value          N8P2F.                              
      @736    PointOfOrigin_X               $CHAR1.                             
      @737    PointOfOriginUB04             $CHAR1.                             
      @738    PRDAY1                        N5PF.                               
      @743    PRDAY2                        N5PF.                               
      @748    PRDAY3                        N5PF.                               
      @753    PRDAY4                        N5PF.                               
