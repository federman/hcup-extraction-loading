...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SIDC_2018_CORE;                                                         
INFILE 'NJ_SID_2018_CORE.ASC' FIRSTOBS=3 LRECL = 2231;                          
...
INPUT                                                                           
      ...
      @1305   HCUP_OS                       N2PF.                               
      @1307   HISPANIC                      N2PF.                               
      @1309   HISPANIC_X                    $CHAR5.                             
      @1314   Homeless                      N2PF.                               
      @1316   HOSPST                        $CHAR2.                             
      @1318   I10_DX_Admitting              $CHAR7.                             
      @1325   I10_DX1                       $CHAR7.                             
      @1332   I10_DX2                       $CHAR7.                             
      @1339   I10_DX3                       $CHAR7.                             
      @1346   I10_DX4                       $CHAR7.                             
      ...
      @1702   I10_PR24                      $CHAR7.                             
      @1709   I10_PR25                      $CHAR7.                             
      @1716   I10_PROCTYPE                  N3PF.                               
      @1719   KEY                           15.                                 
      @1734   LOS                           N5PF.                               
      @1739   LOS_X                         N6PF.                               
      @1745   MARITALSTATUS_X               $CHAR1.                             
      @1746   MARITALSTATUSUB04             $CHAR1.                             
      @1747   MDC                           N2PF.                               
      @1749   MDC_NoPOA                     N2PF.                               
      @1751   MDNUM1_R                      N9PF.                               
      @1760   MDNUM2_R                      N9PF.                               
      ...
      @1847   PL_RUCC                       N2PF.                               
      @1849   PL_UIC                        N2PF.                               
      @1851   PL_UR_CAT4                    N2PF.                               
      @1853   POA_Disch_Edit1               N2PF.                               
      @1855   POA_Disch_Edit2               N2PF.                               
      @1857   POA_Hosp_Edit1                N2PF.                               
      @1859   POA_Hosp_Edit2                N2PF.                               
      @1861   POA_Hosp_Edit3                N2PF.                               
      @1863   POA_Hosp_Edit3_Value          N8P2F.                              
      @1871   PointOfOrigin_X               $CHAR1.                             
      @1872   PointOfOriginUB04             $CHAR1.                             
      @1873   PRDAY1                        N5PF.                               
      @1878   PRDAY2                        N5PF.                               
      @1883   PRDAY3                        N5PF.                               
      @1888   PRDAY4                        N5PF.                               
      ...
      @2022   READMIT                       N2PF.                               
      @2024   TOTCHG                        N10PF.                              
      @2034   TOTCHG_X                      N15P2F.                             
      @2049   TRAN_IN                       N2PF.                               
      @2051   TRAN_OUT                      N2PF.                               
      @2053   YEAR                          N4PF.                               
      @2057   ZIP                           $CHAR5.                             
      @2062   ZIP3                          $CHAR3.                             
      @2065   ZIPINC_QRTL                   N3PF.                               
      @2068   TOWN                          $CHAR4.                             
      @2072   AYEAR                         N4PF.                               
      @2076   BMONTH                        N2PF.                               
      @2078   BYEAR                         N4PF.                               
