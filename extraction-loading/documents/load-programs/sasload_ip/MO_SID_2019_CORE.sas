...
*  Data Step                  *;                                                
*******************************;                                                
DATA MO_SIDC_2019_CORE;                                                         
INFILE 'MO_SID_2019_CORE.ASC' FIRSTOBS=3 LRECL = 947;                           
...
INPUT                                                                           
      ...
      @484    I10_PR24                      $CHAR7.                             
      @491    I10_PR25                      $CHAR7.                             
      @498    I10_PROCTYPE                  N3PF.                               
      @501    I10_SERVICELINE               N2PF.                               
      @503    KEY                           15.                                 
      @518    LOS                           N5PF.                               
      @523    LOS_X                         N6PF.                               
      @529    MDC                           N2PF.                               
