...
*  Data Step                  *;                                                
*******************************;                                                
DATA MN_SIDC_2018_CORE;                                                         
INFILE 'MN_SID_2018_CORE.ASC' FIRSTOBS=3 LRECL = 1332;                          
...
INPUT                                                                           
      ...
      @118    HCUP_OS                       N2PF.                               
      @120    HISPANIC                      N2PF.                               
      @122    HISPANIC_X                    $CHAR20.                            
      @142    HOSPST                        $CHAR2.                             
      @144    I10_DX_Admitting              $CHAR7.                             
      @151    I10_DX1                       $CHAR7.                             
      @158    I10_DX2                       $CHAR7.                             
      @165    I10_DX3                       $CHAR7.                             
      @172    I10_DX4                       $CHAR7.                             
      ...
      @869    PL_UIC                        N2PF.                               
      @871    PL_UR_CAT4                    N2PF.                               
      @873    POA_Disch_Edit1               N2PF.                               
      @875    POA_Disch_Edit2               N2PF.                               
      @877    POA_Hosp_Edit1                N2PF.                               
      @879    POA_Hosp_Edit2                N2PF.                               
      @881    POA_Hosp_Edit3                N2PF.                               
      @883    POA_Hosp_Edit3_Value          N8P2F.                              
      @891    PointOfOrigin_X               $CHAR1.                             
      @892    PointOfOriginUB04             $CHAR1.                             
      @893    PRDAY1                        N5PF.                               
      @898    PRDAY2                        N5PF.                               
      @903    PRDAY3                        N5PF.                               
      @908    PRDAY4                        N5PF.                               
      ...
      @1067   RACE_X                        $CHAR20.                            
      @1087   TOTCHG                        N10PF.                              
      @1097   TOTCHG_X                      N15P2F.                             
      @1112   TRAN_IN                       N2PF.                               
      @1114   TRAN_OUT                      N2PF.                               
      @1116   YEAR                          N4PF.                               
      @1120   ZIP                           $CHAR5.                             
      @1125   ZIP3                          $CHAR3.                             
      @1128   ZIPINC_QRTL                   N3PF.                               
      @1131   AYEAR                         N4PF.                               
      @1135   BMONTH                        N2PF.                               
      @1137   BYEAR                         N4PF.                               
      @1141   PRMONTH1                      N2PF.                               
