...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SIDC_2016_CORE;                                                         
INFILE 'SC_SID_2016_CORE.ASC' FIRSTOBS=3 LRECL = 532;                           
...
INPUT                                                                           
      ...
      @156    I10_DX14                      $CHAR7.                             
      @163    I10_DX15                      $CHAR7.                             
      @170    I10_ECAUSE1                   $CHAR7.                             
      @177    I10_ECAUSE2                   $CHAR7.                             
      @184    I10_ECAUSE3                   $CHAR7.                             
      @191    I10_ECAUSE4                   $CHAR7.                             
      @198    I10_ECAUSE5                   $CHAR7.                             
      @205    I10_ECAUSE6                   $CHAR7.                             
      @212    I10_ECAUSE7                   $CHAR7.                             
      @219    I10_ECAUSE8                   $CHAR7.                             
      @226    I10_ECAUSE9                   $CHAR7.                             
      @233    I10_NDX                       N3PF.                               
      @236    I10_NECAUSE                   N2PF.                               
      @238    I10_NPR                       N3PF.                               
      @241    I10_PR1                       $CHAR7.                             
      @248    I10_PR2                       $CHAR7.                             
      @255    I10_PR3                       $CHAR7.                             
      ...
      @388    PL_NCHS                       N2PF.                               
      @390    PL_UR_CAT4                    N2PF.                               
      @392    POA_Disch_Edit1               N2PF.                               
      @394    POA_Disch_Edit2               N2PF.                               
      @396    POA_Hosp_Edit1                N2PF.                               
      @398    POA_Hosp_Edit2                N2PF.                               
      @400    POA_Hosp_Edit3                N2PF.                               
      @402    POA_Hosp_Edit3_Value          N8P2F.                              
