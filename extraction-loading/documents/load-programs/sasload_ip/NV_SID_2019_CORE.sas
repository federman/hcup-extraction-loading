...
*  Data Step                  *;                                                
*******************************;                                                
DATA NV_SIDC_2019_CORE;                                                         
INFILE 'NV_SID_2019_CORE.ASC' FIRSTOBS=3 LRECL = 828;                           
...
INPUT                                                                           
      ...
      @553    LOS                           N5PF.                               
      @558    LOS_X                         N6PF.                               
      @564    MARITALSTATUSUB04             $CHAR1.                             
      @565    MARITALSTATUS_X               $CHAR1.                             
      @566    MDC                           N2PF.                               
      @568    MDC_NoPOA                     N2PF.                               
      @570    MDNUM1_R                      N9PF.                               
      @579    MDNUM2_R                      N9PF.                               
      ...
      @619    PL_UIC                        N2PF.                               
      @621    PL_UR_CAT4                    N2PF.                               
      @623    POA_Disch_Edit1               N2PF.                               
      @625    POA_Disch_Edit2               N2PF.                               
      @627    POA_Hosp_Edit1                N2PF.                               
      @629    POA_Hosp_Edit2                N2PF.                               
      @631    POA_Hosp_Edit3                N2PF.                               
      @633    POA_Hosp_Edit3_Value          N8P2F.                              
      @641    PRDAY1                        N5PF.                               
      @646    PRDAY2                        N5PF.                               
      @651    PRDAY3                        N5PF.                               
      @656    PRDAY4                        N5PF.                               
      ...
      @761    PRDAY25                       N5PF.                               
      @766    PSTATE                        $CHAR2.                             
      @768    PSTATE_GEO                    $CHAR2.                             
      @770    PSTCO                         N5PF.                               
      @775    PSTCO_GEO                     N5PF.                               
      @780    PointOfOriginUB04             $CHAR1.                             
      @781    PointOfOrigin_X               $CHAR2.                             
      @783    RACE                          N2PF.                               
      @785    RACE_EDIT                     N2PF.                               
      @787    RACE_X                        $CHAR2.                             
      @789    TOTCHG                        N10PF.                              
