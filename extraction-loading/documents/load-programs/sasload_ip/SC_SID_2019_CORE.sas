...
*  Data Step                  *;                                                
*******************************;                                                
DATA SC_SIDC_2019_CORE;                                                         
INFILE 'SC_SID_2019_CORE.ASC' FIRSTOBS=3 LRECL = 490;                           
...
INPUT                                                                           
      ...
      @425    PRDAY13                       N5PF.                               
      @430    PSTATE                        $CHAR2.                             
      @432    PSTATE_GEO                    $CHAR2.                             
      @434    PSTCO                         N5PF.                               
      @439    PointOfOriginUB04             $CHAR1.                             
      @440    PointOfOrigin_X               $CHAR1.                             
      @441    RACE                          N2PF.                               
      @443    RACE_EDIT                     N2PF.                               
      @445    RACE_X                        $CHAR3.                             
      @448    TOTCHG                        N10PF.                              
