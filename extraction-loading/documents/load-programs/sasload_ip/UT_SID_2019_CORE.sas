...
*  Data Step                  *;                                                
*******************************;                                                
DATA UT_SIDC_2019_CORE;                                                         
INFILE 'UT_SID_2019_CORE.ASC' FIRSTOBS=3 LRECL = 1745;                          
...
INPUT                                                                           
      ...
      @1265   DaysToEvent                   N6PF.                               
      @1271   FEMALE                        N2PF.                               
      @1273   HCUP_ED                       N2PF.                               
      @1275   HCUP_OS                       N2PF.                               
      @1277   HISPANIC                      N2PF.                               
      @1279   HISPANIC_X                    $CHAR6.                             
      @1285   HOSPST                        $CHAR2.                             
      @1287   I10_BIRTH                     N3PF.                               
      @1290   I10_DELIVERY                  N3PF.                               
      @1293   I10_DX1                       $CHAR7.                             
      @1300   I10_DX2                       $CHAR7.                             
      @1307   I10_DX3                       $CHAR7.                             
      @1314   I10_DX4                       $CHAR7.                             
      ...
      @1419   I10_DX19                      $CHAR7.                             
      @1426   I10_DX20                      $CHAR7.                             
      @1433   I10_DX_Admitting              $CHAR7.                             
      @1440   I10_NDX                       N3PF.                               
      @1443   I10_NPR                       N3PF.                               
      @1446   I10_ORPROC                    N2PF.                               
      @1448   I10_PR1                       $CHAR7.                             
      @1455   I10_PR2                       $CHAR7.                             
      @1462   I10_PR3                       $CHAR7.                             
      @1469   I10_PR4                       $CHAR7.                             
      @1476   I10_PR5                       $CHAR7.                             
      @1483   I10_PR6                       $CHAR7.                             
      @1490   I10_PROCTYPE                  N3PF.                               
      @1493   I10_SERVICELINE               N2PF.                               
      @1495   KEY                           15.                                 
      @1510   LOS                           N5PF.                               
      @1515   LOS_X                         N6PF.                               
      @1521   MARITALSTATUSUB04             $CHAR1.                             
      @1522   MARITALSTATUS_X               $CHAR1.                             
      @1523   MDC                           N2PF.                               
      @1525   MDC_NoPOA                     N2PF.                               
      @1527   MDNUM1_R                      N9PF.                               
      @1536   MEDINCSTQ                     N2PF.                               
      ...
      @1621   PRDAY6                        N5PF.                               
      @1626   PSTATE                        $CHAR2.                             
      @1628   PSTATE_GEO                    $CHAR2.                             
      @1630   PSTCO_GEO                     N5PF.                               
      @1635   PointOfOriginUB04             $CHAR1.                             
      @1636   PointOfOrigin_X               $CHAR1.                             
      @1637   RACE                          N2PF.                               
      @1639   RACE_EDIT                     N2PF.                               
      @1641   RACE_X                        $CHAR6.                             
      @1647   TOTCHG                        N10PF.                              
      @1657   TOTCHG_X                      N15P2F.                             
      @1672   TRAN_IN                       N2PF.                               
      @1674   TRAN_OUT                      N2PF.                               
      @1676   VisitLink                     N9PF.                               
      @1685   YEAR                          N4PF.                               
