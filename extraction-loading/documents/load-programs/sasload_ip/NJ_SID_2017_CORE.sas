...
*  Data Step                  *;                                                
*******************************;                                                
DATA NJ_SIDC_2017_CORE;                                                         
INFILE 'NJ_SID_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1725;                          
...
INPUT                                                                           
      ...
      @719    HCUP_OS                       N2PF.                               
      @721    HISPANIC                      N2PF.                               
      @723    HISPANIC_X                    $CHAR5.                             
      @728    Homeless                      N2PF.                               
      @730    HOSPST                        $CHAR2.                             
      @732    I10_DX_Admitting              $CHAR7.                             
      @739    I10_DX1                       $CHAR7.                             
      @746    I10_DX2                       $CHAR7.                             
      @753    I10_DX3                       $CHAR7.                             
      @760    I10_DX4                       $CHAR7.                             
      ...
      @1193   I10_PR24                      $CHAR7.                             
      @1200   I10_PR25                      $CHAR7.                             
      @1207   I10_PROCTYPE                  N3PF.                               
      @1210   KEY                           15.                                 
      @1225   LOS                           N5PF.                               
      @1230   LOS_X                         N6PF.                               
      @1236   MARITALSTATUS_X               $CHAR1.                             
      @1237   MARITALSTATUSUB04             $CHAR1.                             
      @1238   MDC                           N2PF.                               
      @1240   MDC_NoPOA                     N2PF.                               
      @1242   MDNUM1_R                      N9PF.                               
      @1251   MDNUM2_R                      N9PF.                               
      ...
      @1362   PointOfOrigin_X               $CHAR1.                             
      @1363   PointOfOriginUB04             $CHAR1.                             
      @1364   PRDAY1                        N5PF.                               
      @1369   PRDAY2                        N5PF.                               
      @1374   PRDAY3                        N5PF.                               
      @1379   PRDAY4                        N5PF.                               
