...
*  Data Step                  *;                                                
*******************************;                                                
DATA WV_SIDC_2019_CORE;                                                         
INFILE 'WV_SID_2019_CORE.ASC' FIRSTOBS=3 LRECL = 966;                           
...
INPUT                                                                           
      ...
      @541    I10_PR24                      $CHAR7.                             
      @548    I10_PR25                      $CHAR7.                             
      @555    I10_PROCTYPE                  N3PF.                               
      @558    I10_SERVICELINE               N2PF.                               
      @560    KEY                           15.                                 
      @575    LOS                           N5PF.                               
      @580    LOS_X                         N6PF.                               
      @586    MDC                           N2PF.                               
      ...
      @636    PointOfOrigin_X               $CHAR1.                             
      @637    PointOfOriginUB04             $CHAR1.                             
      @638    PRDAY1                        N5PF.                               
      @643    PRDAY2                        N5PF.                               
      @648    PRDAY3                        N5PF.                               
      @653    PRDAY4                        N5PF.                               
