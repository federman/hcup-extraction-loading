...
*  Data Step                  *;                                                
*******************************;                                                
DATA AK_SIDC_2015q4_DX_PR_GRPS;                                                 
INFILE 'AK_SID_2015q4_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 845;                   
...
INPUT                                                                           
      ...
      @517    I10_INJURY                    N2PF.                               
      @519    I10_MULTINJURY                N2PF.                               
      @521    I10_PCLASS1                   N2PF.                               
      @523    I10_PCLASS2                   N2PF.                               
      @525    I10_PCLASS3                   N2PF.                               
      @527    I10_PCLASS4                   N2PF.                               
      @529    I10_PCLASS5                   N2PF.                               
      @531    I10_PCLASS6                   N2PF.                               
      @533    I10_PCLASS7                   N2PF.                               
      @535    I10_PCLASS8                   N2PF.                               
      @537    I10_PCLASS9                   N2PF.                               
      @539    I10_PCLASS10                  N2PF.                               
      @541    I10_PCLASS11                  N2PF.                               
      @543    I10_PCLASS12                  N2PF.                               
      @545    I10_PCLASS13                  N2PF.                               
      @547    I10_PCLASS14                  N2PF.                               
      @549    I10_PCLASS15                  N2PF.                               
      @551    I10_PCLASS16                  N2PF.                               
      @553    I10_PCLASS17                  N2PF.                               
      @555    I10_PCLASS18                  N2PF.                               
      @557    I10_PCLASS19                  N2PF.                               
      @559    I10_PCLASS20                  N2PF.                               
      @561    I10_PCLASS21                  N2PF.                               
      @563    I10_PCLASS22                  N2PF.                               
      @565    I10_PCLASS23                  N2PF.                               
      @567    I10_PCLASS24                  N2PF.                               
      @569    I10_PCLASS25                  N2PF.                               
      @571    I10_PRMCCS1                   $CHAR8.                             
      @579    I10_PRMCCS2                   $CHAR8.                             
      @587    I10_PRMCCS3                   $CHAR8.                             
      @595    I10_PRMCCS4                   $CHAR8.                             
      @603    I10_PRMCCS5                   $CHAR8.                             
      @611    I10_PRMCCS6                   $CHAR8.                             
      @619    I10_PRMCCS7                   $CHAR8.                             
      @627    I10_PRMCCS8                   $CHAR8.                             
      @635    I10_PRMCCS9                   $CHAR8.                             
      @643    I10_PRMCCS10                  $CHAR8.                             
      @651    I10_PRMCCS11                  $CHAR8.                             
      @659    I10_PRMCCS12                  $CHAR8.                             
      @667    I10_PRMCCS13                  $CHAR8.                             
      @675    I10_PRMCCS14                  $CHAR8.                             
      @683    I10_PRMCCS15                  $CHAR8.                             
      @691    I10_PRMCCS16                  $CHAR8.                             
      @699    I10_PRMCCS17                  $CHAR8.                             
      @707    I10_PRMCCS18                  $CHAR8.                             
      @715    I10_PRMCCS19                  $CHAR8.                             
      @723    I10_PRMCCS20                  $CHAR8.                             
      @731    I10_PRMCCS21                  $CHAR8.                             
      @739    I10_PRMCCS22                  $CHAR8.                             
      @747    I10_PRMCCS23                  $CHAR8.                             
      @755    I10_PRMCCS24                  $CHAR8.                             
      @763    I10_PRMCCS25                  $CHAR8.                             
      @771    I10_U_BLOOD                   N2PF.                               
      @773    I10_U_CATH                    N2PF.                               
      @775    I10_U_CTSCAN                  N2PF.                               
      @777    I10_U_EKG                     N2PF.                               
      @779    I10_U_MHSA                    N2PF.                               
      @781    I10_U_MRT                     N2PF.                               
      @783    I10_U_PACEMAKER               N2PF.                               
      @785    I10_U_PHYTHERAPY              N2PF.                               
      @787    I10_U_RADTHERAPY              N2PF.                               
      @789    I10_U_STRESS                  N2PF.                               
      @791    KEY                           15.                                 
      @806    U_CCU                         N2PF.                               
      @808    U_CHESTXRAY                   N2PF.                               
      @810    U_DIALYSIS                    N2PF.                               
      @812    U_ECHO                        N2PF.                               
      @814    U_ED                          N2PF.                               
      @816    U_EEG                         N2PF.                               
      @818    U_EPO                         N2PF.                               
      @820    U_ICU                         N2PF.                               
      @822    U_LITHOTRIPSY                 N2PF.                               
      @824    U_NEWBN2L                     N2PF.                               
      @826    U_NEWBN3L                     N2PF.                               
      @828    U_NEWBN4L                     N2PF.                               
      @830    U_NUCMED                      N2PF.                               
      @832    U_OBSERVATION                 N2PF.                               
      @834    U_OCCTHERAPY                  N2PF.                               
      @836    U_ORGANACQ                    N2PF.                               
      @838    U_OTHIMPLANTS                 N2PF.                               
      @840    U_RESPTHERAPY                 N2PF.                               
      @842    U_SPEECHTHERAPY               N2PF.                               
