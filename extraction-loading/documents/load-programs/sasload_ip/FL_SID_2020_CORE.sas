...
*  Data Step                  *;                                                
*******************************;                                                
DATA FL_SIDC_2020_CORE;                                                         
INFILE 'FL_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 1047;                          
...
INPUT                                                                           
      ...
      @99     HCUP_OS                       N2PF.                               
      @101    HISPANIC                      N2PF.                               
      @103    HISPANIC_X                    $CHAR2.                             
      @105    Homeless                      N2PF.                               
      @107    HospitalUnit                  N2PF.                               
      @109    HOSPST                        $CHAR2.                             
      @111    I10_BIRTH                     N3PF.                               
      @114    I10_DELIVERY                  N3PF.                               
      @117    I10_DX_Admitting              $CHAR7.                             
      @124    I10_DX1                       $CHAR7.                             
      @131    I10_DX2                       $CHAR7.                             
      @138    I10_DX3                       $CHAR7.                             
      @145    I10_DX4                       $CHAR7.                             
      ...
      @571    I10_PR30                      $CHAR7.                             
      @578    I10_PR31                      $CHAR7.                             
      @585    I10_PROCTYPE                  N3PF.                               
      @588    I10_SERVICELINE               N2PF.                               
      @590    KEY                           15.                                 
      @605    LOS                           N5PF.                               
      @610    LOS_X                         N6PF.                               
      @616    MDC                           N2PF.                               
      ...
      @651    PAY1                          N2PF.                               
      @653    PAY1_X                        $CHAR1.                             
      @654    PCLASS_ORPROC                 N2PF.                               
      @656    PL_CBSA                       N3PF.                               
      @659    PL_NCHS                       N2PF.                               
      @661    PL_RUCC                       N2PF.                               
      @663    PL_UIC                        N2PF.                               
      @665    PL_UR_CAT4                    N2PF.                               
      @667    POA_Disch_Edit1               N2PF.                               
      @669    POA_Disch_Edit2               N2PF.                               
      @671    POA_Hosp_Edit1                N2PF.                               
      @673    POA_Hosp_Edit2                N2PF.                               
      @675    POA_Hosp_Edit3                N2PF.                               
      @677    POA_Hosp_Edit3_Value          N8P2F.                              
      @685    PointOfOrigin_X               $CHAR2.                             
      @687    PointOfOriginUB04             $CHAR1.                             
      @688    PRDAY1                        N5PF.                               
      @693    PRDAY2                        N5PF.                               
      @698    PRDAY3                        N5PF.                               
      @703    PRDAY4                        N5PF.                               
      ...
      @838    PRDAY31                       N5PF.                               
      @843    PSTATE                        $CHAR2.                             
      @845    PSTATE_GEO                    $CHAR2.                             
      @847    PSTCO                         N5PF.                               
      @852    PSTCO_GEO                     N5PF.                               
      @857    RACE                          N2PF.                               
      @859    RACE_PCT_MISS_HOSP            N7P2F.                              
      @866    RACE_X                        $CHAR1.                             
      @867    TOTCHG                        N10PF.                              
      @877    TOTCHG_X                      N15P2F.                             
      @892    TRAN_IN                       N2PF.                               
