...
*  Data Step                  *;                                                
*******************************;                                                
DATA MA_SIDC_2017_CORE;                                                         
INFILE 'MA_SID_2017_CORE.ASC' FIRSTOBS=3 LRECL = 2765;                          
...
INPUT                                                                           
      ...
      @194    HCUP_OS                       N2PF.                               
      @196    HISPANIC                      N2PF.                               
      @198    HISPANIC_X                    $CHAR15.                            
      @213    Homeless                      N2PF.                               
      @215    HOSPST                        $CHAR2.                             
      @217    I10_DX_Admitting              $CHAR7.                             
      @224    I10_DX1                       $CHAR7.                             
      @231    I10_DX2                       $CHAR7.                             
      @238    I10_DX3                       $CHAR7.                             
      @245    I10_DX4                       $CHAR7.                             
      ...
      @1671   PAYER2_X                      $CHAR3.                             
      @1674   PL_CBSA                       N3PF.                               
      @1677   PL_UR_CAT4                    N2PF.                               
      @1679   POA_Disch_Edit1               N2PF.                               
      @1681   POA_Disch_Edit2               N2PF.                               
      @1683   POA_Hosp_Edit1                N2PF.                               
      @1685   POA_Hosp_Edit2                N2PF.                               
      @1687   POA_Hosp_Edit3                N2PF.                               
      @1689   POA_Hosp_Edit3_Value          N8P2F.                              
      @1697   PRDAY1                        N5PF.                               
      @1702   PRDAY2                        N5PF.                               
      @1707   PRDAY3                        N5PF.                               
      @1712   PRDAY4                        N5PF.                               
      ...
      @2161   RACE_X                        $CHAR13.                            
      @2174   TOTCHG                        N10PF.                              
      @2184   TOTCHG_X                      N15P2F.                             
      @2199   TRAN_IN                       N2PF.                               
      @2201   TRAN_OUT                      N2PF.                               
      @2203   VisitLink                     N9PF.                               
      @2212   YEAR                          N4PF.                               
      @2216   ZIP3                          $CHAR3.                             
      @2219   ZIPINC_QRTL                   N3PF.                               
      @2222   AYEAR                         N4PF.                               
      @2226   PRMONTH1                      N2PF.                               
      @2228   PRMONTH2                      N2PF.                               
      @2230   PRMONTH3                      N2PF.                               
