...
*  Data Step                  *;                                                
*******************************;                                                
DATA MN_SIDC_2010_DX_PR_GRPS;                                                   
INFILE 'MN_SID_2010_DX_PR_GRPS.ASC' FIRSTOBS=3 LRECL = 964;                     
...
INPUT                                                                           
      ...
      @939    U_NEWBN4L                     N2PF.                               
      @941    U_NUCMED                      N2PF.                               
      @943    U_OBSERVATION                 N2PF.                               
      @945    U_OCCTHERAPY                  N2PF.                               
      @947    U_ORGANACQ                    N2PF.                               
      @949    U_OTHIMPLANTS                 N2PF.                               
      @951    U_PACEMAKER                   N2PF.                               
      @953    U_PHYTHERAPY                  N2PF.                               
      @955    U_RADTHERAPY                  N2PF.                               
      @957    U_RESPTHERAPY                 N2PF.                               
      @959    U_SPEECHTHERAPY               N2PF.                               
      @961    U_STRESS                      N2PF.                               
      @963    U_ULTRASOUND                  N2PF.                               
      ;                                                                         
