...
*  Data Step                  *;                                                
*******************************;                                                
DATA RI_SIDC_2018_CORE;                                                         
INFILE 'RI_SID_2018_CORE.ASC' FIRSTOBS=3 LRECL = 1058;                          
...
INPUT                                                                           
      ...
      @219    HCUP_OS                       N2PF.                               
      @221    HISPANIC                      N2PF.                               
      @223    HISPANIC_X                    $CHAR4.                             
      @227    HOSPST                        $CHAR2.                             
      @229    I10_DX_Admitting              $CHAR7.                             
      @236    I10_DX1                       $CHAR7.                             
      @243    I10_DX2                       $CHAR7.                             
      @250    I10_DX3                       $CHAR7.                             
      @257    I10_DX4                       $CHAR7.                             
      ...
      @689    PL_UIC                        N2PF.                               
      @691    PL_UR_CAT4                    N2PF.                               
      @693    POA_Disch_Edit1               N2PF.                               
      @695    POA_Disch_Edit2               N2PF.                               
      @697    POA_Hosp_Edit1                N2PF.                               
      @699    POA_Hosp_Edit2                N2PF.                               
      @701    POA_Hosp_Edit3                N2PF.                               
      @703    POA_Hosp_Edit3_Value          N8P2F.                              
      @711    PointOfOrigin_X               $CHAR1.                             
      @712    PointOfOriginUB04             $CHAR1.                             
      @713    PRDAY1                        N5PF.                               
      @718    PRDAY2                        N5PF.                               
      @723    PRDAY3                        N5PF.                               
      @728    PRDAY4                        N5PF.                               
