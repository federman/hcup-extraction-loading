...
*  Data Step                  *;                                                
*******************************;                                                
DATA MS_SIDC_2019_CORE;                                                         
INFILE 'MS_SID_2019_CORE.ASC' FIRSTOBS=3 LRECL = 1158;                          
...
INPUT                                                                           
      ...
      @110    DXPOA50                       $CHAR1.                             
      @111    DXPOA51                       $CHAR1.                             
      @112    DaysToEvent                   N6PF.                               
      @118    FEMALE                        N2PF.                               
      @120    HCUP_ED                       N2PF.                               
      @122    HCUP_OS                       N2PF.                               
      @124    HISPANIC                      N2PF.                               
      @126    HISPANIC_X                    $CHAR1.                             
      @127    HOSPST                        $CHAR2.                             
      @129    HospitalUnit                  N2PF.                               
      @131    I10_BIRTH                     N3PF.                               
      @134    I10_DELIVERY                  N3PF.                               
      @137    I10_DX1                       $CHAR7.                             
      @144    I10_DX2                       $CHAR7.                             
      @151    I10_DX3                       $CHAR7.                             
      @158    I10_DX4                       $CHAR7.                             
      ...
      @670    I10_PR24                      $CHAR7.                             
      @677    I10_PR25                      $CHAR7.                             
      @684    I10_PROCTYPE                  N3PF.                               
      @687    I10_SERVICELINE               N2PF.                               
      @689    KEY                           15.                                 
      @704    LOS                           N5PF.                               
      @709    LOS_X                         N6PF.                               
      @715    MDC                           N2PF.                               
      ...
      @778    PL_UIC                        N2PF.                               
      @780    PL_UR_CAT4                    N2PF.                               
      @782    POA_Disch_Edit1               N2PF.                               
      @784    POA_Disch_Edit2               N2PF.                               
      @786    POA_Hosp_Edit1                N2PF.                               
      @788    POA_Hosp_Edit2                N2PF.                               
      @790    POA_Hosp_Edit3                N2PF.                               
      @792    POA_Hosp_Edit3_Value          N8P2F.                              
      @800    PRDAY1                        N5PF.                               
      @805    PRDAY2                        N5PF.                               
      @810    PRDAY3                        N5PF.                               
      @815    PRDAY4                        N5PF.                               
      ...
      @920    PRDAY25                       N5PF.                               
      @925    PSTATE                        $CHAR2.                             
      @927    PSTATE_GEO                    $CHAR2.                             
      @929    PSTCO                         N5PF.                               
      @934    PSTCO_GEO                     N5PF.                               
      @939    PointOfOriginUB04             $CHAR1.                             
      @940    PointOfOrigin_X               $CHAR1.                             
      @941    RACE                          N2PF.                               
      @943    RACE_EDIT                     N2PF.                               
      @945    RACE_X                        $CHAR1.                             
      @946    TOTCHG                        N10PF.                              
