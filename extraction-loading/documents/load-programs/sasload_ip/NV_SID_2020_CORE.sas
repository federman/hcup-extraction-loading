...
*  Data Step                  *;                                                
*******************************;                                                
DATA NV_SIDC_2020_CORE;                                                         
INFILE 'NV_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 835;                           
...
INPUT                                                                           
      ...
      @106    HOSPST                        $CHAR2.                             
      @108    I10_BIRTH                     N3PF.                               
      @111    I10_DELIVERY                  N3PF.                               
      @114    I10_DX_Admitting              $CHAR7.                             
      @121    I10_DX1                       $CHAR7.                             
      @128    I10_DX2                       $CHAR7.                             
      @135    I10_DX3                       $CHAR7.                             
      @142    I10_DX4                       $CHAR7.                             
      ...
      @519    I10_PR24                      $CHAR7.                             
      @526    I10_PR25                      $CHAR7.                             
      @533    I10_PROCTYPE                  N3PF.                               
      @536    I10_SERVICELINE               N2PF.                               
      @538    KEY                           15.                                 
      @553    LOS                           N5PF.                               
      @558    LOS_X                         N6PF.                               
      @564    MARITALSTATUS_X               $CHAR1.                             
      @565    MARITALSTATUSUB04             $CHAR1.                             
      @566    MDC                           N2PF.                               
      @568    MDC_NoPOA                     N2PF.                               
      @570    MDNUM1_R                      N9PF.                               
      @579    MDNUM2_R                      N9PF.                               
      @588    MDNUMTYPE1                    $CHAR1.                             
      @589    MDNUMTYPE2                    $CHAR1.                             
      @590    MEDINCSTQ                     N2PF.                               
      @592    OS_TIME                       N11P2F.                             
      @603    PAY1                          N2PF.                               
      @605    PAY1_X                        $CHAR2.                             
      ...
      @611    PAY3                          N2PF.                               
      @613    PAY3_X                        $CHAR2.                             
      @615    PCLASS_ORPROC                 N2PF.                               
      @617    PL_NCHS                       N2PF.                               
      @619    PL_RUCC                       N2PF.                               
      @621    PL_UIC                        N2PF.                               
      @623    PL_UR_CAT4                    N2PF.                               
      @625    POA_Disch_Edit1               N2PF.                               
      @627    POA_Disch_Edit2               N2PF.                               
      @629    POA_Hosp_Edit1                N2PF.                               
      @631    POA_Hosp_Edit2                N2PF.                               
      @633    POA_Hosp_Edit3                N2PF.                               
      @635    POA_Hosp_Edit3_Value          N8P2F.                              
      @643    PointOfOrigin_X               $CHAR2.                             
      @645    PointOfOriginUB04             $CHAR1.                             
      @646    PRDAY1                        N5PF.                               
      @651    PRDAY2                        N5PF.                               
      @656    PRDAY3                        N5PF.                               
      @661    PRDAY4                        N5PF.                               
      ...
      @766    PRDAY25                       N5PF.                               
      @771    PSTATE                        $CHAR2.                             
      @773    PSTATE_GEO                    $CHAR2.                             
      @775    PSTCO                         N5PF.                               
      @780    PSTCO_GEO                     N5PF.                               
      @785    RACE                          N2PF.                               
      @787    RACE_PCT_MISS_HOSP            N7P2F.                              
      @794    RACE_X                        $CHAR2.                             
      @796    TOTCHG                        N10PF.                              
      @806    TOTCHG_X                      N15P2F.                             
      @821    TRAN_IN                       N2PF.                               
