...
*  Data Step                  *;                                                
*******************************;                                                
DATA KS_SIDC_2019_CORE;                                                         
INFILE 'KS_SID_2019_CORE.ASC' FIRSTOBS=3 LRECL = 929;                           
...
INPUT                                                                           
      ...
      @86     HISPANIC_X                    $CHAR1.                             
      @87     HOSPST                        $CHAR2.                             
      @89     HospitalUnit                  N2PF.                               
      @91     I10_BIRTH                     N2PF.                               
      @93     I10_DELIVERY                  N2PF.                               
      @95     I10_DX1                       $CHAR7.                             
      @102    I10_DX2                       $CHAR7.                             
      @109    I10_DX3                       $CHAR7.                             
      @116    I10_DX4                       $CHAR7.                             
      ...
      @558    PL_UIC                        N2PF.                               
      @560    PL_UR_CAT4                    N2PF.                               
      @562    POA_Disch_Edit1               N2PF.                               
      @564    POA_Disch_Edit2               N2PF.                               
      @566    POA_Hosp_Edit1                N2PF.                               
      @568    POA_Hosp_Edit2                N2PF.                               
      @570    POA_Hosp_Edit3                N2PF.                               
      @572    POA_Hosp_Edit3_Value          N8P2F.                              
      @580    PRDAY1                        N5PF.                               
      @585    PRDAY2                        N5PF.                               
      @590    PRDAY3                        N5PF.                               
      @595    PRDAY4                        N5PF.                               
