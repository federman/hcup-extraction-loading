...
*  Data Step                  *;                                                
*******************************;                                                
DATA DC_SIDC_2018_CORE;                                                         
INFILE 'DC_SID_2018_CORE.ASC' FIRSTOBS=3 LRECL = 2288;                          
...
INPUT                                                                           
      ...
      @1694   POA_Disch_Edit1               N2PF.                               
      @1696   POA_Disch_Edit2               N2PF.                               
      @1698   POA_Hosp_Edit1                N2PF.                               
      @1700   POA_Hosp_Edit2                N2PF.                               
      @1702   POA_Hosp_Edit3                N2PF.                               
      @1704   POA_Hosp_Edit3_Value          N8P2F.                              
      @1712   PointOfOrigin_X               $CHAR3.                             
      @1715   PointOfOriginUB04             $CHAR1.                             
      @1716   PRDAY1                        N5PF.                               
      @1721   PRDAY2                        N5PF.                               
      @1726   PRDAY3                        N5PF.                               
      @1731   PRDAY4                        N5PF.                               
      ...
      @2227   RACE_X                        $CHAR3.                             
      @2230   TOTCHG                        N10PF.                              
      @2240   TOTCHG_X                      N15P2F.                             
      @2255   TRAN_IN                       N2PF.                               
      @2257   TRAN_OUT                      N2PF.                               
      @2259   YEAR                          N4PF.                               
      @2263   ZIP                           $CHAR5.                             
      @2268   ZIP3                          $CHAR3.                             
      @2271   ZIPINC_QRTL                   N3PF.                               
      @2274   HOSPID                        N5PF.                               
      @2279   AYEAR                         N4PF.                               
      @2283   BMONTH                        N2PF.                               
      @2285   BYEAR                         N4PF.                               
