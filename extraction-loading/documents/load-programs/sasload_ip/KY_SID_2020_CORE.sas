...
*  Data Step                  *;                                                
*******************************;                                                
DATA KY_SIDC_2020_CORE;                                                         
INFILE 'KY_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 966;                           
...
INPUT                                                                           
      ...
      @96     HCUP_OS                       N2PF.                               
      @98     HISPANIC                      N2PF.                               
      @100    HISPANIC_X                    $CHAR2.                             
      @102    HOSP_NPI                      $CHAR10.                            
      @112    HOSPST                        $CHAR2.                             
      @114    I10_BIRTH                     N3PF.                               
      @117    I10_DELIVERY                  N3PF.                               
      ...
      @497    I10_PR24                      $CHAR7.                             
      @504    I10_PR25                      $CHAR7.                             
      @511    I10_PROCTYPE                  N3PF.                               
      @514    I10_SERVICELINE               N2PF.                               
      @516    KEY                           15.                                 
      @531    LOS                           N5PF.                               
      @536    LOS_X                         N6PF.                               
      @542    MDC                           N2PF.                               
      ...
      @573    PAY3                          N2PF.                               
      @575    PAY3_X                        $CHAR5.                             
      @580    PCLASS_ORPROC                 N2PF.                               
      @582    PL_CBSA                       N3PF.                               
      @585    PL_NCHS                       N2PF.                               
      @587    PL_RUCC                       N2PF.                               
      @589    PL_UIC                        N2PF.                               
      @591    PL_UR_CAT4                    N2PF.                               
      @593    POA_Disch_Edit1               N2PF.                               
      @595    POA_Disch_Edit2               N2PF.                               
      @597    POA_Hosp_Edit1                N2PF.                               
      @599    POA_Hosp_Edit2                N2PF.                               
      @601    POA_Hosp_Edit3                N2PF.                               
      @603    POA_Hosp_Edit3_Value          N8P2F.                              
      @611    PointOfOrigin_X               $CHAR1.                             
      ...
      @733    PRDAY25                       N5PF.                               
      @738    PSTATE                        $CHAR2.                             
      @740    PSTATE_GEO                    $CHAR2.                             
      @742    PSTCO                         N5PF.                               
      @747    PSTCO_GEO                     N5PF.                               
      @752    RACE                          N2PF.                               
      @754    RACE_PCT_MISS_HOSP            N7P2F.                              
      @761    RACE_X                        $CHAR2.                             
      @763    TOTCHG                        N10PF.                              
      @773    TOTCHG_X                      N15P2F.                             
      @788    TRAN_IN                       N2PF.                               
