...
*  Data Step                  *;                                                
*******************************;                                                
DATA DE_SIDC_2020_CORE;                                                         
INFILE 'DE_SID_2020_CORE.ASC' FIRSTOBS=3 LRECL = 397;                           
...
INPUT                                                                           
      ...
      @70     HOSPST                        $CHAR2.                             
      @72     I10_BIRTH                     N3PF.                               
      @75     I10_DELIVERY                  N3PF.                               
      @78     I10_DX_Admitting              $CHAR7.                             
      @85     I10_DX1                       $CHAR7.                             
      @92     I10_DX2                       $CHAR7.                             
      @99     I10_DX3                       $CHAR7.                             
      @106    I10_DX4                       $CHAR7.                             
      ...
      @189    I10_PR5                       $CHAR7.                             
      @196    I10_PR6                       $CHAR7.                             
      @203    I10_PROCTYPE                  N3PF.                               
      @206    I10_SERVICELINE               N2PF.                               
      @208    KEY                           15.                                 
      @223    LOS                           N5PF.                               
      @228    LOS_X                         N6PF.                               
      @234    MARITALSTATUS_X               $CHAR1.                             
      @235    MARITALSTATUSUB04             $CHAR1.                             
      @236    MDC                           N2PF.                               
      @238    MDC_NoPOA                     N2PF.                               
      @240    MDNUM1_R                      N9PF.                               
      @249    MEDINCSTQ                     N2PF.                               
      ...
      @270    PAY3                          N2PF.                               
      @272    PAY3_X                        $CHAR2.                             
      @274    PCLASS_ORPROC                 N2PF.                               
      @276    PL_CBSA                       N3PF.                               
      @279    PL_NCHS                       N2PF.                               
      @281    PL_RUCC                       N2PF.                               
      @283    PL_UIC                        N2PF.                               
      @285    PL_UR_CAT4                    N2PF.                               
      @287    PointOfOrigin_X               $CHAR1.                             
      @288    PointOfOriginUB04             $CHAR1.                             
      @289    PRDAY1                        N5PF.                               
      @294    PRDAY2                        N5PF.                               
      @299    PSTATE                        $CHAR2.                             
      @301    PSTATE_GEO                    $CHAR2.                             
      @303    PSTCO                         N5PF.                               
      @308    PSTCO_GEO                     N5PF.                               
      @313    RACE                          N2PF.                               
      @315    RACE_PCT_MISS_HOSP            N7P2F.                              
      @322    RACE_X                        $CHAR1.                             
      @323    TOTCHG                        N10PF.                              
      @333    TOTCHG_X                      N15P2F.                             
      @348    TRAN_IN                       N2PF.                               
