...
*  Data Step                  *;                                                
*******************************;                                                
DATA RI_SIDC_2017_CORE;                                                         
INFILE 'RI_SID_2017_CORE.ASC' FIRSTOBS=3 LRECL = 1064;                          
...
INPUT                                                                           
      ...
      @222    HCUP_OS                       N2PF.                               
      @224    HISPANIC                      N2PF.                               
      @226    HISPANIC_X                    $CHAR4.                             
      @230    HOSPST                        $CHAR2.                             
      @232    I10_DX_Admitting              $CHAR7.                             
      @239    I10_DX1                       $CHAR7.                             
      @246    I10_DX2                       $CHAR7.                             
      @253    I10_DX3                       $CHAR7.                             
      @260    I10_DX4                       $CHAR7.                             
      ...
      @692    PL_UIC                        N2PF.                               
      @694    PL_UR_CAT4                    N2PF.                               
      @696    POA_Disch_Edit1               N2PF.                               
      @698    POA_Disch_Edit2               N2PF.                               
      @700    POA_Hosp_Edit1                N2PF.                               
      @702    POA_Hosp_Edit2                N2PF.                               
      @704    POA_Hosp_Edit3                N2PF.                               
      @706    POA_Hosp_Edit3_Value          N8P2F.                              
      @714    PointOfOrigin_X               $CHAR1.                             
      @715    PointOfOriginUB04             $CHAR1.                             
      @716    PRDAY1                        N5PF.                               
      @721    PRDAY2                        N5PF.                               
      @726    PRDAY3                        N5PF.                               
      @731    PRDAY4                        N5PF.                               
